# Write
  <div><!M^1>0<!M#1 #text/0>, <!M^2>1<!M#2 #text/0>, <!M^3>2<!M#3 #text/0>, <!M^4>3<!M#4 #text/0>, <!M/0 #div/0></div><!M#0 #div/0><script>(M$h=[]).push((b,s)=>({1:{},2:{},3:{},4:{}}),[])</script>
