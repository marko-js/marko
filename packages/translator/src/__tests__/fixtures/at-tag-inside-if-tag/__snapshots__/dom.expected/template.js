...
const _customTagBody = /* @__PURE__ */_createRenderer("<!>", /* replace, skip(5) */"%-", null, [_x$customTagBody]);
...
export const walks = /* beginChild(1), _customTag_walks, endChild */`0${_customTag_walks}&`;
