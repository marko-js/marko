...
const _forBody2 = /* @__PURE__ */_createRenderer("<div> </div>",
/* next(1), get */
"D ");

const _val$forBody = /* @__PURE__ */_source(1, [], (_scope, val) => _data(_scope[0], val));

const _forBody = /* @__PURE__ */_createRenderer("<div> </div>",
/* next(1), get */
"D ");

const _for2 = /* @__PURE__ */_loop(7, 1, _forBody2, [_val$forBody2], (_scope, [val]) => _setSource(_scope, _val$forBody2, val), (_scope, arrA = _scope[14]) => [arrA, null]);

const _for = /* @__PURE__ */_loop(0, 1, _forBody, [_val$forBody], (_scope, [val]) => _setSource(_scope, _val$forBody, val), (_scope, arrA = _scope[14]) => [arrA, null]);

const _arrA = /* @__PURE__ */_derivation(14, 1, [_for, _for2], _scope => [1, 2, 3]);
