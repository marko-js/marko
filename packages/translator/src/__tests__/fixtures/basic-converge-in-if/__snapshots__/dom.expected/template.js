...
const _expr_a_b$ifBody = /* @__PURE__ */_subscriber([], 2, (_scope, a = _scope._[1], b = _scope._[2]) => _data(_scope[0], a + b));
const _b$ifBody = /* @__PURE__ */_closure(1, 2, [_expr_a_b$ifBody]);
const _a$ifBody = /* @__PURE__ */_closure(1, 1, [_expr_a_b$ifBody]);
...
const _b = /* @__PURE__ */_source(2, [/* @__PURE__ */_inConditionalScope(_b$ifBody, 0)]);
const _a = /* @__PURE__ */_source(1, [/* @__PURE__ */_inConditionalScope(_a$ifBody, 0)]);
const _setup = _scope => {
