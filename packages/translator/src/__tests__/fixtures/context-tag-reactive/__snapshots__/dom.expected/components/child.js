...
export default /* @__PURE__ */_createRenderFn(template, walks, setup, void 0, closures, "packages/translator/src/__tests__/fixtures/context-tag-reactive/components/child.marko");