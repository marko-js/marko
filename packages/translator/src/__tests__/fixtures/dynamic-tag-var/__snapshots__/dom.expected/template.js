...
const _dynamicTagName3 = /* @__PURE__ */_conditional("#text/2", 1, (_scope, dynamic = _scope["dynamic"]) => dynamic);
const _dynamicTagName2 = /* @__PURE__ */_conditional("#text/1", 1, (_scope, show = _scope["show"]) => show && child);
const _dynamicTagName = /* @__PURE__ */_conditional("#text/0", 1, _scope => child);
const _dynamic = /* @__PURE__ */_source("dynamic", [_dynamicTagName3]);
const _show = /* @__PURE__ */_source("show", [_dynamicTagName2, _dynamicTagName4]);
const _setup = _scope => {
