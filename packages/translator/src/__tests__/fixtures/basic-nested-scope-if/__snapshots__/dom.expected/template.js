...
const _clickCount$elseBody = /* @__PURE__ */_closure(1, 1, [], (_scope, clickCount) => _data(_scope[0], clickCount));
...
const _hydrate_clickCount$ifBody = _register("packages/translator/src/__tests__/fixtures/basic-nested-scope-if/template.marko_1_clickCount", _scope => _on(_scope[0], "click", function () {
  const clickCount = _scope._[1];
  _queueSource(_scope._, _clickCount, clickCount + 1);
}));
const _clickCount$ifBody = /* @__PURE__ */_closure(1, 1, [], (_scope, clickCount) => {
...
const _if = /* @__PURE__ */_conditional(0, 1, (_scope, clickCount = _scope[1]) => clickCount < 3 ? _ifBody : _elseBody);
const _clickCount = /* @__PURE__ */_source(1, [_if, /* @__PURE__ */_inConditionalScope(_clickCount$elseBody, 0), /* @__PURE__ */_inConditionalScope(_clickCount$ifBody, 0)]);
const _setup = _scope => {
