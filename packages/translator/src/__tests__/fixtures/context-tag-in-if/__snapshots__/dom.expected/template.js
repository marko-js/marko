...
const _show$putBody = _registerSubscriber("packages/translator/src/__tests__/fixtures/context-tag-in-if/template.marko_1_show/subscriber", /* @__PURE__ */_dynamicClosure("show", (_scope, show) => _if$putBody(_scope, show ? _ifBody : null), void 0, void 0, _if$putBody));
