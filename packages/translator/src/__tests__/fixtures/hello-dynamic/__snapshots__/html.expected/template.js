...
const _renderer = _register((input, _tagVar, _scope0_) => {
  ...
  _write(`Hello <!>${_escapeXML(input.name)}${_markHydrateNode(_scope0_id, "#text/0")}! Hello <!>${_toString(input.name)}${_markHydrateNode(_scope0_id, "#text/1")}! Hello <!>${_toString(input.missing)}${_markHydrateNode(_scope0_id, "#text/2")}!`);
