...
const _renderer = ({
  ...
  _write(`Hello <!>${_escapeXML(name)}${_markHydrateNode(_scope, 0)}! Hello <!>${_toString(name)}${_markHydrateNode(_scope, 1)}! Hello <!>${_toString(missing)}${_markHydrateNode(_scope, 2)}!`);
};
