...
const _missing = _source(4, [], (_scope, missing) => _html(_scope[2], missing));

const _name = _source(3, [], (_scope, name) => {
  _data(_scope[0], name);

  _html(_scope[1], name);
});

export const attrs = _destructureSources([_name, _missing], (_scope, {
  name,
  missing
}) => {
