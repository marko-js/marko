...
export const walks = /* replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1), replace, skip(5), over(1) */"%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b%-b";
