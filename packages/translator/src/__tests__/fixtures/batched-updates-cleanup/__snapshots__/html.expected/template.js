...
const _renderer = _register((input, _tagVar, _scope0_) => {
  ...
  _writeEffect(_scope0_id, "packages/translator/src/__tests__/fixtures/batched-updates-cleanup/template.marko_0_show");
  _writeScope(_scope0_id, {
    "show": show,
    "#text/1!": _scope1_,
    "#text/1(": _ifRenderer
  }, _scope0_);
}, "packages/translator/src/__tests__/fixtures/batched-updates-cleanup/template.marko");
