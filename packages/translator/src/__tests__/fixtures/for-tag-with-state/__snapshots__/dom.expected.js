...
function _apply_arrB(_scope, arrB) {
  if (_write(_scope, 9, arrB)) _setLoopOf(_scope, 4, arrB, _for2, null, _apply2_val);
}

function _apply_arrA(_scope, arrA) {
  if (_write(_scope, 8, arrA)) _setLoopOf(_scope, 0, arrA, _for, null, _apply1_val);
}
