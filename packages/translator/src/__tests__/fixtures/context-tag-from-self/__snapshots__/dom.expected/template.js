...
const _setup = _scope => {
  _initContextProvider(_scope, 0, 1, "packages/translator/src/__tests__/fixtures/context-tag-from-self/template.marko", _putBody);
  _notifySignal(_scope, _put);
};
export const template = "<div><!></div>";
export const walks = /* next(1), replace, skip(1), out(1) */"D%)l";
