...
const _for = /* @__PURE__ */_loop(0, 1, _forBody, [_child$forBody], (_scope, [child]) => _setSource(_scope, _child$forBody, child), (_scope, input = _scope[1]) => [input.children, function (c) {
  return c.id;
}]);
const _input = /* @__PURE__ */_source(1, [_for]);
