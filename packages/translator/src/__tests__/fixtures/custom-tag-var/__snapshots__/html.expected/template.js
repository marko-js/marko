...
const _renderer = /* @__PURE__ */_createRenderer((input, _tagVar) => {
  ...
  const data = _child._({}, _register( /* @__PURE__ */_createRenderer(() => {}), "packages/translator/src/__tests__/fixtures/custom-tag-var/template.marko_0_data", _scope0_id));
  _write(`<div>${_escapeXML(data)}${_markResumeNode(_scope0_id, "#text/1")}</div>`);
  _writeScope(_scope0_id, {});
});
export default /* @__PURE__ */_createTemplate(_renderer, "packages/translator/src/__tests__/fixtures/custom-tag-var/template.marko");