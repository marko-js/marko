...
const _hydrate_show = _register("packages/translator/src/__tests__/fixtures/lifecycle-tag-conditional/template.marko_0_show", _scope => _on(_scope[7], "click", function () {
  const show = _scope[9];
  _queueSource(_scope, _show, !show);
}));
const _show = /* @__PURE__ */_source(9, [_if], (_scope, show) => _queueHydrate(_scope, _hydrate_show));
const _hydrate_x = _register("packages/translator/src/__tests__/fixtures/lifecycle-tag-conditional/template.marko_0_x", _scope => _on(_scope[6], "click", function () {
  const x = _scope[8];
