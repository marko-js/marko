...
export default /* @__PURE__ */_createRenderFn(template, walks, setup, null, closures, "packages/translator/src/__tests__/fixtures/migrate-out-global/template.marko");