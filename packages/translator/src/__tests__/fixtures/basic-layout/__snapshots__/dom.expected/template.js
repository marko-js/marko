import { data as _data, bindRenderer as _bindRenderer, setSource as _setSource, dynamicSubscribers as _dynamicSubscribers, dynamicClosure as _dynamicClosure, createRenderer as _createRenderer, source as _source, notifySignal as _notifySignal, destructureSources as _destructureSources, createRenderFn as _createRenderFn } from "@marko/runtime-fluurt/src/dom";
...
const _setup = _scope => {
  ...
  _notifySignal(_scope, _layout_attrs);
};
...
export const walks =
/* beginChild(1), _layout_walks, endChild */
`0${_layout_walks}&`;
