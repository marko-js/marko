...
const _expr_c_d = /* @__PURE__ */_subscriber([], 2, (_scope, c = _scope[2], d = _scope[3]) => _classAttr(_scope[0], ["a", {
  b: c,
  d
}]));
...
const _input = /* @__PURE__ */_source(1, []);
...
export const walks =
/* get, over(3), beginChild(4), _customTag_walks, endChild, beginChild(5), _customTag_walks, endChild */
` d3${_customTag_walks}&4${_customTag_walks}&`;
