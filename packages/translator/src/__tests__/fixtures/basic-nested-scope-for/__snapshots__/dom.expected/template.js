...
const _expr_selected_num$forBody = /* @__PURE__ */_subscriber([], 2, (_scope, selected = _scope._[1], num = _scope[2]) => {
...
const _selected$forBody = /* @__PURE__ */_closure(1, 1, [_expr_selected_num$forBody]);
...
const _selected = /* @__PURE__ */_source(1, [/* @__PURE__ */_inLoopScope(_selected$forBody, 0)]);
const _setup = _scope => {
