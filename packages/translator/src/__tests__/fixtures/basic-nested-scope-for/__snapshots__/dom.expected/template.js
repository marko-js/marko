import { setSource as _setSource, on as _on, attr as _attr, queueSource as _queueSource, data as _data, subscriber as _subscriber, inLoopScope as _inLoopScope, closure as _closure, source as _source, register as _register, queueHydrate as _queueHydrate, createRenderer as _createRenderer, loop as _loop, notifySignal as _notifySignal, createRenderFn as _createRenderFn } from "@marko/runtime-fluurt/src/dom";
...
const _hydrate_num$forBody = _register("packages/translator/src/__tests__/fixtures/basic-nested-scope-for/template.marko_1_num", _scope => _on(_scope[0], "click", function () {
  const num = _scope[2];
