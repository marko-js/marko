...
const _forBody9 = /* @__PURE__ */_createRenderer("<div> </div><div></div><div></div>",
/* get, next(1), get, out(1), over(1), get */
" D lb ");

const _i$forBody6 = "SIGNAL NOT INITIALIZED";

const _forBody8 = /* @__PURE__ */_createRenderer("<div> </div><div></div><div></div>",
/* get, next(1), get, out(1), over(1), get */
" D lb ");

const _i$forBody5 = "SIGNAL NOT INITIALIZED";

const _forBody7 = /* @__PURE__ */_createRenderer("<div> </div><div></div><div></div><!>",
...
const _forBody6 = /* @__PURE__ */_createRenderer("<div><!>: <!></div><div></div><div></div>",
...
const _forBody5 = /* @__PURE__ */_createRenderer("<div><!>: <!></div>",
...
const _forBody4 = /* @__PURE__ */_createRenderer("<div><!>: <!></div><div></div><div></div>",
/* get, next(1), replace, over(2), replace, out(1), over(1), get */
" D%c%lb ");

const _i$forBody2 = "SIGNAL NOT INITIALIZED";

const _forBody3 = /* @__PURE__ */_createRenderer("<div> </div><div></div><div></div>",
/* next(1), get */
"D ");
...
const _forBody2 = /* @__PURE__ */_createRenderer("<div><!>: <!></div><div></div><div></div>",
...
const _forBody = /* @__PURE__ */_createRenderer("<div><!>: <!></div><div></div><div></div>",
/* next(1), replace, over(2), replace */
"D%c%");

const _for3 = /* @__PURE__ */_loop(28, 1, _forBody5, [_val$forBody4, _i$forBody4, _list$forBody], (_scope, [val, i, list]) => {
...
const _for2 = /* @__PURE__ */_loop(21, 1, _forBody4, [_val$forBody3, _i$forBody3], (_scope, [val, i]) => {
...
const _obj = /* @__PURE__ */_derivation(71, 1, [], _scope => ({
  a: 1,
  b: 1,
  c: 1
}));

const _arr = /* @__PURE__ */_derivation(70, 1, [_for, _for2, _for3], _scope => [1, 2, 3]);
