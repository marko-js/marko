...
const _for3 = /* @__PURE__ */_loop("#text/4", 1, _forBody5, [_val$forBody4, _i$forBody4, _list$forBody], (_scope, [val, i, list]) => {
...
const _for2 = /* @__PURE__ */_loop("#text/3", 1, _forBody4, [_val$forBody3, _i$forBody3], (_scope, [val, i]) => {
...
const _obj = /* @__PURE__ */_derivation("obj", 1, [], _scope => ({
  a: 1,
  b: 1,
  c: 1
}));
const _arr = /* @__PURE__ */_derivation("arr", 1, [_for, _for2, _for3], _scope => [1, 2, 3]);
const _setup = _scope => {
