...
const _renderer = (input, _tagVar) => {
  ...
  if (true) {
    ...
    _write(`<div></div>${_markHydrateNode(_scope1_, "#div/0")}`);
  }
  _writeHydrateCall(_scope0_, "packages/translator/src/__tests__/fixtures/native-tag-ref-hoisting/template.marko_0");
};
