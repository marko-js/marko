...
_marko_template._ = _marko_renderer(function (input, out, _component, component, state) {
  ...
  if (_tagName) out.w(`<${_tagName}></${_tagName}>`);

  const _tagName2 = input.show && "div";

  if (_tagName2) out.w(`<${_tagName2}></${_tagName2}>`);
  ...
  if (_tagName7) out.w(`<${_tagName7}></${_tagName7}>`);
  ...
  if (tagConstB) out.w(`<${tagConstB}></${tagConstB}>`);
  let tagLazyAssign;
  tagLazyAssign = "a";
  if (tagLazyAssign) out.w(`<${tagLazyAssign}></${tagLazyAssign}>`);
