...
module.exports = !require.extensions[".marko"]
  ...
  : function load(templatePath, templateSrc, options) {
    switch (arguments.length) {
      ...
      case 2:
        return (fallback = fallback || require("./fallback-node"))(templatePath, templateSrc);
      case 3:
        return (fallback = fallback || require("./fallback-node"))(templatePath, templateSrc, options);
    }
  };
