...
//           child,
//           "Unexpected content in script tag only javascript/typescript is supported.",
//           SyntaxError,
//         );
//       }
...
//       start == null || end == null
//         ? parseExpression(tag.hub.file, code)
//         : parseExpression(tag.hub.file, code, "()=>{".length, start, end);
