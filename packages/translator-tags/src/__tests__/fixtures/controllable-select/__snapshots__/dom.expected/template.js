...
const _setup__effect = _effect("packages/translator-tags/src/__tests__/fixtures/controllable-select/template.marko_0", _scope => _controllable_select_value_effect(_scope, "#select/0"));
