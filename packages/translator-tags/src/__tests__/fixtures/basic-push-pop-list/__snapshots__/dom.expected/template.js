...
import { data as _data, on as _on, createRenderer as _createRenderer, value as _value, register as _register, effect as _effect, intersection as _intersection, loopOf as _loopOf, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _expr_id_items_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-push-pop-list/template.marko_0_id_items", _scope => _on(_scope["#button/1"], "click", _onClick(_scope)));
...
const _items_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-push-pop-list/template.marko_0_items", _scope => _on(_scope["#button/2"], "click", _onClick2(_scope)));
const _items = /* @__PURE__ */_state("items", (_scope, items) => {
  _items_effect(_scope);
  _for(_scope, [items]);
}, () => _expr_id_items);
const _id = /* @__PURE__ */_state("id", null, () => _expr_id_items);
