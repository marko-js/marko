...
const _setup__effect = _register("packages/translator-tags/src/__tests__/fixtures/controllable-checked/template.marko_0", _scope => _controllable_input_checked_effect(_scope, "#input/0"));
