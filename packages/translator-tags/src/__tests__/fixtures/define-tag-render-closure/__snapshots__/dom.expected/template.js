...
const _x$defineBody = _$.registerSubscriber("__tests__/template.marko_1_x/subscriber", /* @__PURE__ */_$.dynamicClosure("x", (_scope, x) => _$.data(_scope["#text/0"], x)));
const _defineBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRendererWithOwner("<div> </div>", /* next(1), get */"D ", void 0, () => [_x$defineBody]));
