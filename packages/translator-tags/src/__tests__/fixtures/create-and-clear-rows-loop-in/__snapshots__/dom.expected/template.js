import { data as _data, value as _value, createRenderer as _createRenderer, loopIn as _loopIn, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
const _key$forBody2 = /* @__PURE__ */_value("key", (_scope, key) => _data(_scope["#text/0"], key));
const _forBody2 = /* @__PURE__ */_createRenderer("<p> </p>", /* next(1), get */"D ", void 0, void 0, void 0, (_scope, _destructure, _clean) => {
  let key;
...
const _forBody = /* @__PURE__ */_createRenderer("<p><!>: <!></p>", /* next(1), replace, over(2), replace */"D%c%", void 0, void 0, void 0, (_scope, _destructure2, _clean) => {
  let key, text;
