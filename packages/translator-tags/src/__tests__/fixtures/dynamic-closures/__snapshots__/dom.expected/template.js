...
const a = 1;
import { on as _on, data as _data, inChild as _inChild, createRenderer as _createRenderer, dynamicClosure as _dynamicClosure, registerSubscriber as _registerSubscriber, conditional as _conditional, createRendererWithOwner as _createRendererWithOwner, register as _register, dynamicSubscribers as _dynamicSubscribers, state as _state, value as _value, effect as _effect, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _c = /* @__PURE__ */_state("c", null, () => _dynamicSubscribers("c"));
const _b = /* @__PURE__ */_value("b", null, () => _dynamicSubscribers("b"));
const _setup__effect = _effect("packages/translator-tags/src/__tests__/fixtures/dynamic-closures/template.marko_0", _scope => _on(_scope["#button/0"], "click", function () {
  _c(_scope, 4);
}));
