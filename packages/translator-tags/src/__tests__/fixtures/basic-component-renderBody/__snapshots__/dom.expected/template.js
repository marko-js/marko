...
const _clickCount = /* @__PURE__ */_value("clickCount", (_scope, clickCount) => _myButton__onClick_(_scope["#childScope/0"], _onClick(_scope)), _dynamicSubscribers("clickCount"), _inChild("#childScope/0", _myButton__onClick_));
const _setup = _scope => {
