...
import { setTagVar as _setTagVar, dynamicTagAttrs as _dynamicTagAttrs, conditional as _conditional, registerBoundSignal as _registerBoundSignal, value as _value, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
const _inputDynamic_input = _dynamicTagAttrs("#text/2");
const _dynamicTagName = /* @__PURE__ */_conditional("#text/2", _scope => {
  _setTagVar(_scope, "#text/2!", _data3);
