...
import { data as _data, state as _state, value as _value, register as _register, queueEffect as _queueEffect, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _setup__effect = _register("packages/translator-tags/src/__tests__/fixtures/log-tag/template.marko_0", _scope => _output(_scope, JSON.stringify(testLog)));
