...
const _checkedChange = _register("packages/translator-tags/src/__tests__/fixtures/controllable-checked-spread/template.marko_0/checkedChange", _scope => function (v) {
  _queueSource(_scope, _checked, v);
});
