...
const _input__effect = _effect("packages/translator-tags/src/__tests__/fixtures/controllable-checked-spread/components/checkbox.marko_0_input", _scope => _attrsEvents(_scope, "#input/0"));
