# Write
  <div>0<!M*1 #text/0>: <!>1<!M*1 #text/1></div><div>1<!M*2 #text/0>: <!>2<!M*2 #text/1></div><div>2<!M*3 #text/0>: <!>3<!M*3 #text/1></div><div>0<!M*4 #text/0>: <!>1<!M*4 #text/1></div><div>1<!M*5 #text/0>: <!>2<!M*5 #text/1></div><div>2<!M*6 #text/0>: <!>3<!M*6 #text/1></div><!M|0 #text/1 4,5,6><script>(M$h=[]).push(_=>(_.e={0:{"#text/1(":new Map(_.a=[[0,_.b={}],[1,_.c={}],[2,_.d={}]])},4:_.b,5:_.c,6:_.d}),[])</script>
...
<html>
  ...
  <body>
    ...
    <!--M|0 #text/1 4,5,6-->
    <script>
      (M$h=[]).push(_=&gt;(_.e={0:{"#text/1(":new Map(_.a=[[0,_.b={}],[1,_.c={}],[2,_.d={}]])},4:_.b,5:_.c,6:_.d}),[])
    </script>
  </body>
</html>
```
