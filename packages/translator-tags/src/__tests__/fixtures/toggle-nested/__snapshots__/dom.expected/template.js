...
const _value2$ifBody = _$.registerSubscriber("__tests__/template.marko_3_value2/subscriber", /* @__PURE__ */_$.dynamicClosure("value2", (_scope, value2) => _$.data(_scope["#text/0"], value2), _scope => _scope._._));
const _ifBody3 = _$.register("__tests__/template.marko_3_renderer", /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", void 0, () => [_value2$ifBody]));
const _value1$ifBody = _$.registerSubscriber("__tests__/template.marko_2_value1/subscriber", /* @__PURE__ */_$.dynamicClosure("value1", (_scope, value1) => _$.data(_scope["#text/0"], value1), _scope => _scope._._));
const _ifBody2 = _$.register("__tests__/template.marko_2_renderer", /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", void 0, () => [_value1$ifBody]));
...
const _ifBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<!><!><!><!>", /* replace, over(1), replace */"D%b%D", void 0, () => [_value2$ifBody2, _value1$ifBody2]));
