...
const _destructure3 = (_scope, {
  ...
  _children_(_scope, children);
};
export const _input_ = /* @__PURE__ */_value("input", (_scope, input) => _destructure3(_scope, input));
export const _template_ = "<div></div>";
export const _walks_ = /* get, over(1) */" b";
export const _setup_ = function () {};
export default /* @__PURE__ */_createTemplate( /* @__PURE__ */_createRenderer(_template_, _walks_, _setup_, void 0, void 0, (_scope, _destructure4, _clean) => {
  let input;
  if (!_clean) [input] = _destructure4;
  _input_(_scope, input, _clean);
}), "packages/translator-tags/src/__tests__/fixtures/move-and-clear-children/template.marko");