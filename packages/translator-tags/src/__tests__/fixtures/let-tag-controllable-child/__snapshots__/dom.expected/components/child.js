...
const _onClick2 = _scope => {
  ...
  return function () {
    _queueSource(_scope, _otherState, otherState + 1);
  };
};
const _otherState_effect = _register("packages/translator-tags/src/__tests__/fixtures/let-tag-controllable-child/components/child.marko_0_otherState", _scope => _on(_scope["#button/3"], "click", _onClick2(_scope)));
const _otherState = /* @__PURE__ */_value("otherState", (_scope, otherState) => {
  _data(_scope["#text/5"], otherState);
  _queueEffect(_scope, _otherState_effect);
});
...
export const _input_ = /* @__PURE__ */_value("input", (_scope, input) => {
  ...
  _otherState_init(_scope, input["value"]);
