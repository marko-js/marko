...
const _expr_input_value_input_valueChange = /* @__PURE__ */_$.intersection(2, _scope => {
  const {
    input_value,
    input_valueChange
  } = _scope;
...
const _input_valueChange = /* @__PURE__ */_$.value("input_valueChange", 0, () => _expr_input_value_input_valueChange);
