...
import { on as _on, inChild as _inChild, createRenderer as _createRenderer, intersection as _intersection, closure as _closure, value as _value, register as _register, loopOf as _loopOf, inLoopScope as _inLoopScope, effect as _effect, intersections as _intersections, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _forBody2 = _register("packages/translator-tags/src/__tests__/fixtures/basic-nested-for/template.marko_2_renderer", /* @__PURE__ */_createRenderer(`${_child_template}`, /* beginChild, _child_walks, endChild */`/${_child_walks}&`, _setup$forBody, () => [_outer$forBody], void 0, () => _params_3$forBody));
...
const _forBody = _register("packages/translator-tags/src/__tests__/fixtures/basic-nested-for/template.marko_1_renderer", /* @__PURE__ */_createRenderer("<!><!><!>", /* replace */"D%D", void 0, () => [_items$forBody], void 0, () => _params_2$forBody));
...
const _items_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-nested-for/template.marko_0_items", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
