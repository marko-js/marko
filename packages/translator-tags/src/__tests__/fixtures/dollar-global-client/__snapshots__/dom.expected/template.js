...
const _ifBody2 = _$.register("__tests__/template.marko_2_renderer", /* @__PURE__ */_$.createRenderer("<span class=hidden> </span>", /* next(1), get */"D ", _setup$ifBody2));
const _setup$ifBody = _scope => {
  _$.data(_scope["#text/0"], _scope.$global.x);
};
const _ifBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", _setup$ifBody));
