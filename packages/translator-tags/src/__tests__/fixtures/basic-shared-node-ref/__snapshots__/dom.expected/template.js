...
import { attr as _attr, data as _data, on as _on, createRenderer as _createRenderer, value as _value, register as _register, loopOf as _loopOf, effect as _effect, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _list_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-shared-node-ref/template.marko_0_list", _scope => _on(_scope["#button/2"], "click", _onClick(_scope)));
const _list = /* @__PURE__ */_state("list", (_scope, list) => {
  _list_effect(_scope);
...
const _open_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-shared-node-ref/template.marko_0_open", _scope => _on(_scope["#button/1"], "click", _onClick2(_scope)));
const _open = /* @__PURE__ */_state("open", (_scope, open) => {
