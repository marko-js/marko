...
const _renderer = /* @__PURE__ */_createRenderer((input, _tagVar) => {
  ...
  }, "packages/translator-tags/src/__tests__/fixtures/controllable-checked-value/template.marko_0/checkedValueChange", _scope0_id), "a")} type=radio>${_markResumeNode(_scope0_id, "#input/0")}<input${_controllable_input_checkedValue(_scope0_id, "#input/1", checkedValue, _register(function (_new_checkedValue2) {
    checkedValue = _new_checkedValue2;
  }, "packages/translator-tags/src/__tests__/fixtures/controllable-checked-value/template.marko_0/checkedValueChange_0", _scope0_id), "b")} type=radio>${_markResumeNode(_scope0_id, "#input/1")}<input${_controllable_input_checkedValue(_scope0_id, "#input/2", checkedValue, _register(function (_new_checkedValue3) {
    checkedValue = _new_checkedValue3;
  }, "packages/translator-tags/src/__tests__/fixtures/controllable-checked-value/template.marko_0/checkedValueChange_0", _scope0_id), "c")} type=radio>${_markResumeNode(_scope0_id, "#input/2")}<span>${_escapeXML(checkedValue)}${_markResumeNode(_scope0_id, "#text/3")}</span>`);
