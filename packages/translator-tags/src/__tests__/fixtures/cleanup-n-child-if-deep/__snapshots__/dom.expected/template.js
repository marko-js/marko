...
const _ = _register("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0/_", _scope => function (msg) {
...
const _ifBody3 = _registerRenderer("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_3_renderer", /* @__PURE__ */_createRenderer(`${_child_template}`, /* beginChild, _child_walks, endChild */`/${_child_walks}&`, _setup$ifBody3, () => [_write$ifBody3]));
...
const _ifBody2 = _registerRenderer("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_2_renderer", /* @__PURE__ */_createRenderer(`<div>${_child_template}<!></div>`, /* next(1), beginChild, _child_walks, endChild, replace */`D/${_child_walks}&%`, _setup$ifBody2, () => [_write$ifBody2, _showInner$ifBody]));
...
const _ifBody = _registerRenderer("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_1_renderer", /* @__PURE__ */_createRenderer(`<div>${_child_template}<!></div>`, /* next(1), beginChild, _child_walks, endChild, replace */`D/${_child_walks}&%`, _setup$ifBody, () => [_write$ifBody, _showMiddle$ifBody]));
