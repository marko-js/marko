...
const _showInner_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showInner", (_scope, {
  showInner
...
const _showMiddle_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showMiddle", (_scope, {
  showMiddle
...
const _showOuter_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showOuter", (_scope, {
  showOuter
...
_$.register("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0/write", _write2);
