...
const _showInner_effect = _effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showInner", _scope => _on(_scope["#button/2"], "click", _onClick(_scope)));
...
const _showMiddle_effect = _effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showMiddle", _scope => _on(_scope["#button/1"], "click", _onClick2(_scope)));
...
const _showOuter_effect = _effect("packages/translator-tags/src/__tests__/fixtures/cleanup-n-child-if-deep/template.marko_0_showOuter", _scope => _on(_scope["#button/0"], "click", _onClick3(_scope)));
