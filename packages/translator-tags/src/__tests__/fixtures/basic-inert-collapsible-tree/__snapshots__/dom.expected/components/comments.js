...
const _ifBody = _$.register("__tests__/components/comments.marko_2_renderer", /* @__PURE__ */_$.createRenderer(_comments_template, /* beginChild, _comments_walks, endChild */`/${_comments_walks}&`, _setup$ifBody, () => [_id$ifBody, _comment_comments$ifBody]));
...
const _open$forBody_effect = _$.effect("__tests__/components/comments.marko_1_open", (_scope, {
  open
...
const _forBody = _$.register("__tests__/components/comments.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<li><span> </span><button> </button><!></li>", /* get, next(2), get, out(1), get, next(1), get, out(1), replace */" E l D l%", _setup$forBody, () => [_input_path$forBody], () => _params_2$forBody));
