...
export const _input_ = /* @__PURE__ */_value("input", (_scope, input) => _for(_scope, [input.comments]), _inLoopScope(_input$forBody, "#ul/0"), _for);
...
}), "packages/translator-tags/src/__tests__/fixtures/basic-inert-collapsible-tree/components/comments.marko");