...
const _customTagBody = _register("packages/translator-tags/src/__tests__/fixtures/custom-tag-parameters-from-single-arg/template.marko_1_renderer", /* @__PURE__ */_createRendererWithOwner("<div>Count: <!></div>", /* next(1), over(1), replace */"Db%", void 0, void 0, void 0, () => _params_2$customTagBody));
