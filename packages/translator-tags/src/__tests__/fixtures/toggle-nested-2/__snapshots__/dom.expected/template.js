...
const _count$ifBody_effect = _$.effect("__tests__/template.marko_2_count", (_scope, {
  _: {
    _: {
      count
    }
...
const _count$ifBody = _$.registerSubscriber("__tests__/template.marko_2_count/subscriber", /* @__PURE__ */_$.dynamicClosure("count", (_scope, count) => {
  _$.data(_scope["#text/1"], count);
  _count$ifBody_effect(_scope);
}, _scope => _scope._._));
const _ifBody2 = _$.register("__tests__/template.marko_2_renderer", /* @__PURE__ */_$.createRenderer("<button id=count> </button>", /* get, next(1), get */" D ", void 0, () => [_count$ifBody]));
const _if$ifBody = /* @__PURE__ */_$.conditional("#text/1", 0);
const _inner$ifBody_effect = _$.effect("__tests__/template.marko_1_inner", (_scope, {
  _: {
    inner
  }
}) => _$.on(_scope["#button/0"], "click", function () {
...
const _ifBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<button id=inner></button><!><!>", /* get, over(1), replace */" b%D", void 0, () => [_inner$ifBody]));
