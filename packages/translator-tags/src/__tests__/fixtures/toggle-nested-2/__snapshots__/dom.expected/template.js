...
const _count$ifBody_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/toggle-nested-2/template.marko_2_count", (_scope, {
  _: {
    _: {
      count
    }
...
const _inner$ifBody_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/toggle-nested-2/template.marko_1_inner", (_scope, {
  _: {
    inner
  }
}) => _$.on(_scope["#button/0"], "click", function () {
...
const _outer_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/toggle-nested-2/template.marko_0_outer", (_scope, {
  outer
}) => _$.on(_scope["#button/0"], "click", function () {
  _outer(_scope, !outer);
}));
