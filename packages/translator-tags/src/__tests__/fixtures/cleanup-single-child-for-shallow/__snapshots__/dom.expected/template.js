...
const _ = _register("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-for-shallow/template.marko_0/_", _scope => function (msg) {
...
const _forBody = _registerRenderer("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-for-shallow/template.marko_1_renderer", /* @__PURE__ */_createRenderer(`${_child_template}`, /* beginChild, _child_walks, endChild */`/${_child_walks}&`, _setup$forBody, [_write$forBody], void 0, _params_2$forBody));
...
const _items_effect = _register("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-for-shallow/template.marko_0_items", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
