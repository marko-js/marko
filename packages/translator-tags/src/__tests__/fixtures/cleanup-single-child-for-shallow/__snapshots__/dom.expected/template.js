...
const _expr_items_items_length_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-for-shallow/template.marko_0_items_items_length", _scope => _$.on(_scope["#button/0"], "click", _onClick(_scope)));
