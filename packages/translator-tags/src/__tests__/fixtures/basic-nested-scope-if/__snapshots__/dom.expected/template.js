...
import { on as _on, data as _data, createRenderer as _createRenderer, closure as _closure, register as _register, effect as _effect, conditional as _conditional, inConditionalScope as _inConditionalScope, intersections as _intersections, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _clickCount$ifBody_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-nested-scope-if/template.marko_1_clickCount", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
...
const _clickCount = /* @__PURE__ */_state("clickCount", (_scope, clickCount) => _if(_scope, clickCount < 3 ? _ifBody : _elseBody), () => _intersections([_if, _inConditionalScope(_clickCount$ifBody, "#text/0"), _inConditionalScope(_clickCount$elseBody, "#text/0")]));
