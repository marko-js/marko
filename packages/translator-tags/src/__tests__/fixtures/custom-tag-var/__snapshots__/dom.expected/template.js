...
const _data = _$.registerBoundSignal("packages/translator-tags/src/__tests__/fixtures/custom-tag-var/template.marko_0_data/var", /* @__PURE__ */_$.value("data", (_scope, data) => _$.data(_scope["#text/1"], data)));
