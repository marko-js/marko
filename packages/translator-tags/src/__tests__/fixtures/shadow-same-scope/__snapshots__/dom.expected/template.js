...
const _count4_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/shadow-same-scope/template.marko_0__count3", (_scope, {
  _count3
...
const _count3_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/shadow-same-scope/template.marko_0__count2", (_scope, {
  _count2
...
const _count2_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/shadow-same-scope/template.marko_0__count", (_scope, {
  _count
...
const _count_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/shadow-same-scope/template.marko_0_count", (_scope, {
  count
