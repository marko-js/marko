...
import { createRenderer as _createRenderer, effect as _effect, conditional as _conditional, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
const _setup$ifBody_effect = _effect("packages/translator-tags/src/__tests__/fixtures/native-tag-ref-downstream-effect/template.marko_1", _scope => _scope._["#div/0"].textContent = "hello");
