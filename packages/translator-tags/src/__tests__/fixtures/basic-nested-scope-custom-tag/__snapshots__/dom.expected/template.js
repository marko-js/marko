...
import { on as _on, data as _data, inChild as _inChild, createRendererWithOwner as _createRendererWithOwner, effect as _effect, dynamicClosure as _dynamicClosure, registerSubscriber as _registerSubscriber, register as _register, dynamicSubscribers as _dynamicSubscribers, state as _state, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _count$childBody_effect = _effect("packages/translator-tags/src/__tests__/fixtures/basic-nested-scope-custom-tag/template.marko_1_count", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
