...
const _by = _register("packages/translator-tags/src/__tests__/fixtures/remove-and-add-rows/template.marko_0/by", _scope => function (c) {
  return c.id;
});
...
const _forBody = _register("packages/translator-tags/src/__tests__/fixtures/remove-and-add-rows/template.marko_1_renderer", /* @__PURE__ */_createRenderer(" ", /* get */" ", void 0, void 0, void 0, _params_2$forBody));
