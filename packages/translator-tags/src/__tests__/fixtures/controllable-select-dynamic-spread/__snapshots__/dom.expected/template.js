...
const _tagSelectBody = _register("packages/translator-tags/src/__tests__/fixtures/controllable-select-dynamic-spread/template.marko_1_renderer", /* @__PURE__ */_createRenderer("<option>A</option><option>B</option><option>C</option>", /* get, over(1), get, over(1), get */" b b ", _setup$tagSelectBody));
...
const _tag = /* @__PURE__ */_value2("tag", (_scope, tag) => _dynamicTagName(_scope, (tag ? "select" : {}) || _tagSelectBody), _dynamicTagName);
