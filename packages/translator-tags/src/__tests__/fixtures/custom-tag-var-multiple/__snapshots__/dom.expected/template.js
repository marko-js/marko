...
const _data = _register("packages/translator/src/__tests__/fixtures/custom-tag-var-multiple/template.marko_0_data", /* @__PURE__ */_value("data", (_scope, data) => _data2(_scope["#text/1"], data)));
const _setup = _scope => {
...
export default /* @__PURE__ */_createTemplate( /* @__PURE__ */_createRenderer(template, walks, setup), "packages/translator/src/__tests__/fixtures/custom-tag-var-multiple/template.marko");