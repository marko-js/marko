...
const _renderer = /* @__PURE__ */_$.createRenderer((input, _tagVar) => {
  ...
  const value = "hello";
  _$.write(`<input${_$.controllable_input_value(_scope0_id, "#input/0", value, _$.register(function (_new_value) {
    value = _new_value;
...
export default /* @__PURE__ */_$.createTemplate(_renderer, "packages/translator-tags/src/__tests__/fixtures/controllable-input-value/template.marko");