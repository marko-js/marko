...
const _num = /* @__PURE__ */_value("num", (_scope, num) => _for(_scope, [num, 0, 1]), _inLoopScope(_num$forBody, "#text/0"));
const _setup = _scope => {
  _num(_scope, 0);
};
