...
import { on as _on, data as _data, createRenderer as _createRenderer, value as _value, effect as _effect, closure as _closure, register as _register, loopTo as _loopTo, inLoopScope as _inLoopScope, intersections as _intersections, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _num$forBody_effect = _effect("packages/translator-tags/src/__tests__/fixtures/for-event-handler/template.marko_1_num", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
const _num$forBody = /* @__PURE__ */_closure("num", (_scope, num) => _num$forBody_effect(_scope));
