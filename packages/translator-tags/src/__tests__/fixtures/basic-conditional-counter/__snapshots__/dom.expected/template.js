...
import { on as _on, data as _data, createRenderer as _createRenderer, closure as _closure, register as _register, conditional as _conditional, queueEffect as _queueEffect, inConditionalScope as _inConditionalScope, state as _state, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _count = /* @__PURE__ */_state("count", (_scope, count) => _queueEffect(_scope, _count_effect), () => _inConditionalScope(_count$ifBody, "#text/2"));
