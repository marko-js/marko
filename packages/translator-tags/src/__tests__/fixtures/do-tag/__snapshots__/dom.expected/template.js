...
const _2 = _register("packages/translator-tags/src/__tests__/fixtures/do-tag/template.marko_0/__0", _scope => function () {
  log.const += "rendered";
});
const _3 = _register("packages/translator-tags/src/__tests__/fixtures/do-tag/template.marko_0/__0", _scope => {
  const {
    str
  } = _scope;
  return function () {
...
const _str = /* @__PURE__ */_value("str", (_scope, str) => _3(_scope)(_scope));
