...
const _expr_name_write_effect = _effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-deep/components/child.marko_0_name_write", _scope => {
  const {
    name,
    write
  } = _scope;
