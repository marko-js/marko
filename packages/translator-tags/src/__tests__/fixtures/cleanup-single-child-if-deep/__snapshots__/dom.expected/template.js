...
const _showInner_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-deep/template.marko_0_showInner", _scope => _$.on(_scope["#button/2"], "click", _onClick(_scope)));
...
const _showMiddle_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-deep/template.marko_0_showMiddle", _scope => _$.on(_scope["#button/1"], "click", _onClick2(_scope)));
...
const _showOuter_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-deep/template.marko_0_showOuter", _scope => _$.on(_scope["#button/0"], "click", _onClick3(_scope)));
...
export default /* @__PURE__ */_$.createTemplate(/* @__PURE__ */_$.createRenderer(_template_, _walks_, _setup_), "packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-deep/template.marko");