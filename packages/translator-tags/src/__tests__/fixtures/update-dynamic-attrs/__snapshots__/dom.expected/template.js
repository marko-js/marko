...
import { attrs as _attrs, attrsEvents as _attrsEvents, attr as _attr, partialAttrs as _partialAttrs, effect as _effect, intersection as _intersection, state as _state, value as _value, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
const _expr_input_a_effect = _effect("packages/translator-tags/src/__tests__/fixtures/update-dynamic-attrs/template.marko_0_input_a", _scope => _attrsEvents(_scope, "#div/1"));
...
const _input__effect = _effect("packages/translator-tags/src/__tests__/fixtures/update-dynamic-attrs/template.marko_0_input", _scope => {
  const {
    input
  } = _scope;
