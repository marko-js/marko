...
const _show_effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/cleanup-single-child-if-same-scope/template.marko_0_show", _scope => _$.on(_scope["#button/0"], "click", _onClick(_scope)));
