...
const _input__effect = _register("packages/translator-tags/src/__tests__/fixtures/cleanup-effect-signal/components/child.marko_0_input", _scope => {
  const {
    input
  } = _scope;
  input.write('mounted');
...
export default /* @__PURE__ */_createTemplate( /* @__PURE__ */_createRenderer(_template_, _walks_, _setup_, void 0, void 0, _params__), "packages/translator-tags/src/__tests__/fixtures/cleanup-effect-signal/components/child.marko");