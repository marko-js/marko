...
import { _setup_ as _helloSetter, _args_ as _helloSetter_args, _template_ as _helloSetter_template, _walks_ as _helloSetter_walks } from "./components/hello-setter.marko";
const _setup = _scope => {
