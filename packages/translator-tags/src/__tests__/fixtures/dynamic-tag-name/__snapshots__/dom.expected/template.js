...
export const walks = /* replace, over(1), replace, over(1), get, over(1), get, over(1), replace, over(1), replace, over(1), beginChild, _undefined_walks, endChild, beginChild, _undefined_walks, endChild, beginChild, _undefined_walks, endChild, replace, over(1), get, over(1), get, over(1), get, over(1), get, over(1), get, over(1) */`%b%b b b%b%b/${_undefined_walks}&/${_undefined_walks}&/${_undefined_walks}&%b b b b b b`;
export const setup = _setup2;
export default /* @__PURE__ */_createTemplate( /* @__PURE__ */_createRenderer(template, walks, setup, void 0, void 0, void 0, void 0, void 0, args), "packages/translator-tags/src/__tests__/fixtures/dynamic-tag-name/template.marko");