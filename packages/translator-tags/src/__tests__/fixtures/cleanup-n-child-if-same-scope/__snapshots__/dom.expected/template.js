...
const _setup$ifBody_effect = _$.effect("__tests__/template.marko_1", _scope => {
...
const _ifBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<div>a</div><span>b</span><p>c</p>", "", _setup$ifBody));
