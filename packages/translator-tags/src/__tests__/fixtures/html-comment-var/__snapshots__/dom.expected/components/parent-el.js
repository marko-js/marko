...
const _setup__effect = _$.effect("packages/translator-tags/src/__tests__/fixtures/html-comment-var/components/parent-el.marko_0", _scope => _tagName(_scope, _scope["#comment/0"].parentElement.tagName));
