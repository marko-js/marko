...
const _renderer = /* @__PURE__ */_$.createRenderer((input, _tagVar) => {
  ...
  const divName = _parentEl({}, _$.register(() => {}, "packages/translator-tags/src/__tests__/fixtures/html-comment-var/template.marko_0_divName/var", _scope0_id));
  _$.write(`${_$.escapeXML(divName)}${_$.markResumeNode(_scope0_id, "#text/1")}</div><span>`);
  const _childScope2 = _$.peekNextScope();
  const spanName = _parentEl({}, _$.register(() => {}, "packages/translator-tags/src/__tests__/fixtures/html-comment-var/template.marko_0_spanName/var", _scope0_id));
