import { queueSource as _queueSource, on as _on, data as _data, register as _register, queueEffect as _queueEffect, intersection as _intersection, value as _value, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _y_change = /* @__PURE__ */_value("_y_change", null, _expr__y_change_y);
const _x = /* @__PURE__ */_value("x", (_scope, x) => {
  _data(_scope["#text/1"], x);
  _y(_scope, x);
}, _y);
const _valueChange = _scope => function (newValue) {
