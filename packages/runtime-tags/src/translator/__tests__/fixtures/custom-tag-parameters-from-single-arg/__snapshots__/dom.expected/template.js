...
const _customTagBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRendererWithOwner("<div>Count: <!></div>", /* next(1), over(1), replace */"Db%", void 0, void 0, () => _params_2$customTagBody));
