...
// A shell serves content a tag names or a patch may create that nothing
// registers (a registered body resolves through its module), or a renderer
// that cannot mount a child.
