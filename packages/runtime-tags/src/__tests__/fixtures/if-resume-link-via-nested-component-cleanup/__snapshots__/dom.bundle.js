...
const $if$1 = /*@__PURE__*/ _if(0, $template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("b"), $if_content__setup);
...
const $if = /*@__PURE__*/ _if(2, "<!>", /*@__PURE__*/ ((_w0) => `/${_w0}&`)("%b"), $if_content__show);
