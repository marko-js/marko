...
var child_default = _template("__tests__/tags/child.marko", (input) => {
	...
	_html(`<input${_attr_input_value($scope0_id, "#input/0", input.value)}${_attr_class(input.class)}${_attr("data-a", input.a)}>${_el_resume($scope0_id, "#input/0", $sg__input_class__OR__input_value__OR__input_a)}`);
