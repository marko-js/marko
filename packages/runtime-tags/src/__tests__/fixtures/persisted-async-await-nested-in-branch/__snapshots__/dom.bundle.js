...
const $await_content2 = /*@__PURE__*/ _await_content(0, "<em><!>:<!></em>", "D%c%", $await_content2__setup);
...
const $await_content = _resume("a1", /*@__PURE__*/ _await_content(0, "<!><!><!>", "b%", $await_content__setup));
