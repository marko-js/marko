...
const $if_content2__input_detail = /*@__PURE__*/ _closure_get("input_detail", ($scope) => _text($scope["#text/0"], $scope._._.input_detail), ($scope) => $scope._._, "__tests__/template.marko_2_input_detail#7/subscribe");
