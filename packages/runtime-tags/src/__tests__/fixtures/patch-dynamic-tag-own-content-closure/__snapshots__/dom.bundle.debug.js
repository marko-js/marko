...
const $walks = "b%b D l";
const $Content_content__n = /*@__PURE__*/ _closure_get("n", ($scope) => _text($scope["#text/3"], $scope._.n), 0, "__tests__/template.marko_1_n#7/subscribe");
...
const $Content_content = _content("__tests__/template.marko_1*content", "<em><!> <!> <!></em>", " D%c%c%", $Content_content__setup, $Content_content__$params);
