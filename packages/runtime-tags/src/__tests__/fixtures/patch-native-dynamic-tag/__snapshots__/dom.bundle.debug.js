...
const $walks = "b%b b";
const $inputonsectionarticle_content__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_label", /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/0"], $scope._.input_label), 0, "__tests__/template.marko_1_input_label#5/subscribe"), 0);
...
const $inputonsectionarticle_content__count = /*@__PURE__*/ _closure_get("count", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_1_count#6/subscribe");
const $inputonsectionarticle_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", "<!> <!>", "%c%", $inputonsectionarticle_content__setup);
