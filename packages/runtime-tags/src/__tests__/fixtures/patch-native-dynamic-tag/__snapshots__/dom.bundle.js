// template.marko
const $inputonsectionarticle_content__input_label = /*@__PURE__*/ _fill_join_closure("a1", 5, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.a, $scope._.f), 0, "a1", 5), 0);
...
const $inputonsectionarticle_content__count = /*@__PURE__*/ _closure_get(9, ($scope) => _text($scope.b, $scope._.g), 0, "a2", 6);
