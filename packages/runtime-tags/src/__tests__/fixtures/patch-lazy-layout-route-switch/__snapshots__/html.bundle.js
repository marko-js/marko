...
_shells({
	...
	d1: /*@__PURE__*/ ((_w0, _w1) => `d1;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `b%b/${_w0}&b`)($walks), /*@__PURE__*/ ((_w0) => `<!><!>${_w0}<!>`)($template$2)),
	d2: "d2,<p>home</p>",
...
var template_default = _template_patch("d", (input) => {
	...
	}, $scope0_id, "a", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["d2", "d1"], $scope0_reason, 1);
