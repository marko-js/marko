...
const _c$if_content = _$.registerDynamicClosure("__tests__/template.marko_3_c/subscriber", "c/4", (_scope, c) => _$.data(_scope["#text/2"], c), _scope => _scope._._);
const _b$if_content = /* @__PURE__ */_$.dynamicClosure("b/3", (_scope, b) => _$.data(_scope["#text/1"], b), _scope => _scope._._);
...
const _c$customTag_content = _$.registerDynamicClosure("__tests__/template.marko_1_c/subscriber", "c/4", (_scope, c) => _$.data(_scope["#text/2"], c));
const _b$customTag_content = /* @__PURE__ */_$.dynamicClosure("b/3", (_scope, b) => _$.data(_scope["#text/1"], b));
