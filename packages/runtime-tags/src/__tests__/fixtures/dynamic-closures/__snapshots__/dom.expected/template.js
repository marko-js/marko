...
const _c$if_content = _$.registerDynamicClosure("__tests__/template.marko_3_c/subscriber", "c", (_scope, c) => _$.data(_scope["#text/2"], c), 0, _scope => _scope._._);
const _b$if_content = /* @__PURE__ */_$.dynamicClosure("b", (_scope, b) => _$.data(_scope["#text/1"], b), 0, _scope => _scope._._);
...
const _c$customTag_content = _$.registerDynamicClosure("__tests__/template.marko_1_c/subscriber", "c", (_scope, c) => _$.data(_scope["#text/2"], c));
