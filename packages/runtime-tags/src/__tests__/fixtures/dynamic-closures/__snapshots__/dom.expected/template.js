export const _template = `<button></button>${_customTag_template}<div></div>`;
export const _walks = /* get, over(1), beginChild, _customTag_walks, endChild, get, over(1) */` b/${_customTag_walks}& b`;
const a = 1;
