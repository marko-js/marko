...
const a = 1;
const $if_content2__b = /*@__PURE__*/ _closure_get("b", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._._.b)), ($scope) => $scope._._);
const $if_content2__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], a));
const $if_content2__setup = ($scope) => {
	$if_content2__setup__render($scope);
	$if_content2__b($scope);
	$if_content2__c($scope);
};
const $if_content2__c = /*@__PURE__*/ _closure_get("c", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope._._.c)), ($scope) => $scope._._);
...
const $customtag_content__b = /*@__PURE__*/ _closure_get("b", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.b)));
const $customtag_content__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], a));
const $customtag_content__setup = ($scope) => {
	$customtag_content__setup__render($scope);
	$customtag_content__b($scope);
	$customtag_content__c($scope);
};
const $customtag_content__c = /*@__PURE__*/ _closure_get("c", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope._.c)));
