...
const $frame_content2__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_label", /*@__PURE__*/ _closure_get("input_label", $frame_content2__input_label__OR__b, 0, "__tests__/template.marko_2_input_label#6/subscribe"), 1);
const $frame_content2__setup = ($scope) => {
	$frame_content2__input_label($scope);
	$frame_content2__b($scope);
};
const $frame_content2__b = /*@__PURE__*/ _closure_get("b", $frame_content2__input_label__OR__b, 0, "__tests__/template.marko_2_b#8/subscribe");
...
const $frame_content__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_label", /*@__PURE__*/ _closure_get("input_label", $frame_content__input_label__OR__a, 0, "__tests__/template.marko_1_input_label#6/subscribe"), 0);
const $frame_content__setup = ($scope) => {
	$frame_content__input_label($scope);
	$frame_content__a($scope);
};
const $frame_content__a = /*@__PURE__*/ _closure_get("a", $frame_content__input_label__OR__a, 0, "__tests__/template.marko_1_a#7/subscribe");
