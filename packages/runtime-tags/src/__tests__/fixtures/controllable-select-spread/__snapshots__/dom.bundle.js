...
const $input = /*@__PURE__*/ _const(2, ($scope) => {
	_attrs_content($scope, "a", $scope.c, _controllable_select);
	$input__script($scope);
});

// template.marko
const $myselect_content = /*@__PURE__*/ _content("a1", "<option value=a>A</option><option value=b>B</option><option value=c>C</option>");
