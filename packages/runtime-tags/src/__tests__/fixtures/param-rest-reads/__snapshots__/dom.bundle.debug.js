...
const $child_content__first = /*@__PURE__*/ _render(($scope, first) => _text($scope["#text/0"], first));
const $child_content__$params3_ = /*@__PURE__*/ _render(($scope, $params3_1) => _text($scope["#text/1"], $params3_1));
const $child_content__$params3_2 = /*@__PURE__*/ _render(($scope, $params3_2) => _text($scope["#text/2"], $params3_2));
const $child_content__others_length = /*@__PURE__*/ _render(($scope, others_length) => _text($scope["#text/3"], others_length));
...
const $for_content__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope["#LoopKey"]));
const $for_content__setup = ($scope) => $for_content__setup__render($scope);
const $for_content__meta_length = /*@__PURE__*/ _render(($scope, meta_length) => _text($scope["#text/2"], meta_length));
