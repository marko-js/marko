...
const $input_as__OR__htmlInput = /* @__PURE__ */_._or(5, $scope => $dynamicTag($scope, $scope.inputAs || "div", () => $scope.htmlInput));
export const $inputAs = /* @__PURE__ */_._const("inputAs", $input_as__OR__htmlInput);
export const $htmlInput = /* @__PURE__ */_._const("htmlInput", $input_as__OR__htmlInput);
