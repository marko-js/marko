...
const $walks = " b";
const $setup = () => {};
const $await_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => $input_label($scope["#childScope/0"], $scope._._.input_value), ($scope) => $scope._._, "__tests__/template.marko_2_input_value#4/subscribe");
