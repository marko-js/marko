...
const $catch_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<p class=failed>failed: <!></p>", "Db%l", 0, $catch_content__$params);
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<p class=loading>loading…</p>", "b");
...
_update_content("__tests__/template.marko_3_content", $catch_content_holes);
...
const $catch_content__err_message = ($scope, err_message) => _text($scope["#text/0"], err_message);
const $catch_content__$params = ($scope, $params2) => $catch_content__err_message($scope, $params2[0]?.message);
const $catch_content = _content_resume("__tests__/template.marko_3_content", "<p class=failed>failed: <!></p>", "Db%l", 0, $catch_content__$params);
const $placeholder_content = _content_resume("__tests__/template.marko_2_content", "<p class=loading>loading…</p>", "b");
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<p class=feed> </p>", "D l");
const $try_content__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content__$params);
const $try_content__setup = ($scope) => {
	$await_content($scope);
