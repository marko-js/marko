...
const $catch_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<p class=failed>failed: <!></p>", "Db%", 0, $catch_content__$params);
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<p class=loading>loading…</p>");
...
const $catch_content__err_message = ($scope, err_message) => _text($scope["#text/0"], err_message);
const $catch_content__$params = ($scope, $params2) => $catch_content__err_message($scope, $params2[0]?.message);
const $catch_content = _content_resume("__tests__/template.marko_3_content", "<p class=failed>failed: <!></p>", "Db%", 0, $catch_content__$params);
const $placeholder_content = _content_resume("__tests__/template.marko_2_content", "<p class=loading>loading…</p>");
