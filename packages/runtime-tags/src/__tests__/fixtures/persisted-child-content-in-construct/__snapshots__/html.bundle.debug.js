...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	wrap_default({ content: _content_elide("__tests__/tags/card/index.marko_1*content", () => {
		...
		_html(`<em>${_patch_text($scope1_id, "#text/0", input.note, void 0, $scope0_owned, 0)}</em>`);
		_subscribe(_unfilled_if($scope0_owned, 0) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/tags/card/index.marko", "3:2"));
	}, $scope0_id) });
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason && _scope($scope0_id, { input_note: input.note }, "__tests__/template.marko", 0, { input_note: ["input.note"] });
}, 1, () => [card_default]);
