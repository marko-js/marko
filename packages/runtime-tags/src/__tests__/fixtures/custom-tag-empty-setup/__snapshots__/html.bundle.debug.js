...
var cell_default = _template("__tests__/tags/cell/index.marko", (input) => {
	...
	_html_opens("__tests__/tags/cell/index.marko:1:1"), _html(`<span class=cell>${_escape(input.value)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 0))}</span>`);
...
var row_default = _template("__tests__/tags/row/index.marko", (input) => {
	const $scope0_reason = _scope_reason();
	const $scope0_id = _scope_id();
	_html_opens("__tests__/tags/row/index.marko:1:1"), _html("<div class=row>");
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	let quantity = 2;
	_html_opens("__tests__/template.marko:2:1"), _html(`<button>add</button>${_el_resume($scope0_id, "#button/0")}`);
