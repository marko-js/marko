...
const $walks = " b";
const $for = /*@__PURE__*/ _for_of("#div/0", "<div></div>", "b");
...
const $children = /*@__PURE__*/ _let("children/1", ($scope) => {
	$children_length($scope, $scope.children?.length);
	$for($scope, [$scope.children]);
	$children__script($scope);
});
const $children_length = /*@__PURE__*/ _const("children_length", /*@__PURE__*/ _render(($scope) => _attr($scope["#div/0"], "data-children", $scope.children_length)));
