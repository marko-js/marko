...
const $walks = " b";
const $setup = () => {};
const $widget_content__item_text = /*@__PURE__*/ _closure_get("item_text", ($scope) => _text($scope["#text/0"], $scope._.item_text), 0, "__tests__/template.marko_2_item_text#3/subscribe");
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#ul/0", /*@__PURE__*/ ((_w0) => `<li>${_w0}</li>`)($template$1), /*@__PURE__*/ ((_w0) => `D/${_w0}&l`)("b%c"), $for_content__setup, $for_content__$params);
