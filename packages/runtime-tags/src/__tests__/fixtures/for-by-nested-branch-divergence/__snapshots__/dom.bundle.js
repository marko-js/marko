// template.marko
const $else_content__item_id = /*@__PURE__*/ _if_closure(0, 1, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.e)));
const $else_content__setup = $else_content__item_id;
const $if_content__item_id = /*@__PURE__*/ _if_closure(0, 0, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.e)));
