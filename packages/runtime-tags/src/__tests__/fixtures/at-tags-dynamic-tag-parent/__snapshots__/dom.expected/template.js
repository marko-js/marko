...
const $footer_content = _$.registerContent("__tests__/template.marko_3_renderer", "Footer content", /* over(1) */"b");
const $header_content = _$.registerContent("__tests__/template.marko_2_renderer", "Header content", /* over(1) */"b");
