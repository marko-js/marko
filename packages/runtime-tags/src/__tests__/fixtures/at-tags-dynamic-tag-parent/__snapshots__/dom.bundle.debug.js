...
const $footer_content = _content("__tests__/template.marko_3*content", "Footer content");
const $header_content = _content("__tests__/template.marko_2*content", "Header content");
const $x_content = _content("__tests__/template.marko_1*content", "Body content");
