...
const $input_header_class = /*@__PURE__*/ _render(($scope, input_header_class) => _attr_class($scope["#header/0"], input_header_class));
...
const $input_footer_class = /*@__PURE__*/ _render(($scope, input_footer_class) => _attr_class($scope["#footer/3"], input_footer_class));
