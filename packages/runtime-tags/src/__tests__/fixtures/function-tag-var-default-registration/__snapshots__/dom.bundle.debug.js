...
const $onClick3__script = _script("__tests__/template.marko_0_onClick#3", ($scope) => _on($scope["#button/0"], "click", $scope.onClick));
...
_resumed["__tests__/template.marko_0/updateText"] = $updateText;
