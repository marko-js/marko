...
var widget_default = _template_persisted("__tests__/tags/widget/index.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, { input_label: input.label }, "__tests__/tags/widget/index.marko", 0, { input_label: ["input.label"] }) : _filled_guard($scope0_owned, 0) && _patch_write($scope0_id, "input_label", input.label);
}, 0, 0);
