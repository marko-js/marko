...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_html("</main>");
	$scope0_page ? _scope($scope0_id, { input_tag: input.tag }, "__tests__/template.marko", 0, { input_tag: ["input.tag"] }) : _filled_guard($scope0_reason, 2) && _patch_write($scope0_id, "input_tag", input.tag);
}, 1, 0);
