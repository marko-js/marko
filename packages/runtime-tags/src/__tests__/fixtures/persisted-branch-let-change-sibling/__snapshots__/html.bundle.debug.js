...
_shells({
	"__tests__/template.marko": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko;${_w0};${_w1}`)(((_w0) => `0${_w0}&E lDb%l%l`)(""), ((_w0) => `${_w0}<main><h1> </h1><p>Last <!></p><!></main>`)("")),
	...
	_if(() => {
		if (input.show) {
			...
			_scope($scope1_id, {
				...
				count: "6:10",
				"TagVariableChange:count": ["countChange", "6:10"]
			});
			return 0;
		}
