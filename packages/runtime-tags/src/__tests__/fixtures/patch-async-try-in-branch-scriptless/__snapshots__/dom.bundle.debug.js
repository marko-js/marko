...
const $try_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => $try_content__await_promise($scope, Promise.resolve($scope._._.input_value)), ($scope) => $scope._._, "__tests__/template.marko_2_input_value#4/subscribe");
