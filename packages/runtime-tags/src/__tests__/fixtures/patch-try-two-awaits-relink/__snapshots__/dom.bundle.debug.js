...
const $if_content__input_fast = /*@__PURE__*/ _closure_get("input_fast", ($scope) => $if_content__await_promise($scope, $scope._._.input_fast), ($scope) => $scope._._, "__tests__/template.marko_2_input_fast#5/pending");
...
const $try_content__input_slow = /*@__PURE__*/ _closure_get("input_slow", ($scope) => $try_content__await_promise($scope, $scope._.input_slow));
