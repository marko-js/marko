...
const $if_content__for = /*@__PURE__*/ _for_of("#ol/0", "<li><em>TASK_ROW_MARKUP</em> <span class=name> </span>: <span class=eta> </span></li>", "Db bD lbD ", $for_content__setup, $for_content__$params);
const $if_content__setup = ($scope) => $if_content__for($scope, [getTasks?.($scope.$global.day), function(task) {
	return task.id;
}]);
...
const $if = /*@__PURE__*/ _if("#text/2", "<ol class=lane></ol>", " ", $if_content__setup, "<p class=closed>lane closed</p>");
