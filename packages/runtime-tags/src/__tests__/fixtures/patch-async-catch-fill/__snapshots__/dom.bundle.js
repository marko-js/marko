// template.marko
const $catch_content__input_title = /*@__PURE__*/ _fill_join_closure("a0", 5, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.a, $scope._.f), 0, "a3", 5), 0);
...
const $catch_content = _content_resume("a4", "<p><!> <!></p>", "D%c%", $catch_content__setup, $catch_content__$params);
