...
const $template = /*@__PURE__*/ ((_w0, _w1) => `<!>${_w0}${_w1}<button id=x>x</button><button id=y>y</button>`)($template$1, $Local_content__template);
const $walks = /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}& b b`)($walks$1, $Local_content__walks);
...
const $x = /*@__PURE__*/ _let("x/4", $x__closure);
const $y__closure = /*@__PURE__*/ _closure($Local_content__y);
const $y = /*@__PURE__*/ _let("y/5", $y__closure);
