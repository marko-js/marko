...
const $try_content__input_message = /*@__PURE__*/ _closure_get("input_message", ($scope) => _text($scope["#text/0"], $scope._.input_message), 0, "__tests__/template.marko_1_input_message#5/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_message($scope);
	$try_content__input_boom($scope);
};
const $try_content__input_boom = /*@__PURE__*/ _closure_get("input_boom", ($scope) => _text($scope["#text/1"], $scope._.input_boom ? boom() : ""), 0, "__tests__/template.marko_1_input_boom#6/subscribe");
