...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "loading related…");
...
const $await_content2 = /*@__PURE__*/ _await_content("#text/4", $await_content2__template, $await_content2__walks);
...
_static_shells({
	"__tests__/template.marko_5_update": [$await_content2__template, $await_content2__walks],
	"__tests__/template.marko_5_content": [$await_content2__template, $await_content2__walks],
...
_update_content("__tests__/template.marko_5_update", $await_content2_holes);
const $noop_update = () => {};
...
const $await_content__for = /*@__PURE__*/ _for_of("#ul/0", "<li><!> costs <!></li>", "D%c%", 0, $for_content__$params);
const $await_content__related = ($scope, related) => {
	if (!updating) $await_content__for($scope, [related, function(item) {
		return item.id;
	}]);
...
const $await_content__$params = ($scope, $params2) => $await_content__related($scope, $params2[0]);
const $placeholder_content = _content_resume("__tests__/template.marko_2_content", "loading related…");
...
const $input_title = ($scope, input_title) => _text($scope["#text/0"], input_title);
const $await_content2 = /*@__PURE__*/ _await_content("#text/4", "<em> </em>", "D ");
const $await_promise = /*@__PURE__*/ _await_promise("#text/4", $await_content2__$params);
const $input_note = ($scope, input_note) => {
	if (!updating) $await_promise($scope, resolveAfter(input_note, 2));
};
