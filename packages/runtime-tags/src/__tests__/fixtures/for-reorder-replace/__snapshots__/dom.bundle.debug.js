...
const $walks = " b";
const $setup = () => {};
const $for_content__child_id = /*@__PURE__*/ _render(($scope, child_id) => _attr($scope["#span/0"], "id", child_id));
const $for_content__child_text = /*@__PURE__*/ _render(($scope, child_text) => _text($scope["#text/1"], child_text));
