...
const $x = _var_resume("__tests__/template.marko_0_x/var", /*@__PURE__*/ _let_persisted("x/8"));
...
const $update2 = (_patch, _live) => {
	...
	if ("x" in _patch) _update_seed(_live, $x_seed, _patch["x"]);
	if ("input_data" in _patch) _live["input_data"] = _patch["input_data"];
