...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_try($scope0_id, "#text/2", _content_resume("__tests__/template.marko_1_content", () => {
		...
		}, $sg__input_data__OR__input_tick, "__tests__/template.marko_3_update");
...
_renderer_shells({
	...
	"__tests__/template.marko_0_update": ["<h1> </h1><section><!></section>", " D lD%l"],
	"__tests__/template.marko": ["<h1> </h1><section><!></section>", " D lD%l"]
});
