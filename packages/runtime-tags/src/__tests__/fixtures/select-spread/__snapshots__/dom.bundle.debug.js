...
const $walks = " b Db l";
const $n = /*@__PURE__*/ _let("n/6", /*@__PURE__*/ _render(($scope) => _attr($scope["#option/2"], "value", $scope.n)));
...
const $input_rest__render = /*@__PURE__*/ _render(($scope) => _attrs($scope, "#select/1", $scope.input_rest));
