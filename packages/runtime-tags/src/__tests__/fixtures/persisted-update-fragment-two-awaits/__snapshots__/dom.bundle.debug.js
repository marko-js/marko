...
const $await_content2 = /*@__PURE__*/ _await_content("#text/1", "<p class=summary> </p>", "D l");
...
const $Reports_content__try = /*@__PURE__*/ _try("#text/0", "<!><!><!><!>", "b%b%c", $try_content__setup);
...
const $try_content__update = (_patch, _live) => {
	...
	if ("BranchScopes:#text/1" in _patch) _update_branch(_patch, _live, "#text/1", $await_content2_holes);
};
