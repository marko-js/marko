...
const $walks = "D%b l";
const $if_content__mk = /*@__PURE__*/ _fill_join("__tests__/template.marko0", "mk", /*@__PURE__*/ _if_closure("#text/0", 0, ($scope) => _text($scope["#text/0"], $scope._.mk())));
...
_resumed["__tests__/template.marko_0/mk"] = $mk;
