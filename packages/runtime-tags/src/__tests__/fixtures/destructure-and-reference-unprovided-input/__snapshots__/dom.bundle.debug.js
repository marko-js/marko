...
const $walks$1 = " D%l";
const $setup$1 = () => {};
const $input_class = /*@__PURE__*/ _render(($scope, input_class) => _attr_class($scope["#div/0"], [input_class, "foo"]));
const $rest__render = /*@__PURE__*/ _render(($scope) => _attrs_partial($scope, "#div/0", $scope.rest, { class: 1 }));
