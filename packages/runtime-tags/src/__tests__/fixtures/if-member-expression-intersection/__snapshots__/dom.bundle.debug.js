...
const $walks$1 = " b";
const $if_content__text = /*@__PURE__*/ _if_closure("#div/0", 0, /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.text)));
...
const $id__render = /*@__PURE__*/ _render(($scope) => _attr($scope["#div/0"], "id", $scope.id));
