...
<html>
  ...
  <body>
    ...
    <script>
      WALKER_RUNTIME("M")("_");M._.r=[_=&gt;(_.c={1:_.a={"#text/0=":3,"#text/0:":"b","tag/3":"select","#text/0!":_.b={},"#text/0(":"select"},2:_.b},_.a["#text/0;"]=_._["__tests__/template.marko_0/valueChange"](_.a),_.c),3,"__tests__/template.marko_1",0];M._.w()
    </script>
  </body>
</html>
```
