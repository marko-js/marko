...
const $tagselect_content = _content_resume("__tests__/template.marko_1*content", "<option>A</option><option>B</option><option>C</option>", " b b ", $tagselect_content__setup);
