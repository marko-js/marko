...
const $walks = " b";
const $setup = () => {};
const $for_content__user_name = /*@__PURE__*/ _render(($scope, user_name) => _text($scope["#text/0"], user_name));
const $for_content__user_role = /*@__PURE__*/ _render(($scope, user_role) => _text($scope["#text/1"], user_role));
