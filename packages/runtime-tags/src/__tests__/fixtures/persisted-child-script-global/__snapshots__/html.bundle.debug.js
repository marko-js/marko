...
var badge_default = _template_persisted("__tests__/tags/badge/index.marko", (input) => {
	...
	$scope0_reason ? writeScope($scope0_id, { $global_brand: $global$1?.brand }, "__tests__/tags/badge/index.marko", 0, { $global_brand: ["$global.brand"] }) : _patch_write($scope0_id, "$global_brand", $global$1?.brand);
}, 0, 1);
