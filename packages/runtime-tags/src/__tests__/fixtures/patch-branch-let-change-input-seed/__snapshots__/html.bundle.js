...
var template_default = _template_patch("a", (input) => {
	...
	let last = 0;
	_html(`<main><p>last ${_text_resume($scope0_id, "a", last, 2)}</p>`);
	_if(() => {
		if (input.show) {
	...
	}, $scope0_id, "b", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["a1"], $scope0_reason, 1);
	_html("</main>");
	$scope0_page && _scope($scope0_id, { f: _source_if($scope0_reason, 1) && input.start });
}, 1, 0);
