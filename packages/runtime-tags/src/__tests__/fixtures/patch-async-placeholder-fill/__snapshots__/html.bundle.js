...
var template_default = _template_patch("a", (input) => {
	...
	_try($scope0_id, "a", _content_resume("a2", () => {
		...
		_subscribe(_source_if($scope0_reason, 0) && $input_label__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }), _client_guard($scope0_reason, 0) && "a3", $sg__input_label);
