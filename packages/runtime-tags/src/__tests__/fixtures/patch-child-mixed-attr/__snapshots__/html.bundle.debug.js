...
var price_card_default = _template_patch("__tests__/tags/price-card/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<p>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 0)} x${_patch_text($scope0_id, "#text/1", input.qty, 2, $scope0_reason, 1)}</p>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/price-card/index.marko", 0);
}, 0, 0);
