...
const $box_content__input_a = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(7, $box_content__input_a__OR__input_b, ($scope) => $scope._._, "a5", 4), 0);
const $box_content__setup = ($scope) => {
	$box_content__input_a($scope);
	$box_content__input_b($scope);
};
const $box_content__input_b = /*@__PURE__*/ _fill_join_closure("a1", 5, /*@__PURE__*/ _closure_get(8, $box_content__input_a__OR__input_b, ($scope) => $scope._._, "a6", 5), 0);
