...
const $box_content__input_a = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_a", /*@__PURE__*/ _closure_get("input_a", $box_content__input_a__OR__input_b, ($scope) => $scope._._, "__tests__/template.marko_2_input_a#4/subscribe"), 0);
const $box_content__setup = ($scope) => {
	$box_content__input_a($scope);
	$box_content__input_b($scope);
};
const $box_content__input_b = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_b", /*@__PURE__*/ _closure_get("input_b", $box_content__input_a__OR__input_b, ($scope) => $scope._._, "__tests__/template.marko_2_input_b#5/subscribe"), 0);
