...
export default _._template("__tests__/template.marko", input => {
  ...
  }, "id", $scope0_id, "#div/0", /* state: items */1, /* state: items */1, /* state: items */1, "</div>", 1);
  ...
  }, item => item.id, $scope0_id, "#div/1", /* state: items */1, /* state: items */1, /* state: items */1, "</div>", 1);
  ...
  }, getStringBy(), $scope0_id, "#div/2", /* state: items */1, /* state: items */1, /* state: items */1, "</div>", 1);
  ...
  }, getFunctionBy(), $scope0_id, "#div/3", /* state: items */1, /* state: items */1, /* state: items */1, "</div>", 1);
  ...
  }, getMissingBy(), $scope0_id, "#div/4", /* state: items */1, /* state: items */1, /* state: items */1, "</div>", 1);
