...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	}, "id", $scope0_id, "#div/0", 1, 1, 1, "</div>", 1, 1);
	...
	}, (item) => item.id, $scope0_id, "#div/1", 1, 1, 1, "</div>", 1, 1);
	...
	}, getStringBy(), $scope0_id, "#div/2", 1, 1, 1, "</div>", 1, 1);
	...
	}, getFunctionBy(), $scope0_id, "#div/3", 1, 1, 1, "</div>", 1, 1);
	...
	}, getMissingBy(), $scope0_id, "#div/4", 1, 1, 1, "</div>", 1, 1);
