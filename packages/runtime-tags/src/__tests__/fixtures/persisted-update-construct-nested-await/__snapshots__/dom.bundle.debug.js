...
const $placeholder_content2 = /*@__PURE__*/ _content("__tests__/template.marko_7_content", "<p class=sub>detail…</p>");
...
const $await_content__try = /*@__PURE__*/ _try("#text/1", $try_content2__template, $try_content2__walks, $try_content2__setup);
...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_4_content", "<p class=loading>summary…</p>");
...
_update_content("__tests__/template.marko_8_update", $await_content2_holes);
const $noop_update = () => {};
...
const $await_content2__detail = ($scope, detail) => _text($scope["#text/0"], detail);
const $await_content2__$params = ($scope, $params3) => $await_content2__detail($scope, $params3[0]);
const $placeholder_content2 = _content_resume("__tests__/template.marko_7_content", "<p class=sub>detail…</p>");
const $await_content2 = /*@__PURE__*/ _await_content("#text/0", "<p class=detail> </p>", "D ");
const $try_content2__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content2__$params);
const $try_content2__setup = ($scope) => {
	$await_content2($scope);
	if (!updating) $try_content2__await_promise($scope, getDetail($scope.$global.topic));
...
const $await_content__setup = ($scope) => $await_content__try($scope, { placeholder: attrTag({ content: $placeholder_content2($scope) }) });
const $await_content__$params = ($scope, $params2) => $await_content__summary($scope, $params2[0]);
const $placeholder_content = _content_resume("__tests__/template.marko_4_content", "<p class=loading>summary…</p>");
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<p class=summary> </p><!><!>", "D l%", $await_content__setup);
const $try_content__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content__$params);
const $try_content__setup = ($scope) => {
	$await_content($scope);
	if (!updating) $try_content__await_promise($scope, getSummary($scope.$global.topic));
