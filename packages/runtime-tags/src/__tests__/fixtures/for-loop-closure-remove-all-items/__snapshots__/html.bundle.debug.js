...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_of(items, () => {
		...
		_html_opens("__tests__/template.marko:5:5"), _html(`<button>Test</button>${_el_resume($scope1_id, "#button/0")}`);
		_script($scope1_id, "__tests__/template.marko_1");
		writeScope($scope1_id, {}, "__tests__/template.marko", "4:4");
	}, 0, $scope0_id, "#text/0", 1, 1, 1, 0, 1);
	_html_opens("__tests__/template.marko:10:3"), _html(`<div></div>${_el_resume($scope0_id, "#div/1")}</div>`);
