...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	const one = { content: _content_resume("__tests__/template.marko_1*content", () => {
		...
		_subscribe(_unfilled_if($scope0_reason, 0) && $input_title__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "1:2"), _client_guard($scope0_reason, 0) && "__tests__/template.marko_1_input_title#3/subscribe");
	}, $scope0_id) };
	const two = { content: _content_resume("__tests__/template.marko_2*content", () => {
		...
		}, "__tests__/template.marko", "2:2"), _client_guard($scope0_reason, 0) && "__tests__/template.marko_2_input_title#3/subscribe");
	}, $scope0_id) };
	_html("<div");
	...
	$scope0_page ? _scope($scope0_id, {
		...
		one: $si__input_which && one,
		two: $si__input_which && two,
