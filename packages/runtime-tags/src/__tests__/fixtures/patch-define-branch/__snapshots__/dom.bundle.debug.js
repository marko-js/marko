...
const $foo_content__input_x = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_x", /*@__PURE__*/ _closure_get("input_x", ($scope) => _text($scope["#text/0"], $scope._.input_x), 0, "__tests__/template.marko_1_input_x#4/subscribe"), 0);
