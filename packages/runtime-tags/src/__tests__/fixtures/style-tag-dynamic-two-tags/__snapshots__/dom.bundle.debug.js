...
const $input_a = /*@__PURE__*/ _const("input_a", /*@__PURE__*/ _render(($scope) => _style_rule_item($scope["#style/0"], "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bstyle-19tag-19dynamic-19two-19tags-1btemplate-1amarko_0", $scope.input_a)));
const $input_b = /*@__PURE__*/ _const("input_b", /*@__PURE__*/ _render(($scope) => _style_rule_item($scope["#style/1"], "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bstyle-19tag-19dynamic-19two-19tags-1btemplate-1amarko_1", $scope.input_b)));
