...
const $item_content__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $item_content__if($scope, $scope._.input_show ? 0 : 1), 0, "__tests__/template.marko_1_input_show#6/subscribe");
...
const $item_content__n = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_1_n#7/init", "n", $item_content__n__OR__label, 0, "__tests__/template.marko_1_n#7/subscribe");
