...
var child_default = _template("__tests__/tags/child.marko", (input) => {
	...
	let r = _dynamic_tag($scope0_id, "#text/0", input.content, {}, void 0, void 0, void 0, "__tests__/tags/child.marko:1:1");
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let x = child_default({ content: _content("__tests__/template.marko_1_content", () => {
		...
		_html_opens("__tests__/template.marko:2:3"), _html(`<span>${_escape(x)}${_el_resume($scope1_id, "#text/0")}</span>`);
		const $return = 1;
	...
	_html_opens("__tests__/template.marko:5:1"), _html(`<div>${_escape(x)}${_el_resume($scope0_id, "#text/2")}</div>`);
