...
export default _._template("__tests__/template.marko", (input, $serialize) => {
  ...
  }, $scope0_id, "#text/0", 1, _._serialize_guard($serialize, /* input.show */0), _._serialize_guard($serialize, /* input.show */0), 0, 1);
  _._html(`<button>Update</button>${_._el_resume($scope0_id, "#button/1")}`);
  _._script($scope0_id, "__tests__/template.marko_0");
  _._scope($scope0_id, {
    value: _._serialize_if($serialize, /* input.show */0) && value
