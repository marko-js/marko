...
const $label__script = _script("__tests__/template.marko_0_label", ($scope) => {
	{
		const el = document.querySelector("main");
		el.dataset.log = (el.dataset.log || "") + $scope.label;
	}
});
const $label = _var_resume("__tests__/template.marko_0_label/var", /*@__PURE__*/ _const("label", $label__script));
