...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html_opens("__tests__/template.marko:9:1", "__tests__/template.marko:10:1"), _html(`<button id=load>Load</button><button id=inc>Inc</button>${_el_resume($scope0_id, "#button/2")}`);
