...
const $enabled__render = /*@__PURE__*/ _render(($scope) => {
...
const $count = /*@__PURE__*/ _let("count/8", /*@__PURE__*/ _render(($scope) => _text($scope["#text/5"], $scope.count)));
const $log = /*@__PURE__*/ _let("log/9", /*@__PURE__*/ _render(($scope) => _text($scope["#text/6"], $scope.log)));
