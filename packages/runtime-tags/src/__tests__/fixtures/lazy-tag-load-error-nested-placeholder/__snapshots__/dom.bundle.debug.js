...
const $catch_content = _content_resume("__tests__/template.marko_4*content", "caught: <!>", "b%", 0, $catch_content__$params);
const $try_content2__setup = $load_Child_setup;
const $placeholder_content = _content_resume("__tests__/template.marko_2*content", "loading outer...");
