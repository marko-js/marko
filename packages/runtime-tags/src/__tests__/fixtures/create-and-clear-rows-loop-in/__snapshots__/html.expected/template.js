...
export default _._template("__tests__/template.marko", input => {
  ...
  _._for_in(input.children, (key, text) => {
    ...
    _._html(`<p>${_._escape(key)}: ${_._sep(($sg__input_children))}${_._escape(text)}${_._el_resume($scope1_id, "#text/1", ($sg__input_children))}</p>`);
  ...
  _._for_in(input.children, key => {
    ...
    ($si__input_children) && _._scope($scope2_id, {}, "__tests__/template.marko", "5:4");
