...
export default _._template("__tests__/template.marko", input => {
  ...
  }, 0, $scope0_id, "#text/0", _._serialize_guard($serialize, /* input.children */0), _._serialize_guard($serialize, /* input.children */0), _._serialize_guard($serialize, /* input.children */0), 0, 1);
  ...
  }, 0, $scope0_id, "#text/1", _._serialize_guard($serialize, /* input.children */0), _._serialize_guard($serialize, /* input.children */0), _._serialize_guard($serialize, /* input.children */0), 0, 1);
  _._html("</div>");
