...
const $for_content2 = /* @__PURE__ */_$.createRenderer("<p> </p>", /* next(1), get, out(1) */"D l", 0, $params3$for$content);
...
const $for_content = /* @__PURE__ */_$.createRenderer("<p><!>: <!></p>", /* next(1), replace, over(2), replace, out(1) */"D%c%l", 0, $params2$for$content);
