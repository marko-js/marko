...
const _key$for_content2 = /* @__PURE__ */_$.value("key/2", (_scope, key) => _$.data(_scope["#text/0"], key));
const _params_3$for_content = /* @__PURE__ */_$.value("_params_3/1", (_scope, _params_3) => _key$for_content2(_scope, _params_3[0]));
const _for_content2 = /* @__PURE__ */_$.createRenderer("<p> </p>", /* next(1), get */"D ", void 0, () => _params_3$for_content);
const _text$for_content = /* @__PURE__ */_$.value("text/4", (_scope, text) => _$.data(_scope["#text/1"], text));
...
export const _input_children_ = /* @__PURE__ */_$.value("input_children/4", (_scope, input_children) => {
  _for(_scope, [input_children]);
  _for2(_scope, [input_children]);
});
export const _input_ = /* @__PURE__ */_$.value("input/3", (_scope, input) => _input_children_(_scope, input.children));
