...
const _for_content2 = /* @__PURE__ */_$.createRenderer("<p> </p>", /* next(1), get */"D ", 0, () => _params_3$for_content);
...
const _for_content = /* @__PURE__ */_$.createRenderer("<p><!>: <!></p>", /* next(1), replace, over(2), replace */"D%c%", 0, () => _params_2$for_content);
