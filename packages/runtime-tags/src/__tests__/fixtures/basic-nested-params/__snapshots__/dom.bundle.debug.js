...
const $child_content2__outer = /*@__PURE__*/ _closure_get("outer", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.outer)));
const $child_content2__setup = $child_content2__outer;
const $child_content2__inner = /*@__PURE__*/ _render(($scope, inner) => _text($scope["#text/1"], inner));
