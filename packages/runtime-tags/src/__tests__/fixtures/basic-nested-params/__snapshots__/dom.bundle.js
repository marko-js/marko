...
// template.marko
const $child_content2__outer = /*@__PURE__*/ _closure_get(3, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.c)));
const $child_content2__setup = $child_content2__outer;
const $child_content2__inner = /*@__PURE__*/ _render(($scope, inner) => _text($scope.b, inner));
