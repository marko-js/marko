...
// template.marko
const $child_content2__outer = /*@__PURE__*/ _closure_get(5, ($scope) => _text($scope.a, $scope._.c), 0, "a0");
...
const $child_content = _content("a2", $template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D%l"), $child_content__setup, $child_content__$params);
