...
const _child_content2 = _$.registerContent("__tests__/template.marko_2_renderer", "<div><!>.<!></div>", /* next(1), replace, over(2), replace */"D%c%", 0, () => _params_3$child_content, _scope => _outer$child_content._(_scope));
...
const _child_content = _$.registerContent("__tests__/template.marko_1_renderer", _child_template, /* beginChild, _child_walks, endChild */`/${_child_walks}&`, _setup$child_content, () => _params_2$child_content, _scope => _y$child_content._(_scope));
