...
const _inner$child_content = /* @__PURE__ */_$.value("inner/3", (_scope, inner) => _$.data(_scope["#text/1"], inner));
const _outer$child_content = _$.registerDynamicClosure("__tests__/template.marko_2_outer/subscriber", "outer/2", (_scope, outer) => _$.data(_scope["#text/0"], outer));
const _params_3$child_content = /* @__PURE__ */_$.value("_params_3/2", (_scope, _params_3) => _inner$child_content(_scope, _params_3[0]));
...
const _y$child_content = _$.registerDynamicClosure("__tests__/template.marko_1_y/subscriber", "y/3", (_scope, y) => _child_input_value(_scope["#childScope/0"], y));
const _outer$child_content2 = /* @__PURE__ */_$.value("outer/2", (_scope, outer) => _outer$child_content(_scope));
const _params_2$child_content = /* @__PURE__ */_$.value("_params_2/1", (_scope, _params_2) => _outer$child_content2(_scope, _params_2[0]));
