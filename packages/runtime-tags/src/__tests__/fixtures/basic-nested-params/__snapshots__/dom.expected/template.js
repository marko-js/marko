...
const $child_content2__inner = /* @__PURE__ */_._const("inner", $scope => _._text($scope["#text/1"], $scope.inner));
const $child_content2__setup = $child_content2__outer;
const $child_content2__$params = /* @__PURE__ */_._const("$params3", $scope => $child_content2__inner($scope, $scope.$params3[0]));
