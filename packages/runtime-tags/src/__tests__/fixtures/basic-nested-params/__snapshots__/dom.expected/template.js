export const $template = /*@__PURE__*/(_w0 => `<button>Inc</button>${_w0}`)(_child_template);
export const $walks =
/*@__PURE__*/
/* get, over(1), <child> */
...
const $child_content = _._content_resume("__tests__/template.marko_1_content", _child_template,
/*@__PURE__*/
/* <child> */
(_w0 => `/${_w0}&`)(_child_walks), $child_content__setup, $child_content__$params);
