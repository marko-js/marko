// template.marko
const $for_content__selected__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope.a, $scope._.d === $scope.e && "danger")));
...
const $for_content__row_label = /*@__PURE__*/ _render(($scope, row_label) => _text($scope.b, row_label));
