...
export default _$.createTemplate("__tests__/template.marko", input => {
  ...
  let data2 = _$.dynamicTag($scope0_id, "#text/2", input.show && child, {});
  ...
  let data3 = _$.dynamicTag($scope0_id, "#text/4", input.dynamic, {});
  ...
  let el1 = _$.dynamicTag($scope0_id, "#text/6", input.show && "div", {});
