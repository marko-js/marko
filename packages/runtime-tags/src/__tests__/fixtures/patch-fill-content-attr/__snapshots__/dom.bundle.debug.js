...
const $frame_content__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_label", /*@__PURE__*/ _closure_get("input_label", $frame_content__input_label__OR__count, 0, "__tests__/template.marko_1_input_label#4/subscribe"), 0);
const $frame_content__setup = ($scope) => {
	$frame_content__input_label($scope);
	$frame_content__count($scope);
};
const $frame_content__count = /*@__PURE__*/ _closure_get("count", $frame_content__input_label__OR__count, 0, "__tests__/template.marko_1_count#5/subscribe");
const $frame_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", "<p>value</p>", " ", $frame_content__setup);
