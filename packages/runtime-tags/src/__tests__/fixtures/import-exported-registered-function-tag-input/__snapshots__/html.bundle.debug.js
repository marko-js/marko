...
var press_default = _template("__tests__/tags/press.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	let label = "quiet";
	_html_opens("__tests__/tags/press.marko:2:1", "__tests__/tags/press.marko:3:1"), _html(`<button>press</button>${_el_resume($scope0_id, "#button/0")}<div>${_escape(label)}${_el_resume($scope0_id, "#text/1")}</div>`);
