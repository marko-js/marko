// tags/child.marko
const $Content_content__input_label = /*@__PURE__*/ _fill_join_closure("b0", 2, /*@__PURE__*/ _closure_get(5, ($scope) => _text($scope.b, $scope._.c)), 0);
...
const $Content_content__count = /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.c, $scope._.d));
