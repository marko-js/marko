...
const $walks = /*@__PURE__*/ ((_w0) => `/${_w0}&%b D l`)($MyTag_content__walks);
...
const $if = /*@__PURE__*/ _if("#text/1", $MyTag_content__template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($MyTag_content__walks), $if_content__setup);
