...
const $MyTag_content__x = /*@__PURE__*/ _closure_get("x", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.x)));
...
const $x__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/3"], $scope.x));
