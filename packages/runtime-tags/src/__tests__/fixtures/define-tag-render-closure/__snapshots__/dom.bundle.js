...
const $MyTag_content__x = /*@__PURE__*/ _closure_get(5, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.e)));
...
const $x__render = /*@__PURE__*/ _render(($scope) => _text($scope.d, $scope.e));
