...
var card_default = _template_patch("__tests__/tags/picker/card.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	const $global$1 = $global();
	_html(`<em>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 0)} ${_patch_text($scope0_id, "#text/1", $global$1.brand, 2)}</em>`);
	_global_subscribe("__tests__/tags/picker/card.marko_0_$global_brand#5/global", $scope0_id);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/picker/card.marko", 0);
}, 0, 1);
...
var picker_default = _template_patch("__tests__/tags/picker/index.marko", (input) => {
