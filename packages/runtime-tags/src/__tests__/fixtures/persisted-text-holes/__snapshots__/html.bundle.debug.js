...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_html(`<div class=card><h1>${_patch_text($scope0_id, "#text/0", input.title, void 0, $scope0_owned, 0)}</h1><p>${_patch_text($scope0_id, "#text/1", input.body, void 0, $scope0_owned, 1)}</p></div>`);
