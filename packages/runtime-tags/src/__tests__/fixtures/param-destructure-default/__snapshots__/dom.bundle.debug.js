...
const $ChildB_content__$bar = ($scope, $bar2 = 1) => $ChildB_content__bar($scope, $bar2);
const $ChildB_content__$foo = ($scope, foo = { bar: 2 }) => $ChildB_content__$pattern($scope, foo);
...
const $ChildA_content__$bar = ($scope, $bar = 1) => $ChildA_content__bar($scope, $bar);
const $ChildA_content__$foo = ($scope, foo = { bar: 2 }) => $ChildA_content__$pattern($scope, foo);
