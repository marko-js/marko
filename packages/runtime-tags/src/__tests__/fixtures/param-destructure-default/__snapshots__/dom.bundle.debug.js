...
const $ChildB_content__bar = /*@__PURE__*/ _render(($scope, bar) => _text($scope["#text/0"], bar));
...
const $ChildB_content__foo__render = /*@__PURE__*/ _render(($scope, foo) => _text($scope["#text/1"], typeof foo));
const $ChildB_content__foo = ($scope, foo) => {
	$ChildB_content__foo__render($scope, foo);
...
const $ChildA_content__bar = /*@__PURE__*/ _render(($scope, bar) => _text($scope["#text/0"], bar));
...
const $ChildA_content__foo__render = /*@__PURE__*/ _render(($scope, foo) => _text($scope["#text/1"], typeof foo));
const $ChildA_content__foo = ($scope, foo) => {
	$ChildA_content__foo__render($scope, foo);
