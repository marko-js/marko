...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html_opens("__tests__/template.marko:3:1"), _html(`</div>${_el_resume($scope0_id, "#div/0")}<div`);
	_attrs_content({
		a,
		...input.value
	}, "#div/1", $scope0_id, "div");
	_html_opens("__tests__/template.marko:4:1"), _html(`</div>${_el_resume($scope0_id, "#div/1")}<div${_attr("a", a)}`);
