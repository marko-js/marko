...
const $walks = " b b b";
const $input_value__OR__a__render = /*@__PURE__*/ _render(($scope) => _attrs_content($scope, "#div/1", {
	a: $scope.a,
	...$scope.input_value
}));
...
const $input_value__OR__a = /*@__PURE__*/ _or(7, ($scope) => {
	$input_value__OR__a__render($scope);
	$input_value__OR__a__script($scope);
});
const $a__render = /*@__PURE__*/ _render(($scope) => _attr($scope["#div/2"], "a", $scope.a));
