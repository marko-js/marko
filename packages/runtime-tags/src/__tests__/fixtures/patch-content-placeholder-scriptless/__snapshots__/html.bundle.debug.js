...
var card_default = _template_patch("__tests__/tags/card/index.marko", (input) => {
	...
	_html("<section>");
	_try($scope0_id, "#text/0", _content_resume("__tests__/tags/card/index.marko_2*content", () => {
		...
		$scope0_page && _subscribe(_unfilled_if($scope0_reason, 1) && $input_promise__closures, _scope($scope2_id, { _: _scope_with_id($scope0_id) }, "__tests__/tags/card/index.marko", "2:4"), _client_guard($scope0_reason, 1) && "__tests__/tags/card/index.marko_2_input_promise#4/subscribe", 0);
		...
		_subscribe(_source_if($scope0_reason, 0) && $input_content__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/tags/card/index.marko", "4:6"), _client_guard($scope0_reason, 0) && "__tests__/tags/card/index.marko_1_input_content#3/subscribe", $sg__input_content);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	card_default({
		...
		content: _content_resume("__tests__/template.marko_1*content", () => {
			const $scope1_reason = _scope_reason();
			const $scope1_id = _scope_id();
			_html(`<em>${_patch_text($scope1_id, "#text/0", input.note, void 0, $scope0_reason, 1)}</em>`);
			_subscribe(_unfilled_if($scope0_reason, 1) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "2:4"), _client_guard($scope0_reason, 1) && "__tests__/template.marko_1_input_note#4/subscribe");
		}, $scope0_id)
	});
	_html("</main>");
	$scope0_page && _scope($scope0_id, {
