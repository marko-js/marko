...
const $try_content__input_promise = /*@__PURE__*/ _closure_get("input_promise", ($scope) => $try_content__await_promise($scope, $scope._.input_promise), 0, "__tests__/tags/card/index.marko_2_input_promise#4/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_promise($scope);
	$await_content($scope);
};
const $placeholder_content__dynamicTag = /*@__PURE__*/ _dynamic_tag("#text/0");
const $placeholder_content__input_content = /*@__PURE__*/ _fill_join_closure("__tests__/tags/card/index.marko0", "input_content", /*@__PURE__*/ _closure_get("input_content", ($scope) => $placeholder_content__dynamicTag($scope, $scope._.input_content), 0, "__tests__/tags/card/index.marko_1_input_content#3/subscribe"), 0);
...
const $card_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._.input_note), 0, "__tests__/template.marko_1_input_note#4/subscribe");
