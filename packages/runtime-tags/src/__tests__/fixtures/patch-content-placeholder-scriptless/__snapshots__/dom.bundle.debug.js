...
const $placeholder_content__input_content = /*@__PURE__*/ _closure_get("input_content", ($scope) => $placeholder_content__dynamicTag($scope, $scope._.input_content), 0, "__tests__/tags/card/index.marko_1_input_content#3/subscribe");
