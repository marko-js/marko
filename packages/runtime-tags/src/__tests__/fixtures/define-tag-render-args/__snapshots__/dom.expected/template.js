...
const _c$define_content = /* @__PURE__ */_$.value("c/6", (_scope, c) => _$.data(_scope["#text/2"], c));
const _b$define_content = /* @__PURE__ */_$.value("b/5", (_scope, b) => _$.data(_scope["#text/1"], b));
const _a$define_content = /* @__PURE__ */_$.value("a/4", (_scope, a) => _$.data(_scope["#text/0"], a));
const _params_2$define_content = /* @__PURE__ */_$.value("_params_2/3", (_scope, _params_2) => {
