...
var code_block_default = _template_persisted("__tests__/tags/code-block.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_text_length = _source_guard($scope0_reason, 4), $scope0_page = _page_render(), $si__input_text = _source_if($scope0_reason, 3);
	...
	_if(() => {
		if (input.text.length > 2) {
			...
			_html(`<div>${_patch_html($scope1_id, "#text/0", highlight(input.text), void 0, $scope0_reason, 0)}</div>`);
			_scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/tags/code-block.marko", "4:2");
			return 0;
		} else {
			const $scope2_id = _scope_id();
			_html(`<span>${_patch_html($scope2_id, "#text/0", highlight(input.text), void 0, $scope0_reason, 0)}</span>`);
			_scope($scope2_id, { _: _scope_with_id($scope0_id) }, "__tests__/tags/code-block.marko", "7:2");
			return 1;
		}
	}, $scope0_id, "#text/0", 1, $sg__input_text_length, $sg__input_text_length, void 0, void 0, ["__tests__/tags/code-block.marko_1*shell", "__tests__/tags/code-block.marko_2*shell"], $scope0_reason, 4);
	...
	$scope0_page ? _scope($scope0_id, {
		...
		highlight: "1:8"
	}) : (_filled_guard($scope0_reason, 3) && _client_guard($scope0_reason, 4) && _patch_value($scope0_id, "__tests__/tags/code-block.marko0", input.text), _filled_guard($scope0_reason, 2) && _client_guard($scope0_reason, 4) && _patch_value($scope0_id, "__tests__/tags/code-block.marko1", highlight), _filled_guard($scope0_reason, 2) && _patch_write($scope0_id, "input_cursor", input.cursor));
}, 0, 1);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	_set_serialize_reason(_mask_group($scope0_reason, 0) << 1 | _mask_group($scope0_reason, 0) << 3 | _mask_group($scope0_reason, 0) << 7 | _mask_group($scope0_reason, 0) << 9);
