...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_of(states, (state, i) => {
		...
		let checked = state;
		_html_opens("__tests__/template.marko:12:3"), _html(`<input${_attr_input_checked($scope1_id, "#input/0", checked, _resume((_new_checked) => {
	...
	_html_opens("__tests__/template.marko:14:1"), _html(`<div>${_escape(states.join(","))}${_el_resume($scope0_id, "#text/1")}</div>`);
