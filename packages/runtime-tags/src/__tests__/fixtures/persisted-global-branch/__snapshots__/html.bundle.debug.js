...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_if(() => {
		if ($global$1.meta.headings) {
			...
			$scope0_reason && _scope($scope1_id, {}, "__tests__/template.marko", "3:6");
			return 0;
		}
	}, $scope0_id, "#text/0", 1, $scope0_reason, $scope0_reason, void 0, void 0, ["__tests__/template.marko_1*shell"]);
	_html(`<main>${_patch_text($scope0_id, "#text/1", input.msg, void 0, $scope0_owned, 0)}</main>`);
	_if(() => {
	...
	}, $scope0_id, "#text/2", 1, $scope0_reason, $scope0_reason, void 0, void 0, ["__tests__/template.marko_2*shell"]);
	_trailers("</body></html>");
