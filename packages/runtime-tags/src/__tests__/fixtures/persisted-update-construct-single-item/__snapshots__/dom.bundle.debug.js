...
const $for_update = _update_for_keyed("#text/2", ($p, $l) => $for_content__update($p, $l), "__tests__/template.marko_1_update");
const $for_content__update = ($patch, $live) => {
	if ("BranchScopes:#article/0" in $patch) _update_for($patch["BranchScopes:#article/0"], $live["BranchScopes:#article/0"], $for_content2_holes, $live, "BranchScopes:#article/0", "__tests__/template.marko_2_update");
};
