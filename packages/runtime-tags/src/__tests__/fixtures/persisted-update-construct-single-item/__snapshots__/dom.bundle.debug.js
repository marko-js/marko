...
const $for_content__for = /*@__PURE__*/ _for_of("#article/0", "<span><!>:<!>:<!></span>", "D%c%c%", $for_content2__setup, $for_content2__$params);
const $for_content__setup = ($scope) => $for_content__for($scope, [CELLS, "id"]);
...
const $for = /*@__PURE__*/ _for_of("#text/2", "<article></article>", " ", $for_content__setup, $for_content__$params);
