...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_of($global().items, (item) => {
		...
		}, "id", $scope1_id, "#article/0", _persisted_reason(), _persisted_reason(), 0, "</article>", 1, "__tests__/template.marko_2_update");
...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<span><!>:<!>:<!></span>", "D%c%c%l"],
	"__tests__/template.marko_2_content": ["<span><!>:<!>:<!></span>", "D%c%c%l"],
	"__tests__/template.marko_1_update": ["<article></article>", " b"],
	"__tests__/template.marko_1_content": ["<article></article>", " b"],
