...
const $wrap_content__input_promise = /*@__PURE__*/ _fill_join_closure("a0", 3, /*@__PURE__*/ _closure_get(4, ($scope) => $wrap_content__await_promise($scope, $scope._.d), 0, "a0", 3), 0);
const $wrap_content__setup = ($scope) => {
	$wrap_content__input_promise($scope);
	$await_content($scope);
};
const $wrap_content = _content$1("a1", "<!><!><!>", "b%", $wrap_content__setup);
