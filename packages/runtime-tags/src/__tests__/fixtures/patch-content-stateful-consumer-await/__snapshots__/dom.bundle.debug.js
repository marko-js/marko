...
const $wrap_content__input_promise = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_promise", /*@__PURE__*/ _closure_get("input_promise", ($scope) => $wrap_content__await_promise($scope, $scope._.input_promise)), 0);
