...
const $for_update = _update_for(0, "a1", (branch, args) => _update_scope(args[0], branch));
const $for_update2 = _update_for(1, "a3", (branch, args) => $for_content__update(args[0], branch));
const $count_seed = _update_signal("a5");
const $if_update2 = _update_signal("a4");
