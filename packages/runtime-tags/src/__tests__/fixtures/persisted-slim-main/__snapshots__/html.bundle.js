...
var template_default = _template("a", (input) => {
	...
	_if(() => results.total ? 0 : 1, $scope0_id, "c", _persisted_reason(), _persisted_reason(), _persisted_reason(), void 0, void 0, "a3", [() => {
		...
		_for_of(results.items, (item) => {
			...
			return item.id;
		}, $scope1_id, "a", _persisted_reason(), _persisted_reason(), _persisted_reason(), "</ul>", 1, "a0");
		_html("<nav class=pagination>");
		_for_to(results.totalPages, 1, 1, (page) => {
			const $scope2_id = _scope_id();
			_if(() => page === search.page ? 0 : 1, $scope2_id, "a", _persisted_reason(), _persisted_reason(), _persisted_reason(), 0, 1, "a2", [() => {
		...
		}, 0, $scope1_id, "b", _persisted_reason(), _persisted_reason(), _persisted_reason(), "</nav>", 0, "a1");
