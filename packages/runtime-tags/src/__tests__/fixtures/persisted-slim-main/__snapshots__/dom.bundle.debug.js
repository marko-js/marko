...
const $for_content__if = /*@__PURE__*/ _if("#text/0", "<span class=current> </span>", "D ", $if_content2__setup, "<a> </a>", " D ", $else_content__setup);
...
const $if_content__for2 = /*@__PURE__*/ _for_to("#nav/1", "<!><!><!>", "b%", $for_content__setup);
...
const $if = /*@__PURE__*/ _if("#text/2", "<ul class=items></ul><nav class=pagination></nav>", " b ", $if_content__setup, "<p class=empty>No results</p>");
