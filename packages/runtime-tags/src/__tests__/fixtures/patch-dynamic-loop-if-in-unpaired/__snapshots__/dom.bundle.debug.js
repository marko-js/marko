...
const $for_content__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/1"], $scope._._._.input_label), ($scope) => $scope._._._, "__tests__/template.marko_3_input_label#6/subscribe");
...
const $if_content__input_items = /*@__PURE__*/ _closure_get("input_items", ($scope) => $if_content__for($scope, [$scope._._.input_items]), ($scope) => $scope._._, "__tests__/template.marko_2_input_items#5/subscribe");
const $if_content__setup = $if_content__input_items;
const $Card_content__if = /*@__PURE__*/ _if("#text/0", "<ul></ul>", " ", $if_content__setup);
const $Card_content__input_on = /*@__PURE__*/ _closure_get("input_on", ($scope) => $Card_content__if($scope, $scope._.input_on ? 0 : 1), 0, "__tests__/template.marko_1_input_on#4/subscribe");
