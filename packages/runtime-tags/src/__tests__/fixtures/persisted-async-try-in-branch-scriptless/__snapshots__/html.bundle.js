...
var template_default = _template_persisted("a", (input) => {
	...
	_if(() => {
		if (input.show) {
			...
			_try($scope1_id, "a", _content_resume("a3", () => {
				...
				$scope0_reason && _subscribe(_source_if($scope0_reason, 2) && $input_value__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }));
	...
	}, $scope0_id, "a", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["a4"], $scope0_owned, 1);
