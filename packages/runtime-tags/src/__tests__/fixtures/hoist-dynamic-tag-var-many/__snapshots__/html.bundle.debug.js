...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_to(5, 0, 1, () => {
		...
		let setHtml = _dynamic_tag($scope1_id, "#text/0", 1 && child_default, {}, void 0, void 0, void 0, "__tests__/template.marko:4:3");
	...
	let to = 3;
	_html_opens("__tests__/template.marko:11:1"), _html("<hr>");
	_for_to(to, 0, 1, () => {
		const $scope2_id = _scope_id();
		const $Child_scope2 = _peek_scope_id();
		let setHtml2 = _dynamic_tag($scope2_id, "#text/0", 1 && child_default, {}, void 0, void 0, void 0, "__tests__/template.marko:15:3");
	...
	_html_opens("__tests__/template.marko:22:1"), _html("<hr>");
	_for_to(3, 0, 1, (i) => {
		const $scope3_id = _scope_id();
		_html_opens("__tests__/template.marko:25:3"), _html("<ul>");
		_for_to(3, 0, 1, (j) => {
			const $scope4_id = _scope_id();
			const $Child_scope3 = _peek_scope_id();
			let setHtml3 = _dynamic_tag($scope4_id, "#text/0", 1 && child_default, {}, void 0, void 0, void 0, "__tests__/template.marko:27:5");
