...
const $walks = "b%c%c%c";
const $setHtml3_getter = _hoist_resume("__tests__/template.marko_0_setHtml3#2/hoist", "setHtml3", "BranchScopes:#ul/0", "BranchScopes:#text/2");
const $for_content4__dynamicTag = /*@__PURE__*/ _dynamic_tag("#text/0", 0, () => $for_content4__setHtml);
const $for_content4__setHtml = _var_resume("__tests__/template.marko_4_setHtml3#2/var", /*@__PURE__*/ _const("setHtml3", ($scope) => _assert_hoist($scope.setHtml3)));
const $for_content4__setup = ($scope) => $for_content4__dynamicTag($scope, 1 && child_default);
const $for_content3__for = /*@__PURE__*/ _for_to_unkeyed("#ul/0", "<!><!><!>", "b1", $for_content4__setup);
...
const $for_content2__setHtml = _var_resume("__tests__/template.marko_2_setHtml2#2/var", /*@__PURE__*/ _const("setHtml2", ($scope) => _assert_hoist($scope.setHtml2)));
...
const $for_content__setHtml = _var_resume("__tests__/template.marko_1_setHtml#2/var", /*@__PURE__*/ _const("setHtml", ($scope) => _assert_hoist($scope.setHtml)));
const $for_content__setup = ($scope) => $for_content__dynamicTag($scope, 1 && child_default);
const $for = /*@__PURE__*/ _for_to_unkeyed("#text/0", "<!><!><!>", "b1", $for_content__setup);
const $for2 = /*@__PURE__*/ _for_to_unkeyed("#text/1", "<!><!><!>", "b1", $for_content2__setup);
