...
const $walks = " b";
const $setup = () => {};
const $widget_content__input_text = /*@__PURE__*/ _closure_get("input_text", ($scope) => _text($scope["#text/0"], $scope._._.input_text), ($scope) => $scope._._, "__tests__/template.marko_2_input_text#4/subscribe");
