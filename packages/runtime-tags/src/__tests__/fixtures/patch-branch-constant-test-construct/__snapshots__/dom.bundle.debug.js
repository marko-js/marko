...
const $if_content__input_down$1 = /*@__PURE__*/ _closure_get("input_down", ($scope) => $if_content__if($scope, $scope._._._.input_down ? 0 : 1), ($scope) => $scope._._._, "__tests__/page.marko_3_input_down#3/subscribe");
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/0", $template$2, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$2), $for_content__setup, $for_content__$params);
