...
const $if_content__input_down = /*@__PURE__*/ _closure_get("input_down", ($scope) => $if_content__if($scope, $scope._._._.input_down ? 0 : 1), ($scope) => $scope._._._, "__tests__/page.marko_3_input_down#3/subscribe");
const $if_content__setup = $if_content__input_down;
const $aside_content__if = /*@__PURE__*/ _if("#text/1", "<!><!><!>", "b%", $if_content__setup);
...
const $input = ($scope, input) => $input_down($scope, input.down);
const $input_down__closure = /*@__PURE__*/ _closure($if_content__input_down);
const $input_down = /*@__PURE__*/ _const("input_down", $input_down__closure);
var page_default = /*@__PURE__*/ _template("__tests__/page.marko", $template, "b%c", $setup, $input);
