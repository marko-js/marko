...
const $walks = "b%b b";
const $Box_content__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/0"], $scope._._.input_label), ($scope) => $scope._._, "__tests__/template.marko_2_input_label#5/subscribe");
...
const $inputonCardnull_content__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_1_count#6/init", "count", ($scope) => $input_k($scope["#childScope/0"], $scope._.count), 0, "__tests__/template.marko_1_count#6/subscribe");
...
const $inputonCardnull_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$1), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks$1), $inputonCardnull_content__setup);
