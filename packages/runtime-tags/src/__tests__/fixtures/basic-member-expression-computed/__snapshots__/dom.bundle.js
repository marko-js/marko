// template.marko
const $items__OR__index = /*@__PURE__*/ _or(6, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope.d[$scope.f])));
const $items = /*@__PURE__*/ _let(3, ($scope) => {
	$items_($scope, $scope.d?.[0]);
	$items__OR__index($scope);
});
const $items_ = /*@__PURE__*/ _const(4, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope.e)));
