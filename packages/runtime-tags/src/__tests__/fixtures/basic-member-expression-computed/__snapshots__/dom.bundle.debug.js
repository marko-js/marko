...
const $items__OR__index = /*@__PURE__*/ _or(6, /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.items[$scope.index])));
const $items = /*@__PURE__*/ _let("items/3", ($scope) => {
	$items_($scope, $scope.items?.[0]);
	$items__OR__index($scope);
});
const $items_ = /*@__PURE__*/ _const("items_0", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.items_0)));
