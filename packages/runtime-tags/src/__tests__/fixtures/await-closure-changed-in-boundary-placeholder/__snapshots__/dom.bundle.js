...
// template.marko
const $await_content__count = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.a, $scope._._.c), ($scope) => $scope._._, "a0");
const $boundary_content__count = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.a, $scope._.c), 0, "a1");
