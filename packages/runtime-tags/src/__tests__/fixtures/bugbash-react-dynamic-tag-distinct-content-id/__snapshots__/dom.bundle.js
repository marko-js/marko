// tags/provider.marko
const $content_content__input_value$1 = /*@__PURE__*/ _closure_get(2, ($scope) => _text($scope.a, $scope._.c));
const $content_content$1 = _content_resume("b0", "<span>v:<!></span>", "Db%l", $content_content__input_value$1);

// tags/provider2.marko
const $content_content__input_value = /*@__PURE__*/ _closure_get(2, ($scope) => _text($scope.a, $scope._.c));
const $content_content = _content_resume("c0", "<span>v:<!></span>", "Db%l", $content_content__input_value);
