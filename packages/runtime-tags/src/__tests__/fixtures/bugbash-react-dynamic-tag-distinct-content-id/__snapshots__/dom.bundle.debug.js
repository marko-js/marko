...
const $template$2 = "";
const $walks$2 = "";
const $content_content__input_value$1 = /*@__PURE__*/ _closure_get("value", ($scope) => _text($scope["#text/0"], $scope._.value));
const $content_content__setup$1 = $content_content__input_value$1;
const $content_content$1 = _content_resume("__tests__/tags/provider.marko_1_content", "<span>v:<!></span>", "Db%l", $content_content__setup$1);
const $content$1 = /*@__PURE__*/ _const("content", ($scope) => _return($scope, $scope.content));
function $setup$2($scope) {
	$content$1($scope, { content: $content_content$1($scope) });
}
const $input$1 = ($scope, input) => $value$1($scope, input.value);
const $value__closure$1 = /*@__PURE__*/ _closure($content_content__input_value$1);
const $value$1 = /*@__PURE__*/ _const("value", $value__closure$1);
var provider_default = /*@__PURE__*/ _template("__tests__/tags/provider.marko", "", "", $setup$2, $input$1);
...
const $content_content = _content_resume("__tests__/tags/provider2.marko_1_content", "<span>v:<!></span>", "Db%l", $content_content__setup);
...
var provider2_default = /*@__PURE__*/ _template("__tests__/tags/provider2.marko", "", "", $setup$1, $input);
...
const $a = /*@__PURE__*/ _let("a/8", ($scope) => $value$1($scope["#childScope/0"], $scope.a));
