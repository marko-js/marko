...
var echo_default = _template_patch("__tests__/tags/echo/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	const { ...rest } = input;
	_html(`<em>${_patch_text($scope0_id, "#text/0", rest.label, void 0, $scope0_reason, 0)}</em>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/echo/index.marko", 0);
}, 0, 0);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	}, "__tests__/template.marko", 0, { other: "1:6" });
}, 1, () => [echo_default]);
