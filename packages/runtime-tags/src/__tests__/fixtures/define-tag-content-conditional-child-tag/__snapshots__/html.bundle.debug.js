...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const Box = { content: _content("__tests__/template.marko_2*content", (input) => {
		...
		child_default({ content: _content_resume("__tests__/template.marko_3*content", () => {
			...
			_subscribe($si__input_content && $Box_content2__input_content__closures, _scope($scope3_id, { _: _scope_with_id($scope2_id) }, "__tests__/template.marko", "2:4"), "__tests__/template.marko_3_input_content#3/subscribe", $sg__input_content);
	...
	Box.content({ content: _content_resume("__tests__/template.marko_1*content", () => {
		...
		_subscribe($si__input_label && $input_label__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "7:2"), "__tests__/template.marko_1_input_label#3/subscribe", $sg__input_label);
