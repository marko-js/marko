...
const $child_content__input_content = /*@__PURE__*/ _closure_get(4, ($scope) => $child_content__dynamicTag($scope, $scope._.d));
const $child_content = _content_resume("a0", "<!><!><!>", "b%", $child_content__input_content);
