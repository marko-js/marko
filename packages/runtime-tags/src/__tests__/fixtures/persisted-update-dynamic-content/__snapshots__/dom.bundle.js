...
const $Specs_content = _content_resume("a1", "<ul></ul>", " b", $Specs_content__setup);
...
const $Overview_content = _content_resume("a0", "<p>Overview of <!>: <!></p>", "Db%c%l", $Overview_content__setup);
...
_update_content("a1", $Specs_content__update);
_update_content("a0", $Overview_content_holes);
