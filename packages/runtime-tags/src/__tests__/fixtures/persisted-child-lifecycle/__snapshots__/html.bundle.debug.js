...
const $walks$1 = "D%c%l";
_shells({ "__tests__/tags/widget/index.marko": "__tests__/tags/widget/index.marko !;D%c%;<p><!>:<!></p>" });
var widget_default = _template_persisted("__tests__/tags/widget/index.marko", (input) => {
	const $scope0_owned = _persisted_ownership(), $scope0_reason = _persisted_reason();
	const $scope0_id = _scope_id();
	let mounted = 0;
	_html(`<p>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_owned, 0)}:${_text_resume($scope0_id, "#text/1", mounted, 2)}</p>`);
	_script($scope0_id, "__tests__/tags/widget/index.marko_0_mounted#5");
	_patch_value($scope0_id, "__tests__/tags/widget/index.marko0", mounted, 1);
	$scope0_reason && _scope($scope0_id, { mounted }, "__tests__/tags/widget/index.marko", 0, { mounted: "1:6" });
