...
const $await_content2__b = /*@__PURE__*/ _let("b/2", ($scope) => _text($scope["#text/1"], $scope.b));
const $await_content2__setup__script = _script("__tests__/template.marko_2", ($scope) => _on($scope["#button/0"], "click", function() {
	$await_content2__b($scope, $scope.b + 1);
}));
const $await_content2__setup = ($scope) => {
	$await_content2__b($scope, 1);
	$await_content2__setup__script($scope);
};
const $await_content__a = /*@__PURE__*/ _let("a/2", ($scope) => _text($scope["#text/1"], $scope.a));
