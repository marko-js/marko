...
const $walks = " b";
const $setup = () => {};
const $card_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._._.input_note), ($scope) => $scope._._, "__tests__/template.marko_2_input_note#4/subscribe");
...
const $card_content__input_inner = /*@__PURE__*/ _closure_get("input_inner", ($scope) => $card_content__dynamicTag($scope, $scope._._.input_inner), ($scope) => $scope._._, "__tests__/template.marko_2_input_inner#5/subscribe");
