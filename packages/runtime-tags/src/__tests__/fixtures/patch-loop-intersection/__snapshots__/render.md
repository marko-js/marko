...
## Change
```
UPDATE: main > p:nth-of-type(1)::text "Store a #0" => "Store a #1"
UPDATE: main > p:nth-of-type(2)::text "Store b #0" => "Store b #1"
```
...
UPDATE: main > p:nth-of-type(2)::text "Store b #1" => "Store! b #1"
```
