...
const $walks = " D%c%l";
const $count = /*@__PURE__*/ _let("count/7", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.count)));
...
const $input_label = /*@__PURE__*/ _render(($scope, input_label) => _text($scope["#text/1"], input_label));
