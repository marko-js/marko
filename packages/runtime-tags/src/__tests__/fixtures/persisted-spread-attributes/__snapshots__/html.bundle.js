...
var template_default = _template_persisted("a", (input) => {
	...
	_html(`<main><a${_patch_attrs({
		href: "/static",
		...input.attrs
	}, "a", $scope0_id, "a", void 0, $scope0_owned, 1)}>${_patch_text($scope0_id, "b", input.label, void 0, $scope0_owned, 2)}</a>${_el_resume($scope0_id, "a")}`);
	_if(() => {
		if (input.show) {
			...
			_html(`<img${_patch_attrs({
				alt: "hero",
				...input.img
			}, "a", $scope1_id, "img", void 0, $scope0_owned, 4)}>${_el_resume($scope1_id, "a")}`);
			_script($scope1_id, "a1");
			_scope($scope1_id, { _: _scope_with_id($scope0_id) });
			return 0;
		}
	}, $scope0_id, "c", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["a0"], $scope0_owned, 3);
