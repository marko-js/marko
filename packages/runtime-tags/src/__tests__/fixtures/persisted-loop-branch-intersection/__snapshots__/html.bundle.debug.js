	...
	_for_of(input.items, (item) => {
		...
		_if(() => {
			if (input.flag) {
				...
				_subscribe($count__closures, _subscribe(_source_if($scope0_reason, 3) && $input_suffix__closures, writeScope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "4:6")));
				return 0;
			}
		}, $scope1_id, "#text/0", 1, $sg__input_flag, $sg__input_flag, void 0, void 0, [0]);
		writeScope($scope1_id, {
			item,
			_: _scope_with_id($scope0_id)
		}, "__tests__/template.marko", "3:4", { item: "3:8" });
	}, (item) => item, $scope0_id, "#text/0", 1, _source_guard($scope0_reason, 0), _source_guard($scope0_reason, 1), void 0, void 0, "__tests__/template.marko_1_shell");
