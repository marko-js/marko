...
export const config: TestConfig = {
  persisted: true,
  dom_bundle_excludes: ["getDetails", "server-only", "Part "],
  // The branch's values-free markup is its static shell: held once in the
  // lazy persisted entry, never in an eager module, and never re-shipped
  // with the patch that constructs the branch.
  persisted_entry_only: ["costs ", "use price"],
