...
_renderer_shells({
	"a3": ["<p>no selection</p>", "b"],
	"a6": ["<p>no selection</p>", "b"],
	"a4": ["<section><h2> </h2><p>costs <!></p><button class=copy>use price</button></section>", "E lDb%l l"],
	"a7": ["<section><h2> </h2><p>costs <!></p><button class=copy>use price</button></section>", "E lDb%l l"],
