...
var template_default = _template("__tests__/template.marko", (input) => {
	_scope_reason();
	const $scope0_id = _scope_id();
	_html_opens("__tests__/template.marko:3:1"), _html("<div id=value-missing>");
	wrap_default({ class: "foo" });
	_html_opens("__tests__/template.marko:6:1"), _html("</div><div id=value-undefined>");
	wrap_default({ value: undefined });
	_html_opens("__tests__/template.marko:9:1"), _html("</div><div id=dynamic-value-set>");
	_dynamic_tag($scope0_id, "#text/2", Wrap, {
		class: "bar",
		value: "abcd"
	}, 0, 0, 0, "__tests__/template.marko:10:3");
	_html("</div>");
}, 1);
