...
const $update2$1 = (_patch, _live) => {
	if ("BranchScopes:#div/0" in _patch) _update_for(_patch["BranchScopes:#div/0"], _live["BranchScopes:#div/0"], $for_content_holes);
};
const _merge$1 = _resume("__tests__/tags/chip-list.marko_0_update", $update2$1);
