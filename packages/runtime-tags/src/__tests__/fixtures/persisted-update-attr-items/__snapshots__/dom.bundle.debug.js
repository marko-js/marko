...
const $for_content_content = _resume("__tests__/tags/chip-list.marko_1_content/update", [
	"<span class=chip> </span>",
	" D l",
	$for_content__setup
]);
const $for = /* @__PURE__ */ _for_of("#div/0", $for_content_content[0], $for_content_content[1], $for_content_content[2], $for_content__$params);
