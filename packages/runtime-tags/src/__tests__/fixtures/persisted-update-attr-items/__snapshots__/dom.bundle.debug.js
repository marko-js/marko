...
const $for = /*@__PURE__*/ _for_of("#div/0", "<span class=chip> </span>", " D ", $for_content__setup, $for_content__$params);
...
_static_shells({ "__tests__/tags/chip-list.marko_0_update": [$template$1, " b"] });
const $update2$1 = () => {};
const $for_content__update = ($patch, $live) => {
	if ("cat" in $patch) $live["cat"] = $patch["cat"];
};
_update_content("__tests__/tags/chip-list.marko_1_update", $for_content__update);
