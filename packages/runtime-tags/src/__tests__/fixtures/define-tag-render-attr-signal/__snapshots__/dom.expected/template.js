...
const _number$define_content = /* @__PURE__ */_$.value("number/3", (_scope, number) => _$.data(_scope["#text/0"], number));
const _pattern_$define_content = /* @__PURE__ */_$.value("_pattern_/2", (_scope, _pattern_) => _number$define_content(_scope, _pattern_.number));
const _params_2$define_content = /* @__PURE__ */_$.value("_params_2/1", (_scope, _params_2) => _pattern_$define_content(_scope, _params_2?.[0]));
...
const _MyTag = /* @__PURE__ */_$.value("MyTag/4", (_scope, MyTag) => _expr_x_MyTag(_scope));
