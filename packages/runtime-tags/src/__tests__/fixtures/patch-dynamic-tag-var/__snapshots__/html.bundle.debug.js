...
var one_default = _template_patch("__tests__/tags/one.marko", (input) => {
...
var two_default = _template_patch("__tests__/tags/two.marko", (input) => {
	const $scope0_reason = _scope_reason();
	const $scope0_id = _scope_id();
	_html("<b>two</b>");
	const $return = input.a + "?";
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	let x = _dynamic_tag($scope0_id, "#text/0", $tag, $input2, void 0, void 0, void 0, _patch_dynamic_tag($scope0_id, "#text/0", $tag, $input2, 0, "__tests__/template.marko_0_x#8/var", $scope0_reason, 0));
	_var($scope0_id, "#scopeOffset/1", $inputwhichonetwo_scope, "__tests__/template.marko_0_x#8/var");
	_html(`<p>${_patch_text($scope0_id, "#text/2", x, void 0, $scope0_reason, 0)}</p>`);
