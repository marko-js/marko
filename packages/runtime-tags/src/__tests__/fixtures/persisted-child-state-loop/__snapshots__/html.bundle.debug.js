...
var list_default = _template_persisted("__tests__/tags/list/index.marko", (input) => {
	const $scope0_owned = _persisted_ownership(), $scope0_reason = _persisted_reason(), $sg__input_items__OR__input_suffix = _source_guard($scope0_reason, 0);
	...
	}, 0, $scope0_id, "#ul/0", 1, $sg__input_items__OR__input_suffix, _source_guard($scope0_reason, 1), void 0, void 0, "__tests__/tags/list/index.marko_1*shell", $scope0_owned, 1);
