...
var wrap_default = /*@__PURE__*/ _template_patch("__tests__/tags/wrap.marko", $template$1, "D%l", 0, $input$1);
...
const $wrap_content__input_promise = /*@__PURE__*/ _closure_get("input_promise", ($scope) => $wrap_content__await_promise($scope, $scope._.input_promise));
