...
const $walks = "D%l";
const $setup = () => {};
const $inputmodeaboxAboxB_content__input_text = /*@__PURE__*/ _closure_get("input_text", ($scope) => _text($scope["#text/0"], $scope._.input_text), 0, "__tests__/template.marko_1_input_text#4/subscribe");
