...
const $if_content__comment_comments = /* @__PURE__ */_._if_closure("comment_comments", "#text/4", 0, ($scope, comment_comments) => $input_comments($scope["#childScope/0"], comment_comments));
const $if_content__id = /* @__PURE__ */_._if_closure("id", "#text/4", 0, ($scope, id) => $input_path($scope["#childScope/0"], id));
