...
const _if_content = _$.register("__tests__/components/comments.marko_2_renderer", /* @__PURE__ */_$.createRenderer(_comments_template, /* beginChild, _comments_walks, endChild */`/${_comments_walks}&`, _setup$if_content, () => [_id$if_content, _comment_comments$if_content]));
...
const _open$for_content_effect = _$.effect("__tests__/components/comments.marko_1_open", (_scope, {
  open
...
const _for_content = _$.register("__tests__/components/comments.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<li><span> </span><button> </button><!></li>", /* get, next(2), get, out(1), get, next(1), get, out(1), replace */" E l D l%", _setup$for_content, () => [_input_path$for_content], () => _params_2$for_content));
...
export default /* @__PURE__ */_$.createTemplate("__tests__/components/comments.marko", _template_, _walks_, _setup_, void 0, () => _params__);