...
const $for_content__id__render = /*@__PURE__*/ _render(($scope) => _attr($scope["#li/0"], "id", $scope.id));
const $for_content__id = /*@__PURE__*/ _const("id", ($scope) => {
	$for_content__id__render($scope);
...
const $for_content__open = /*@__PURE__*/ _let("open/12", /*@__PURE__*/ _render(($scope) => {
...
const $for_content__comment_text = /*@__PURE__*/ _render(($scope, comment_text) => _text($scope["#text/1"], comment_text));
