# Write
```html
  <button>inc</button><!--M_*1 #button/0--><!--M_[2--><!--M_!^b-->LOADING...<!--M_!b--><!--M_]1 #text/1--><style M_>t{display:none}</style><t M_=b><!--M_#c--></t><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.c={1:_.a={"#text/1!":_.b={"clickCount(":0,"*":"#text/1"},clickCount:0,"clickCount!":_.d=new Set},2:_.b},_.b._=_.a,_.b["%"]=_._["__tests__/template.marko_2_renderer"](_.a),(_.d).add(_.b),_.c),1,"__tests__/template.marko_0_clickCount"];REORDER_RUNTIME(M._);M._.w()</script>
```

# Write
```html
  <t M_=c><!--M_[4-->0<!--M_*4 #text/0--><!--M_]2 #text/0--></t><script>M._.r.push(_=>(_.e={4:_.f={}},(_.b["#text/0!"]=_.f),_.e));M._.w()</script>
```
...
<html>
  ...
  <body>
    ...
    <!--M_]1 #text/1-->
    <script>
      WALKER_RUNTIME("M")("_");M._.r=[_=&gt;(_.c={1:_.a={"#text/1!":_.b={"clickCount(":0,"*":"#text/1"},clickCount:0,"clickCount!":_.d=new Set},2:_.b},_.b._=_.a,_.b["%"]=_._["__tests__/template.marko_2_renderer"](_.a),(_.d).add(_.b),_.c),1,"__tests__/template.marko_0_clickCount"];REORDER_RUNTIME(M._);M._.w()
    </script>
    <script>
      M._.r.push(_=&gt;(_.e={4:_.f={}},(_.b["#text/0!"]=_.f),_.e));M._.w()
    </script>
  </body>
</html>
```
