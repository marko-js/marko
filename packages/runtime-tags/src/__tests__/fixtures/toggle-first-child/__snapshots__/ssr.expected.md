# Write
```html
  <div><span>Hello<!--M_*2 #text/0--></span><!--M_|1 #text/0 2--><span></span><span></span></div><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.c={1:_.a={value:"Hello","#text/0(":0,"#text/0!":_.b={}},2:_.b},_.b._=_.a,_.c),0]</script>
```
