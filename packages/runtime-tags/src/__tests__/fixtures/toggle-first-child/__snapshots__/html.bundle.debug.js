...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_if(() => {
		if (value) {
			...
			_html_opens("__tests__/template.marko:4:5"), _html(`<span>${_escape(value)}${_el_resume($scope1_id, "#text/0", $sg__input_value)}</span>`);
	...
	_html_opens("__tests__/template.marko:6:3", "__tests__/template.marko:7:3"), _html("<span></span><span></span></div>");
