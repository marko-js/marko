...
const $dynamicType__OR__value = /*@__PURE__*/ _or(12, ($scope) => _attr_input_value_dynamic_default($scope, "#input/7", _attr_input_type($scope["#input/7"], $scope.dynamicType, $scope.value)));
const $dynamicType = /*@__PURE__*/ _let("dynamicType/10", $dynamicType__OR__value);
