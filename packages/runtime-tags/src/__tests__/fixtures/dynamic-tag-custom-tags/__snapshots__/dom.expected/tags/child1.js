...
export const _value_ = /* @__PURE__ */_$.value("value/3", (_scope, value) => _$.data(_scope["#text/0"], value));
...
export default /* @__PURE__ */_$.createTemplate("__tests__/tags/child1.marko", _template_, _walks_, _setup_, () => _params__);