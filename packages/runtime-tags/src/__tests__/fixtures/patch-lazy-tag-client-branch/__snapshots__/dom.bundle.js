...
const $if_content2__input_label = /*@__PURE__*/ _fill_join_closure("b1", 5, /*@__PURE__*/ _closure_get(8, ($scope) => $load_Child_tag_input_label($scope.b, $scope._._.f), ($scope) => $scope._._, "b0", 5), 0);
