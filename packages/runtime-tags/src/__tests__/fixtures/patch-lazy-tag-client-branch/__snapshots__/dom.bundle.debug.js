...
const $if_content2__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_label", /*@__PURE__*/ _closure_get("input_label", ($scope) => $load_Child_tag_input_label($scope["#childScope/1"], $scope._._.input_label), ($scope) => $scope._._, "__tests__/template.marko_2_input_label#5/subscribe"), 0);
