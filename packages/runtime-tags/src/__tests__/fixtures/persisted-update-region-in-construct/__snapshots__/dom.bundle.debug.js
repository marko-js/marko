...
const $await_content__for = /*@__PURE__*/ _for_to("#div/0", "<div class=review>review <!></div>", "Db%l", $for_content2__setup);
...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_5_content", "loading…", "b");
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<div class=reviews></div>", " b", $await_content__setup);
...
const $placeholder_content = _content_resume("__tests__/template.marko_5_content", "loading…", "b");
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<div class=reviews></div>", " b", $await_content__setup);
const $try_content__await_promise = /*@__PURE__*/ _await_promise("#text/0");
const $try_content__setup = ($scope) => {
	$await_content($scope);
