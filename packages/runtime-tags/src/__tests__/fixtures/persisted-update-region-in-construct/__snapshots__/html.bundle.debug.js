...
var sticky_default = _template("__tests__/tags/sticky.marko", (input) => {
	...
	writeScope($scope0_id, { n: _seed_fill(_state_reason() && n) }, "__tests__/tags/sticky.marko", 0, { n: "1:6" });
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const Beta = { content: _content("__tests__/template.marko_2_content", () => {
		...
		}, $scope2_id, "#ul/0", "__tests__/template.marko_r0");
		...
		_try($scope2_id, "#text/3", _content_resume("__tests__/template.marko_4_content", () => {
			...
			_await($scope4_id, "#text/0", resolveAfter(undefined, 1), () => {
				...
				}, $scope6_id, "#div/0", "__tests__/template.marko_r1");
				_html("</div>");
	...
	writeScope($scope0_id, { count: _seed_fill(_state_reason() && count) }, "__tests__/template.marko", 0, { count: "5:6" });
	_resume_branch($scope0_id);
}, 1);
_renderer_shells({
