...
const $walks = "b%b%b%c";
_enable_catch();
const $await_content3__v = /*@__PURE__*/ _render(($scope, v) => _text($scope["#text/0"], v));
...
const $catch_content3 = _content_resume("__tests__/template.marko_8_content", "Rejected C", "b");
const $await_content3 = /*@__PURE__*/ _await_content("#text/0", "<div>Resolved C: <!></div><button>Before</button>", "Db%l b", $await_content3__setup);
...
const $await_content2__v = /*@__PURE__*/ _render(($scope, v) => _text($scope["#text/0"], v));
...
const $await_content__v = /*@__PURE__*/ _render(($scope, v) => _text($scope["#text/0"], v));
...
const $try3 = /*@__PURE__*/ _try("#text/2", "<!><!><!>", "b%c", $try_content3__setup);
function $setup($scope) {
	$try($scope, { catch: attrTag({ content: $catch_content($scope) }) });
	$try2($scope, { catch: attrTag({ content: $catch_content2($scope) }) });
	$try3($scope, { catch: attrTag({ content: $catch_content3($scope) }) });
}
