...
const _i$for_content2 = /* @__PURE__ */_$.value("i/4", (_scope, i) => _$.data(_scope["#text/0"], i));
const _val$for_content2 = /* @__PURE__ */_$.value("val/3", (_scope, val) => _$.data(_scope["#text/1"], val));
...
const _arrA = /* @__PURE__ */_$.value("arrA/2", (_scope, arrA) => _for(_scope, [arrA]));
