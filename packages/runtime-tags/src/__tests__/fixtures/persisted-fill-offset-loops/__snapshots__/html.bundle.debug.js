...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_for_of(input.rows, (row) => {
		...
		_for_of(row.cells, (cell) => {
			...
			_filled_guard($scope0_reason, 1) ? _patch_value($scope2_id, "__tests__/template.marko1", cell) : _patch_init($scope2_id, "__tests__/template.marko_2_input_rows#6/init");
