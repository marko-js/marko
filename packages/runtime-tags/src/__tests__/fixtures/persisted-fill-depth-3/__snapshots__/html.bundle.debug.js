			...
			_if(() => {
				if (input.inner) {
					...
					_for_of(input.items, (item) => {
						...
						_filled_guard($scope0_reason, 3) ? _patch_value($scope3_id, "__tests__/template.marko1", item) : _patch_init($scope3_id, "__tests__/template.marko_3_input_items#6/init");
					...
					_subscribe(_unfilled_if($scope0_reason, 3) && $input_items__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "4:6"));
					return 0;
				}
