...
var tabs_default = _template_persisted("__tests__/tags/tabs/index.marko", (input) => {
	...
	_if(() => {
		if (input.tab.on) {
			...
			_html("<div>a</div>");
			$scope0_reason && _scope($scope1_id, {}, "__tests__/tags/tabs/index.marko", "1:2");
			return 0;
		} else {
	...
	}, $scope0_id, "#text/0", 1, $sg__input_tab_on, $sg__input_tab_on, void 0, void 0, ["__tests__/tags/tabs/index.marko_1*shell", "__tests__/tags/tabs/index.marko_2*shell"], $scope0_owned, 0);
	$scope0_reason && _scope($scope0_id, {}, "__tests__/tags/tabs/index.marko", 0);
}, 0, 0);
