...
export const _walks_ = /* beginChildWithVar, _counter_walks, endChild, get, next(1), get, out(1), get, over(1) */`0${_counter_walks}& D l b`;
...
const _setup__effect = _$.effect("__tests__/template.marko_0", _scope => _$.on(_scope["#button/4"], "click", function () {
