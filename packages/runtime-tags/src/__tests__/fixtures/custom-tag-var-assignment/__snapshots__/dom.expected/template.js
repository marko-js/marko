export const $template = /*@__PURE__*/(_w0 => `${_w0}<button class=inc-parent> </button><button class=reset>reset</button>`)(_counter_template);
export const $walks =
/*@__PURE__*/
/* <counter/var>, get, next(1), get, out(1), get, over(1) */
(_w0 => `0${_w0}& D l b`)(_counter_walks);
