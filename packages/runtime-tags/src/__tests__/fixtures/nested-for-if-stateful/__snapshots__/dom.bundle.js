// template.marko
const $else_content__count = /*@__PURE__*/ _if_closure(0, 1, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope._.c)));
...
const $if_content__count__render = /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope._.c + 1));
