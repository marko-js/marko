...
const _count$else_content = /* @__PURE__ */_$.conditionalClosure("#text/0", () => _else_content, (_scope, count) => _$.data(_scope["#text/1"], count));
...
const _else_content = _$.register("__tests__/template.marko_3_renderer", /* @__PURE__ */_$.createRenderer("<button>Increment <!></button>", /* get, next(1), over(1), replace */" Db%", _setup$else_content));
...
const _i$if_content = /* @__PURE__ */_$.conditionalClosure("#text/0", () => _if_content, 0, () => _expr_counts_count_i$if_content);
const _count$if_content = /* @__PURE__ */_$.conditionalClosure("#text/0", () => _if_content, (_scope, count) => _$.data(_scope["#text/1"], count + 1), () => _expr_counts_count_i$if_content);
...
const _if_content = _$.register("__tests__/template.marko_2_renderer", /* @__PURE__ */_$.createRenderer("<button>Confirm <!></button>", /* get, next(1), over(1), replace */" Db%", _setup$if_content));
const _if$for_content = /* @__PURE__ */_$.conditional("#text/0", 0);
const _editing$for_content = /* @__PURE__ */_$.state("editing", (_scope, editing) => _if$for_content(_scope, editing ? _if_content : _else_content), () => _if$for_content);
...
const _for_content = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<!><!><!>", /* replace */"D%D", _setup$for_content, () => _params_2$for_content));
