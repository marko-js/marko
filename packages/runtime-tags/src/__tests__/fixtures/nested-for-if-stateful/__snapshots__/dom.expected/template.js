...
const _count$else_content = /* @__PURE__ */_$.conditionalClosure("count/2", "#text/0", 1, (_scope, count) => _$.data(_scope["#text/1"], count));
...
const _i$if_content = /* @__PURE__ */_$.conditionalClosure("i/3", "#text/0", 0, (_scope, i) => _expr_counts_count_i$if_content(_scope));
const _count$if_content = /* @__PURE__ */_$.conditionalClosure("count/2", "#text/0", 0, (_scope, count) => {
  _$.data(_scope["#text/1"], count + 1);
  _expr_counts_count_i$if_content(_scope);
});
const _counts$if_content = _$.registerDynamicClosure("__tests__/template.marko_2_counts/subscriber", "counts/1", (_scope, counts) => _expr_counts_count_i$if_content(_scope), _scope => _scope._._);
...
const _i$for_content = /* @__PURE__ */_$.value("i/3", (_scope, i) => _i$if_content(_scope));
const _count$for_content = /* @__PURE__ */_$.value("count/2", (_scope, count) => {
  _count$if_content(_scope);
  _count$else_content(_scope);
});
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/1", (_scope, _params_2) => {
