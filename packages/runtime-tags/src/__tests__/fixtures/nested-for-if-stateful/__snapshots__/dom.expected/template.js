...
const _i$if_content = /* @__PURE__ */_$.conditionalClosure("i", "#text/0", 0, 0, () => _expr_counts_count_i$if_content);
const _count$if_content = /* @__PURE__ */_$.conditionalClosure("count", "#text/0", 0, (_scope, count) => _$.data(_scope["#text/1"], count + 1), () => _expr_counts_count_i$if_content);
const _counts$if_content = _$.registerDynamicClosure("__tests__/template.marko_2_counts/subscriber", "counts", 0, () => _expr_counts_count_i$if_content, _scope => _scope._._);
