...
const $template = "<!><!><!>";
const $walks = "b%c";
const $else_content__count = /*@__PURE__*/ _if_closure("#text/0", 1, /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.count)));
...
const $if_content__count__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.count + 1));
...
const $if_content__count = /*@__PURE__*/ _if_closure("#text/0", 0, ($scope) => {
	$if_content__count__render($scope);
