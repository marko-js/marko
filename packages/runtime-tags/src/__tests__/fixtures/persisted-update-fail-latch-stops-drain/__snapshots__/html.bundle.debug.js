...
var template_default = _template("__tests__/template.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_performers = _serialize_guard($scope0_reason, 4), $si__input_view = _serialize_if($scope0_reason, 5);
	const $scope0_id = _scope_id();
	let count = 0;
	...
	_dynamic_tag($scope0_id, "#text/6", input.view === "ticker" ? ticker_default : "div", { entries: input.entriesB }, 0, 0, _serialize_guard($scope0_reason, 1) | _persisted_reason(), "__tests__/template.marko_0/update_dynamic_#text/6");
