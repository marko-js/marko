...
const $walks = /*@__PURE__*/ ((_w0) => ` Db%lD l/${_w0}&%b%b%c`)($walks$2);
const $count = _var_resume("__tests__/template.marko_0_count/var", /*@__PURE__*/ _let_persisted("count/16", ($scope) => _text($scope["#text/1"], $scope.count)));
...
const $input_view__OR__input_entries = /*@__PURE__*/ _or(13, ($scope) => $dynamicTag($scope, $scope.input_view === "ticker" ? ticker_default : "div", () => ({ entries: $scope.input_entries })));
const $dynamicTag2 = /*@__PURE__*/ _dynamic_tag("#text/6");
const $input_view__OR__input_entriesB = /*@__PURE__*/ _or(15, ($scope) => $dynamicTag2($scope, $scope.input_view === "ticker" ? ticker_default : "div", () => ({ entries: $scope.input_entriesB })));
...
const $update2 = ($patch, $live) => {
	...
	if ("ConditionalRenderer:#text/6" in $patch || "BranchScopes:#text/6" in $patch) _update_dynamic($patch, $live, "ConditionalRenderer:#text/6", "BranchScopes:#text/6");
};
...
const $walks = /*@__PURE__*/ ((_w0) => ` Db%lD l/${_w0}&%b%b%c`)($walks$1);
const $count = /*@__PURE__*/ _let_persisted("count/16", ($scope) => _text($scope["#text/1"], $scope.count));
