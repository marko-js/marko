...
const $Box_content__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/0"], $scope._._.input_label), ($scope) => $scope._._, "__tests__/template.marko_2_input_label#4/subscribe");
const $Box_content__setup = ($scope) => {
	$Box_content__input_label($scope);
	$Box_content__count($scope);
};
const $Box_content__count = /*@__PURE__*/ _closure_get("count", ($scope) => _text($scope["#text/1"], $scope._._.count), ($scope) => $scope._._, "__tests__/template.marko_2_count#5/subscribe");
const $Box_content = /*@__PURE__*/ _content("__tests__/template.marko_2*content", "<!>!<!>", "%c%", $Box_content__setup);
const $Card_content__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => $input_k($scope["#childScope/0"], $scope._.input_label), 0, "__tests__/template.marko_1_input_label#4/subscribe");
