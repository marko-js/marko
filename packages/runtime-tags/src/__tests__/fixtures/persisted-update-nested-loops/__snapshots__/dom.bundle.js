...
const $for_update2 = _update_for(1, "a1", (branch, args) => _update_scope(args[0], branch));
const $count_seed = _update_signal("a5");
const $for_update3 = _update_for(2, "a2", (branch, args) => $for_content__update(args[0], branch));
const $if_update = _update_signal("a4");
