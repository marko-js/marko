...
var template_default = _template("a", (input) => {
	...
	_for_of(getNav(), (section) => {
		...
		}, "slug", $scope1_id, "b", _persisted_reason(), _persisted_reason(), _persisted_reason(), 0, 1);
		_html("</div>");
	...
	_if(() => {
		if (REGIONS.length) {
			...
			}, 0, $scope3_id, "a", _persisted_reason(), _persisted_reason(), 0, "</p>", 1);
	...
	writeScope($scope0_id, {
		...
		Be: _persisted_reason() && $path__closures,
		Bf: _persisted_reason() && $region__closures
	});
