...
const $if = /*@__PURE__*/ _if("#text/0", $if_content__template, $if_content__walks, 0, $else_content__template, $else_content__walks, $else_content__setup);
...
const $if = /*@__PURE__*/ _if("#text/0", "<h2>Something went wrong</h2>", 0, 0, "<h1> </h1><button> </button>", "D l D ", $else_content__setup);
const $input_err = ($scope, input_err) => {
	if (!updating) $if($scope, input_err ? 0 : 1);
};
const $input = ($scope, input) => {
