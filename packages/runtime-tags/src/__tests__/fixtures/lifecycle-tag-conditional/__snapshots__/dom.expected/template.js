...
const $if_content__x__script = _._script("__tests__/template.marko_1_x", ($scope, {
  _: {
    x
  }
...
const $if_content__x = /* @__PURE__ */_._if_closure("x", "#text/0", 0, $if_content__x__script);
...
const $show = /* @__PURE__ */_._let("show/4", ($scope, show) => {
  $if($scope, show ? 0 : 1);
  $show__script($scope);
});
