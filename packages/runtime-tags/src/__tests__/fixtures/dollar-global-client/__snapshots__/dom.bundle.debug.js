...
const $walks = "D%b%b l";
const $if_content2__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.$global.x));
const $if_content2__setup = ($scope) => $if_content2__setup__render($scope);
const $if_content__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.$global.x));
