...
const $input_color = /*@__PURE__*/ _const("input_color", /*@__PURE__*/ _render(($scope) => _style_rule_item($scope["#style/0"], "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bstyle-19tag-19dynamic-19injection-1btemplate-1amarko_0", $scope.input_color)));
