...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html(`${_style_html(`--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bstyle-19tag-19dynamic-19injection-1btemplate-1amarko_0:${_escape_style_value(input.color)};`)}${_el_resume($scope0_id, "#style/0", $sg__input_color)}<div class=box>Hi</div>`);
