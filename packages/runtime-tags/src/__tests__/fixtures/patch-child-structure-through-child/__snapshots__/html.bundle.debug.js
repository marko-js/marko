...
var leaf_default = _template_patch("__tests__/tags/leaf.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_flag = _source_guard($scope0_reason, 1), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_if(() => {
		if (input.flag) {
			const $scope1_id = _scope_id();
			_html(`<em>${_patch_text($scope1_id, "#text/0", input.label, void 0, $scope0_reason, 2)}</em>`);
...
var mid_default = _template_patch("__tests__/tags/mid.marko", (input) => {
	...
	}, $scope0_id, "#text/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/tags/mid.marko_1*shell"], $scope0_reason, 2);
