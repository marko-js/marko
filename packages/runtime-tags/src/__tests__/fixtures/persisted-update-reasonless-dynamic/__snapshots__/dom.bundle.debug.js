...
const $walks = " Db%l%c";
const $Fallback_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<p class=fallback>fallback</p>");
const $Primary_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=primary>primary</p>");
