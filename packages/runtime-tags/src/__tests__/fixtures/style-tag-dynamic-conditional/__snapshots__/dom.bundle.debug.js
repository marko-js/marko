...
const $walks = "b%c";
const $setup = () => {};
const $if_content__input_color = /*@__PURE__*/ _if_closure("#text/0", 0, /*@__PURE__*/ _render(($scope) => _style_rule_item($scope["#style/0"], "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bstyle-19tag-19dynamic-19conditional-1btemplate-1amarko_0", $scope._.input_color)));
const $if_content__setup__render = /*@__PURE__*/ _render(($scope) => _style_shell($scope, "#style/0"));
const $if_content__setup = ($scope) => {
	$if_content__setup__render($scope);
