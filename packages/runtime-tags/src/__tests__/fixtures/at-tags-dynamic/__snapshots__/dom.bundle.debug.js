...
const $walks$1 = "b%b%c";
const $setup$1 = () => {};
const $for_content3__attrs__render = /*@__PURE__*/ _render(($scope) => _attrs_partial($scope, "#div/0", $scope.attrs, { class: 1 }));
...
const $for_content3__attrs = /*@__PURE__*/ _const("attrs", ($scope) => {
	$for_content3__attrs__render($scope);
...
const $for_content2__attrs__render = /*@__PURE__*/ _render(($scope) => _attrs_partial_content($scope, "#div/0", $scope.attrs, { class: 1 }));
...
const $for_content2__attrs = /*@__PURE__*/ _const("attrs", ($scope) => {
	$for_content2__attrs__render($scope);
...
const $for_content__attrs__render = /*@__PURE__*/ _render(($scope) => _attrs_partial($scope, "#div/0", $scope.attrs, { class: 1 }));
...
const $for_content__attrs = /*@__PURE__*/ _const("attrs", ($scope) => {
	$for_content__attrs__render($scope);
...
const $row_content = /*@__PURE__*/ _content_closures(_content_resume("__tests__/template.marko_3_content", " ", " b"), { row: /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.row)) });
