...
export default _._template("__tests__/tags/hello/index.marko", input => {
  const $scope0_reason = _._scope_reason(),
    $sg__input_list_item = _._serialize_guard($scope0_reason, /* input.list.item */1),
    $sg__input_col = _._serialize_guard($scope0_reason, /* input.col */2),
    $sg__input_list_item__OR__input_col = _._serialize_guard($scope0_reason, /* input.list.item, input.col */0);
  ...
  _._for_of(input.list.item, item => {
    ...
    _._dynamic_tag($scope1_id, "#text/1", item.content, {}, 0, 0, ($sg__input_list_item));
  ...
  _._for_of(input.col, col => {
    ...
    _._for_of(col.row, row => {
      ...
      _._dynamic_tag($scope3_id, "#text/1", row.content, {}, 0, 0, ($sg__input_col));
