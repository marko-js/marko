...
// template.marko
const $row_content2 = _content_resume("a3", "Outside");
const $row_content = _content_closures_resume("a2", /*@__PURE__*/ _content("a2", " ", " "), { 2($scope) {
	_text($scope.a, $scope.c);
} });
const $item_content2 = _content_resume("a1", "bar");
const $item_content = _content_resume("a0", "foo");
