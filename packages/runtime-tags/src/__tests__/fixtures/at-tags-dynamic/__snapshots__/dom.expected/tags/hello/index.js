...
const $for_content3 = /* @__PURE__ */_$.createRenderer("<div class=row><!></div>", /* get, next(1), replace, out(1) */" D%l", 0, $params4$for$content);
...
const $for_content2 = /* @__PURE__ */_$.createRenderer("<div class=col></div><!><!>", /* get, over(1), replace, over(2) */" b%c", 0, $params3$for$content);
...
const $for_content = /* @__PURE__ */_$.createRenderer("<div class=item><!></div>", /* get, next(1), replace, out(1) */" D%l", 0, $params2$for$content);
