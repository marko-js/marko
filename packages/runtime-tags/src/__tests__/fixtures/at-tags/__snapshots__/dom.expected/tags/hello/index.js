...
export const _input_foo_ = /* @__PURE__ */_$.value("input_foo/3", (_scope, input_foo) => _dynamicTag(_scope, input_foo));
export const _input_ = /* @__PURE__ */_$.value("input/2", (_scope, input) => _input_foo_(_scope, input.foo));
