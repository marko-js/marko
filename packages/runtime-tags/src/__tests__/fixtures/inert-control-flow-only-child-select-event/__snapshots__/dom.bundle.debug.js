...
const $walks = " b";
const $for_content__selected = /*@__PURE__*/ _for_selector("#select/0", "selected", "#LoopKey", /*@__PURE__*/ _render(($scope) => _attr($scope["#option/0"], "selected", $scope._.selected === $scope["#LoopKey"])));
