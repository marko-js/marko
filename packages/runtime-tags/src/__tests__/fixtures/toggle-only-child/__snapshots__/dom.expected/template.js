...
const _input_value$if_content = /* @__PURE__ */_$.conditionalClosure("input_value/3", "#div/0", 0, (_scope, input_value) => _$.data(_scope["#text/0"], input_value));
...
export const _input_value_ = /* @__PURE__ */_$.value("input_value/3", (_scope, input_value) => {
