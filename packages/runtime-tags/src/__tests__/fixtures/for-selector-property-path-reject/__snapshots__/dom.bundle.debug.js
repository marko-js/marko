...
const $walks = "D l";
const $for_content__selected__OR__row_id = /*@__PURE__*/ _or(6, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#tr/0"], ($scope._.selected?.id === $scope.row_id || $scope._.selected === $scope.row_id) && "danger")));
