...
const _opt$for_content = /* @__PURE__ */_$.value("opt/3", (_scope, opt) => {
  _$.attr(_scope["#option/0"], "value", opt);
  _$.data(_scope["#text/1"], opt);
});
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => _opt$for_content(_scope, _params_2[0]));
...
const _options_ = /* @__PURE__ */_$.value("options_0/5", (_scope, options_0) => _value(_scope, options_0));
