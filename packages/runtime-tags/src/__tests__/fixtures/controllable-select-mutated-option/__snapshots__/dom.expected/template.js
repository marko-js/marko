...
const _for_content = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRenderer("<option> </option>", /* get, next(1), get */" D ", void 0, () => _params_2$for_content));
