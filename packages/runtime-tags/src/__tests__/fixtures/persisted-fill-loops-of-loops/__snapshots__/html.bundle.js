...
var template_default = _template_persisted("a", (input) => {
	...
	_for_of(input.rows, (row) => {
		...
		_for_of(row.cells, (cell) => {
			...
			_filled_guard($scope0_owned, 0) ? _patch_value($scope2_id, "a1", cell) : _patch_init($scope2_id, "a2");
		...
		}, (cell) => cell, $scope1_id, "a", 1, $sg__input_rows, $sg__input_rows, void 0, void 0, "a1", $scope0_owned, 0);
		_scope($scope1_id, { _: _scope_with_id($scope0_id) });
	}, (row) => row.id, $scope0_id, "a", 1, $sg__input_rows, $sg__input_rows, void 0, void 0, "a0", $scope0_owned, 0);
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		i: $count__closures
	}) : _filled_guard($scope0_owned, 1) && _patch_value($scope0_id, "a0", input.suffix);
}, 1, 0);
