...
const $mytag_content2 = _$.registerContent("__tests__/template.marko_2_renderer", "Span", /* over(1) */"b");
const $mytag_content = _$.registerContent("__tests__/template.marko_1_renderer", "Div", /* over(1) */"b");
