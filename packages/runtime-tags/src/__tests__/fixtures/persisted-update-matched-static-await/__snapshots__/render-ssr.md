...
INSERT: footer > em:nth-of-type(1)::text@8 + ::text("First")
...
INSERT: footer > em:nth-of-type(2)::text@8 + ::text("First")
...
INSERT: footer > em:nth-of-type(3)::text@8 + ::text("First")
...
## Change
```
UPDATE: footer > em:nth-of-type(1)::text@12 "First" => "Second"
UPDATE: footer > em:nth-of-type(2)::text@12 "First" => "Second"
UPDATE: footer > em:nth-of-type(3)::text@12 "First" => "Second"
```
