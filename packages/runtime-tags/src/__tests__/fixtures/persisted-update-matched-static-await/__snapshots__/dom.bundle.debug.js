...
_enable_catch();
const $placeholder_content2 = /*@__PURE__*/ _content("__tests__/template.marko_9_content", "loading reviews…");
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_7_content", "loading deals…");
...
const $await_content__for = /*@__PURE__*/ _for_to("#text/0", "<em>review <!> of <!></em>", "Db%c%", $for_content__setup);
...
const $else_content__try2 = /*@__PURE__*/ _try("#text/1", $try_content__template, $try_content__walks, $try_content__setup);
...
const $if = /*@__PURE__*/ _if("#text/3", $if_content__template, $if_content__walks, 0, $else_content__template, $else_content__walks, $else_content__setup);
...
_static_shells({
	"__tests__/template.marko_8_update": [$await_content2__template, $await_content2__walks],
	"__tests__/template.marko_8_content": [$await_content2__template, $await_content2__walks],
	"__tests__/template.marko_6_update": [$try_content2__template, $try_content2__walks],
	"__tests__/template.marko_6_content": [$try_content2__template, $try_content2__walks],
	"__tests__/template.marko_5_update": [$if_content__template, $if_content__walks],
	"__tests__/template.marko_5_content": [$if_content__template, $if_content__walks],
...
_update_content("__tests__/template.marko_8_update", $noop_update);
_update_content("__tests__/template.marko_7_content", $noop_update);
_update_content("__tests__/template.marko_6_update", $try_content2__update);
...
const $walks = "D l Db%l%c";
_enable_catch();
const $placeholder_content2 = _content_resume("__tests__/template.marko_9_content", "loading reviews…");
const $placeholder_content = _content_resume("__tests__/template.marko_7_content", "loading deals…");
const $await_content2 = /*@__PURE__*/ _await_content("#text/0", "<p><strong>deals never change</strong></p>");
const $try_content2__await_promise = /*@__PURE__*/ _await_promise("#text/0");
const $try_content2__setup = ($scope) => {
	$await_content2($scope);
	if (!updating) $try_content2__await_promise($scope, resolveAfter(0, 1));
...
const $else_content__try2 = /*@__PURE__*/ _try("#text/1", "<!><!><!>", "b%", $try_content__setup);
const $else_content__setup = ($scope) => {
	$else_content__try($scope, { placeholder: attrTag({ content: $placeholder_content($scope) }) });
	$else_content__try2($scope, { placeholder: attrTag({ content: $placeholder_content2($scope) }) });
};
...
const $if = /*@__PURE__*/ _if("#text/3", "<p>gone</p>", 0, 0, "<section><!></section><footer><!></footer>", "D%lD%", $else_content__setup);
const $input_missing = ($scope, input_missing) => {
	if (!updating) $if($scope, input_missing ? 0 : 1);
};
const $input = ($scope, input) => {
