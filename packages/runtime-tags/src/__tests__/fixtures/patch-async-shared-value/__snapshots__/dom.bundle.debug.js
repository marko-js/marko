...
const $await_content__item = /*@__PURE__*/ _closure_get("item", ($scope) => $input_item($scope["#childScope/1"], $scope._._.item), ($scope) => $scope._._, "__tests__/template.marko_2_item#7/subscribe");
...
const $try_content__input_promise = /*@__PURE__*/ _closure_get("input_promise", ($scope) => $try_content__await_promise($scope, $scope._.input_promise), 0, "__tests__/template.marko_1_input_promise#6/subscribe");
