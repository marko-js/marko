...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_try($scope0_id, "#text/2", _content_resume("__tests__/template.marko_1*content", () => {
		...
		_await($scope1_id, "#text/0", input.promise, (value) => {
			...
			}, "__tests__/template.marko", "9:6"), _client_guard($scope0_reason, 1) && "__tests__/template.marko_2_item#7/subscribe");
		}, 1, "__tests__/template.marko_2*content", 1);
		$scope0_page && _subscribe(_unfilled_if($scope0_reason, 2) && $input_promise__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "7:4"), _client_guard($scope0_reason, 2) && "__tests__/template.marko_1_input_promise#6/subscribe", 0);
