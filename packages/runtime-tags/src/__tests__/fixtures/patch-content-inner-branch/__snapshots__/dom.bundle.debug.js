...
const $if_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._._.input_note), ($scope) => $scope._._, "__tests__/template.marko_2_input_note#5/subscribe");
const $if_content__setup = $if_content__input_note;
const $card_content__if = /*@__PURE__*/ _if("#text/0", "<em> </em>", "D ", $if_content__setup);
const $card_content__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $card_content__if($scope, $scope._.input_show ? 0 : 1), 0, "__tests__/template.marko_1_input_show#4/subscribe");
