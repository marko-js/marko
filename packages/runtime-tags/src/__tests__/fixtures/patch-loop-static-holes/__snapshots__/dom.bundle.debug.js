...
const $for_content2__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/1"], $scope._._.input_note), ($scope) => $scope._._, "__tests__/template.marko_3_input_note#5/subscribe");
...
const $if_content__for = /*@__PURE__*/ _for_of_unkeyed("#div/0", "<p><!>:<!></p>", "D%c%", $for_content2__setup, $for_content2__$params);
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#ul/0", "<li><!>:<!></li>", "D%c%", $for_content__setup, $for_content__$params);
const $for2 = /*@__PURE__*/ _for_of_unkeyed("#ol/1", "<li> </li>", "D ", 0, $for_content3__$params);
