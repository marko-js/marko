...
const $try_content__show = /*@__PURE__*/ _closure_get("show/5", $try_content__show__OR__value, 0, "__tests__/template.marko_1_show#3/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__show($scope);
	$try_content__value($scope);
};
const $try_content__value = /*@__PURE__*/ _closure_get("value/6", $try_content__show__OR__value, 0, "__tests__/template.marko_1_value#4/subscribe");
