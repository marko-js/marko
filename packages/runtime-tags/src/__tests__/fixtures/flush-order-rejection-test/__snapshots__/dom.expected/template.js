...
const $await_content = /* @__PURE__ */_._content_branch("<div>Should not see this: <!></div>", /* next(1), over(1), replace, out(1) */"Db%l", 0, $await_content__$params);
...
const $try_content__setup = $scope => {
  $try_content__await($scope, rejectAfter(new Error("failed"), 1));
};
