...
const $try_content__input_promise = /*@__PURE__*/ _closure_get("input_promise", ($scope) => $try_content__await_promise($scope, $scope._.input_promise), 0, "__tests__/template.marko_3_input_promise#6/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_promise($scope);
	$await_content($scope);
};
const $if_content__input_detail = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_detail", /*@__PURE__*/ _closure_get("input_detail", ($scope) => _text($scope["#text/0"], $scope._._.input_detail), ($scope) => $scope._._, "__tests__/template.marko_2_input_detail#5/subscribe"), 1);
const $if_content__setup = $if_content__input_detail;
const $catch_content__if = /*@__PURE__*/ _if("#text/0", "<p> </p>", "D ", $if_content__setup);
const $catch_content__input_detail = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_detail", /*@__PURE__*/ _closure_get("input_detail", ($scope) => $catch_content__if($scope, $scope._.input_detail ? 0 : 1), 0, "__tests__/template.marko_1_input_detail#5/subscribe"), 0);
