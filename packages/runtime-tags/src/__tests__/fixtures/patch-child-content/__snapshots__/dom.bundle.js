...
// template.marko
const $box_content__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.a, "t:" + $scope._._.e), ($scope) => $scope._._, "a5", 4), 0);
const $box_content = /*@__PURE__*/ _content$1("a0", "<p> </p>", "D ", $box_content__input_title);
