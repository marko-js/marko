...
const $template = "<header><button> </button></header><main><!></main>";
...
enableBranches();
var layout_default = /* @__PURE__ */ _template("__tests__/tags/layout/layout.marko", $template, $walks, $setup, $input);
