...
const $walks = "b%c";
const $setup = () => {};
const $inputwrapouterdiv_content__input_x = /*@__PURE__*/ _closure_get("input_x", ($scope) => _text($scope["#text/0"], $scope._.input_x), 0, "__tests__/template.marko_1_input_x#4/subscribe");
const $inputwrapouterdiv_content__setup = $inputwrapouterdiv_content__input_x;
const $inputwrapouterdiv_content = _content("__tests__/template.marko_1*content", "body <!>", "b%", $inputwrapouterdiv_content__setup);
_content_resume($inputwrapouterdiv_content);
