...
# Update `{"$global":{"persisted":true,"persistedFragment":true,"view":"reports","topic":"sales"}}`
```html
<button
  class="count"
>
...
# Update `{"$global":{"persisted":true,"persistedFragment":true,"view":"reports","topic":"growth"}}`
```html
<button
  class="count"
>
