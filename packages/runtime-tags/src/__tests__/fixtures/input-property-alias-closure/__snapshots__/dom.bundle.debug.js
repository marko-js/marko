...
const $Child_content2__input_text = /*@__PURE__*/ _closure_get("input_text", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.input_text)));
...
const $Child_content__input_text = /*@__PURE__*/ _render(($scope, input_text) => _text($scope["#text/0"], input_text));
