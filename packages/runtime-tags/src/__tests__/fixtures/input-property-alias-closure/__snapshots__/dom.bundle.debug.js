...
const $Child_content2__input_text = /*@__PURE__*/ _closure_get("input_text/4", ($scope) => _text($scope["#text/0"], $scope._.input_text), 0, "__tests__/template.marko_2_input_text#3/subscribe");
const $Child_content2__setup = $Child_content2__input_text;
const $Child_content2 = /*@__PURE__*/ _content("__tests__/template.marko_2*content", " ", " ", $Child_content2__setup);
