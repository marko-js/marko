...
const $Child_content2__input_text = /*@__PURE__*/ _closure_get("input_text", ($scope) => _text($scope["#text/0"], $scope._.input_text), 0, "__tests__/template.marko_2_input_text#3/subscribe");
