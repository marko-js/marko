...
export default _._template("__tests__/template.marko", input => {
  const $scope0_reason = _._scope_reason(),
    ...
    $si__input_text = _._serialize_if($scope0_reason, /* input.text */0);
  ...
  _._set_serialize_reason({
    /* input.text, input.content */0: ($sg__input_text),
    /* input.text */1: $sg__input_text
  });
  Child.content({
    text: input.text,
  ...
  ($si__input_text) && _._scope($scope0_id, {
