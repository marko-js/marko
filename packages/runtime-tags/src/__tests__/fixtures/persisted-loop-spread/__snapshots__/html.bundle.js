...
var template_default = _template_persisted("a", (input) => {
	...
	_for_of(input.items, (item) => {
		...
		_html(`<li${_patch_attrs(item.attrs, "a", $scope1_id, "li", void 0, $scope0_reason, 0)}>${_patch_text($scope1_id, "b", item.id, void 0, $scope0_reason, 0)}</li>${_el_resume($scope1_id, "a")}`);
