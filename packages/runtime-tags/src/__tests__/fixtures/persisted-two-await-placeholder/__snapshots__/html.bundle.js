...
var template_default = _template_persisted("a", (input) => {
	...
	_try($scope0_id, "a", _content_resume("a5", () => {
		...
		$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 2) && $input_b__closures, _subscribe(_unfilled_if($scope0_owned, 1) && $input_a__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) })));
