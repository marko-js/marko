...
const $catch_content2 = _content("__tests__/template.marko_4*content", "<em>inner</em>");
const $catch_content = _content("__tests__/template.marko_3*content", "<em>outer</em>");
