...
const $if_content__baz = /* @__PURE__ */_._let("baz/1", ($scope, baz) => _._text($scope["#text/0"], baz));
const $if_content__foo = /* @__PURE__ */_._if_closure("foo", "#text/0", 0, $if_content__baz);
