...
const $item_content = _content_closures_resume("__tests__/template.marko_3*content", /*@__PURE__*/ _content("__tests__/template.marko_3*content", " ", " "), { i($scope) {
	_text($scope["#text/0"], $scope.i);
} });
const $for_content__item__script = _script("__tests__/template.marko_2_item#2", ($scope) => _attrs_script($scope, "#div/0"));
