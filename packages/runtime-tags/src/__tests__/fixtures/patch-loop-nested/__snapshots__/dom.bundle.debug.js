...
const $walks = "D%b b l";
const $for_content2__input_note = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_note", /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/2"], $scope._._.input_note), ($scope) => $scope._._, "__tests__/template.marko_2_input_note#5/subscribe"), 0);
...
const $for_content__for = /*@__PURE__*/ _for_of_unkeyed("#text/0", "<div><!><!>: <!></div>", "D%b%c%", $for_content2__setup, $for_content2__$params);
