// template.marko
const $for_content2__input_note = /*@__PURE__*/ _fill_join_closure("a0", 5, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.c, $scope._._.f), ($scope) => $scope._._, "a0", 5), 0);
...
const $for_content__for = /*@__PURE__*/ _for_of_unkeyed(0, "<div><!><!>: <!></div>", "D%b%c%", $for_content2__setup, $for_content2__$params);
...
const $for = /*@__PURE__*/ _for_of_unkeyed(0, "<!><!><!>", "b%", $for_content__setup, $for_content__$params);
