    ...
    if (show) {
      ...
      _._if(() => {
        if (value1) {
          ...
          _._serialize_if($scope0_reason, /* input.value1 */5) && _._subscribe($value__closures, _._scope($scope2_id, {
      ...
      _._if(() => {
        if (value2) {
          ...
          _._serialize_if($scope0_reason, /* input.value2 */6) && _._subscribe($value2__closures, _._scope($scope3_id, {
            _: _._scope_with_id($scope1_id),
      ...
      _._serialize_if($scope0_reason, /* input.show, input.value1, input.value2 */3) && _._scope($scope1_id, {
        _: _._serialize_if($scope0_reason, /* input.value1, input.value2 */2) && _._scope_with_id($scope0_id)
