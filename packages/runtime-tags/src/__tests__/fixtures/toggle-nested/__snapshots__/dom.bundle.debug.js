...
const $walks = " b";
const $setup = () => {};
const $if_content3__input_value = /*@__PURE__*/ _closure_get("value2", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._._.value2)), ($scope) => $scope._._);
const $if_content3__setup = $if_content3__input_value;
const $if_content2__input_value = /*@__PURE__*/ _closure_get("value1", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._._.value1)), ($scope) => $scope._._);
