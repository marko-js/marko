...
const _value2$if_content = _$.registerDynamicClosure("__tests__/template.marko_3_value2/subscriber", "value2", (_scope, value2) => _$.data(_scope["#text/0"], value2), _scope => _scope._._);
const _if_content3 = /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", 0, 0, _scope => _value2$if_content._(_scope));
const _value1$if_content = _$.registerDynamicClosure("__tests__/template.marko_2_value1/subscriber", "value1", (_scope, value1) => _$.data(_scope["#text/0"], value1), _scope => _scope._._);
const _if_content2 = /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", 0, 0, _scope => _value1$if_content._(_scope));
