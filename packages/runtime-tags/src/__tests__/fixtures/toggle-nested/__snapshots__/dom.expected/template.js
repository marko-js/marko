...
const _value2$if_content = _$.registerDynamicClosure("__tests__/template.marko_3_value2/subscriber", "value2/5", (_scope, value2) => _$.data(_scope["#text/0"], value2), _scope => _scope._._);
...
const _value1$if_content = _$.registerDynamicClosure("__tests__/template.marko_2_value1/subscriber", "value1/4", (_scope, value1) => _$.data(_scope["#text/0"], value1), _scope => _scope._._);
...
const _value2$if_content2 = /* @__PURE__ */_$.conditionalClosure("value2/5", "#div/0", 0, (_scope, value2) => _if$if_content2(_scope, value2 ? 0 : 1));
const _value1$if_content2 = /* @__PURE__ */_$.conditionalClosure("value1/4", "#div/0", 0, (_scope, value1) => _if$if_content(_scope, value1 ? 0 : 1));
...
export const _value2_ = /* @__PURE__ */_$.value("value2/5", (_scope, value2) => {
  _value2$if_content2(_scope);
  _value2$if_content(_scope);
});
export const _value1_ = /* @__PURE__ */_$.value("value1/4", (_scope, value1) => {
  _value1$if_content2(_scope);
  _value1$if_content(_scope);
});
export const _show_ = /* @__PURE__ */_$.value("show/3", (_scope, show) => _if(_scope, show ? 0 : 1));
