...
const $if_content3 = /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", 0, 0, $scope => $value2$if$content($scope));
const $value1$if$content = /* @__PURE__ */_$.dynamicClosureRead("value1", ($scope, value1) => _$.data($scope["#text/0"], value1), $scope => $scope._._);
const $if_content2 = /* @__PURE__ */_$.createRenderer("<span> </span>", /* next(1), get */"D ", 0, 0, $scope => $value1$if$content($scope));
