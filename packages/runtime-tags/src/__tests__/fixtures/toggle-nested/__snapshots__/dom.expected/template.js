...
const _value2_closure = /* @__PURE__ */_$.dynamicClosure(_value2$if_content);
export const _value2 = /* @__PURE__ */_$.value("value2", _scope => {
  _value2$if_content2(_scope);
  _value2_closure(_scope);
});
const _value_closure = /* @__PURE__ */_$.dynamicClosure(_value1$if_content);
export const _value = /* @__PURE__ */_$.value("value1", _scope => {
  _value1$if_content2(_scope);
  _value_closure(_scope);
});
export const _show = /* @__PURE__ */_$.value("show", (_scope, show) => _if(_scope, show ? 0 : 1));
export const _input = /* @__PURE__ */_$.value("input", (_scope, input) => {
  _show(_scope, input.show);
  _value(_scope, input.value1);
  _value2(_scope, input.value2);
});
