...
const $if_content3__input_value = /* @__PURE__ */_._closure_get("value2", $scope => _._text($scope["#text/0"], $scope._._.value2), $scope => $scope._._);
const $if_content3__setup = $if_content3__input_value;
const $if_content2__input_value = /* @__PURE__ */_._closure_get("value1", $scope => _._text($scope["#text/0"], $scope._._.value1), $scope => $scope._._);
...
const $if_content__input_value = /* @__PURE__ */_._if_closure("#div/0", 0, $scope => $if_content__if($scope, $scope._.value1 ? 0 : 1));
...
const $if_content__input_value2 = /* @__PURE__ */_._if_closure("#div/0", 0, $scope => $if_content__if2($scope, $scope._.value2 ? 0 : 1));
...
const $value__closure = /* @__PURE__ */_._closure($if_content2__input_value);
export const $value = /* @__PURE__ */_._const("value1", $scope => {
  $if_content__input_value($scope);
  $value__closure($scope);
});
const $value2__closure = /* @__PURE__ */_._closure($if_content3__input_value);
