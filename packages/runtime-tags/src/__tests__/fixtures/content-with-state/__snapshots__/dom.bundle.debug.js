...
const $inner_content__input_content = /*@__PURE__*/ _closure_get("input_content/4", ($scope) => $inner_content__dynamicTag($scope, $scope._.input_content), 0, "__tests__/tags/outer.marko_1_input_content#3/subscribe");
...
const $outer_content__count = /*@__PURE__*/ _closure_get("count/3", ($scope) => _text($scope["#text/0"], $scope._.count), 0, "__tests__/template.marko_1_count#2/subscribe");
const $outer_content__setup = $outer_content__count;
const $outer_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", "<span> </span>", "D ", $outer_content__setup);
