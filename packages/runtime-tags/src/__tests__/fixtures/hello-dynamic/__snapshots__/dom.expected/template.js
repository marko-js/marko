...
export const $input_name = /* @__PURE__ */_._const("input_name", ($scope, input_name) => {
  _._text($scope["#text/0"], input_name);
  _._html($scope, input_name, "#text/1");
});
export const $input_missing = /* @__PURE__ */_._const("input_missing", ($scope, input_missing) => _._html($scope, input_missing, "#text/2"));
