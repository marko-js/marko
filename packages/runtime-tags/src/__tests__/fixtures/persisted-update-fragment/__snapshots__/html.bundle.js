...
var template_default = _template("a", (input) => {
	...
	const Dashboard = { content: _content("a3", () => {
		...
		_var($scope2_id, "c", $childScope, "a7");
		...
		_for_of(getMetrics?.($global().range), (metric) => {
			...
			return metric.name;
		}, $scope2_id, "g", _persisted_reason(), _persisted_reason(), _persisted_reason(), "</ul>", 1, "a0");
		_if(() => $global().admin ? 0 : void 0, $scope2_id, "h", _persisted_reason(), _persisted_reason(), _persisted_reason(), 0, 1, "a1", [() => {
