...
// template.marko
const $Dashboard_content__setup__script = _script_update("a3", ($scope) => _on($scope.d, "click", function() {
	_var_change($scope.b, $scope.l + 1);
}));
const $Dashboard_content__tally = _var_resume("a1", /*@__PURE__*/ _const(11, ($scope) => _text($scope.e, $scope.l)));
