...
_shells({
	...
	"__tests__/template.marko_1*shell": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko_1*shell !;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `D%c%l/${_w0}&b`)("b%c"), /*@__PURE__*/ ((_w0) => `<p><!> hit <!></p>${_w0}<!>`)($template$1))
});
