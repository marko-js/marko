...
const $row_content__input_suffix = /*@__PURE__*/ _closure_get("input_suffix", ($scope) => _text($scope["#text/1"], $scope._.input_suffix), 0, "__tests__/template.marko_1_input_suffix#3/subscribe");
