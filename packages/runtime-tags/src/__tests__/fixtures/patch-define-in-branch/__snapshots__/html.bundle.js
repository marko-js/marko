...
var template_default = _template_patch("a", (input) => {
	...
	const row = { content: _content_elide("a0", (label) => {
		...
		_subscribe(_unfilled_if($scope0_reason, 1) && $input_suffix__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }));
	}, $scope0_id) };
	_html("<ul>");
	_if(() => {
		if (input.show) {
	...
	}, $scope0_id, "a", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["a1"], $scope0_reason, 2);
