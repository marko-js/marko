...
const $for_content2 = /* @__PURE__ */_$.createRenderer(_child_template, /* beginChild, _child_walks, endChild */`/${_child_walks}&`, $setup$for$content, $params3$for$content, $scope => $outer$for$content._($scope));
...
const $for_content = /* @__PURE__ */_$.createRenderer("<!><!><!>", /* replace */"D%D", 0, $params2$for$content, $scope => $items$for$content._($scope));
