...
const _outer$for_content = /* @__PURE__ */_$.loopClosure("outer/2", "#text/0", (_scope, outer) => _expr_outer_inner$for_content(_scope));
const _inner$for_content = /* @__PURE__ */_$.value("inner/2", (_scope, inner) => _expr_outer_inner$for_content(_scope));
const _params_3$for_content = /* @__PURE__ */_$.value("_params_3/1", (_scope, _params_3) => _inner$for_content(_scope, _params_3[0]));
...
const _outer$for_content2 = /* @__PURE__ */_$.value("outer/2", (_scope, outer) => _outer$for_content(_scope));
const _items$for_content = /* @__PURE__ */_$.loopClosure("items/2", "#text/1", (_scope, items) => _for$for_content(_scope, [items]));
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/1", (_scope, _params_2) => _outer$for_content2(_scope, _params_2[0]));
