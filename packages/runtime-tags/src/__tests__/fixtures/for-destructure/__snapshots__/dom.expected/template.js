...
const _description$for_content = /* @__PURE__ */_$.value("description/5", (_scope, description) => _$.data(_scope["#text/1"], description));
const _name$for_content = /* @__PURE__ */_$.value("name/4", (_scope, name) => _$.data(_scope["#text/0"], name));
const _pattern_$for_content = /* @__PURE__ */_$.value("_pattern_/3", (_scope, _pattern_) => {
  _name$for_content(_scope, _pattern_.name);
  _description$for_content(_scope, _pattern_.description);
});
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => _pattern_$for_content(_scope, _params_2?.[0]));
