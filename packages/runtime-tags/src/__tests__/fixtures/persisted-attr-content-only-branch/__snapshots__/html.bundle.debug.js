...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_if(() => input.show ? 0 : undefined, $scope0_id, "#text/2", $sg__input_show, $sg__input_show, $sg__input_show, 0, 1, "__tests__/template.marko_0/update_if_#text/2", [() => {
		...
		_attr_content("#div/0", $scope2_id, Panel);
		_html(`</div>${_el_resume($scope2_id, "#div/0")}`);
		$sg__input_show && writeScope($scope2_id, {}, "__tests__/template.marko", "8:2");
...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<div class=host></div>", " b"],
	"__tests__/template.marko_2_content": ["<div class=host></div>", " b"],
