...
var card_default = _template_patch("__tests__/tags/card/index.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		input_header: ["input.header"],
		open: "1:6"
	}) : _filled_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/tags/card/index.marko0", input.header);
}, 0, 0);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	card_default({ header: attrTag({ content: _content_resume("__tests__/template.marko_1*content", () => {
		...
		_subscribe(_source_if($scope0_reason, 0) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "3:6"), _client_guard($scope0_reason, 0) && "__tests__/template.marko_1_input_note#3/subscribe", $sg__input_note);
