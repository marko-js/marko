...
// template.marko
const $header_content__input_note = /*@__PURE__*/ _fill_join_closure("a0", 3, /*@__PURE__*/ _closure_get(4, ($scope) => _text($scope.a, $scope._.d), 0, "a0", 3), 0);
const $header_content = _content("a1", "<em> </em>", "D ", $header_content__input_note);
