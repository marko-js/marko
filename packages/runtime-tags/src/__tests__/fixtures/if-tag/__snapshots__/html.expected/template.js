...
export default _._template("__tests__/template.marko", input => {
  ...
  _._if(() => {
    if (input.a + input.b) {
      ...
      _._html("Hello");
      _._serialize_guard($scope0_reason, /* input.a, input.b */0) && _._scope($scope1_id, {}, "__tests__/template.marko", "1:2");
      return 0;
    }
  ...
  _._if(() => {
    if (input.a, input.b) {
      ...
      _._html("World");
      _._serialize_guard($scope0_reason, /* input.a, input.b */0) && _._scope($scope2_id, {}, "__tests__/template.marko", "5:2");
      return 0;
    }
  ...
  _._if(() => {
    if (input.x) {
      ...
      _._html("A");
      _._serialize_guard($scope0_reason, /* input.x, input.y */1) && _._scope($scope3_id, {}, "__tests__/template.marko", "10:4");
      return 0;
    } else if (input.y) {
      const $scope4_id = _._scope_id();
      _._html("B");
      _._serialize_guard($scope0_reason, /* input.x, input.y */1) && _._scope($scope4_id, {}, "__tests__/template.marko", "13:4");
      return 1;
    } else {
      const $scope5_id = _._scope_id();
      _._html("C");
      _._serialize_guard($scope0_reason, /* input.x, input.y */1) && _._scope($scope5_id, {}, "__tests__/template.marko", "16:4");
      return 2;
    }
  ...
  _._serialize_guard($scope0_reason, /* input.a, input.b, input.x, input.y */2) && _._scope($scope0_id, {
