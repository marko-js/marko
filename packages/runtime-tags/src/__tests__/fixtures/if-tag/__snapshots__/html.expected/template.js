...
export default _._template("__tests__/template.marko", input => {
  const $scope0_reason = _._scope_reason(),
    ...
    $si__input_a__OR__input_b = _._serialize_if($scope0_reason, /* input.a, input.b */0),
    $si__input_x__OR__input_y = _._serialize_if($scope0_reason, /* input.x, input.y */1),
    $sg__input_x__OR__input_y = _._serialize_guard($scope0_reason, /* input.x, input.y */1);
  const $scope0_id = _._scope_id();
  _._if(() => {
    if (input.a + input.b) {
      const $scope1_id = _._scope_id();
      _._html("Hello");
      ($si__input_a__OR__input_b) && _._scope($scope1_id, {}, "__tests__/template.marko", "1:2");
      return 0;
    }
  ...
  _._if(() => {
    if (input.a, input.b) {
      ...
      _._html("World");
      ($si__input_a__OR__input_b) && _._scope($scope2_id, {}, "__tests__/template.marko", "5:2");
      return 0;
    }
  ...
  _._if(() => {
    if (input.x) {
      ...
      _._html("A");
      ($si__input_x__OR__input_y) && _._scope($scope3_id, {}, "__tests__/template.marko", "10:4");
      return 0;
    } else if (input.y) {
      const $scope4_id = _._scope_id();
      _._html("B");
      ($si__input_x__OR__input_y) && _._scope($scope4_id, {}, "__tests__/template.marko", "13:4");
      return 1;
    } else {
      const $scope5_id = _._scope_id();
      _._html("C");
      $si__input_x__OR__input_y && _._scope($scope5_id, {}, "__tests__/template.marko", "16:4");
      return 2;
    }
