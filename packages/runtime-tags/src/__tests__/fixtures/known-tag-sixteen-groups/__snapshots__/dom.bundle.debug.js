// tags/child.marko
const $template$1 = "<p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p><p> </p>";
const $walks$1 = "D lD lD lD lD lD lD lD lD lD lD lD lD lD lD lD lD lD l";
const $setup$1 = () => {};
...
const $input_a15__OR__input_a = /*@__PURE__*/ _or(37, ($scope) => _text($scope["#text/17"], $scope.input_a15 + $scope.input_a16));
const $input_a16 = /*@__PURE__*/ _const("input_a15", ($scope) => {
	_text($scope["#text/15"], $scope.input_a15);
	$input_a15__OR__input_a($scope);
});
const $input_a17 = /*@__PURE__*/ _const("input_a16", ($scope) => {
	_text($scope["#text/16"], $scope.input_a16);
	$input_a15__OR__input_a($scope);
});
...
function $setup($scope) {
	$input_a2($scope["#childScope/0"], 1);
	$input_a3($scope["#childScope/0"], 2);
	$input_a4($scope["#childScope/0"], 3);
	$input_a5($scope["#childScope/0"], 4);
	$input_a6($scope["#childScope/0"], 5);
	$input_a7($scope["#childScope/0"], 6);
	$input_a8($scope["#childScope/0"], 7);
	$input_a9($scope["#childScope/0"], 8);
	$input_a10($scope["#childScope/0"], 9);
	$input_a11($scope["#childScope/0"], 10);
	$input_a12($scope["#childScope/0"], 11);
	$input_a13($scope["#childScope/0"], 12);
	$input_a14($scope["#childScope/0"], 13);
