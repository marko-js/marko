...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	widget_default({ content: _content_elide("__tests__/template.marko_1*content", () => {
		...
		$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 0) && $input_kind__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "3:4"));
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_inner: ["input.inner"],
		open: "1:6"
	}) : _filled_guard($scope0_owned, 1) && _patch_value($scope0_id, "__tests__/template.marko0", input.inner);
}, 1, () => [widget_default]);
