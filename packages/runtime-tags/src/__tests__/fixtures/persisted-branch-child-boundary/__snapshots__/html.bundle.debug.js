...
const $walks = " b";
_shells({ "__tests__/template.marko_2*shell": "__tests__/template.marko_2*shell,<em>closed</em>" });
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_if$1(() => {
		if (input.show) {
			...
			$scope0_reason && writeScope($scope2_id, {}, "__tests__/template.marko", "5:4");
			return 1;
		}
	}, $scope0_id, "#main/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, [0, "__tests__/template.marko_2*shell"]);
