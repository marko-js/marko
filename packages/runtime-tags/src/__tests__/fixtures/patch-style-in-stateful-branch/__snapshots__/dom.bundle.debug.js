...
const $walks = "b%b b";
const $if_content__input_color = /*@__PURE__*/ _fill_join("__tests__/template.marko0", "input_color", /*@__PURE__*/ _if_closure("#text/0", 0, ($scope) => _style_rule_item($scope["#style/0"], "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bpatch-19style-19in-19stateful-19branch-1btemplate-1amarko_0", $scope._.input_color)));
