...
const _i$for_content6 = /* @__PURE__ */_$.value("i/4", (_scope, i) => {
  _$.attr(_scope["#div/0"], "key", i);
  _$.data(_scope["#text/1"], i);
  _$.attr(_scope["#div/2"], "key", `other-${i}`);
});
const _params_9$for_content = /* @__PURE__ */_$.value("_params_9/3", (_scope, _params_9) => _i$for_content6(_scope, _params_9[0]));
...
const _i$for_content5 = /* @__PURE__ */_$.value("i/4", (_scope, i) => {
  _$.attr(_scope["#div/0"], "key", i);
  _$.data(_scope["#text/1"], i);
  _$.attr(_scope["#div/2"], "key", `other-${i}`);
});
const _params_8$for_content = /* @__PURE__ */_$.value("_params_8/3", (_scope, _params_8) => _i$for_content5(_scope, _params_8[0]));
...
const _i$for_content4 = /* @__PURE__ */_$.value("i/5", (_scope, i) => {
  _$.attr(_scope["#div/0"], "key", i);
  _$.data(_scope["#text/1"], i);
  _$.attr(_scope["#div/2"], "key", `other-${i}`);
});
const _params_7$for_content = /* @__PURE__ */_$.value("_params_7/4", (_scope, _params_7) => _i$for_content4(_scope, _params_7[0]));
...
const _val$for_content4 = /* @__PURE__ */_$.value("val/6", (_scope, val) => _$.data(_scope["#text/2"], val));
const _key$for_content2 = /* @__PURE__ */_$.value("key/5", (_scope, key) => {
  _$.attr(_scope["#div/0"], "key", key);
  _$.data(_scope["#text/1"], key);
  _$.attr(_scope["#div/3"], "key", `other-${key}`);
});
const _params_6$for_content = /* @__PURE__ */_$.value("_params_6/4", (_scope, _params_6) => {
...
const _i$for_content3 = /* @__PURE__ */_$.value("i/6", (_scope, i) => {
  _$.attr(_scope["#div/0"], "key", i);
  _$.data(_scope["#text/1"], i);
  _$.attr(_scope["#div/3"], "key", `other-${i}`);
});
const _val$for_content3 = /* @__PURE__ */_$.value("val/5", (_scope, val) => _$.data(_scope["#text/2"], val));
const _params_5$for_content = /* @__PURE__ */_$.value("_params_5/4", (_scope, _params_5) => {
...
const _i$for_content2 = /* @__PURE__ */_$.value("i/2", (_scope, i) => _$.data(_scope["#text/0"], i));
const _params_4$for_content = /* @__PURE__ */_$.value("_params_4/1", (_scope, _params_4) => _i$for_content2(_scope, _params_4[0]));
const _for_content3 = /* @__PURE__ */_$.createRenderer("<div> </div><div></div><div></div>", /* next(1), get */"D ", void 0, () => _params_4$for_content);
const _val$for_content2 = /* @__PURE__ */_$.value("val/4", (_scope, val) => _$.data(_scope["#text/1"], val));
const _key$for_content = /* @__PURE__ */_$.value("key/3", (_scope, key) => _$.data(_scope["#text/0"], key));
const _params_3$for_content = /* @__PURE__ */_$.value("_params_3/2", (_scope, _params_3) => {
...
const _i$for_content = /* @__PURE__ */_$.value("i/4", (_scope, i) => _$.data(_scope["#text/0"], i));
const _val$for_content = /* @__PURE__ */_$.value("val/3", (_scope, val) => _$.data(_scope["#text/1"], val));
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => {
...
const _obj = /* @__PURE__ */_$.value("obj/10", (_scope, obj) => {
  _for2(_scope, [obj]);
  _for5(_scope, [obj]);
});
const _arr = /* @__PURE__ */_$.value("arr/9", (_scope, arr) => {
  _for(_scope, [arr]);
  _for4(_scope, [arr]);
});
