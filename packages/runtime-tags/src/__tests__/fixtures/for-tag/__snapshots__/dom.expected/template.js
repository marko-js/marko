...
const $for_content10__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content10__$params = /* @__PURE__ */_._const("$params11", ($scope, $params11) => $for_content10__i($scope, $params11[0]));
const $for_content10 = /* @__PURE__ */_._content_branch("<!> ", /* replace, over(2) */"%c", 0, $for_content10__$params);
const $for_content9__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content9__$params = /* @__PURE__ */_._const("$params10", ($scope, $params10) => $for_content9__i($scope, $params10[0]));
const $for_content9 = /* @__PURE__ */_._content_branch("<!> ", /* replace, over(2) */"%c", 0, $for_content9__$params);
const $for_content8__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content8__$params = /* @__PURE__ */_._const("$params9", ($scope, $params9) => $for_content8__i($scope, $params9[0]));
const $for_content8 = /* @__PURE__ */_._content_branch(" ", /* get, over(1) */" b", 0, $for_content8__$params);
const $for_content7__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content7__$params = /* @__PURE__ */_._const("$params8", ($scope, $params8) => $for_content7__i($scope, $params8[0]));
const $for_content7 = /* @__PURE__ */_._content_branch(" ", /* get, over(1) */" b", 0, $for_content7__$params);
const $for_content6__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content6__$params = /* @__PURE__ */_._const("$params7", ($scope, $params7) => $for_content6__i($scope, $params7[0]));
const $for_content6 = /* @__PURE__ */_._content_branch(" ", /* get, over(1) */" b", 0, $for_content6__$params);
const $for_content5__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content5__$params = /* @__PURE__ */_._const("$params6", ($scope, $params6) => $for_content5__i($scope, $params6[0]));
const $for_content5 = /* @__PURE__ */_._content_branch(" ", /* get, over(1) */" b", 0, $for_content5__$params);
const $for_content4__i = /* @__PURE__ */_._const("i", ($scope, i) => _._text($scope["#text/0"], i));
const $for_content4__$params = /* @__PURE__ */_._const("$params5", ($scope, $params5) => $for_content4__i($scope, $params5[0]));
...
const $arr = /* @__PURE__ */_._const("arr", ($scope, arr) => $for($scope, [arr]));
const $for2 = /* @__PURE__ */_._for_in("#text/1", $for_content2);
const $obj = /* @__PURE__ */_._const("obj", ($scope, obj) => $for2($scope, [obj]));
const $for3 = /* @__PURE__ */_._for_to("#text/2", $for_content3);
const $for4 = /* @__PURE__ */_._for_until("#text/3", $for_content4);
const $for5 = /* @__PURE__ */_._for_to("#text/4", $for_content5);
const $for6 = /* @__PURE__ */_._for_until("#text/5", $for_content6);
const $for7 = /* @__PURE__ */_._for_to("#text/6", $for_content7);
const $for8 = /* @__PURE__ */_._for_until("#text/7", $for_content8);
const $for9 = /* @__PURE__ */_._for_to("#text/8", $for_content9);
const $for10 = /* @__PURE__ */_._for_until("#text/9", $for_content10);
