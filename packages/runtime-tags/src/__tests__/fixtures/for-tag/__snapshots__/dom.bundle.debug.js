...
const $for8 = /*@__PURE__*/ _for_until("#text/7", " ", " ", $for_content8__setup);
const $for9 = /*@__PURE__*/ _for_to("#text/8", "<!> ", "%", $for_content9__setup);
const $for10 = /*@__PURE__*/ _for_until("#text/9", "<!> ", "%", $for_content10__setup);
