...
const $for_content10__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content10__setup = ($scope) => $for_content10__setup__render($scope);
const $for_content9__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content9__setup = ($scope) => $for_content9__setup__render($scope);
const $for_content8__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content8__setup = ($scope) => $for_content8__setup__render($scope);
const $for_content7__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content7__setup = ($scope) => $for_content7__setup__render($scope);
const $for_content6__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content6__setup = ($scope) => $for_content6__setup__render($scope);
const $for_content5__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content5__setup = ($scope) => $for_content5__setup__render($scope);
const $for_content4__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content4__setup = ($scope) => $for_content4__setup__render($scope);
const $for_content3__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope["#LoopKey"]));
const $for_content3__setup = ($scope) => $for_content3__setup__render($scope);
