...
const $frame_content2__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $frame_content2__if($scope, $scope._._.input_show ? 0 : 1), ($scope) => $scope._._, "__tests__/template.marko_2_input_show#6/subscribe");
