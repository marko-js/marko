...
var store_default = /*@__PURE__*/ _template_patch("__tests__/tags/store.marko", "", "", $setup$2);
...
const $if_content__store_set = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_3_store_set#9/init", "store_set", ($scope) => $if_content__count($scope, 0, $scope._._._.store_set), ($scope) => $scope._._._);
...
const $frame_content2__if = /*@__PURE__*/ _if("#text/0", "<span>Seen <!></span><button>+</button>", "Db%l ", $if_content__setup);
const $frame_content2__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $frame_content2__if($scope, $scope._._.input_show ? 0 : 1), ($scope) => $scope._._);
const $frame_content2__setup = $frame_content2__input_show;
const $frame_content2 = /*@__PURE__*/ _content("__tests__/template.marko_2*content", "<!><!><!>", "b%", $frame_content2__setup);
const $frame_content__setup = ($scope) => $input_content_direct($scope["#childScope/0"], $frame_content2($scope));
const $frame_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D%l"), $frame_content__setup);
...
const $input_show__closure = /*@__PURE__*/ _closure($frame_content2__input_show);
