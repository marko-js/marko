// template.marko
const $template = "<button id=inc>inc</button><button id=show>show</button><div>count: <!></div><!><!><!>";
const $walks = " b bDb%l%b%c";
_enable_catch();
...
const $if_content__count = /*@__PURE__*/ _if_closure("#text/3", 0, /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.count)));
...
const $if = /*@__PURE__*/ _if("#text/3", "<span>late: <!></span>", "Db%l", $if_content__setup);
