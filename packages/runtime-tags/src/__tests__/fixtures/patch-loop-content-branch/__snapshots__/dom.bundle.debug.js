...
const $walks = " b";
const $setup = () => {};
const $else_content__item_n = /*@__PURE__*/ _closure_get("item_n", ($scope) => _text($scope["#text/0"], $scope._._.item_n), ($scope) => $scope._._, "__tests__/template.marko_4_item_n#5/subscribe");
const $else_content__setup = $else_content__item_n;
const $if_content__item_n = /*@__PURE__*/ _closure_get("item_n", ($scope) => _text($scope["#text/0"], $scope._._.item_n), ($scope) => $scope._._, "__tests__/template.marko_3_item_n#5/subscribe");
...
const $card_content__item_alt = /*@__PURE__*/ _closure_get("item_alt", ($scope) => $card_content__if($scope, $scope._.item_alt ? 0 : 1), 0, "__tests__/template.marko_2_item_alt#4/subscribe");
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#ul/0", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$1), $for_content__setup, $for_content__$params);
