...
const $Child_content__input_a = /* @__PURE__ */_._const("input_a", ($scope, input_a) => _._text($scope["#text/0"], input_a));
const $Child_content__input_b = /* @__PURE__ */_._const("input_b", ($scope, input_b) => _._text($scope["#text/1"], input_b));
