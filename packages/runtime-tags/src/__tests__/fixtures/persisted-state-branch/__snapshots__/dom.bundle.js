...
const $if = /*@__PURE__*/ _if(4, $if_content__template, $if_content__walks, $if_content__count);
...
const $for = /*@__PURE__*/ _for_of(5, $for_content__template, $for_content__walks, $for_content__setup, $for_content__$params);
...
_static_shells({
	...
	"a1": [$if_content__template, $if_content__walks],
...
const $update2 = ($patch, $live) => {
	...
	$_holes($patch, $live);
	if ("Ae" in $patch) _update_if_state($patch, $live, "De", "Ae", [0]);
...
_update_content("a2", $for_content_holes);
const $noop_update = () => {};
...
const $for_content__$params = ($scope, $params2) => $for_content__item($scope, $params2[0]);
const $if_content__count = /*@__PURE__*/ _if_closure(4, 0, ($scope) => _text($scope.a, $scope._.l));
const $if = /*@__PURE__*/ _if(4, "<p class=detail>detail <!></p>", "Db%", $if_content__count);
...
const $for = /*@__PURE__*/ _for_of(5, "<li><!>:<!></li>", "D%c%", $for_content__setup, $for_content__$params);
