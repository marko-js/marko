...
var struct_default = _template_patch("__tests__/tags/struct/index.marko", (input) => {
	...
	_if(() => {
		if (input.mode) {
			...
			_html("<div>a</div>");
			$scope0_page && _scope($scope1_id, {}, "__tests__/tags/struct/index.marko", "1:2");
			return 0;
		} else {
			const $scope2_id = _scope_id();
			_html("<span>b</span>");
			$scope0_page && _scope($scope2_id, {}, "__tests__/tags/struct/index.marko", "4:2");
			return 1;
		}
	}, $scope0_id, "#text/0", 1, $sg__input_mode, $sg__input_mode, void 0, void 0, ["__tests__/tags/struct/index.marko_1*shell", "__tests__/tags/struct/index.marko_2*shell"], $scope0_reason, 0);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/struct/index.marko", 0);
}, 0, 0);
