...
const $elseif_content__input_kind = /*@__PURE__*/ _closure_get("input_kind", ($scope) => _text($scope["#text/0"], $scope._._.input_kind), ($scope) => $scope._._, "__tests__/template.marko_2_input_kind#3/subscribe");
...
const $widget_content__input_kind = /*@__PURE__*/ _closure_get("input_kind", ($scope) => $widget_content__if($scope, $scope._.input_kind === "a" ? 0 : $scope._.input_kind === "b" ? 1 : 2), 0, "__tests__/template.marko_1_input_kind#3/subscribe");
