...
var child_default = _template_persisted("__tests__/tags/child.marko", (input) => {
	...
	_html(`<div${_patch_attrs(htmlInput, "#div/0", $scope0_id, "div", void 0, $scope0_reason, 1)}>`);
	_for_of(buttons, (button) => {
		const $scope1_id = _scope_id();
		_if(() => {
			if (button) {
				const $scope2_id = _scope_id();
				_dynamic_tag($scope2_id, "#text/0", button, {}, 0, 0, $sg__input_button, _patch_dynamic_tag($scope2_id, "#text/0", button, 0, 0, 0, $scope0_reason, 0));
				$scope0_page && _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/tags/child.marko", "4:8");
				return 0;
			}
		}, $scope1_id, "#text/0", 1, $sg__input_button, $sg__input_button, void 0, void 0, ["__tests__/tags/child.marko_2*shell"], $scope0_reason, 0);
		$scope0_page && _scope($scope1_id, { button: _source_if($scope0_reason, 0) && button }, "__tests__/tags/child.marko", "3:4", { button: "3:8" });
