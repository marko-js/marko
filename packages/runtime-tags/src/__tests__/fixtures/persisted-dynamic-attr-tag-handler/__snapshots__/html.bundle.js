...
var child_default = _template_persisted("b", (input) => {
	...
	_html(`<div${_patch_attrs(htmlInput, "a", $scope0_id, "div", void 0, $scope0_owned, 1)}>`);
	_for_of(buttons, (button) => {
		const $scope1_id = _scope_id();
		_if(() => {
			if (button) {
				const $scope2_id = _scope_id();
				_dynamic_tag($scope2_id, "a", button, {}, 0, 0, $sg__input_button, _patch_dynamic_tag($scope2_id, "a", button, 0, 0, 0, $scope0_owned, 0));
				$scope0_reason && _scope($scope2_id, { _: _scope_with_id($scope1_id) });
				return 0;
			}
		}, $scope1_id, "a", 1, $sg__input_button, $sg__input_button, void 0, void 0, ["b1"], $scope0_owned, 0);
		$scope0_reason && _scope($scope1_id, { c: _source_if($scope0_reason, 0) && button });
	}, 0, $scope0_id, "a", 1, 1, $sg__input_button, void 0, void 0, "b0", $scope0_owned, 0);
