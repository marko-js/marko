...
// A render-once list whose value never exists in the browser (the feed
// example's `server import`ed TAGS constant): fresh construction must
// build the loop's branches from the patch alone.
