...
const $setup$1 = () => {};
const subsByKey = {};
const $value = _var_resume("d2", /* @__PURE__ */ _let(3, ($scope) => _return($scope, $scope.d)));
...
const $added = _var_resume("b2", /* @__PURE__ */ _let(12, ($scope) => _text($scope.d, $scope.m)));
...
// tags/layout.marko
const $open = _var_resume("c2", /* @__PURE__ */ _let(6, ($scope) => _text($scope.b, $scope.g ? "collapse" : "expand")));
...
const $for_content2_content = _resume("a0", [
	"<li> </li>",
	"D l",
	0
]);
const $await_content__for = /* @__PURE__ */ _for_of(0, $for_content2_content[0], $for_content2_content[1], $for_content2_content[2], $for_content2__$params);
...
const $Item_content__if = _var_resume("a1", /* @__PURE__ */ _if(0, "<h2>not found</h2>", "b", 0, /* @__PURE__ */ ((_w0) => `<img class=thumb><h2 class=title> </h2><div class=price>$<!></div>${_w0}<!><!>`)($template), /* @__PURE__ */ ((_w0) => ` bD lDb%l/${_w0}&%c`)($walks), $else_content2__setup));
...
const $Cart_content__products = _var_resume("a2", /* @__PURE__ */ _let(4, $Cart_content__list__OR__products));
...
const $count = _var_resume("a3", /* @__PURE__ */ _let(3, ($scope) => _text($scope.b, $scope.d)));
