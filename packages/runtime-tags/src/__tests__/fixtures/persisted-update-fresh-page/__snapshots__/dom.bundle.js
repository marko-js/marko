...
// template.marko
_enable_catch();
const $placeholder_content = _content_resume("a11", "loading recommendations…", "b");
...
const $Cart_content__list = _var_resume("a15", /*@__PURE__*/ _const_persisted(4, ($scope) => {
...
_update_content("a2", $Cart_content__update);
const _merge = _resume("a14", $update2);
