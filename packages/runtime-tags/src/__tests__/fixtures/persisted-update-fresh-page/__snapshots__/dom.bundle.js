...
// template.marko
_enable_catch();
const $placeholder_content = _content_resume("a2", "loading recommendations…", "b");
...
const $Cart_content__list = _var_resume("a0", /*@__PURE__*/ _const(4, ($scope) => {
...
const $for_update = _update_for(0, "a8", (branch, args) => _update_scope(args[0], branch));
const $if_update = _update_signal("a9");
const $products_seed = _update_signal("a10");
const $for_update2 = _update_for(2, "a7", (branch, args) => _update_scope(args[0], branch));
...
_update_content("a1", $Cart_content__update);
