...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_tag__OR__input_cls = _source_guard($scope0_reason, 0), $sg__input_wrap = _source_guard($scope0_reason, 5), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	...
	$scope0_page && _scope($scope0_id, {
		input_tag: _source_if($scope0_reason, 4) && input.tag,
		input_cls: _source_if($scope0_reason, 3) && input.cls,
		input_note: _source_if($scope0_reason, 5) && input.note,
