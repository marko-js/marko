...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/1", $tag2, {}, _content_elide("__tests__/template.marko_1*content", () => {
		...
		_html(_patch_text($scope1_id, "#text/0", input.note, void 0, $scope0_owned, 6));
		_subscribe(_unfilled_if($scope0_owned, 6) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "3:4"));
	}, $scope0_id), 0, $sg__input_wrap, _patch_dynamic_tag($scope0_id, "#text/1", $tag2, 0, "__tests__/template.marko_1*content", 0, $scope0_owned, 5));
