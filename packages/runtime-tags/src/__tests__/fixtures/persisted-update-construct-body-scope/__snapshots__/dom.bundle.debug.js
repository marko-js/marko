...
const $update2$2 = ($patch, $live) => {
	...
	if ("input_onReady" in $patch) $input_onReady_update($live, $patch["input_onReady"]);
};
_construct("__tests__/tags/mounter.marko_0_update", $construct$1);
const $merge$2 = _resume("__tests__/tags/mounter.marko_0_update", $update2$2);
_update_content("__tests__/tags/mounter.marko", $merge$2, $construct$1);
...
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=home>home</p>");
