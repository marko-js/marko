...
const $Child_content__input_value = /*@__PURE__*/ _closure_get("input_value/5", ($scope) => _text($scope["#text/0"], $scope._.input_value), 0, "__tests__/template.marko_1_input_value#4/subscribe");
