...
var my_input_default = _template("__tests__/tags/my-input.marko", (input) => {
	...
	_html_opens("__tests__/tags/my-input.marko:1:1", "__tests__/tags/my-input.marko:2:1"), _html(`<input${_attrs(input, "#input/0", $scope0_id, "input")}>${_el_resume($scope0_id, "#input/0")}<span>${_escape(input.value)}${_el_resume($scope0_id, "#text/1", _serialize_guard($scope0_reason, 0))}</span>`);
