...
const $content = (input) => {
	...
	_html(`<li>${_patch_text($scope0_id, "a", input.node.name, void 0, $scope0_owned, 0)}`);
	_if(() => {
		if (input.node.children) {
			...
			}, 0, $scope1_id, "a", 1, $sg__input_node_children, $sg__input_node_children, void 0, void 0, "b1", $scope0_owned, 1);
			_html(`</ul>${_el_resume($scope1_id, "a", $sg__input_node_children)}`);
			$scope0_reason && _scope($scope1_id, { _: _scope_with_id($scope0_id) });
			return 0;
		}
	}, $scope0_id, "b", 1, $sg__input_node_children, $sg__input_node_children, void 0, void 0, ["b0"], $scope0_owned, 1);
	_html("</li>");
	$scope0_reason && _scope($scope0_id, { g: _source_if($scope0_reason, 1) && input.node?.children });
};
...
var template_default = _template_persisted("a", (input) => {
	...
	$scope0_reason && _scope($scope0_id, { e: input.tree });
}, 1, () => [tree_default]);
