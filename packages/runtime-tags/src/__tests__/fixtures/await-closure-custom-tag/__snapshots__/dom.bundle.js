// tags/child.marko
const $input_q = ($scope, input_q) => _text($scope.b, input_q);
...
const $await_content__input_data_q = _closure_get(10, ($scope) => $input_q($scope.a, $scope._._.h), ($scope) => $scope._._, "c0");
const $await_content__on = _closure_get(11, ($scope) => $input_on$1($scope.a, $scope._._.i), ($scope) => $scope._._, "c1");
