...
const $await_content__input_data_q = _closure_get("input_data_q", ($scope) => $input_q($scope["#childScope/0"], $scope._._.input_data_q), ($scope) => $scope._._, "__tests__/tags/parent.marko_2_input_data_q#7/pending");
const $await_content__setup = ($scope) => {
	$await_content__input_data_q($scope);
	$await_content__on($scope);
	$setup$2($scope["#childScope/0"]);
};
const $await_content__on = _closure_get("on", ($scope) => $input_on$1($scope["#childScope/0"], $scope._._.on), ($scope) => $scope._._, "__tests__/tags/parent.marko_2_on#8/pending");
