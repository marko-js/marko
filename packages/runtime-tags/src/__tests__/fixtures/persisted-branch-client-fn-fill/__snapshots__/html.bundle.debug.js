...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_title: ["input.title"],
		getTitle: "1:8"
	}) : (_filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko0", getTitle), _filled_guard($scope0_owned, 0) && _patch_write($scope0_id, "input_title", input.title));
}, 1, 0);
