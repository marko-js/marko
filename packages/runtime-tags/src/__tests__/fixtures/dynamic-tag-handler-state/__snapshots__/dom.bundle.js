// template.marko
const $inputtag_content3 = /*@__PURE__*/ _content("a4", "aliased");
const $inputtag_content2 = /*@__PURE__*/ _content("a3", "inline");
const $inputtag_content = /*@__PURE__*/ _content("a2", "spread");
const $dynamicTag = /*@__PURE__*/ _dynamic_tag(0, $inputtag_content);
