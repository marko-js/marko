...
var counter_default = _template("__tests__/tags/counter.marko", (input) => {
	...
	let count = 0;
	_html_opens("__tests__/tags/counter.marko:2:1"), _html(`<button id=count>${_escape(count)}${_el_resume($scope0_id, "#text/1")}</button>${_el_resume($scope0_id, "#button/0")}`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html_opens("__tests__/template.marko:7:1"), _html(`<button id=changeTag></button>${_el_resume($scope0_id, "#button/1")}`);
