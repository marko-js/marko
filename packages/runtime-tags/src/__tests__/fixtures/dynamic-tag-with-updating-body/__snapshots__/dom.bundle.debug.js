...
const $tagName = /*@__PURE__*/ _let("tagName/2", ($scope) => $dynamicTag($scope, "tagName" in $scope ? $scope.tagName : "div"));
const $setup__script = _script("__tests__/template.marko_0", ($scope) => _on($scope["#button/1"], "click", function() {
	$tagName($scope, ("tagName" in $scope ? $scope.tagName : "div") === "span" ? "div" : "span");
}));
