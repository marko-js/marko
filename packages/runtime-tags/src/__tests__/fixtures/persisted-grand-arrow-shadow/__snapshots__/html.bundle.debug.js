...
var widget_default = _template_persisted("__tests__/tags/widget/index.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, { input_title: input.title }, "__tests__/tags/widget/index.marko", 0, { input_title: ["input.title"] }) : _owned_guard($scope0_owned, 0) && _patch_write($scope0_id, "input_title", input.title);
}, 0, 0);
