...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	let el = _dynamic_tag($scope0_id, "#text/0", $tag, {}, void 0, void 0, void 0, _patch_dynamic_tag($scope0_id, "#text/0", $tag, 0, 0, "__tests__/template.marko_0_el#8/var", $scope0_reason, 0));
	...
	$scope0_page ? _scope($scope0_id, {
		...
		clicks: "1:6",
		el: "2:15"
	}) : _filled_guard($scope0_reason, 0) && _patch_write($scope0_id, "el", el);
}, 1, 1);
