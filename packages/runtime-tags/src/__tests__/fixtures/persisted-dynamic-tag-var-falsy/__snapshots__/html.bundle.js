...
var template_default = _template_persisted("a", (input) => {
	...
	let el = _dynamic_tag($scope0_id, "a", $tag, {}, void 0, void 0, void 0, _patch_dynamic_tag($scope0_id, "a", $tag, 0, 0, "a0", $scope0_reason, 0));
	...
	$scope0_page ? _scope($scope0_id, {
		h: clicks,
		i: el
	}) : _filled_guard($scope0_reason, 0) && _patch_write($scope0_id, "i", el);
}, 1, 1);
