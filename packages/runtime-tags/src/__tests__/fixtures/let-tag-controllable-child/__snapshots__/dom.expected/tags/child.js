...
const _expr_input_value_input_valueChange = /* @__PURE__ */_$.intersection(10, _scope => {
  const {
    "input_value/8": input_value,
    "input_valueChange/9": input_valueChange
  } = _scope;
...
const _input_valueChange = /* @__PURE__ */_$.value("input_valueChange/9", (_scope, input_valueChange) => _expr_input_value_input_valueChange(_scope));
const _input_value = /* @__PURE__ */_$.value("input_value/8", (_scope, input_value) => {
  _$.data(_scope["#text/1"], input_value);
  _$.data(_scope["#text/4"], input_value);
  _expr_input_value_input_valueChange(_scope);
});
export const _input_ = /* @__PURE__ */_$.value("input/7", (_scope, input) => {
...
export const _params__ = /* @__PURE__ */_$.value("_params_/6", (_scope, _params_) => _input_(_scope, _params_[0]));
