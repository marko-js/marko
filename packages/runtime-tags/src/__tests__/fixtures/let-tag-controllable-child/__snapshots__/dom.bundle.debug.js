...
const $state = /*@__PURE__*/ _let_change("state/14", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.state)));
const $thirdState = /*@__PURE__*/ _let_change("thirdState/18", /*@__PURE__*/ _render(($scope) => _text($scope["#text/8"], $scope.thirdState)));
...
const $otherState = /*@__PURE__*/ _let_change("otherState/16", /*@__PURE__*/ _render(($scope) => _text($scope["#text/5"], $scope.otherState)));
...
const $source__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.source));
