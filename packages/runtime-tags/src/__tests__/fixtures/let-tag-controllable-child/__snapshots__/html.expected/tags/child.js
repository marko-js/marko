...
export default _$.createTemplate("__tests__/tags/child.marko", (input, $serialize) => {
  ...
  _$.writeScope($scope0_id, {
    input_value: _$.serializeIf($serialize, 1) && input.value,
    input_valueChange: _$.serializeIf($serialize, 0) && input.valueChange,
    state,
    otherState,
