...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		label: "2:8",
		show: "3:8"
	}) : (_filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko0", label), _filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko1", show));
}, 1, 0);
