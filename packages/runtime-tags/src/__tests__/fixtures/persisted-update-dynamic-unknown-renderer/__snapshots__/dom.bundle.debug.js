...
const _merge$1 = _resume("__tests__/tags/ticker.marko_0_update", $update2$1);
_update_content("__tests__/tags/ticker.marko", _merge$1);
...
const $update2 = (_patch, _live) => {
	...
	if ("input_entries" in _patch) _live["input_entries"] = _patch["input_entries"];
	$_holes(_patch, _live);
