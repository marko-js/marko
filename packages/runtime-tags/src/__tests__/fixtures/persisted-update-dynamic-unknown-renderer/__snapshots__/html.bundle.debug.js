...
_renderer_shells({
	"__tests__/template.marko_0_update": ["<button class=count>clicked <!></button><h1> </h1><!><!>", " Db%lD l%c"],
	"__tests__/template.marko": ["<button class=count>clicked <!></button><h1> </h1><!><!>", " Db%lD l%c"]
});
