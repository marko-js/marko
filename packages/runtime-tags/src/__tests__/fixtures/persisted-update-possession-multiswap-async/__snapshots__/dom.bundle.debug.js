...
const $PanelAsync_content = /*@__PURE__*/ _content("__tests__/template.marko_4_content", "<!><!><!>", "b%c", $PanelAsync_content__setup);
...
const $update2 = (_patch, _live) => {
	...
	if ("PanelAsync" in _patch) _live["PanelAsync"] = _patch["PanelAsync"];
