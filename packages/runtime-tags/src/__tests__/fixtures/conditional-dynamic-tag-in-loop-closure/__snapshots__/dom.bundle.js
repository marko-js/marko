...
const $for_content__if = /* @__PURE__ */ _if(0, "<!><!><!>", "b%c", $if_content__setup);
...
// template.marko: 234 (min) 150 (brotli)
...
const $section_content = _content_resume("a1", " ", " b", $section_content__setup);
