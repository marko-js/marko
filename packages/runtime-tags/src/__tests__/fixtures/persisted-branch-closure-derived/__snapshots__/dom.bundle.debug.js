...
const $walks = "E l%b l";
const $if_content__double = /*@__PURE__*/ _resume_init("__tests__/template.marko_1_double/init", /*@__PURE__*/ _if_closure("#text/1", 0, ($scope) => _text($scope["#text/0"], $scope._.double)));
