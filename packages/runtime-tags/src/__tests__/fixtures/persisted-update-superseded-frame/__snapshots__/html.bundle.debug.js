...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let show = true;
	_html(`<button class=toggle>${_escape(_hole_value($scope0_id, "PatchHole:#text/1", show ? "hide" : "show", _state_reason()))}${_el_resume($scope0_id, "#text/1")}</button>${_el_resume($scope0_id, "#button/0")}`);
	_if(() => {
		if (show) {
			...
			_try($scope1_id, "#text/0", _content_resume("__tests__/template.marko_2_content", () => {
				...
				}, $sg__input_note__OR__input_tick, "__tests__/template.marko_4_update");
	...
	}, $scope0_id, "#text/2", 1, 1, 1, 0, 1, void 0, void 0, ["__tests__/template.marko_1_update"]);
...
_renderer_shells({
	...
	"__tests__/template.marko_1_content": ["<section><!></section>", "D%l"],
	"__tests__/template.marko_0_update": ["<button class=toggle> </button><!><!>", " D l%c"],
	"__tests__/template.marko": ["<button class=toggle> </button><!><!>", " D l%c"]
});
