...
const $for_content__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_title", /*@__PURE__*/ _closure_get("input_title", $for_content__input_title__OR__item, ($scope) => $scope._._._, "__tests__/template.marko_3_input_title#4/subscribe"), 0);
...
const $box_content__for = /*@__PURE__*/ _for_of_unkeyed("#text/0", "<span> </span>", "D ", $for_content__setup, $for_content__$params);
