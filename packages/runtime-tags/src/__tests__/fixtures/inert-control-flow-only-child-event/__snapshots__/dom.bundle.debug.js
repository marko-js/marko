...
const $walks = " b";
const $for_content__selected = /*@__PURE__*/ _for_selector("#div/0", "selected", "#LoopKey", /*@__PURE__*/ _render(($scope) => _attr($scope["#span/0"], "data-selected", $scope._.selected === $scope["#LoopKey"])));
