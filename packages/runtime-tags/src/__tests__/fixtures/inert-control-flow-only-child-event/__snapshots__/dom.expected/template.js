...
const $for_content__selected__OR__i = /* @__PURE__ */_._or(4, $scope => {
  let {
    _: {
      selected
    },
  ...
  _._attr($scope["#option/0"], "selected", selected === i);
});
const $for_content__selected = /* @__PURE__ */_._for_closure("selected", "#select/0", $for_content__selected__OR__i);
const $for_content__i = /* @__PURE__ */_._const("i", ($scope, i) => {
