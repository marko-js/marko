...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	let x = _dynamic_tag($scope0_id, "#text/0", $tag, $input2, void 0, void 0, void 0, _patch_dynamic_tag($scope0_id, "#text/0", $tag, $input2, 0, "__tests__/template.marko_0_x#8/var", $scope0_owned, 0));
