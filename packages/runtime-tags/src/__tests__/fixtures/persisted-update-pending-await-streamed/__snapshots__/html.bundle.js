...
var template_default = _template("a", (input) => {
	...
	writeScope($scope0_id, {
		f: (_serialize_if($scope0_reason, 2) || _update_reason()) && input.note,
		g: (_serialize_if($scope0_reason, 1) || _update_reason()) && input.tick,
		h: _state_reason() && clicks,
		Bf: $sg__input_note && $input_note__closures,
		Bg: $sg__input_tick && $input_tick__closures
	});
