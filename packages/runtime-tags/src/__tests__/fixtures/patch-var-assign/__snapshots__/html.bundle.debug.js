...
var counter_box_default = _template_patch("__tests__/tags/counter-box/index.marko", (input) => {
...
_shells({ "__tests__/template.marko": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko !__tests__/template.marko_0;${_w0};${_w1}`)(((_w0) => `D0${_w0}&D l l`)($walks$1), ((_w0) => `<main>${_w0}<p> </p><button>+</button></main>`)($template$1)) });
