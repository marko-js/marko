...
// template.marko
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("a1", 5, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.a, "t:" + $scope._._._.f), ($scope) => $scope._._._, "a6", 5), 0);
const $box_content__if = /*@__PURE__*/ _if(0, "<p> </p>", "D ", $if_content2__input_title);
const $box_content__input_show = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(7, ($scope) => $box_content__if($scope, $scope._._.e ? 0 : 1), ($scope) => $scope._._, "a7", 4), 0);
const $box_content = /*@__PURE__*/ _content$1("a0", "<!><!><!>", "b%", $box_content__input_show);
