...
const $walks = "D%b l";
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], "t:" + $scope._._._.input_title), ($scope) => $scope._._._, "__tests__/template.marko_3_input_title#5/subscribe"), 0);
const $if_content2__setup = $if_content2__input_title;
const $box_content__if = /*@__PURE__*/ _if("#text/0", "<p> </p>", "D ", $if_content2__setup);
const $box_content__input_show = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_show", /*@__PURE__*/ _closure_get("input_show", ($scope) => $box_content__if($scope, $scope._._.input_show ? 0 : 1), ($scope) => $scope._._, "__tests__/template.marko_2_input_show#4/subscribe"), 0);
