...
// template.marko
const $elseif_content2__input_inner = /*@__PURE__*/ _fill_join_closure("a0", 6, /*@__PURE__*/ _closure_get(9, ($scope) => _text($scope.a, $scope._._._.g), ($scope) => $scope._._._, "a11", 6), 1);
const $widget_content2__if = /*@__PURE__*/ _if(0, "<b>A</b>", 0, 0, "<i>B:<!></i>", "Db%", $elseif_content2__input_inner);
const $widget_content2__input_inner = /*@__PURE__*/ _fill_join_closure("a0", 6, /*@__PURE__*/ _closure_get(9, ($scope) => $widget_content2__if($scope, $scope._._.g === "a" ? 0 : $scope._._.g === "b" ? 1 : 2), ($scope) => $scope._._, "a12", 6), 0);
