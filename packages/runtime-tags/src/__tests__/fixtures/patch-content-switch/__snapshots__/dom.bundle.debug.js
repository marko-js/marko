...
const $elseif_content2__input_inner = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_inner", /*@__PURE__*/ _closure_get("input_inner", ($scope) => _text($scope["#text/0"], $scope._._._.input_inner), ($scope) => $scope._._._, "__tests__/template.marko_5_input_inner#6/subscribe"), 1);
...
const $widget_content2__input_inner = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_inner", /*@__PURE__*/ _closure_get("input_inner", ($scope) => $widget_content2__if($scope, $scope._._.input_inner === "a" ? 0 : $scope._._.input_inner === "b" ? 1 : 2), ($scope) => $scope._._, "__tests__/template.marko_4_input_inner#6/subscribe"), 0);
...
const $elseif_content__input_kind = /*@__PURE__*/ _closure_get("input_kind", ($scope) => _text($scope["#text/0"], $scope._._.input_kind), ($scope) => $scope._._, "__tests__/template.marko_2_input_kind#5/subscribe");
...
const $widget_content__input_kind = /*@__PURE__*/ _closure_get("input_kind", ($scope) => $widget_content__if($scope, $scope._.input_kind === "a" ? 0 : $scope._.input_kind === "b" ? 1 : 2), 0, "__tests__/template.marko_1_input_kind#5/subscribe");
