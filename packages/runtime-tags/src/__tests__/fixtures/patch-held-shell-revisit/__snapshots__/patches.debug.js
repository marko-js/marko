// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-held-shell-revisit/template.marko_3*shell;b%b/ Db%l&b;<!><!><button class=b>b:<!></button><!>`, (_.a = {
...
// PATCH holding BwY
[`packages/runtime-tags/src/__tests__/fixtures/patch-held-shell-revisit/template.marko_2*shell;b%b/ Db%l&b;<!><!><button class=a>a:<!></button><!>`, (_.a = {
  "PatchReady:ready:packages/runtime-tags/src/__tests__/fixtures/patch-held-shell-revisit/page-a.marko": {
    "PatchChild:#childScope/0": {
      "PatchChild:BranchScopes:#text/2": {
        "PatchChild:BranchScopes:#text/0": {
          "PatchChild:#childScope/1": {
  ...
  "PatchChild:#childScope/0": {
    "PatchChild:BranchScopes:#text/2": {
      "PatchBranch:#text/0": "packages/runtime-tags/src/__tests__/fixtures/patch-held-shell-revisit/template.marko_2*shell"
    }
  }
}, _.a)]
"BwUA"
