...
const $content = input => {
  const $scope0_reason = _._scope_reason(),
    $si__input_level = _._serialize_if($scope0_reason, /* input.level */0),
    $sg__input_level = _._serialize_guard($scope0_reason, /* input.level */0);
    ...
    if (input.level) {
      ...
      _._try($scope1_id, "#text/1", _._content_resume("__tests__/tags/recurse.marko_2_content", () => {
        ...
        _._await($scope2_id, "#text/0", resolveAfter(0), () => {
          ...
          ($si__input_level) && _._script($scope3_id, "__tests__/tags/recurse.marko_3_input_level/pending");
          const $childScope = _._peek_scope_id();
          _._set_serialize_reason(($sg__input_level));
          $content({
            level: input.level - 1
          });
        ...
        $si__input_level && _._scope($scope2_id, {
      ...
      _._html(`</div>${_._el_resume($scope1_id, "#div/0", $sg__input_level)}`);
      $si__input_level && _._scope($scope1_id, {
        _: _._scope_with_id($scope0_id)
      }, "__tests__/tags/recurse.marko", "3:1");
      return 0;
    }
  }, $scope0_id, "#text/0", $sg__input_level, $sg__input_level, $sg__input_level, 0, 1);
  $si__input_level && _._scope($scope0_id, {
