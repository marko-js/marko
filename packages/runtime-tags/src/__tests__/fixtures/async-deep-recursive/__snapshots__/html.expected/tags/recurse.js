...
const $content = input => {
    ...
    if (input.level) {
      ...
      _._try($scope1_id, "#text/1", _._content_resume("__tests__/tags/recurse.marko_2_content", () => {
        ...
        _._await($scope2_id, "#text/0", new Promise(setImmediate), () => {
          ...
          _._serialize_guard($scope0_reason, /* input.level */0) && _._subscribe($input_level__closures, _._scope($scope3_id, {
        ...
        _._serialize_guard($scope0_reason, /* input.level */0) && _._scope($scope2_id, {
      ...
      _._serialize_guard($scope0_reason, /* input.level */0) && _._scope($scope1_id, {
  ...
  _._serialize_guard($scope0_reason, /* input.level */0) && _._scope($scope0_id, {
