...
const $showbi_content__i = /*@__PURE__*/ _closure_get(4, ($scope) => _text($scope.a, $scope._.d));
...
const $item_content2__show = /*@__PURE__*/ _closure_get(8, ($scope) => $item_content2__if($scope, $scope._.g ? 0 : 1));
const $item_content2 = /*@__PURE__*/ _content_closures(/*@__PURE__*/ _content("a2", "<!><!><!>", "b%", $item_content2__show), { 1: $if_content2__item_text });
...
const $item_content = /*@__PURE__*/ _content_closures(/*@__PURE__*/ _content("a1", "<!><!><!><!><!>", "b%b%b%", $item_content__setup), { 3($scope) {
	$if_content__i($scope);
