...
const $showbi_content__i = /*@__PURE__*/ _closure_get("i", ($scope) => _text($scope["#text/0"], $scope._.i));
...
const $item_content2__show = /*@__PURE__*/ _closure_get("show", ($scope) => $item_content2__if($scope, $scope._.show ? 0 : 1));
