...
const $falseChild_content__setup__script = _script("a0", ($scope) => _on($scope.a, "click", function() {
...
const $falseChild_content = _content_resume("a1", "<button> </button>", " D l", $falseChild_content__setup);
