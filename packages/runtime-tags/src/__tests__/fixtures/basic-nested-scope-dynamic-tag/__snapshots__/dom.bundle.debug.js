...
const $template = "<!><!><!>";
const $walks = "b%c";
const $falseChild_content__count = /*@__PURE__*/ _closure_get("count/2", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_1_count#1/subscribe");
...
const $falseChild_content = _content("__tests__/template.marko_1*content", "<button> </button>", " D ", $falseChild_content__setup);
