...
var child_default = _template("__tests__/tags/child.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", input.content, {}, 0, 0, _serialize_guard($scope0_reason, 0), "__tests__/tags/child.marko:1:1");
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", false || child_default, {}, _content_resume("__tests__/template.marko_1_content", () => {
		...
		_scope_reason();
		_html_opens("__tests__/template.marko:5:3"), _html(`<button>${_escape(count)}${_el_resume($scope1_id, "#text/1")}</button>${_el_resume($scope1_id, "#button/0")}`);
