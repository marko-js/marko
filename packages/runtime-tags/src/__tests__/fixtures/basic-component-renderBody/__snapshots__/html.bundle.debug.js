...
var my_button_default = _template("__tests__/tags/my-button.marko", (input) => {
	...
	_html_opens("__tests__/tags/my-button.marko:2:1"), _html("<button>");
	_dynamic_tag($scope0_id, "#text/1", content, {}, 0, 0, _serialize_guard($scope0_reason, 0), "__tests__/tags/my-button.marko:3:3");
