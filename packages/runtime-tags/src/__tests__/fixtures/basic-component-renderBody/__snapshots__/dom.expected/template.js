...
const _clickCount$myButton_content = _$.registerSubscriber("__tests__/template.marko_1_clickCount/subscriber", /* @__PURE__ */_$.dynamicClosure((_scope, clickCount) => _$.data(_scope["#text/0"], clickCount)));
