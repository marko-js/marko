...
const $await_content2__setup__script = _._script(
  ...
  $await_content = _._await_content(0, ` `, ` b`, ($scope) => {
  ...
  $show = _._let(2, ($scope) => {
    ($if($scope, +!$scope.c), $show__closure($scope));
  });
(_._script(`a4`, ($scope) =>
