...
const $await_content__show = /*@__PURE__*/ _closure_get("show", ($scope) => _text($scope["#text/0"], $scope._._._.show), ($scope) => $scope._._._, "__tests__/template.marko_3_show#2/subscribe");
