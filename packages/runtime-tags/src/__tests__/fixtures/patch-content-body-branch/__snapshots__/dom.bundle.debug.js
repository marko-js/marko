...
const $walks = " b";
const $setup = () => {};
const $else_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._._._.input_note), ($scope) => $scope._._._, "__tests__/template.marko_4_input_note#6/subscribe");
const $else_content__setup = $else_content__input_note;
const $if_content2__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._._._.input_note), ($scope) => $scope._._._, "__tests__/template.marko_3_input_note#6/subscribe");
...
const $card_content__input_alt = /*@__PURE__*/ _closure_get("input_alt", ($scope) => $card_content__if($scope, $scope._._.input_alt ? 0 : 1), ($scope) => $scope._._, "__tests__/template.marko_2_input_alt#5/subscribe");
