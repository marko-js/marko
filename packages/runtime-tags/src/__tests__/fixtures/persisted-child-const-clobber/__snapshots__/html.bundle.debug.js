...
_shells({ "__tests__/tags/card/index.marko": "__tests__/tags/card/index.marko; E lD ;<section><h2> </h2><p> </p></section>" });
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<section${_patch_attr_class($scope0_id, "#section/0", input.klass, $scope0_reason, 0)}><h2>${_patch_text($scope0_id, "#text/1", input.title, void 0, $scope0_reason, 1)}</h2><p>${_patch_text($scope0_id, "#text/2", input.note, void 0, $scope0_reason, 2)}</p></section>${_el_resume($scope0_id, "#section/0")}`);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	if ($scope0_page || _must_render(card_default)) {
