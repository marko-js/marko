...
const $walks = " D%c%l";
const $count = /*@__PURE__*/ _let(7, /*@__PURE__*/ _render(($scope) => _text($scope.c, $scope.h)));
const $input_value = $count;
const $setup__script = _script("a0", ($scope) => _on($scope.a, "click", function() {
	$count($scope, $scope.h + 1);
}));
const $setup = $setup__script;
const $input_label = /*@__PURE__*/ _render(($scope, input_label) => _text($scope.b, input_label));
