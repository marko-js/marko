# Write
```html
  <button>0<!--M_*1 #text/1--> <!>0<!--M_*1 #text/2--></button><!--M_*1 #button/0--><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.a=[0,{count:0}]),1,"__tests__/template.marko_0_count"];M._.w()</script>
```
