...
const $count = _var_resume("a14", /*@__PURE__*/ _let_persisted(9, ($scope) => _text($scope.b, $scope.j)));
...
_update_content("a4", $inputtag_content_holes);
_update_content("a3", $Panel_content_holes);
