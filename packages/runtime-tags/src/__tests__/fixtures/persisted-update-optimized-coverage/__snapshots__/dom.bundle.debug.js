...
const $Panel_content__walks = "D l", $Panel_content__template = "<p> </p>", $if_content__walks = "D l", $if_content__template = "<h2> </h2>", $elseif_content__walks = "b%c", $elseif_content__template = "<!><!><!>", $else_content__walks = /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($Panel_content__walks), $else_content__template = /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($Panel_content__template);
...
const $inputtag_content = /*@__PURE__*/ _content("__tests__/template.marko_5_content", " ", " ", $inputtag_content__setup);
...
const $if = /*@__PURE__*/ _if("#div/2", $if_content__template, $if_content__walks, $if_content__setup, $elseif_content__template, $elseif_content__walks, $elseif_content__setup, $else_content__template, $else_content__walks, $else_content__setup);
...
_static_shells({
	"__tests__/template.marko_4_update": [$else_content__template, $else_content__walks],
	"__tests__/template.marko_4_content": [$else_content__template, $else_content__walks],
	"__tests__/template.marko_3_update": [$elseif_content__template, $elseif_content__walks],
	"__tests__/template.marko_3_content": [$elseif_content__template, $elseif_content__walks],
...
_update_content("__tests__/template.marko_3_update", $elseif_content__update);
_update_content("__tests__/template.marko_2_update", $if_content_holes);
...
const $inputtag_content = _content_resume("__tests__/template.marko_5_content", " ", " ", $inputtag_content__setup);
const $else_content__input_id = /*@__PURE__*/ _if_closure("#div/2", 2, ($scope) => {
	if (!updating) {
		getTitle($scope._.input_id);
	}
...
const $if = /*@__PURE__*/ _if("#div/2", "<h2> </h2>", "D ", $if_content__setup, "<!><!><!>", "b%", $elseif_content__setup, /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($Panel_content__template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($Panel_content__walks), $else_content__setup);
const $input_kind = ($scope, input_kind) => {
	if (!updating) $if($scope, input_kind === "native" ? 0 : input_kind === "dynamic" ? 1 : 2);
};
const $input = ($scope, input) => {
