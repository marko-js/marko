...
const _merge$1 = _resume("__tests__/tags/item-form.marko_0_update", $update$1);
...
const $itemId = /*@__PURE__*/ _const_persisted("itemId", ($scope) => _attr_input_value_default_persisted($scope, "#input/1", $scope.itemId));
...
const $item_title = /*@__PURE__*/ _const_persisted("item_title", ($scope) => _attr_input_value_default_persisted($scope, "#input/0", $scope.item_title));
