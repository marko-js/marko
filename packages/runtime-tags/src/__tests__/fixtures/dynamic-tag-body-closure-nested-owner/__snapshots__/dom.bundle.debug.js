...
const $walks = "b%c";
const $setup = () => {};
const $inputtype_content__input_depth = /*@__PURE__*/ _closure_get("input_depth/7", ($scope) => _text($scope["#text/0"], $scope._._.input_depth), ($scope) => $scope._._, "__tests__/tags/heading.marko_2_input_depth#5/subscribe");
