...
const $if_content__current = /*@__PURE__*/ _closure_get(11, ($scope) => _text($scope.a, $scope._._.e - 1), ($scope) => $scope._._);
const $try_content__if = /*@__PURE__*/ _if(1, "<span class=prev>prev <!></span>", "Db%", $if_content__current);
const $try_content__current = /*@__PURE__*/ _closure_get(11, ($scope) => $try_content__if($scope, $scope._.e > 1 ? 0 : 1));
const $try_content__setup__script = _script("c10", ($scope) => _on($scope.a, "click", function() {
	$scope._.i($scope._.e + 1);
}));
const $try_content__page = /*@__PURE__*/ _init_closure_get("c17", 12, ($scope) => _text($scope.c, $scope._.f));
const $try_content__go_pending = /*@__PURE__*/ _init_closure_get("c18", 13, ($scope) => _text($scope.d, $scope._.j ? "…" : ""));
...
const $page = /*@__PURE__*/ _fill_draft("c1", 5, /* @__PURE__ */ _closure($try_content__page));
const $_pageSource = ($scope) => {
	$page($scope, $scope.e);
};
const $go2 = /*@__PURE__*/ _fill_action("c2", 8, ($scope) => $go_pending($scope, $scope.i.pending));
const $go_pending = /*@__PURE__*/ _const(9, /* @__PURE__ */ _closure($try_content__go_pending));
