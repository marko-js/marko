...
const flag = "cli";
const $if_content__input_title__OR__count = /*@__PURE__*/ _fill_join_if("a0", 6, /*@__PURE__*/ _init_join("a3", /*@__PURE__*/ _or(1, ($scope) => _text($scope.a, shout($scope._.g) + " #" + $scope._.i))), 0, 2, 0);
