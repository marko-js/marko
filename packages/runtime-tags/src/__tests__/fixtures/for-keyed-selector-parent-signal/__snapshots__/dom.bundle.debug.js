...
const $walks = "D l b";
const $for_content__selected__OR__enabled__OR__row_id = /*@__PURE__*/ _or(6, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#tr/0"], $scope._.enabled && $scope._.selected === $scope.row_id && "danger")), 2);
