...
export default _$.createTemplate("__tests__/tags/custom-tag.marko", (input, $serialize) => {
  ...
  _$.write(`<div>Child: ${_$.commentSeparator(_$.serializeGuard($serialize, 0))}${_$.escapeXML(input)}${_$.markResumeNode($scope0_id, "#text/0", _$.serializeGuard($serialize, 0))}</div>`);
  const $return = input;
