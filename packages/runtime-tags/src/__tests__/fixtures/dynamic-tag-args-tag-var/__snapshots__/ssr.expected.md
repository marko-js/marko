# Write
```html
  <button>Count: <!>1<!--M_*1 #text/1--></button><!--M_*1 #button/0--><!--M_[2--><div>Child: <!>1<!--M_*2 #text/0--></div><!--M_]1 #text/2--><div>Parent: <!>1<!--M_*1 #text/3--></div><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.c={1:_.a={x:1,"#text/2!":_.b={},"#text/2(":_._["__tests__/tags/custom-tag.marko"]},2:_.b},_.b["/"]=_._["__tests__/template.marko_0_y/var"](_.a),_.c),1,"__tests__/template.marko_0_x",0];M._.w()</script>
```
