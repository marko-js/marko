	...
	const Reports = { content: _content("__tests__/template.marko_2_content", () => {
		...
		_try($scope2_id, "#text/0", _content_resume("__tests__/template.marko_3_content", () => {
			...
			_await($scope3_id, "#text/0", getReport($global().topic), (report) => {
				...
				_persisted_reason() && writeScope($scope5_id, {}, "__tests__/template.marko", "16:6");
			...
			_await($scope3_id, "#text/1", getSummary($global().topic), (summary) => {
				...
				_persisted_reason() && writeScope($scope6_id, {}, "__tests__/template.marko", "19:6");
			}, _persisted_reason(), "__tests__/template.marko_6_update");
...
_renderer_shells({
	"__tests__/template.marko_6_update": ["<p class=summary> </p>", "D l"],
