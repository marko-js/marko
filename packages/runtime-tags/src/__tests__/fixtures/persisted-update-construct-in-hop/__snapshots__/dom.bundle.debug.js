...
const $Dashboard_content = /*@__PURE__*/ _content("__tests__/template.marko_5_content", $Dashboard_content__template, $Dashboard_content__walks, $Dashboard_content__setup);
const $Home_content__setup = ($scope) => {
	$Widget_content__setup._($scope["#childScope/0"], $scope._);
};
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_4_content", $Home_content__template, $Home_content__walks, $Home_content__setup);
const $WidgetY_content__setup = ($scope) => _text($scope["#text/0"], getLabel?.($scope.$global.topic));
const $WidgetY_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<section class=y>Widget Y: <!></section>", "Db%", $WidgetY_content__setup);
...
const $WidgetX_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<span class=x>Widget X: <!></span>", "Db%", $WidgetX_content__setup);
...
_static_shells({
	"__tests__/template.marko_5_update": [$Dashboard_content__template, $Dashboard_content__walks],
	"__tests__/template.marko_5_content": [$Dashboard_content__template, $Dashboard_content__walks],
	"__tests__/template.marko_4_update": [$Home_content__template, $Home_content__walks],
	"__tests__/template.marko_4_content": [$Home_content__template, $Home_content__walks],
	"__tests__/template.marko_2_update": [$Widget_content__template, $Widget_content__walks],
	"__tests__/template.marko_2_content": [$Widget_content__template, $Widget_content__walks],
	"__tests__/template.marko_0_update": [$template, $walks],
	"__tests__/template.marko": [$template, $walks]
});
const $count_seed = _update_signal("__tests__/template.marko_0_count/var");
const $Dashboard_content__construct = ($scope) => {
	_construct_child($scope, "#childScope/0", "__tests__/template.marko_2_content", $scope._);
};
const $Dashboard_content__update = ($patch, $live) => {
	if ("#childScope/0" in $patch) _update_child($patch["#childScope/0"], $live["#childScope/0"], "__tests__/template.marko_2_content");
};
...
_construct("__tests__/template.marko_5_update", $Dashboard_content__construct);
_construct("__tests__/template.marko_4_update", $Home_content__construct);
_construct("__tests__/template.marko_0_update", $construct);
_update_content("__tests__/template.marko_5_content", $Dashboard_content__update, $Dashboard_content__construct);
_update_content("__tests__/template.marko_4_content", $Home_content__update, $Home_content__construct);
const $noop_update = () => {};
