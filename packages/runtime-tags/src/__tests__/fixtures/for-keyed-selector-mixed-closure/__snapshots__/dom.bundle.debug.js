...
const $walks = " b b";
const $for_content__enabled__OR__selected__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#li/0"], $scope._.enabled && $scope._.selected === $scope.row_id && "danger")), 2);
