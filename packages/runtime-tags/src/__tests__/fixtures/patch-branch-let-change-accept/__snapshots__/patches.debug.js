...
// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-accept/template.marko_1*shell !packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-accept/template.marko_1;Db%l ;<span>Seen <!></span><button>+</button>`, (_.a = {
  "PatchText:#text/0": "Store!",
  "PatchBranch:#text/2": [{
    "PatchSetup:": {
