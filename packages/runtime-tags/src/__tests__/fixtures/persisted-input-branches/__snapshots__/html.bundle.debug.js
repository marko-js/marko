...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	const $scope0_owned = _persisted_ownership(), $scope0_reason = _persisted_reason(), $sg__input_show = _serialize_guard($scope0_reason, 1), $sg__input_items = _serialize_guard($scope0_reason, 2);
	...
	_if(() => {
		if (input.show) {
			...
			_html("<p>shown</p>");
			_serialize_if($scope0_reason, 1) && writeScope($scope1_id, {}, "__tests__/template.marko", "3:4");
			return 0;
		}
