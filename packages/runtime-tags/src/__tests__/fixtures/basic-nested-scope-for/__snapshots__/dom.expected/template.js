...
const _num$for_content = /* @__PURE__ */_$.value("num/3", (_scope, num) => {
  _$.data(_scope["#text/1"], num);
  _expr_selected_num$for_content(_scope);
  _num$for_content_effect(_scope);
});
const _params_2$for_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => _num$for_content(_scope, _params_2[0]));
const _selected$for_content = /* @__PURE__ */_$.loopClosure("selected/1", "#text/0", (_scope, selected) => _expr_selected_num$for_content(_scope));
