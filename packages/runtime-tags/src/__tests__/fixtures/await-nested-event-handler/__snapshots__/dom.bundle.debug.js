...
const $await_content2__changes = /*@__PURE__*/ _closure_get("changes/2", ($scope) => _text($scope["#text/1"], $scope._._._._.changes), ($scope) => $scope._._._._, "__tests__/template.marko_4_changes#1/subscribe");
