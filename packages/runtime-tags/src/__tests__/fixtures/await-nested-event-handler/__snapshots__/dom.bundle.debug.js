...
const $template = "<!><!><!>";
const $walks = "b%c";
const $placeholder_content2 = _content_resume("__tests__/template.marko_6*content", "loading inner...");
const $placeholder_content = _content_resume("__tests__/template.marko_5*content", "loading outer...");
const $await_content2__changes = _closure_get("changes", ($scope) => _text($scope["#text/1"], $scope._._._._.changes), ($scope) => $scope._._._._, "__tests__/template.marko_4_changes#1/pending");
...
const $await_content2 = /*@__PURE__*/ _await_content("#text/0", "<div>changes: <!></div>", " Db%", $await_content2__setup);
