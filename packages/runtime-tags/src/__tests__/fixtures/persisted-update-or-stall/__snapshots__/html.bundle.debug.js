...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_if(() => $global().show ? 0 : 1, $scope0_id, "#text/2", _persisted_reason(), _persisted_reason(), _persisted_reason(), void 0, void 0, "__tests__/template.marko_0/update_if_#text/2", [() => {
		...
		writeScope($scope1_id, {
			pair: _seed_fill(_state_reason() && pair),
...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<p class=empty>hidden</p>", "b"],
	"__tests__/template.marko_2_content": ["<p class=empty>hidden</p>", "b"],
	"__tests__/template.marko_1_update": ["<p class=pair> </p><button class=bump>bump</button><p class=combo><!>:<!></p>", "D l bD%c%l"],
	"__tests__/template.marko_1_content": ["<p class=pair> </p><button class=bump>bump</button><p class=combo><!>:<!></p>", "D l bD%c%l"],
