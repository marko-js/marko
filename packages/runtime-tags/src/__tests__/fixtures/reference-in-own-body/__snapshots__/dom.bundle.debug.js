...
const $Tag_content2__name__script = _script("__tests__/template.marko_2_name#2", ($scope) => console.log(_assert_init($scope._, "name")));
const $Tag_content2__name = /*@__PURE__*/ _closure_get("name/3", $Tag_content2__name__script);
const $Tag_content2__setup = $Tag_content2__name;
const $Tag_content2 = /*@__PURE__*/ _content("__tests__/template.marko_2*content", 0, 0, $Tag_content2__setup);
