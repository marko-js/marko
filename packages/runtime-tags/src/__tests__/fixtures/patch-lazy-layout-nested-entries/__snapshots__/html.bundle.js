...
var page_b_default = _template_patch("c", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render(), $sg__input_wide = _source_guard($scope0_reason, 1);
	const $scope0_id = _scope_id();
	_html(`<h1>B</h1><p>${_patch_text($scope0_id, "a", input.note, void 0, $scope0_reason, 0)}</p>`);
	_if(() => {
		if (input.wide) {
			const $scope1_id = _scope_id();
			_html("<p>wide</p>");
	...
	}, $scope0_id, "b", 1, $sg__input_wide, $sg__input_wide, void 0, void 0, ["c0"], $scope0_reason, 1);
	$scope0_page && _scope($scope0_id, {});
}, 0, 0);
...
_shells({
	...
	d1: /*@__PURE__*/ ((_w0, _w1) => `d1;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `b%b/${_w0}&b`)($walks$2), /*@__PURE__*/ ((_w0) => `<!><!>${_w0}<!>`)($template$2)),
