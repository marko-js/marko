...
var page_b_default = _template_patch("__tests__/page-b.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render(), $sg__input_wide = _source_guard($scope0_reason, 1);
	const $scope0_id = _scope_id();
	_html(`<h1>B</h1><p>${_patch_text($scope0_id, "#text/0", input.note, void 0, $scope0_reason, 0)}</p>`);
	_if(() => {
		if (input.wide) {
			const $scope1_id = _scope_id();
			_html("<p>wide</p>");
			$scope0_page && _scope($scope1_id, {}, "__tests__/page-b.marko", "3:2");
			return 0;
		}
	}, $scope0_id, "#text/1", 1, $sg__input_wide, $sg__input_wide, void 0, void 0, ["__tests__/page-b.marko_1*shell"], $scope0_reason, 1);
	$scope0_page && _scope($scope0_id, {}, "__tests__/page-b.marko", 0);
}, 0, 0);
...
_shells({
	...
	"__tests__/template.marko_1*shell": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko_1*shell;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `b%b/${_w0}&b`)($walks$3), /*@__PURE__*/ ((_w0) => `<!><!>${_w0}<!>`)($template$3)),
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	}, $scope0_id, "#body/0", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["__tests__/template.marko_5*shell", "__tests__/template.marko_1*shell"], $scope0_reason, 3);
