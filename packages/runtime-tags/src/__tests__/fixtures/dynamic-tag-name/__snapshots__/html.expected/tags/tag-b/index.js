...
export default _._template("__tests__/tags/tag-b/index.marko", (input, $serialize) => {
  ...
  _._serialize_guard($serialize, /* className,other,content */1) && _._scope($scope0_id, {}, "__tests__/tags/tag-b/index.marko", 0);
});