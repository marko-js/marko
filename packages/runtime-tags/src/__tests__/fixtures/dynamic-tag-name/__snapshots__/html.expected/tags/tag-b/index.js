...
export default _$.createTemplate("__tests__/tags/tag-b/index.marko", (input, $serialize) => {
  ...
  _$.write(`</div>${_$.markResumeNode($scope0_id, "#div/0", _$.serializeGuard($serialize, /* className,other */0))}`);
  _$.serializeGuard($serialize, /* className,other,content */1) && _$.writeScope($scope0_id, {}, "__tests__/tags/tag-b/index.marko", 0);
});