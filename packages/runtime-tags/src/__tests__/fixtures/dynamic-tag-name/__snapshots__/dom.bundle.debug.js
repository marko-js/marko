...
const $className$1 = /*@__PURE__*/ _render(($scope, className) => _attr_class($scope["#div/0"], className));
const $other$2 = /*@__PURE__*/ _render(($scope, other) => _attr($scope["#div/0"], "data-other", other));
...
const $className = /*@__PURE__*/ _render(($scope, className) => _attr_class($scope["#div/0"], className));
const $other$1 = /*@__PURE__*/ _render(($scope, other) => _attr($scope["#div/0"], "data-other", other));
