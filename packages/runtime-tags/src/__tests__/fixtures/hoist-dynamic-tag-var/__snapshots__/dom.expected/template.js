...
const $if_content4 = /* @__PURE__ */_$.createRenderer("<!><!><!>", /* over(1), dynamicTagWithVar, over(2) */"b1c", $setup$if$content3);
...
const $if_content3 = /* @__PURE__ */_$.createRenderer("<!><!><!>", /* over(1), dynamicTagWithVar, over(2) */"b1c", $setup$if$content2);
...
const $if_content2 = /* @__PURE__ */_$.createRenderer("<!><!><!>", /* over(1), dynamicTagWithVar, over(2) */"b1c", $setup$if$content);
