...
export default _._template("__tests__/template.marko", input => {
  ...
  _._if(() => {
    if (input.show) {
      ...
      }, $scope1_id, "#text/0", 1, _._serialize_guard($serialize, /* input.show */0), _._serialize_guard($serialize, /* input.show */0));
      _._scope($scope1_id, {
  ...
  }, $scope0_id, "#text/2", 1, 0, _._serialize_guard($serialize, /* input.show */0));
  _._if(() => {
    if (true) {
  ...
  }, $scope0_id, "#text/3", 1, 0, _._serialize_guard($serialize, /* input.show */0));
  if (true) {
