...
const _message_text$if_content = /* @__PURE__ */_$.conditionalClosure("message_text/3", "#text/1", 0, (_scope, message_text) => _$.data(_scope["#text/0"], message_text));
...
const _message_text = /* @__PURE__ */_$.value("message_text/3", (_scope, message_text) => _message_text$if_content(_scope));
