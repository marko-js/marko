...
export const _text_ = /* @__PURE__ */_$.value("text/7", (_scope, text) => {
  _$.data(_scope["#text/1"], text);
  _textAlias(_scope, text);
});
export const _pattern__ = /* @__PURE__ */_$.value("_pattern_/6", (_scope, _pattern_) => _text_(_scope, _pattern_.text));
