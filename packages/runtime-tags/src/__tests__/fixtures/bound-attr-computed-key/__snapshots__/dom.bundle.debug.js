...
const $v__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.v));
...
const $wrong = /*@__PURE__*/ _let("wrong/4", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.wrong)));
