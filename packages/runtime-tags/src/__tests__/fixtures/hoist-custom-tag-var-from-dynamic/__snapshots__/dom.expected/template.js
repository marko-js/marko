...
const _inputShowSectionNull_content = _$.registerContent("__tests__/template.marko_4_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$inputShowSectionNull_content, 0, 0, "4?");
...
const _thing_content2 = /* @__PURE__ */_$.createContent("__tests__/template.marko_3_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$thing_content2, 0, 0, "3?");
...
const _inputShowThingNull_content = _$.registerContent("__tests__/template.marko_2_renderer", `<!>${_thing_template}<!>`, /* beginChild, _thing_walks, endChild */`D/${_thing_walks}&D`, _setup$inputShowThingNull_content, 0, 0, "2?");
...
const _thing_content = /* @__PURE__ */_$.createContent("__tests__/template.marko_1_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$thing_content, 0, 0, "1?");
