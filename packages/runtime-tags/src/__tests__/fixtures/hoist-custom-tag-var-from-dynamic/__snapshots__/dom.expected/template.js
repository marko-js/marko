...
const _inputShowSectionNull_content = _$.registerContent("__tests__/template.marko_4_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$inputShowSectionNull_content, 0, 0, "ClosureScopes:4");
...
const _thing_content2 = /* @__PURE__ */_$.createContent("__tests__/template.marko_3_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$thing_content2, 0, 0, "ClosureScopes:3");
...
const _thing_content = /* @__PURE__ */_$.createContent("__tests__/template.marko_1_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$thing_content, 0, 0, "ClosureScopes:1");
