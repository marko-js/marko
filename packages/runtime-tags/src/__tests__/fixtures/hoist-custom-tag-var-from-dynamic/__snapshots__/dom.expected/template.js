...
export const $walks =
/*@__PURE__*/
/* over(1), <thing>, replace, over(1), replace, over(2) */
(_w0 => `b/${_w0}&%b%c`)(_thing_walks);
...
const $inputshowsectionnull_content = _._content_resume("__tests__/template.marko_4_content", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $inputshowsectionnull_content__setup, 0, "ClosureScopes:4");
...
const $thing_content2 = /* @__PURE__ */_._content("__tests__/template.marko_3_content", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $thing_content2__setup, 0, "ClosureScopes:3");
...
const $inputshowThingnull_content = _._content_resume("__tests__/template.marko_2_content", /*@__PURE__*/(_w0 => `<!>${_w0}<!>`)(_thing_template),
/*@__PURE__*/
/* over(1), <thing>, over(1) */
(_w0 => `b/${_w0}&b`)(_thing_walks), $inputshowThingnull_content__setup, 0, "ClosureScopes:2");
...
const $thing_content = /* @__PURE__ */_._content("__tests__/template.marko_1_content", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $thing_content__setup, 0, "ClosureScopes:1");
