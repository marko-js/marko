...
const $inputshowsectionnull_content = _$.registerContent("__tests__/template.marko_4_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, $setup$inputshowsectionnull$content, 0, "ClosureScopes:4");
...
const $thing_content2 = /* @__PURE__ */_$.createContent("__tests__/template.marko_3_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, $setup$thing$content2, 0, "ClosureScopes:3");
...
const $thing_content = /* @__PURE__ */_$.createContent("__tests__/template.marko_1_renderer", _child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, $setup$thing$content, 0, "ClosureScopes:1");
