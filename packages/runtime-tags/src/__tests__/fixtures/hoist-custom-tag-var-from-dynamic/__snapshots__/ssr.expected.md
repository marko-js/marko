  ...
  <body>
    ...
    <script>
      ...
      M._.r = [_ =&gt; (_.i = [0, _.a = {
          ...
          ](_.a), (_.j).add(_.k), (_.j).add(_.l), (_.m).add(_.n), (_.m).add(
          _.o), (_.p).add(_.q), (_.r).add(_.s), (_.r).add(_.t), (_.p).add(_
          .u), (_.v).add(_.w), _.i),
