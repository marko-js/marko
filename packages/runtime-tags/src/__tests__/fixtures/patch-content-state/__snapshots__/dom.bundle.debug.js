...
const $card_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/1"], $scope._.input_note), 0, "__tests__/template.marko_1_input_note#5/subscribe");
const $card_content__setup = ($scope) => {
	$card_content__input_note($scope);
	$card_content__count($scope);
};
const $card_content__count = /*@__PURE__*/ _closure_get("count", ($scope) => _text($scope["#text/0"], $scope._.count), 0, "__tests__/template.marko_1_count#6/subscribe");
