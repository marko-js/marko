// template.marko
const $if_content3__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.a, "z:" + $scope._._._.e), ($scope) => $scope._._._, "a0", 4), 1);
const $if_content3__setup = $if_content3__input_title;
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.a, "y:" + $scope._._.e), ($scope) => $scope._._, "a1", 4), 0);
const $if_content2__setup = ($scope) => {
	$if_content2__input_title($scope);
	$if_content2__open($scope);
};
const $if_content2__if = /*@__PURE__*/ _if(1, "<u> </u>", "D ", $if_content3__setup);
const $if_content2__open = /*@__PURE__*/ _closure_get(7, ($scope) => $if_content2__if($scope, $scope._._.f ? 0 : 1), ($scope) => $scope._._, "a2", 5);
