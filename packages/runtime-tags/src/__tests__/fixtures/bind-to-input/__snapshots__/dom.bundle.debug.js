...
const $x$1 = /*@__PURE__*/ _let_change("x/9", /*@__PURE__*/ _render(($scope) => _attr($scope["#button/0"], "data-internal", $scope.x)));
...
const $counter_content2__x = /*@__PURE__*/ _closure_get("x", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.x)));
...
const $counter_content__x = /*@__PURE__*/ _closure_get("x", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.x)));
