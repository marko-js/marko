// tags/counter.marko
const $x$1 = /*@__PURE__*/ _let_change(9, /*@__PURE__*/ _render(($scope) => _attr($scope.a, "data-internal", $scope.j)));
...
// template.marko
const $counter_content2__x = /*@__PURE__*/ _closure_get(3, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.c)));
const $counter_content__x = /*@__PURE__*/ _closure_get(3, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.c)));
