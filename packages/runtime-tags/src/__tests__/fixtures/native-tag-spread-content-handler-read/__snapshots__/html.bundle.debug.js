...
var my_box_default = _template("__tests__/tags/my-box.marko", (input) => {
	...
	_html_opens("__tests__/tags/my-box.marko:5:1", "__tests__/tags/my-box.marko:9:1"), _html(`</div>${_el_resume($scope0_id, "#div/0")}<button type=button class=cap>check</button>${_el_resume($scope0_id, "#button/1")}<div class=out>${_escape(captured)}${_el_resume($scope0_id, "#text/2")}</div>`);
