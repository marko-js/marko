...
const $walks = "b%b D l";
const $Content_content__count = /*@__PURE__*/ _let("count/6", ($scope) => _text($scope["#text/2"], $scope.count));
...
const $Content_content = _content_resume("__tests__/template.marko_1*content", "<em><!> <!></em>", " D%c%", $Content_content__setup, $Content_content__$params);
