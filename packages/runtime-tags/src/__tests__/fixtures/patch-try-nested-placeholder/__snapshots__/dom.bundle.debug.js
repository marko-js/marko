...
const $try_content2__value = /*@__PURE__*/ _closure_get("value", ($scope) => _text($scope["#text/0"], $scope._.value), 0, "__tests__/template.marko_4_value#2/subscribe");
const $try_content2__setup = $try_content2__value;
const $await_content__try = /*@__PURE__*/ _try("#text/0", "<span> </span>", "D ", $try_content2__setup);
const $await_content__setup = ($scope) => $await_content__try($scope, { catch: attrTag({ content: $catch_content($scope) }) });
const $await_content__$params = ($scope, $params2) => $await_content__value($scope, $params2[0]);
const $await_content__value__closure = /*@__PURE__*/ _closure($try_content2__value);
const $await_content__value = /*@__PURE__*/ _const("value", $await_content__value__closure);
...
const $try_content__input_promise = /*@__PURE__*/ _closure_get("input_promise", ($scope) => $try_content__await_promise($scope, $scope._.input_promise), 0, "__tests__/template.marko_1_input_promise#3/subscribe");
