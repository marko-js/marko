...
const $catch_content = _content_resume("a4", " ", " b", 0, $catch_content__$params);
...
const $try_content__clickCount__script = _script("a1", ($scope) => $scope._.b.textContent = $scope._.d);
