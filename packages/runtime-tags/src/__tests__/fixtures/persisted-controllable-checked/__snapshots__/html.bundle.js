...
var template_default = _template_persisted("a", (input) => {
	...
	_html(`<main><h1>${_patch_text($scope0_id, "a", input.title, $scope0_owned, 0)}${_el_resume($scope0_id, "a")}</h1><input${_attr_input_checked($scope0_id, "b", input.agree, _resume(function(next) {
