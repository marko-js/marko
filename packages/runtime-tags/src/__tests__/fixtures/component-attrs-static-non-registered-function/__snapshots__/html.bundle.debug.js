...
var price_default = _template("__tests__/tags/price.marko", (input) => {
	...
	_html_opens("__tests__/tags/price.marko:1:1"), _html(`<div>${_escape(input.format(input.value))}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 0))}</div>`);
