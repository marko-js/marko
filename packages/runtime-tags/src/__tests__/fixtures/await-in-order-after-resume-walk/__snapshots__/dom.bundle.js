...
const $await_content__value = /*@__PURE__*/ _closure_get(3, ($scope) => _text($scope.b, $scope._._.c), ($scope) => $scope._._, "a0");
const $await_content__setup__script = _script("a1", ($scope) => _on($scope.a, "click", function() {
