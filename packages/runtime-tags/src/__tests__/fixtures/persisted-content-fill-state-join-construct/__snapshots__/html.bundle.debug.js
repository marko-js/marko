...
var card_default = _template_persisted("__tests__/tags/card.marko", (input) => {
	...
	_html("</section>");
	$scope0_page && _scope($scope0_id, { "#childScope/1": _existing_scope($childScope) }, "__tests__/tags/card.marko", 0);
}, 0, () => [frame_default]);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	}, 0, $scope0_id, "#text/0", 1, $sg__input_items, $sg__input_items, void 0, void 0, "__tests__/template.marko_1*shell", $scope0_reason, 1);
