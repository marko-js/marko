...
const $for_content__count = /*@__PURE__*/ _resume("__tests__/template.marko_1_count/init", /*@__PURE__*/ _for_closure("#ul/0", $for_content__input_note__OR__count__OR__item));
