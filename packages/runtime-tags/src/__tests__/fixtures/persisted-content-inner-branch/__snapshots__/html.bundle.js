		...
		content: _content_elide("a0", () => {
			...
			_if(() => {
				if (input.show) {
					...
					_subscribe(_unfilled_if($scope0_owned, 3) && $input_note__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }));
					return 0;
				}
			}, $scope1_id, "a", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["a1"], $scope0_owned, 2);
			$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 2) && $input_show__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }));
