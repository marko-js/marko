...
const $await_content2__input_title = /*@__PURE__*/ _closure_get("input_title", $await_content2__input_title__OR__handler, 0, "__tests__/template.marko_2_input_title#5/subscribe");
const $await_content2__setup = ($scope) => {
	$await_content2__input_title($scope);
	$await_content2__handler($scope);
};
const $await_content2__handler = /*@__PURE__*/ _closure_get("handler", $await_content2__input_title__OR__handler, 0, "__tests__/template.marko_2_handler#9/subscribe");
...
const $await_content__input_title = /*@__PURE__*/ _closure_get("input_title", $await_content__input_title__OR__handler, 0, "__tests__/template.marko_1_input_title#5/subscribe");
const $await_content__setup = ($scope) => {
	$await_content__input_title($scope);
	$await_content__handler($scope);
};
const $await_content__handler = /*@__PURE__*/ _closure_get("handler", $await_content__input_title__OR__handler, 0, "__tests__/template.marko_1_handler#9/subscribe");
