...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_4_content", "loading reviews…", "b");
...
const $for_update = _update_for_keyed("#ul/0", ($p, $l) => $for_content_holes($p, $l), "__tests__/template.marko_6_update");
