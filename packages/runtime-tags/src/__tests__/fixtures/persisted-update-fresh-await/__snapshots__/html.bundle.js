...
var template_default = _template("a", (input) => {
	...
	_if(() => input.productId ? 0 : 1, $scope0_id, "c", $sg__input_productId, $sg__input_productId, $sg__input_productId, void 0, void 0, "a2", [() => {
		...
		_try($scope1_id, "b", _content_resume("a4", () => {
			...
			_await($scope2_id, "a", getReviews(input.productId), (reviews) => {
				...
				_for_of(reviews, (review) => {
					...
					return review.id;
				}, $scope5_id, "a", $sg__input_productId, $sg__input_productId, $sg__input_productId, "</ul>", 1, "a1");
