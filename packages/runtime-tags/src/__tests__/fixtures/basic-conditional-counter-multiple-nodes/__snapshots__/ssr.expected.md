# Write
```html
  <button class=inc></button><!--M_*1 #button/0--><button class=toggle></button><!--M_*1 #button/1--><!--M_[-->The count is <!>0<!--M_*2 #text/0--><!--M_]1 #text/2 2--><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.c=[0,_.a={"ConditionalScope:#text/2":_.b={},show:!0,count:0},_.b],_.b._=_.a,_.c),"__tests__/template.marko_0_show",1,"__tests__/template.marko_0_count",1];M._.w()</script>
```
