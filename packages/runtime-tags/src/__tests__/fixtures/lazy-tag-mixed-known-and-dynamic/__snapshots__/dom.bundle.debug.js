...
const $show__OR__value = /*@__PURE__*/ _or(7, ($scope) => $dynamicTag($scope, ("show" in $scope ? "show" in $scope ? $scope.show : true : true) ? Child : null, () => ({ value: "value" in $scope ? "value" in $scope ? $scope.value : 0 : 0 })));
