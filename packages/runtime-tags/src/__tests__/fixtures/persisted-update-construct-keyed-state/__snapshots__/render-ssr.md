...
## Change
```
UPDATE: ul > li:nth-of-type(1) > button::text "watch" => "watching"
```

# Update `{"$global":{"persisted":true,"filter":"Toys & Games"}}`
```html
<ul>
  <li>
    <span>
...
## Change
```
REMOVE: ul > li:nth-of-type(10) + li
REMOVE: ul > li:nth-of-type(10) + li
REMOVE: ul > li:nth-of-type(10) + li
REMOVE: ul > li:nth-of-type(10) + li
REMOVE: ul > li:nth-of-type(10) + li
...
# Update
```js
_assert.default.strictEqual(item(document), watchedNode);
_assert.default.equal(item(document).textContent, "watching");
```
...
## Change
```
INSERT: ul > li:nth-of-type(10) + li
INSERT: ul > li:nth-of-type(11) + li
INSERT: ul > li:nth-of-type(12) + li
INSERT: ul > li:nth-of-type(13) + li
INSERT: ul > li:nth-of-type(14) + li
INSERT: ul > li:nth-of-type(15) + li
INSERT: ul > li:nth-of-type(16) + li
INSERT: ul > li:nth-of-type(17) + li
INSERT: ul > li:nth-of-type(18) + li
INSERT: ul > li:nth-of-type(19) + li
INSERT: ul > li:nth-of-type(20) + li
INSERT: ul > li:nth-of-type(21) + li
INSERT: ul > li:nth-of-type(22) + li
INSERT: ul > li:nth-of-type(23) + li
INSERT: ul > li:nth-of-type(24) + li
INSERT: ul > li:nth-of-type(25) + li
INSERT: ul > li:nth-of-type(26) + li
INSERT: ul > li:nth-of-type(27) + li
INSERT: ul > li:nth-of-type(28) + li
INSERT: ul > li:nth-of-type(29) + li
INSERT: ul > li:nth-of-type(30) + li
INSERT: ul > li:nth-of-type(31) + li
INSERT: ul > li:nth-of-type(32) + li
INSERT: ul > li:nth-of-type(33) + li
INSERT: ul > li:nth-of-type(34) + li
INSERT: ul > li:nth-of-type(35) + li
INSERT: ul > li:nth-of-type(36) + li
INSERT: ul > li:nth-of-type(37) + li
INSERT: ul > li:nth-of-type(38) + li
INSERT: ul > li:nth-of-type(39) + li
INSERT: ul > li:nth-of-type(40) + li
INSERT: ul > li:nth-of-type(41) + li
INSERT: ul > li:nth-of-type(42) + li
INSERT: ul > li:nth-of-type(43) + li
INSERT: ul > li:nth-of-type(44) + li
INSERT: ul > li:nth-of-type(45) + li
INSERT: ul > li:nth-of-type(46) + li
