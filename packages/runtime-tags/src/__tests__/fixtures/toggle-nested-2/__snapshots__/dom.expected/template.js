export const _template = "<div><button id=outer></button><!></div>";
...
const _count = /* @__PURE__ */_$.state("count/4", _count_closure);
const _inner = /* @__PURE__ */_$.state("inner/3", _inner$if_content);
