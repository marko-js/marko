// template.marko
const $if_content2__count = /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.b, $scope._._.e), ($scope) => $scope._._, "a1", 4);
...
const $if_content__if = /*@__PURE__*/ _if(1, "<button id=count> </button>", " D ", $if_content2__setup);
