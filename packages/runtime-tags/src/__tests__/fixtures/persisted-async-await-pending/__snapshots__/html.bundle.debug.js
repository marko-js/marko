...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_await($scope0_id, "#text/1", new Promise((resolve) => setTimeout(resolve, 10, "slow")), (value) => {
		const $scope1_id = _scope_id();
		_html$1(`<em>${_patch_text($scope1_id, "#text/0", value)}${_el_resume($scope1_id, "#text/0")}</em>`);
