...
_construct("__tests__/tags/shared-list.marko_0_update", $construct$2);
const $merge$2 = _resume("__tests__/tags/shared-list.marko_0_update", $update2$2);
_update_content("__tests__/tags/shared-list.marko", $merge$2, $construct$2);
...
const $watched = _var_resume("__tests__/tags/add-form.marko_0_watched/var", /*@__PURE__*/ _let_persisted("watched/14", ($scope) => _text($scope["#text/4"], $scope.watched ? "watching" : "watch")));
const $quantity = _var_resume("__tests__/tags/add-form.marko_0_quantity/var", /*@__PURE__*/ _let_persisted("quantity/15", ($scope) => _attr_input_value($scope, "#input/7", $scope.quantity, $valueChange($scope))));
const $setup__script$1 = _script_shared(($scope) => {
	_on($scope["#button/3"], "click", function() {
		$watched($scope, !$scope.watched);
	});
	_on($scope["#form/5"], "submit", function() {
	...
	_attr_input_value_script($scope, "#input/7");
...
const $productId = _var_resume("__tests__/tags/add-form.marko_0_productId/var", /*@__PURE__*/ _const_persisted("productId", ($scope) => _attr($scope["#input/6"], "value", $scope.productId)));
...
_static_shells({
	"__tests__/tags/add-form.marko_0_update": [$template$1, $walks$1],
	"__tests__/tags/add-form.marko": [$template$1, $walks$1]
});
...
const $_holes = /*@__PURE__*/ _update_scopes({ "PatchHole:#text/4": /*@__PURE__*/ _update_construct(/*@__PURE__*/ _update_text("#text/4")) });
const $construct$1 = ($scope) => {
	_construct_child($scope, "#childScope/0", "__tests__/tags/shared-list.marko_0_update");
	_var($scope, "#childScope/0", $cart);
	_attr($scope["#input/6"], "value", $scope.productId);
	_attr_input_value($scope, "#input/7", $scope.quantity, $scope["ControlledHandler:#input/7"]);
...
_construct("__tests__/tags/add-form.marko_0_update", $construct$1);
const $merge$1 = _resume("__tests__/tags/add-form.marko_0_update", $update2$1);
_update_content("__tests__/tags/add-form.marko", $merge$1, $construct$1);
...
const $walks = " Db%l%c";
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<p class=home>welcome home</p>");
...
const $Item_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", $Item_content__template, $Item_content__walks, $Item_content__setup);
...
_static_shells({
	"__tests__/template.marko_1_update": [$Item_content__template, $Item_content__walks],
	"__tests__/template.marko_1_content": [$Item_content__template, $Item_content__walks],
...
const $Item_content__construct = ($scope) => {
	_construct_child($scope, "#childScope/1", "__tests__/tags/add-form.marko_0_update");
};
...
_construct("__tests__/template.marko_1_update", $Item_content__construct);
_construct("__tests__/template.marko_0_update", $construct);
const $noop_update = () => {};
_update_content("__tests__/template.marko_2_content", $noop_update);
_update_content("__tests__/template.marko_1_content", $Item_content__update, $Item_content__construct);
...
const $walks$1 = /*@__PURE__*/ ((_w0) => `0${_w0}&%b D l D b b l`)("");
const $cart = _var_resume("__tests__/tags/add-form.marko_0_cart/var", /*@__PURE__*/ _const_persisted("cart"));
const $watched = /*@__PURE__*/ _let_persisted("watched/14", ($scope) => _text($scope["#text/4"], $scope.watched ? "watching" : "watch"));
const $quantity = /*@__PURE__*/ _let_persisted("quantity/15", ($scope) => _attr_input_value($scope, "#input/7", $scope.quantity, $valueChange($scope)));
...
const $productId = /*@__PURE__*/ _const_persisted("productId", ($scope) => _attr($scope["#input/6"], "value", $scope.productId));
const $input_productId$1 = ($scope, input_productId) => {
	if (!updating) $productId($scope, input_productId);
};
const $input$1 = ($scope, input) => $input_productId$1($scope, input.productId);
