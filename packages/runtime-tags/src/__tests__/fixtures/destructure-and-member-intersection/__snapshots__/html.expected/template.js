...
export default _._template("__tests__/template.marko", input => {
  ...
  _._html(`<div>${_._escape(input.a)}${_._el_resume($scope0_id, "#text/0", (_._serialize_guard($scope0_reason, /* input.a */1)))}${_._sep(($sg__input_a__OR__input_b))}${_._escape(a + b)}${_._el_resume($scope0_id, "#text/1", ($sg__input_a__OR__input_b))}</div>`);
