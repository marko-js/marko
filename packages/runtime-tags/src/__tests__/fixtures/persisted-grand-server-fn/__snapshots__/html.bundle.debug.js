...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	_html(`<em>${_patch_text($scope0_id, "#text/0", input.fn("x"), void 0, $scope0_owned, 0)}</em>`);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		fmt: "1:8",
		show: "2:6"
	}) : (_filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko0", fmt), _filled_guard($scope0_owned, 0) && _patch_write($scope0_id, "input_title", input.title));
}, 1, () => [card_default]);
