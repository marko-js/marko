...
var dia_d_default = _template_persisted("__tests__/tags/dia-d/index.marko", (input) => {
	...
	_html(`<em>${_patch_text($scope0_id, "#text/0", input.note, void 0, $scope0_owned, 0)}</em>`);
	$scope0_reason && _scope($scope0_id, {}, "__tests__/tags/dia-d/index.marko", 0);
}, 0, 0);
...
var dia_b_default = _template_persisted("__tests__/tags/dia-b/index.marko", (input) => {
	...
	$scope0_reason && _scope($scope0_id, { "#childScope/0": _existing_scope($childScope) }, "__tests__/tags/dia-b/index.marko", 0);
}, 0, () => [dia_d_default]);
...
var dia_c_default = _template_persisted("__tests__/tags/dia-c/index.marko", (input) => {
	...
	_patch_child($scope0_id, "#childScope/0", $childScope);
	dia_d_default({ note: input.note });
	$scope0_reason && _scope($scope0_id, { "#childScope/0": _existing_scope($childScope) }, "__tests__/tags/dia-c/index.marko", 0);
}, 0, () => [dia_d_default]);
