...
const $if_content__store_set = /*@__PURE__*/ _init_closure_get("a7", 10, ($scope) => $if_content__count($scope, 0, $scope._._.i), ($scope) => $scope._._);
...
const $for_content__store_set = /*@__PURE__*/ _const(8, /* @__PURE__ */ _closure($if_content__store_set));
