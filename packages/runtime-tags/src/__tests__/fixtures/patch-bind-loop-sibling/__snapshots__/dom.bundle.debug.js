...
const $for_content2__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $for_content2__if($scope, $scope._._.input_show && $scope["#LoopKey"] === $scope._["#LoopKey"] ? 0 : 1), ($scope) => $scope._._, "__tests__/template.marko_2_input_show#3/subscribe");
