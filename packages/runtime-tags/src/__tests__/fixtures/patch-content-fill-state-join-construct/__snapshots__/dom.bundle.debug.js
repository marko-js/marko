...
const $walks = "D%b l";
const $card_content__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_2_count#6/init", "count", ($scope) => _text($scope["#text/1"], $scope._._.count), ($scope) => $scope._._, "__tests__/template.marko_2_count#6/subscribe");
const $card_content__setup = ($scope) => {
	$card_content__count($scope);
	$card_content__p_name($scope);
	$card_content__item_id($scope);
};
const $card_content__p_name = /*@__PURE__*/ _closure_get("p_name", ($scope) => _text($scope["#text/0"], $scope._._.p_name), ($scope) => $scope._._, "__tests__/template.marko_2_p_name#8/subscribe");
const $card_content__item_id = /*@__PURE__*/ _closure_get("item_id", ($scope) => _text($scope["#text/2"], $scope._.item_id), 0, "__tests__/template.marko_2_item_id#4/subscribe");
