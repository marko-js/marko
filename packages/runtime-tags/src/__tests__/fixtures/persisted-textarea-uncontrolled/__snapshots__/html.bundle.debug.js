...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_html(`<textarea${_patch_control($scope0_id, "#textarea/0", 2, `[AB]${input.name}[!]`, $scope0_reason, 0)}>${_textarea_value(`[AB]${input.name}[!]`)}</textarea>${_el_resume($scope0_id, "#textarea/0")}`);
