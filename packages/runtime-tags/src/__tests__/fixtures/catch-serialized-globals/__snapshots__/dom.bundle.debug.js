...
const $catch_content__error_message__OR__message__OR__clicked = /*@__PURE__*/ _or(7, ($scope) => _text($scope["#text/1"], ("clicked" in $scope ? $scope.clicked : false) ? $scope.message : $scope.error_message), 2);
