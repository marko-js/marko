...
_shells({
	...
	"__tests__/template.marko_2*shell": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko_2*shell;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `b%b/${_w0}&b`)($walks$3), /*@__PURE__*/ ((_w0) => `<!><!>${_w0}<!>`)($template$3)),
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	$scope0_page && _scope($scope0_id, {
		input_list: _source_if($scope0_reason, 1) && input.list,
	...
	}, "__tests__/template.marko", 0, { input_list: ["input.list"] });
}, 1, () => [
	$PageA_withLoadAssets,
	$PageB_withLoadAssets,
	$Docs_withLoadAssets,
