...
_load_lazy("ready:__tests__/docs.marko", () => import("./docs.mjs").then(() => {}));
...
const $Docs_content__input_page = /*@__PURE__*/ _closure_get("input_page", ($scope) => $Docs_content__if($scope, $scope._._._.input_page === 1 ? 0 : 1), ($scope) => $scope._._._, "__tests__/template.marko_3_input_page#3/subscribe");
...
const $else_content__input_list = /*@__PURE__*/ _closure_get("input_list", 0, ($scope) => $scope._._, "__tests__/template.marko_2_input_list#4/subscribe");
...
const $Root_content__input_page = /*@__PURE__*/ _closure_get("input_page", ($scope) => $Root_content__if($scope, $scope._.input_page === 0 ? 0 : 1), 0, "__tests__/template.marko_1_input_page#3/subscribe");
