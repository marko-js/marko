...
_static_shells({
	"__tests__/tags/stage.marko_0_update": [$template$1, $walks$1],
	"__tests__/tags/stage.marko": [$template$1, $walks$1]
});
...
const $setup__script = _script_update("__tests__/tags/lineup.marko_0", ($scope) => _on($scope["#button/0"], "click", function() {
...
const $input = ($scope, input) => $input_performers($scope, input.performers);
var lineup_default = /*@__PURE__*/ _template("__tests__/tags/lineup.marko", $template, $walks, $setup, $input);
