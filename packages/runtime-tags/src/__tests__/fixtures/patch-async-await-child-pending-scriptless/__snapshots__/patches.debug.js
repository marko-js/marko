// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-async-await-child-pending-scriptless/template.marko_1_#text#0/await;/D%c%l b&;<b class=pill><!>:<!></b><button class=inc>+</button>`, `packages/runtime-tags/src/__tests__/fixtures/patch-async-await-child-pending-scriptless/template.marko_1*shell;b%;<!><!><!>`, (_.a = {
  "PatchBranch:#main/0": [{
