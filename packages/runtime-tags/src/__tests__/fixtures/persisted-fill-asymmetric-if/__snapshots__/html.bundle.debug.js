...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_if(() => {
		if (input.show) {
			...
			_html("<p>shown</p>");
			$scope0_reason && _scope($scope3_id, {}, "__tests__/template.marko", "3:4");
			return 0;
		} else {
	...
	}, $scope0_id, "#text/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/template.marko_3*shell", "__tests__/template.marko_1*shell"], $scope0_owned, 1);
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_title: ["input.title"],
		count: "1:6"
	}) : _filled_guard($scope0_owned, 3) && _patch_value($scope0_id, "__tests__/template.marko0", input.title);
}, 1, 0);
