...
const $walks = "D b%l";
const $if_content2__count = /*@__PURE__*/ _closure_get("count/6", ($scope) => _text($scope["#text/1"], $scope._._.count), ($scope) => $scope._._, "__tests__/template.marko_2_count#4/subscribe");
...
const $if_content__if = /*@__PURE__*/ _if("#text/1", "<button id=count> </button>", " D ", $if_content2__setup);
...
const $if = /*@__PURE__*/ _if("#text/1", "<button id=inner></button><!><!>", " b%", $if_content__setup);
