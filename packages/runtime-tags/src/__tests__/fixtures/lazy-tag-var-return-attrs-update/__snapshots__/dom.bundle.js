...
const $if_content__n = /*@__PURE__*/ _if_closure(2, 0, ($scope) => $load_Child_tag_input_label($scope.b, `x${$scope._.e}`));
...
const $if = /*@__PURE__*/ _if(2, "<!><!><button class=focus>focus</button>", "b%0&b ", $if_content__setup);
