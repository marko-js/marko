...
const $customtag_content__name = /* @__PURE__ */_._const("name", ($scope, name) => _._text($scope["#text/0"], name));
const $customtag_content__count = /* @__PURE__ */_._const("count", ($scope, count) => _._text($scope["#text/1"], count));
const $customtag_content__$params = /* @__PURE__ */_._const("$params2", ($scope, $params2) => $customtag_content__$temp($scope, $params2?.[0]));
const $customtag_content__$temp = /* @__PURE__ */_._const("$temp", ($scope, $temp) => {
