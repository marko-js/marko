...
const _name$customTag_content = /* @__PURE__ */_$.value("name/5", (_scope, name) => _$.data(_scope["#text/0"], name));
const _count$customTag_content = /* @__PURE__ */_$.value("count/4", (_scope, count) => _$.data(_scope["#text/1"], count));
const _pattern_$customTag_content = /* @__PURE__ */_$.value("_pattern_/3", (_scope, _pattern_) => {
  _count$customTag_content(_scope, _pattern_.count);
  _name$customTag_content(_scope, _pattern_.name);
});
const _params_2$customTag_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => _pattern_$customTag_content(_scope, _params_2?.[0]));
