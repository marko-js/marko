...
const $walks$1 = "D l";
const $setup$1 = () => {};
const $input_name__OR__input_write__script = _script("__tests__/tags/child.marko_0_name#3_write#4", ($scope) => $signal($scope, 0).onabort = () => {
...
const $walks = " b b%c";
const $for_content2__write = /*@__PURE__*/ _closure_get("write/6", ($scope) => $write$1($scope["#childScope/0"], $scope._._.write), ($scope) => $scope._._);
...
_resumed["__tests__/template.marko_0/write"] = $write;
