...
export const $walks = /* beginChild, _hello_walks, endChild, get, over(1) */`D/${_hello_walks}& b`;
...
const $item_content = _$.registerContent("__tests__/template.marko_1_renderer", "y: <!>", /* over(1), replace */"b%", 0, $params2$item$content);
