...
const $for_content__i__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.i));
...
const $for_content__i = /*@__PURE__*/ _const("i", ($scope) => {
	$for_content__i__render($scope);
	$for_content__i__script($scope);
});
const $for_content__$params = ($scope, $params2) => $for_content__i($scope, $params2[0]);
const $total = /*@__PURE__*/ _let("total/4", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.total)));
const $seen = /*@__PURE__*/ _let("seen/5", /*@__PURE__*/ _render(($scope) => _text($scope["#text/3"], $scope.seen)));
