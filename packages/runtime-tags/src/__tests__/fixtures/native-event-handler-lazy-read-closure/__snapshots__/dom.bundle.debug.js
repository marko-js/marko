...
const $for_content__i = /*@__PURE__*/ _const("i", ($scope) => _text($scope["#text/1"], $scope.i));
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/0", "<button>pick <!></button>", " Db%", $for_content__setup, $for_content__$params);
