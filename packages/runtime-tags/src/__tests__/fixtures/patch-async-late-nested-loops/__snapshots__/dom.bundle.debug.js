...
const $catch_content = _content("__tests__/template.marko_5*content", "<b> </b>", "D ", 0, $catch_content__$params);
...
const $try_content__item_promise = /*@__PURE__*/ _closure_get("item_promise", ($scope) => $try_content__await_promise($scope, $scope._.item_promise), 0, "__tests__/template.marko_3_item_promise#3/subscribe");
