...
const $await_content__group_id = /*@__PURE__*/ _closure_get("group_id", ($scope) => _text($scope["#text/0"], $scope._._._.group_id), ($scope) => $scope._._._);
const $await_content__setup = $await_content__group_id;
...
const $for_content__for = /*@__PURE__*/ _for_of("#section/0", "<!><!><!>", "b%", $for_content2__setup, $for_content2__$params);
...
const $for_content__group_id__closure = /*@__PURE__*/ _closure($await_content__group_id);
const $for_content__group_id = /*@__PURE__*/ _const("group_id", $for_content__group_id__closure);
