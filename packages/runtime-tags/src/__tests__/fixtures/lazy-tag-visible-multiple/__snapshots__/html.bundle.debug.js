...
// template.marko
const $load_ChildA = withAssets(child_a_default, "ready:__tests__/child-a.marko", [{
	type: "visible",
	selector: ":is(body)"
}]);
const $load_ChildB = withAssets(child_b_default, "ready:__tests__/child-b.marko", [{
	type: "visible",
	selector: ":is(body)"
}]);
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html(`<button>Inc</button>${_el_resume($scope0_id, "#button/0")}<div class=a>`);
