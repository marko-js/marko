...
const $try_content__query = /*@__PURE__*/ _closure_get("query/4", ($scope) => $try_content__await_promise($scope, $scope._.query ? resolveAfter(`found ${$scope._.query}`, 1) : "no query"), 0, "__tests__/template.marko_1_query#3/subscribe");
