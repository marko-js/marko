...
let $load_Child_tag_input_value2 = /* @__PURE__ */ _load_signal(() => import("./v:child.marko.input_value.mjs"));
let $load_Child_tag_input_id2 = /* @__PURE__ */ _load_signal(() => import("./v:child.marko.input_id.mjs"));
...
const $await_content__setup = ($scope) => {
	...
	$load_Child_tag_input_id2($scope["#childScope/1"], "async");
};
const $await_content__value = ($scope, value) => $load_Child_tag_input_value2($scope["#childScope/1"], value);
