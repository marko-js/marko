...
const $walks = " b%c";
_enable_catch();
const $catch_content__err = /*@__PURE__*/ _render(($scope, err) => _text($scope["#text/0"], err));
...
const $try_content__clickCount__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], (() => {
