...
const $catch_content = _content_resume("a3", " ", " b", 0, $catch_content__$params);
const $try_content__clickCount__script = _script("a1", ($scope) => $scope._.a.textContent = $scope._.c);
...
const $try_content__setup__script = _script("a0", ($scope) => _on($scope.a, "click", function() {
