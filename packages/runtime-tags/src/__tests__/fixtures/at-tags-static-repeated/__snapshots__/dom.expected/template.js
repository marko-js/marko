...
const $item_content2 = _._content_resume("__tests__/template.marko_2_content", "Again", /* over(1) */"b");
const $item_content = _._content_resume("__tests__/template.marko_1_content", "Hello", /* over(1) */"b");
