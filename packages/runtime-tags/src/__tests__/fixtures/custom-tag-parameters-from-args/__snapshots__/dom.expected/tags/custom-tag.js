...
const _expr_x_y = /* @__PURE__ */_$.intersection(9, _scope => {
  const {
    "x/7": x,
    "y/8": y
  } = _scope;
...
export const _input_content_ = /* @__PURE__ */_$.value("input_content/6", (_scope, input_content) => _expr_input_content_x_y(_scope));
export const _input_ = /* @__PURE__ */_$.value("input/5", (_scope, input) => _input_content_(_scope, input.content));
