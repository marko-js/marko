...
const $customtag_content__count2 = /* @__PURE__ */_._const("count2", $scope => _._text($scope["#text/1"], $scope.count2));
const $customtag_content__$params = /* @__PURE__ */_._const("$params2", $scope => {
  $customtag_content__count($scope, $scope.$params2[0]);
  $customtag_content__count2($scope, $scope.$params2[1]);
});
