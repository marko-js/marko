...
const _count2$customTag_content = /* @__PURE__ */_$.value("count2/4", (_scope, count2) => _$.data(_scope["#text/1"], count2));
const _count$customTag_content = /* @__PURE__ */_$.value("count/3", (_scope, count) => _$.data(_scope["#text/0"], count));
const _params_2$customTag_content = /* @__PURE__ */_$.value("_params_2/2", (_scope, _params_2) => {
  _count$customTag_content(_scope, _params_2[0]);
  _count2$customTag_content(_scope, _params_2[1]);
});
const _customTag_content = _$.registerContent("__tests__/template.marko_1_renderer", "<div>Counts: <!>,<!></div>", /* next(1), over(1), replace, over(2), replace */"Db%c%", 0, () => _params_2$customTag_content);
