...
const $customtag_content = _$.registerContent("__tests__/template.marko_1_renderer", "<div>Counts: <!>,<!></div>", /* next(1), over(1), replace, over(2), replace, out(1) */"Db%c%l", 0, $params2$customtag$content);
