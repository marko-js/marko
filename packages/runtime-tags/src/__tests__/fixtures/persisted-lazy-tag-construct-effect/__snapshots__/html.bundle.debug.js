...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_if(() => {
		if (input.show) {
			...
			_html(`<div${_patch_attrs(input.attrs, "#div/0", $scope1_id, "div", void 0, $scope0_owned, 2)}>x</div>${_el_resume($scope1_id, "#div/0")}`);
	...
	$scope0_reason && _scope($scope0_id, { input_label: _source_if($scope0_reason, 1) && input.label }, "__tests__/template.marko", 0, { input_label: ["input.label"] });
