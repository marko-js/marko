...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", $tag, {}, _content_elide("__tests__/template.marko_1*content", () => {
		...
		box_default({
			...
			content: _content_elide("__tests__/template.marko_2*content", () => {
				...
				_html(_patch_text($scope2_id, "#text/0", input.label, void 0, $scope0_owned, 2));
				_subscribe(_unfilled_if($scope0_owned, 2) && $input_label__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "5:6"));
			}, $scope1_id)
		});
	...
	}, $scope0_id), 0, _source_guard($scope0_reason, 1), _patch_dynamic_tag($scope0_id, "#text/0", $tag, 0, "__tests__/template.marko_1*content", 0, $scope0_owned, 1));
