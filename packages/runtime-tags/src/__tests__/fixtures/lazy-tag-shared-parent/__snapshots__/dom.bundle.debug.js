...
var parent_a_default = /*@__PURE__*/ _template("__tests__/tags/parent-a.marko", "<!>", $walks$2, $setup$2, $input$1);
...
const $input = ($scope, input) => $input_value($scope, input.value);
var parent_b_default = /*@__PURE__*/ _template("__tests__/tags/parent-b.marko", "<!>", $walks$1, $setup$1, $input);

// template.marko
const $template = /*@__PURE__*/ ((_w0, _w1) => `<button>Inc</button>${_w0}${_w1}`)("<!>", "<!>");
