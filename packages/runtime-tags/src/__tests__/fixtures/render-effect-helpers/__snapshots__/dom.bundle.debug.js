...
// template.marko
const $template = "<button>step</button><div>n=<!></div><div class=base></div><div></div><div></div><div></div><div></div><script type=importmap><\/script><div> </div><div></div><div data-fixed=x></div><img><img alt=y><div></div><input type=checkbox><input type=checkbox><input type=radio><input type=radio><input><input><input><input type=hidden><select><option value=one>one</option><option value=two>two</option></select><select><option value=one>one</option><option value=two>two</option></select><details><summary>s</summary> body</details><details><summary>s2</summary> b2</details><dialog>d</dialog><dialog>d2</dialog><style></style>";
...
const $Chunk_content = _content_resume("__tests__/template.marko_1_content", "chunk <!>", "b%", $Chunk_content__setup);
...
const $spread__script = _script("__tests__/template.marko_0_spread", ($scope) => {
...
const $hidden = /*@__PURE__*/ _let("hidden/39", ($scope) => _attr_input_value($scope, "#input/22", $scope.hidden, $valueChange2($scope), _attr_input_value_attribute_default));
