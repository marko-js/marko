...
export default _$.createTemplate("__tests__/template.marko", input => {
  ...
  let Child = "a";
  const el = _$.nodeRef();
  _$.write(`<div><svg>${_$.toString(input.value)}${_$.markResumeNode($scope0_id, "#text/1")}`);
  ...
  _$.write(`</svg><math>${_$.toString(input.value)}${_$.markResumeNode($scope0_id, "#text/3")}`);
  ...
  _$.dynamicTag($scope0_id, "#text/5", Parent, {}, _$.registerContent("__tests__/template.marko_1_renderer", () => {
    ...
    _$.write(`${_$.toString(input.value)}${_$.markResumeNode($scope1_id, "#text/0")}`);
  ...
  _$.writeScope($scope0_id, {
    ...
    Parent,
    Child,
    "ClosureScopes:input_value": $input_value_closures
