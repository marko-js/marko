...
_static_shells({ "__tests__/tags/static-bit.marko_0_update": [$template$2, "b"] });
const $update2$2 = () => {};
...
_static_shells({
	"__tests__/tags/stateful-widget.marko_0_update": [$template$1, $walks$1],
	"__tests__/tags/stateful-widget.marko": [$template$1, $walks$1]
});
