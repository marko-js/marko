...
const $walks = "D%b l";
const $if_content__seen__script = _script("__tests__/template.marko_1_seen#1", ($scope) => document.querySelector("main").dataset.seen = String($scope.seen));
const $if_content__seen = /*@__PURE__*/ _const("seen", ($scope) => {
