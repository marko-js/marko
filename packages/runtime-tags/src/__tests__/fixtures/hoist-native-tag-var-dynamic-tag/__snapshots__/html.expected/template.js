...
const _renderer = /* @__PURE__ */_$.createRenderer(input => {
  ...
  const _subscribers3 = new Set();
  const _hoisted_el4 = _$.hoist(_scope0_id, "__tests__/template.marko_0/_hoisted_el4");
  const _subscribers4 = new Set();
  _child({
    content: _$.register(/* @__PURE__ */_$.createRenderer(() => {
      const _scope1_id = _$.nextScopeId();
      const el = _$.nodeRef();
      _$.write(`<span></span>${_$.markResumeNode(_scope1_id, "#span/0")}`);
      _$.writeSubscribe(_subscribers, _$.writeScope(_scope1_id, {}, "__tests__/template.marko", "3:2"));
  ...
  _$.dynamicTagInput(_scope0_id, "#text/1", input.show ? Child : null, {}, _$.register(/* @__PURE__ */_$.createRenderer(() => {
    ...
    const _subscribers2 = new Set();
    _child({
      content: _$.register(/* @__PURE__ */_$.createRenderer(() => {
        const _scope3_id = _$.nextScopeId();
        const el2 = _$.nodeRef();
        _$.write(`<div></div>${_$.markResumeNode(_scope3_id, "#div/0")}`);
        _$.writeSubscribe(_subscribers2, _$.writeScope(_scope3_id, {}, "__tests__/template.marko", "16:4"));
      }), "__tests__/template.marko_3_renderer", _scope2_id)
    });
    _$.writeEffect(_scope2_id, "__tests__/template.marko_2__hoisted_el2");
    _$.writeSubscribe(_subscribers3, _$.writeScope(_scope2_id, {
      _hoisted_el2: _hoisted_el2,
      "#childScope/0?": _subscribers2,
  ...
  _$.dynamicTagInput(_scope0_id, "#text/2", input.show ? 'section' : null, {}, _$.register(/* @__PURE__ */_$.createRenderer(() => {
    ...
    _$.writeSubscribe(_subscribers4, _$.writeScope(_scope4_id, {}, "__tests__/template.marko", "34:4"));
  }), "__tests__/template.marko_4_renderer", _scope0_id));
  _$.writeEffect(_scope0_id, "__tests__/template.marko_0__hoisted_el4");
