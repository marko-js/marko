// template.marko
const $if_content2__label = /*@__PURE__*/ _fill_join_closure("a0", 6, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.a, $scope._._.g), ($scope) => $scope._._, "a0", 6), 0);
...
const $if = /*@__PURE__*/ _if(0, "<!><!><!>", "b%", $if_content__show);
