...
const $walks = "D%b l";
const $if_content2__label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "label", /*@__PURE__*/ _closure_get("label", ($scope) => _text($scope["#text/0"], $scope._._.label), ($scope) => $scope._._, "__tests__/template.marko_2_label#6/subscribe"), 0);
