...
var grand_default = _template_patch("__tests__/tags/grand/index.marko", (input) => {
	...
	_html("</div>");
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/grand/index.marko", 0);
}, 0, 0);
...
var child_default = _template_patch("__tests__/tags/child/index.marko", (input) => {
	...
	_html("</section>");
	$scope0_page && _scope($scope0_id, { "#childScope/1": _existing_scope($childScope) }, "__tests__/tags/child/index.marko", 0);
}, 0, () => [grand_default]);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	child_default({
		...
		content: _content_elide("__tests__/template.marko_1*content", () => {
			...
			_subscribe(_unfilled_if($scope0_reason, 1) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "2:4"));
		}, $scope0_id)
	});
	_html("</main>");
