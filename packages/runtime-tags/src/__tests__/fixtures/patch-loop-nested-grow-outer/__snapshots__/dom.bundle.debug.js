...
const $walks = "b%b b";
const $for_content2__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_2_count#5/init", "count", ($scope) => _text($scope["#text/0"], $scope._["#LoopKey"] + "@" + $scope._._.count), ($scope) => $scope._._);
