...
const $footer_content__input_submitLabel = /*@__PURE__*/ _closure_get("input_submitLabel", ($scope) => _text($scope["#text/0"], $scope._.input_submitLabel || "OK"), 0, "__tests__/template.marko_1_input_submitLabel#6/subscribe");
const $footer_content__setup = ($scope) => {
	$footer_content__input_submitLabel($scope);
	$footer_content__input_label($scope);
};
const $footer_content__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/1"], $scope._.input_label), 0, "__tests__/template.marko_1_input_label#7/subscribe");
