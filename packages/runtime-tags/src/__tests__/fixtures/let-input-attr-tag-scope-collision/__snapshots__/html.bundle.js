...
var template_default = _template("a", (input) => {
	...
	child_tag_default({ footer: attrTag({ content: _content("a0", () => {
		...
		_serialize_if($scope0_reason, 0) && _subscribe($si__input_label && $input_label__closures, _subscribe($si__input_submitLabel && $input_submitLabel__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) })));
