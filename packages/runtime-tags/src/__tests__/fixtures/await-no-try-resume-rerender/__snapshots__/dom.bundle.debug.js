...
const $walks = " b%c";
const $await_content__n = /*@__PURE__*/ _closure_get("n/3", ($scope) => _text($scope["#text/0"], $scope._.n), 0, "__tests__/template.marko_1_n#2/subscribe");
const $await_content__setup = $await_content__n;
const $await_content = /*@__PURE__*/ _await_content("#text/1", "<div id=out>done <!></div>", "Db%", $await_content__setup);
