...
const $Baz_content2 = _content_resume("__tests__/template.marko_4*content", "<div>Baz Fallback</div>");
const $Bar_content = _content_resume("__tests__/template.marko_2*content", "<div>Bar Fallback</div>");
const $Foo_content = _content_resume("__tests__/template.marko_1*content", "<div>Foo Fallback</div>");
