...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_to(5, 0, 1, () => {
		...
		_scope($scope1_id, { setHtml }, "__tests__/template.marko", "1:2", { setHtml: "2:10" });
	...
	_for_to(to, 0, 1, () => {
		...
		_scope($scope2_id, { setHtml2 }, "__tests__/template.marko", "12:2", { setHtml2: "13:10" });
	...
	_for_to(3, 0, 1, (i) => {
		...
		_for_to(3, 0, 1, (j) => {
			...
			_scope($scope4_id, { setHtml3 }, "__tests__/template.marko", "24:4", { setHtml3: "25:12" });
			_assert_hoist(setHtml3);
		}, 0, $scope3_id, "#ul/0", 1, 0, 0, 0, 1);
		_html("</ul>");
		_scope($scope3_id, {}, "__tests__/template.marko", "22:2");
