...
const _params3$for_content = /* @__PURE__ */_$.value("_params3");
const _setup$for_content3 = _scope => {
  _$.setTagVar(_scope, "#childScope/0", _setHtml3$for_content);
  _child(_scope["#childScope/0"]);
};
const _for_content4 = /* @__PURE__ */_$.createRenderer(_child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$for_content3, _params3$for_content);
const _for$for_content = /* @__PURE__ */_$.loopTo("#ul/0", _for_content4);
const _params2$for_content = /* @__PURE__ */_$.value("_params2");
const _setup$for_content4 = _scope => {
  _for$for_content(_scope, [3, 0, 1]);
};
const _for_content3 = /* @__PURE__ */_$.createRenderer("<ul></ul>", /* get */" ", _setup$for_content4, _params2$for_content);
...
const _for_content = /* @__PURE__ */_$.createRenderer(_child_template, /* beginChildWithVar, _child_walks, endChild */`0${_child_walks}&`, _setup$for_content);
...
const _hoisted_setHtml4_effect = _$.effect("__tests__/template.marko_0__hoisted_setHtml3", ({
  _hoisted_setHtml3
}) => {
  {
    let i = 0;
...
export function _setup(_scope) {
  ...
  _to(_scope, 3);
  _for3(_scope, [3, 0, 1]);
  _hoisted_setHtml4(_scope, _get_hoisted_setHtml(_scope));
