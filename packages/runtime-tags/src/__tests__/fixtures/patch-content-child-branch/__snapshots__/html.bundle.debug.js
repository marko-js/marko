...
var card_default = _template_patch("__tests__/tags/card/index.marko", (input) => {
	...
	}, $scope0_id, "#section/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/tags/card/index.marko_1*shell"], $scope0_reason, 1);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	card_default({
		...
		content: _content_resume("__tests__/template.marko_1*content", () => {
			...
			_subscribe(_unfilled_if($scope0_reason, 2) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "2:4"), _client_guard($scope0_reason, 2) && "__tests__/template.marko_1_input_note#4/subscribe");
		}, $scope0_id)
	});
	_html("</main>");
