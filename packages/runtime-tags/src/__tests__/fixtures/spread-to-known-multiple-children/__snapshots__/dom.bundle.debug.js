...
const $input_class$1 = /*@__PURE__*/ _render(($scope, input_class) => _attr_class($scope["#input/0"], input_class));
...
const $input_value = ($scope, input_value) => {
	$input_value$1($scope["#childScope/0"], input_value);
	$input_value$1($scope["#childScope/1"], input_value);
};
