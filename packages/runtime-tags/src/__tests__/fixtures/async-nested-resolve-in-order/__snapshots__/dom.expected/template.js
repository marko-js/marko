...
const $await_content6 = /* @__PURE__ */_$.createRenderer(" ", /* get, over(1) */" b", 0, $params7$await$content);
...
const $await_content5 = /* @__PURE__ */_$.createRenderer("<!><!>k", /* replace, over(1), replace, over(2) */"%b%c", $setup$await$content3, $params6$await$content);
...
const $await_content4 = /* @__PURE__ */_$.createRenderer("<!><!>l", /* replace, over(1), replace, over(2) */"%b%c", $setup$await$content4, $params5$await$content);
...
const $await_content2 = /* @__PURE__ */_$.createRenderer("<!><!>e", /* replace, over(1), replace, over(2) */"%b%c", $setup$await$content, $params3$await$content);
...
const $await_content = /* @__PURE__ */_$.createRenderer("<!><!>f", /* replace, over(1), replace, over(2) */"%b%c", $setup$await$content2, $params2$await$content);
