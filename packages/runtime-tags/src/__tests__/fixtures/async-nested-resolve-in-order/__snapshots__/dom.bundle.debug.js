...
const $walks = "b%c%c";
const $await_content6__result = /*@__PURE__*/ _render(($scope, result6) => _text($scope["#text/0"], result6));
const $await_content6__$params = ($scope, $params7) => $await_content6__result($scope, $params7[0]);
const $await_content5__result = /*@__PURE__*/ _render(($scope, result5) => _text($scope["#text/0"], result5));
...
const $await_content4__result = /*@__PURE__*/ _render(($scope, result4) => _text($scope["#text/0"], result4));
...
const $await_content3__result = /*@__PURE__*/ _render(($scope, result3) => _text($scope["#text/0"], result3));
const $await_content3__$params = ($scope, $params4) => $await_content3__result($scope, $params4[0]);
const $await_content2__result = /*@__PURE__*/ _render(($scope, result2) => _text($scope["#text/0"], result2));
...
const $await_content__result = /*@__PURE__*/ _render(($scope, result1) => _text($scope["#text/0"], result1));
