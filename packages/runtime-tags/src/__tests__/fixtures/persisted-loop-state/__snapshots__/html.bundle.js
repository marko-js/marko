...
var template_default = _template_persisted("a", (input) => {
	...
	}, "id", $scope0_id, "a", 1, $sg__input_items, $sg__input_items, void 0, void 0, 0);
	_html(`</ul>${_el_resume($scope0_id, "a", $sg__input_items)}<button>Count <!>${_escape(count)}${_el_resume($scope0_id, "c")}</button>${_el_resume($scope0_id, "b")}</main>`);
