...
const _b$if_content = /* @__PURE__ */_$.conditionalClosure("#text/0", 0, 0, () => _expr_a_b$if_content);
const _a$if_content = /* @__PURE__ */_$.conditionalClosure("#text/0", 0, 0, () => _expr_a_b$if_content);
