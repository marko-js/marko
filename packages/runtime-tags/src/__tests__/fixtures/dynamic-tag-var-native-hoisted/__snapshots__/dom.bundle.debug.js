...
const $inputitemType_content = _content_resume("__tests__/template.marko_4*content", "item <!>", "b%", $inputitemType_content__setup);
const $inputtype_content = _content_resume("__tests__/template.marko_3*content", "body");
