...
const $await_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => _text($scope["#text/0"], $scope._._._._.input_value), ($scope) => $scope._._._._, "__tests__/template.marko_4_input_value#4/subscribe");
...
const $try_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => $try_content__await_promise($scope, Promise.resolve($scope._._._.input_value)), ($scope) => $scope._._._, "__tests__/template.marko_3_input_value#4/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_value($scope);
	$await_content($scope);
};
const $card_content__try = /*@__PURE__*/ _try("#text/0", "<!><!><!>", "b%", $try_content__setup);
const $card_content__setup = ($scope) => $card_content__try($scope, { placeholder: attrTag({ content: $placeholder_content($scope) }) });
