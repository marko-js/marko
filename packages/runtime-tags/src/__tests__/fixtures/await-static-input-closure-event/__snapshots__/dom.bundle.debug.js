...
const $await_content__input_foo = _closure_get("input_foo", ($scope) => _text($scope["#text/0"], $scope._._.input_foo), ($scope) => $scope._._, "__tests__/template.marko_2_input_foo#3/pending");
...
const $await_content__count = _closure_get("count", ($scope) => _text($scope["#text/2"], $scope._._.count), ($scope) => $scope._._, "__tests__/template.marko_2_count#4/pending");
