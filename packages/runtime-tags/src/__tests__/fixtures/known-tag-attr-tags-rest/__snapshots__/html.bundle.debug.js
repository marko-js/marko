...
var inner_default = _template("__tests__/tags/inner/index.marko", (input) => {
	...
	_for_of(input.stuff.row, (row) => {
		...
		_html_opens("__tests__/tags/inner/index.marko:2:3"), _html(`<div>row ${_sep($sg__input_stuff_row)}${_escape(row.x)}${_el_resume($scope1_id, "#text/0", $sg__input_stuff_row)}</div>`);
	...
	_html_opens("__tests__/tags/inner/index.marko:4:1", "__tests__/tags/inner/index.marko:5:1"), _html(`<div>other ${_sep($sg__input_stuff_other_y)}${_escape(input.stuff.other.y)}${_el_resume($scope0_id, "#text/1", $sg__input_stuff_other_y)}</div><div>cond ${_sep($sg__input_stuff_cond_a)}${_escape(input.stuff.cond.a)}${_el_resume($scope0_id, "#text/2", $sg__input_stuff_cond_a)}</div>`);
...
var child_default = _template("__tests__/tags/child/index.marko", (input) => {
	...
	_html_opens("__tests__/tags/child/index.marko:2:1"), _html(`<h1>${_escape(title)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 1))}</h1>`);
