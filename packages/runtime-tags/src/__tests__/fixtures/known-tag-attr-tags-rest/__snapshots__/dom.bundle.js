...
const $for_content__row_x = /*@__PURE__*/ _render(($scope, row_x) => _text($scope.a, row_x));
...
const $input_stuff_other_y = /*@__PURE__*/ _render(($scope, input_stuff_other_y) => _text($scope.b, input_stuff_other_y));
const $input_stuff_cond_a = /*@__PURE__*/ _render(($scope, input_stuff_cond_a) => _text($scope.c, input_stuff_cond_a));
