...
const $setup$2 = () => {};
const $for_content__row_x = /*@__PURE__*/ _render(($scope, row_x) => _text($scope["#text/0"], row_x));
...
const $input_stuff_other_y = /*@__PURE__*/ _render(($scope, input_stuff_other_y) => _text($scope["#text/1"], input_stuff_other_y));
const $input_stuff_cond_a = /*@__PURE__*/ _render(($scope, input_stuff_cond_a) => _text($scope["#text/2"], input_stuff_cond_a));
...
const $setup$1 = () => {};
const $title = /*@__PURE__*/ _render(($scope, title) => _text($scope["#text/0"], title));
