...
var price_card_default = _template_persisted("__tests__/tags/price-card.marko", (input) => {
	...
	$scope0_reason ? writeScope($scope0_id, {
		...
		input_label: ["input.label"],
		qty: "1:6"
	}) : _patch_value($scope0_id, "__tests__/tags/price-card.marko0", input.label);
...
var promo_tag_default = _template_persisted("__tests__/tags/promo-tag.marko", (input) => {
	...
	$scope0_reason ? writeScope($scope0_id, {
		...
		input_text: ["input.text"],
		seen: "1:6"
	}) : _patch_value($scope0_id, "__tests__/tags/promo-tag.marko0", input.text);
	_resume_branch($scope0_id);
});
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason && writeScope($scope0_id, {
		...
		"#childScope/5": _existing_scope($childScope2)
