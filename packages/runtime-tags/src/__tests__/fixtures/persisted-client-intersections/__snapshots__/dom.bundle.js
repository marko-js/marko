...
const $input_label__OR__qty = /*@__PURE__*/ _fillable("b0", 4, /*@__PURE__*/ _or(6, ($scope) => _text($scope.a, $scope.e + " x" + $scope.f)));
...
const $input_text__OR__seen = /*@__PURE__*/ _fillable("c0", 4, /*@__PURE__*/ _or(6, ($scope) => _text($scope.a, $scope.e + " (" + $scope.f + ")")));
