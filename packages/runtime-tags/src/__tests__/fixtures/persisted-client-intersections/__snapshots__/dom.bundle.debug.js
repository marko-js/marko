...
const $walks$3 = "E l l";
const $input_label__OR__qty = /*@__PURE__*/ _fillable("__tests__/tags/price-card.marko0", "input_label", /*@__PURE__*/ _or(6, ($scope) => _text($scope["#text/0"], $scope.input_label + " x" + $scope.qty)));
...
const $input_label$1 = /*@__PURE__*/ _const("input_label", $input_label__OR__qty);
...
const $walks$2 = "D l b";
const $input_text__OR__seen = /*@__PURE__*/ _fillable("__tests__/tags/promo-tag.marko0", "input_text", /*@__PURE__*/ _or(6, ($scope) => _text($scope["#text/0"], $scope.input_text + " (" + $scope.seen + ")")));
...
const $input_text = /*@__PURE__*/ _const("input_text", $input_text__OR__seen);
