...
const $placeholder_content2 = _content_resume("__tests__/template.marko_5*content", "_A_");
...
const $placeholder_content = _content_resume("__tests__/template.marko_2*content", "_B_");
