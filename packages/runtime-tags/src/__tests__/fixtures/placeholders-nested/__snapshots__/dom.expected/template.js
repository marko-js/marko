...
const $try_content2__await = /* @__PURE__ */_._await("#text/0", " ", /* get, over(1) */" b", 0, $await_content2__$params);
...
const $await = /* @__PURE__ */_._await("#text/1", " ", /* get, over(1) */" b", 0, $await_content3__$params);
