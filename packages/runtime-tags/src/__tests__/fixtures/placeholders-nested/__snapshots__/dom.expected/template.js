...
_._enable_catch();
_._enable_catch();
const $await_content3__data = /* @__PURE__ */_._const("data", ($scope, data) => _._text($scope["#text/0"], data));
const $await_content3__$params = /* @__PURE__ */_._const("$params4", ($scope, $params4) => $await_content3__data($scope, $params4[0]));
...
const $await_content2__$params = /* @__PURE__ */_._const("$params3", ($scope, $params3) => $await_content2__data($scope, $params3[0]));
