...
const $placeholder_content2 = _$.registerContent("__tests__/template.marko_5_renderer", "_A_");
...
const $try_content2 = /* @__PURE__ */_$.createRenderer("e<!>g", /* over(1), replace */"b%", $setup$try$content2);
