...
const $for_content__walks = "E l%l", $for_content__template = "<section><h2> </h2><!></section>", $for_content2__walks = " D l", $for_content2__template = "<button> </button>";
const $template = "<!><!><!>";
const $walks = "b%c";
...
const $for_content__for = /*@__PURE__*/ _for_of("#text/1", "<button> </button>", " D ", $for_content2__setup, $for_content2__$params);
const $for_content__group_items = ($scope, group_items) => {
	if (!updating) $for_content__for($scope, [group_items, "id"]);
};
const $for_content__$params = ($scope, $params2) => {
...
const $for = /*@__PURE__*/ _for_of("#text/0", "<section><h2> </h2><!></section>", "E l%", 0, $for_content__$params);
function $setup($scope) {
	if (!updating) $for($scope, [getGroups?.($scope.$global.filter), "id"]);
}
