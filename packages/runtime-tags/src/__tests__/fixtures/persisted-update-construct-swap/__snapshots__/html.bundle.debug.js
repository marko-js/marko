...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const PanelA = { content: _content("__tests__/template.marko_1_content", () => {
		...
		_html(`<p class=a>Panel A: ${_sep(_persisted_reason())}${_escape(_hole_value($scope1_id, "PatchHole:#text/0", getLabel?.($global().topic), _persisted_reason()))}${_el_resume($scope1_id, "#text/0", _persisted_reason())}</p><span class=a2>alpha detail</span><em class=a3>${_escape(_hole_value($scope1_id, "PatchHole:#text/1", getMotto?.(), _persisted_reason()))}${_el_resume($scope1_id, "#text/1")}</em>`);
	...
	const PanelB = { content: _content("__tests__/template.marko_2_content", () => {
		...
		_html(`<section class=b>Panel B: ${_sep(_persisted_reason())}${_escape(_hole_value($scope2_id, "PatchHole:#text/0", getLabel?.($global().topic), _persisted_reason()))}${_el_resume($scope2_id, "#text/0", _persisted_reason())}</section><span class=b2>beta detail</span>`);
		_persisted_reason() && writeScope($scope2_id, {}, "__tests__/template.marko", "11:2");
	}) };
...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<section class=b>Panel B: <!></section><span class=b2>beta detail</span>", "Db%lb"],
	"__tests__/template.marko_2_content": ["<section class=b>Panel B: <!></section><span class=b2>beta detail</span>", "Db%lb"],
	"__tests__/template.marko_1_update": ["<p class=a>Panel A: <!></p><span class=a2>alpha detail</span><em class=a3> </em>", "Db%lbD l"],
	"__tests__/template.marko_1_content": ["<p class=a>Panel A: <!></p><span class=a2>alpha detail</span><em class=a3> </em>", "Db%lbD l"],
