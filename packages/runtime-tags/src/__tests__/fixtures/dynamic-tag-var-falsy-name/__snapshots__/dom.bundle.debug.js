...
const $inputa11yTextbutton_content = _content_resume("__tests__/tags/child/index.marko_2*content", "content");
...
const $wrapper_content__input_a11yText = /*@__PURE__*/ _closure_get("input_a11yText", ($scope) => $wrapper_content__dynamicTag($scope, $scope._.input_a11yText && "button", () => ({ "aria-label": $scope._.input_a11yText })));
