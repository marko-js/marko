...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_for_of(input.items, (item) => {
		...
		_html(`<p>${_patch_text($scope1_id, "#text/0", collect($global$1, item), void 0, $scope0_owned, 0)}</p>`);
		_scope($scope1_id, {}, "__tests__/template.marko", "3:4");
	}, 0, $scope0_id, "#text/0", 1, $sg__input_items, $sg__input_items, void 0, void 0, "__tests__/template.marko_1*shell", $scope0_owned, 0);
	...
	}, $scope0_id, "#text/1", 1, $scope0_reason, $scope0_reason, void 0, void 0, ["__tests__/template.marko_2*shell"]);
	_html("</main>");
