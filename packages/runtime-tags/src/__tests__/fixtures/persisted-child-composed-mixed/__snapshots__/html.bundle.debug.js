...
var leaf_default = _template_persisted("__tests__/tags/relay/tags/leaf/index.marko", (input) => {
	...
	_html(`<b>${_patch_text($scope0_id, "#text/0", input.text, void 0, $scope0_owned, 0)}</b>`);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_base: ["input.base"],
		count: "1:6"
	}) : _filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko0", input.base);
}, 1, () => [relay_default]);
