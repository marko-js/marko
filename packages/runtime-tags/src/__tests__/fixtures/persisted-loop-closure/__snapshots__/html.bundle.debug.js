// template.marko
_renderer_shells({ "__tests__/template.marko_1_shell": ",`__tests__/template.marko_1_shell __tests__/template.marko_1_boost/init;D bD ;<li> <span> </span></li>`" });
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	}, 0, $scope0_id, "#ul/0", 1, 1, _source_guard($scope0_reason, 0), void 0, void 0, "__tests__/template.marko_1_shell");
