...
const $walks = " b b";
const $for_content__boost = /*@__PURE__*/ _resume_init("__tests__/template.marko_1_boost/init", /*@__PURE__*/ _for_closure("#ul/0", ($scope) => _text($scope["#text/1"], $scope._.boost)));
