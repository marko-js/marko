...
var template_default = _template("a", (input) => {
	...
	_for_of($global().items, (item) => {
		...
		_html("<li>");
		_dynamic_tag($scope2_id, "a", item.view === "b" ? PanelB : PanelA, {}, 0, 0, _persisted_reason() | _persisted_reason(), "a0");
		_html("</li>");
		_persisted_reason() && writeScope($scope2_id, { _: _scope_with_id($scope0_id) });
	}, 0, $scope0_id, "c", _persisted_reason(), _persisted_reason(), _persisted_reason(), "</ul>", 1, "a4");
