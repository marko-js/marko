...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	let n = _dynamic_tag($scope0_id, "#text/0", $tag, [...$input2], 0, 1, void 0, _patch_dynamic_tag($scope0_id, "#text/0", $tag, $input2, 0, "__tests__/template.marko_0_n#8/var", $scope0_owned, 0));
