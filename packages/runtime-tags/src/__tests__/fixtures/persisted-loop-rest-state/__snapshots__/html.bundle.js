...
var template_default = _template_persisted("a", (input) => {
	...
	_for_of(input.items, ({ id, ...rest }) => {
		...
		_filled_guard($scope0_reason, 0) ? _patch_value($scope1_id, "a0", id) : _patch_init($scope1_id, "a1");
		_filled_guard($scope0_reason, 0) ? _patch_value($scope1_id, "a1", rest) : _patch_init($scope1_id, "a1");
