...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	}, 0, $scope0_id, "#main/0", 1, 1, _source_guard($scope0_reason, 1), void 0, void 0, "__tests__/template.marko_1*shell", $scope0_reason, 1);
	_html(`</main>${_el_resume($scope0_id, "#main/0")}`);
