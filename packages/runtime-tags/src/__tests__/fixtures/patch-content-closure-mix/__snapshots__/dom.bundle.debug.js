...
const $walks = " b";
const $setup = () => {};
const $card_content__input_prefix = /*@__PURE__*/ _closure_get("input_prefix", ($scope) => _text($scope["#text/1"], $scope._._.input_prefix), ($scope) => $scope._._, "__tests__/template.marko_2_input_prefix#4/subscribe");
const $card_content__setup = ($scope) => {
	$card_content__input_prefix($scope);
	$card_content__$global_brand($scope);
	$card_content__item($scope);
};
const $card_content__$global_brand = /*@__PURE__*/ _global_join("brand", "__tests__/template.marko_2_$global_brand#5/global", /*@__PURE__*/ _closure_get("$global_brand", ($scope) => _text($scope["#text/0"], $scope.$global.brand), ($scope) => $scope._._, "__tests__/template.marko_2_$global_brand#5/subscribe"));
const $card_content__item = /*@__PURE__*/ _closure_get("item", ($scope) => _text($scope["#text/2"], $scope._.item), 0, "__tests__/template.marko_2_item#2/subscribe");
