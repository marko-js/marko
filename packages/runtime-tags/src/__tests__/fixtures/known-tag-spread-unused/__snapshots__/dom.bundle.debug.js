// template.marko
const $Foo_content__walks = " b", $Foo_content__template = " ", $Bar_content__walks = /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Foo_content__walks), $Bar_content__template = $Foo_content__template;
const $template = $Bar_content__template;
const $walks = /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Bar_content__walks);
