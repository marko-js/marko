...
const $walks$2 = " b";
const $setup$2 = () => {};
const $input__script = _script("__tests__/tags/btn.marko_0_input#2", ($scope) => _attrs_script($scope, "#button/0"));
const $input$1 = /*@__PURE__*/ _const("input", ($scope) => {
	_attrs_content($scope, "#button/0", $scope.input);
	$input__script($scope);
});
var btn_default = /*@__PURE__*/ _template("__tests__/tags/btn.marko", $template$2, " b", 0, $input$1);

// tags/child.marko
const $template$1 = "<!><!><!>";
const $walks$1 = "b%c";
const $setup$1 = () => {};
const $for_content__item = ($scope, item) => $input$1($scope["#childScope/0"], {
	...item,
	class: "item"
});
const $for_content__$params = ($scope, $params2) => $for_content__item($scope, $params2[0]);
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/0", $template$2, /*@__PURE__*/ ((_w0) => `/${_w0}&`)(" b"), 0, $for_content__$params);
...
const $item_content__count = /*@__PURE__*/ _closure_get("count/2", ($scope) => _text($scope["#text/0"], $scope._.count), 0, "__tests__/template.marko_1_count#1/subscribe");
