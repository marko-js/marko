...
const $if_content__input_suffix = /*@__PURE__*/ _closure_get("input_suffix", $if_content__input_suffix__OR__count, ($scope) => $scope._._);
const $if_content__setup = ($scope) => {
	$if_content__input_suffix($scope);
	$if_content__count($scope);
};
const $if_content__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_2_count#7/init", "count", $if_content__input_suffix__OR__count, ($scope) => $scope._._);
