...
const $walks = "D%b l";
const $if_content__input_suffix__OR__count__OR__item = /*@__PURE__*/ _fill_join_if("__tests__/template.marko1", "item", /*@__PURE__*/ _init_join("__tests__/template.marko_2_item#2/init", /*@__PURE__*/ _fill_join("__tests__/template.marko0", "input_suffix", /*@__PURE__*/ _init_join("__tests__/template.marko_2_input_suffix#6/init", /*@__PURE__*/ _or(1, ($scope) => _text($scope["#text/0"], $scope._.item + ":" + $scope._._.input_suffix + "@" + $scope._._.count), 2)), 0, ($join) => /*@__PURE__*/ _for_closure("#text/0", /*@__PURE__*/ _if_closure("#text/0", 0, $join)))), 0, "#text/0", 0);
...
const $for_content__item = /*@__PURE__*/ _fill_const("__tests__/template.marko1", "item", $if_content__item);
