...
var child_default = _template_persisted("__tests__/tags/child.marko", (input) => {
	...
	_if(() => {
		if (input.show) {
			...
			const l = input.label + "!";
			_filled_guard($scope0_reason, 1) ? _patch_value($scope1_id, "__tests__/tags/child.marko2", l) : _patch_init($scope1_id, "__tests__/tags/child.marko_1_input_label#5/init");
	...
	}, $scope0_id, "#text/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/tags/child.marko_1*shell"], $scope0_reason, 0);
	...
	$scope0_page ? _scope($scope0_id, {
		...
		c: "1:6"
	}) : _filled_guard($scope0_reason, 1) && _client_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/tags/child.marko0", input.label);
}, 0, 0);
