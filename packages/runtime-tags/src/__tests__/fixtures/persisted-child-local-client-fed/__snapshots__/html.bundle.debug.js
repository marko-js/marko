...
var child_default = _template_persisted("__tests__/tags/child.marko", (input) => {
	...
	_if(() => {
		if (input.show) {
			...
			const l = input.label + "!";
			_owned_guard($scope0_owned, 1) ? _patch_value($scope1_id, "__tests__/tags/child.marko0", l) : _patch_init($scope1_id, "__tests__/tags/child.marko_1_input_label#5/init");
