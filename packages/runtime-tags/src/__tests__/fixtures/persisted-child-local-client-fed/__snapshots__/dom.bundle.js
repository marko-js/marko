// tags/child.marko
const $if_content__c__OR__l = /*@__PURE__*/ _fill_join("b0", 1, /*@__PURE__*/ _or(2, ($scope) => _text($scope.a, $scope.b + "#" + $scope._.g)));
const $if_content__l = /*@__PURE__*/ _fill_const("b0", 1, $if_content__c__OR__l);
...
const $c = /*@__PURE__*/ _let(6, $if_content__c);
