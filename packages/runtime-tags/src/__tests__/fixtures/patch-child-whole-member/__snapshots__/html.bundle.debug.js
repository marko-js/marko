...
var duo_default = _template_patch("__tests__/tags/duo/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<h2>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 1)}</h2><p>${_patch_text($scope0_id, "#text/1", JSON.stringify(input), void 0, $scope0_reason, 0)}</p>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/duo/index.marko", 0);
}, 0, 0);
