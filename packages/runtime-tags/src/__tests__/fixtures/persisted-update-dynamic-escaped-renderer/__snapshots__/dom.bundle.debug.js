...
const $update2$1 = (_patch, _live) => {
	if ("input_performers" in _patch) _live["input_performers"] = _patch["input_performers"];
...
const _merge$1 = _resume("__tests__/tags/stage.marko_0_update", $update2$1);
_update_content("__tests__/tags/stage.marko", _merge$1);
...
const _merge = _resume("__tests__/tags/lineup.marko_0_update", $update2);
_update_content("__tests__/tags/lineup.marko", _merge);
function _patch2(_fail) {
	return patch(_merge, _fail);
}
