...
const $message = /*@__PURE__*/ _let("message/4", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.message)));
const $log = /*@__PURE__*/ _let("log/5", /*@__PURE__*/ _render(($scope) => _text($scope["#text/3"], $scope.log)));
