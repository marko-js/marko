...
const $walks = "D l%c";
_enable_catch();
const $await_content__value__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.value));
...
const $value__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.value));
