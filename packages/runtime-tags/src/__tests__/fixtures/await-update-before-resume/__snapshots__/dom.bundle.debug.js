...
const $try_content__value = /*@__PURE__*/ _closure_get("value", ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.value, 3)), 0, "__tests__/template.marko_1_value#2/subscribe");
