...
const $walks = "D l%c";
const $await_content__value__script = _script("__tests__/template.marko_3_value#2", ($scope) => console.log(`effect ran value=${$scope.value}`));
...
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<div id=inside> </div>", "D ", $await_content__setup);
const $try_content__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content__$params);
const $try_content__value = /*@__PURE__*/ _closure_get("value/3", ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.value, 3)), 0, "__tests__/template.marko_1_value#2/subscribe");
