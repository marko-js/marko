// template.marko
_enable_catch();
const $await_content__value__script = _script("a4", ($scope) => console.log(`effect ran value=${$scope.c}`));
const $await_content__value = /*@__PURE__*/ _const(2, ($scope) => {
	_text($scope.a, $scope.c);
	$await_content__value__script($scope);
});
const $await_content__setup = _script("a3", ($scope) => console.log(`setup effect ran`));
...
const $try_content__value = /*@__PURE__*/ _closure_get(3, ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.c, 3)));
const $value__closure = /*@__PURE__*/ _closure($try_content__value);
const $value = /*@__PURE__*/ _let(2, ($scope) => {
	_text($scope.a, $scope.c);
	$value__closure($scope);
});
const $setup__script = _script("a0", ($scope) => (async () => {
