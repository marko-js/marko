// total: 8739 (min) 3731 (brotli)
// template.marko: 418 (min) 227 (brotli)
_enable_catch();
...
const $try_content__value = /* @__PURE__ */ _closure_get(2, ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.c, 3)));
