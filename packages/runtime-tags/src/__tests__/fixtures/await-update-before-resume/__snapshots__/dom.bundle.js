...
const $try_content__value = /*@__PURE__*/ _closure_get(3, ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.c, 3)), 0, "a4", 2);
const $value__closure = /*@__PURE__*/ _closure($try_content__value);
const $value = /*@__PURE__*/ _let(2, ($scope) => {
	_text($scope.a, $scope.c);
	$value__closure($scope);
});
const $setup__script = _script("a5", ($scope) => (async () => {
