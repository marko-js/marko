...
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/1", /*@__PURE__*/ ((_w0) => `<p><!> hit <!></p>${_w0}<!>`)($template$1), /*@__PURE__*/ ((_w0) => `D%c%l/${_w0}&b`)("b%c"), $for_content__setup, $for_content__$params);
...
_resumed["__tests__/template.marko_1/onCount"] = $onCount;
