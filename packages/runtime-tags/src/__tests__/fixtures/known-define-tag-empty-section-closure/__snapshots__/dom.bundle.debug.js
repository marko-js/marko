...
const $template$1 = $Tag_content__template;
const $walks$1 = /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Tag_content__walks);
...
const $Tag_content__if = /*@__PURE__*/ _if("#text/0", "<div> </div>", "D ", $if_content__setup$1);
...
var test_default = /*@__PURE__*/ _template("__tests__/tags/test.marko", "<!>", $walks$1, $setup$1);
...
const $if = /*@__PURE__*/ _if("#text/0", "<!>", /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$1), $if_content__setup);
