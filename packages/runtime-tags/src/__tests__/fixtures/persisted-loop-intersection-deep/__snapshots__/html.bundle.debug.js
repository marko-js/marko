	...
	_if(() => {
		if (input.show) {
			...
			_for_of(input.items, (item) => {
				...
				_filled_guard($scope0_reason, 2) ? _patch_value($scope2_id, "__tests__/template.marko1", item) : _patch_init($scope2_id, "__tests__/template.marko_2_input_items#5/init");
