...
const $try_content__n = /*@__PURE__*/ _closure_get("n", ($scope) => $try_content__await_promise($scope, resolveAfter("v" + $scope._.n, $scope._.n)), 0, "__tests__/template.marko_1_n#6/subscribe");
