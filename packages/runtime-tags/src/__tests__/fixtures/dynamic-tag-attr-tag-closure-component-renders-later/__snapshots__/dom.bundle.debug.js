...
const $if_content__input_item_content = /*@__PURE__*/ _if_closure("#text/1", 0, ($scope) => $if_content__dynamicTag($scope, $scope._.input_item_content));
const $if_content__setup = $if_content__input_item_content;
...
const $input_item_content = /*@__PURE__*/ _const("input_item_content", $if_content__input_item_content);
...
const $item_content__input_text = /*@__PURE__*/ _closure_get("input_text/5", ($scope) => _text($scope["#text/0"], $scope._.input_text), 0, "__tests__/tags/heading.marko_1_input_text#4/subscribe");
