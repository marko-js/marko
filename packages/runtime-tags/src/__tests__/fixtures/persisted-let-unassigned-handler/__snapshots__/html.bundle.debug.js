...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, { x_length: x?.length }, "__tests__/template.marko", 0, { x_length: ["x.length", "1:6"] }) : _filled_guard($scope0_owned, 0) && _patch_write($scope0_id, "x_length", x?.length);
}, 1, 0);
