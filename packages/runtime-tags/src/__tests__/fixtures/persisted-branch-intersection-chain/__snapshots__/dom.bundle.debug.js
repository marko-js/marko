...
const $else_content__count = /*@__PURE__*/ _init_if_closure("__tests__/template.marko_3_count#7/init", "#div/0", 2, ($scope) => _text($scope["#text/0"], $scope._.count));
const $else_content__setup = $else_content__count;
const $elseif_content__input_title__OR__count = /*@__PURE__*/ _fill_join_if("__tests__/template.marko0", "input_title", /*@__PURE__*/ _init_join("__tests__/template.marko_2_input_title#6/init", /*@__PURE__*/ _or(1, ($scope) => _text($scope["#text/0"], $scope._.input_title + " @" + $scope._.count))), 0, "#div/0", 1);
...
const $elseif_content__count = /*@__PURE__*/ _init_if_closure("__tests__/template.marko_2_count#7/init", "#div/0", 1, $elseif_content__input_title__OR__count);
const $if_content__input_title__OR__count = /*@__PURE__*/ _fill_join_if("__tests__/template.marko0", "input_title", /*@__PURE__*/ _init_join("__tests__/template.marko_1_input_title#6/init", /*@__PURE__*/ _or(1, ($scope) => _text($scope["#text/0"], $scope._.input_title + " #" + $scope._.count))), 0, "#div/0", 0);
...
const $if_content__count = /*@__PURE__*/ _init_if_closure("__tests__/template.marko_1_count#7/init", "#div/0", 0, $if_content__input_title__OR__count);
