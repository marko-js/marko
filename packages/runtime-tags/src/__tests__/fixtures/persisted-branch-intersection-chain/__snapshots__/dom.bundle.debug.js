...
const $else_content__count = /*@__PURE__*/ _resume_init("__tests__/template.marko_3_count/init", /*@__PURE__*/ _if_closure("#div/0", 2, ($scope) => _text($scope["#text/0"], $scope._.count)));
...
const $elseif_content__count = /*@__PURE__*/ _resume_init("__tests__/template.marko_2_count/init", /*@__PURE__*/ _if_closure("#div/0", 1, $elseif_content__input_title__OR__count));
...
const $if_content__count = /*@__PURE__*/ _resume_init("__tests__/template.marko_1_count/init", /*@__PURE__*/ _if_closure("#div/0", 0, $if_content__input_title__OR__count));
