// template.marko
const $else_content__count = /*@__PURE__*/ _init_if_closure("a7", 0, 2, ($scope) => _text($scope.a, $scope._.h));
...
const $elseif_content__count = /*@__PURE__*/ _init_if_closure("a6", 0, 1, $elseif_content__input_title__OR__count);
...
const $if_content__count = /*@__PURE__*/ _init_if_closure("a5", 0, 0, $if_content__input_title__OR__count);
