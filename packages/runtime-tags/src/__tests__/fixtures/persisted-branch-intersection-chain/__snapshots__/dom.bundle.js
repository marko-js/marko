// template.marko
const $else_content__count = /*@__PURE__*/ _resume_init("a7", /*@__PURE__*/ _if_closure(0, 2, ($scope) => _text($scope.a, $scope._.h)));
...
const $elseif_content__count = /*@__PURE__*/ _resume_init("a6", /*@__PURE__*/ _if_closure(0, 1, $elseif_content__input_title__OR__count));
...
const $if_content__count = /*@__PURE__*/ _resume_init("a5", /*@__PURE__*/ _if_closure(0, 0, $if_content__input_title__OR__count));
