...
var panel_default = _template_persisted("__tests__/tags/panel.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", $tag, {}, 0, 0, $sg__input_aside, _patch_dynamic_tag($scope0_id, "#text/0", $tag, 0, 0, 0, $scope0_reason, 0));
	_html("</div></section>");
...
var page_default = _template_persisted("__tests__/page.marko", (input) => {
	...
	_for_of(input.items, (item) => {
		...
		_filled_guard($scope0_reason, 0) ? _patch_value($scope1_id, "__tests__/page.marko2", item?.n) : _patch_init($scope1_id, "__tests__/page.marko_1_input_items#6/init");
		...
		panel_default({ aside: attrTag({ content: _content_elide("__tests__/page.marko_2*content", () => {
			...
			_subscribe($scope0_page && $for_content__item_n__closures, _subscribe($p_base__closures, _subscribe($bonus__closures, _scope($scope2_id, {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		bonus: "1:6",
		p_base: ["p.base", "2:8"]
	}) : (_filled_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/page.marko0", input.items), _patch_value($scope0_id, "__tests__/page.marko1", p?.base));
}, 0, 1);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_page && _scope($scope0_id, { input_items: input.items }, "__tests__/template.marko", 0, { input_items: ["input.items"] });
}, 1, () => [page_default]);
