...
export const _id_ = /* @__PURE__ */_$.value("id/3", (_scope, id) => _$.data(_scope["#text/0"], id));
export const _input_ = /* @__PURE__ */_$.value("input/2", (_scope, input) => _id_(_scope, input.id));
