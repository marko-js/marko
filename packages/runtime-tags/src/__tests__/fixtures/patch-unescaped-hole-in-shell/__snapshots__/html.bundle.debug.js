				...
				if (input.show > 1) {
					...
					_if(() => {
						if (input.html) {
							...
							}, "__tests__/template.marko", "6:8"), _client_guard($scope0_reason, 2) && "__tests__/template.marko_3_input_html#4/subscribe");
							return 0;
						}
					...
					_if(() => {
						if (input.html) {
							...
							}, "__tests__/template.marko", "10:8"), _client_guard($scope0_reason, 2) && "__tests__/template.marko_4_input_html#4/subscribe");
							return 0;
						}
					}, $scope2_id, "#text/1", 1, $sg__input_html, $sg__input_html, void 0, void 0, ["__tests__/template.marko_4*shell"], $scope0_reason, 2);
					$scope0_page && _subscribe(_unfilled_if($scope0_reason, 2) && $input_html__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "5:6"), _client_guard($scope0_reason, 2) && "__tests__/template.marko_2_input_html#4/subscribe", $sg__input_html);
					return 0;
				}
