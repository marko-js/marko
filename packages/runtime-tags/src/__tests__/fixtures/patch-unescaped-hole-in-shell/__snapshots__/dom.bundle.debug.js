...
const $walks = " b";
const $setup = () => {};
const $if_content4__input_html = /*@__PURE__*/ _closure_get("input_html", ($scope) => _html($scope, $scope._._._.input_html, "#text/0"), ($scope) => $scope._._._, "__tests__/template.marko_4_input_html#4/subscribe");
...
}, ($scope) => $scope._._._, "__tests__/template.marko_3_input_html#4/subscribe");
...
}, ($scope) => $scope._._, "__tests__/template.marko_2_input_html#4/subscribe");
