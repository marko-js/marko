...
var pill_default = _template_patch("b", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<b class=pill>${_patch_text($scope0_id, "a", input.text, void 0, $scope0_reason, 0)}</b>`);
...
_shells({
	...
	a: "a; ;<main></main>",
	a1: /*@__PURE__*/ ((_w0, _w1) => `a1;${_w0};${_w1}`)(((_w0) => `/${_w0}&`)("D l"), $template),
	a2: "a2;b%;<!><!><!>",
	a3: "a3,<em>closed</em>"
});
