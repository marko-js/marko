...
const $card_content2__$global_brand = /*@__PURE__*/ _global_join("brand", "__tests__/template.marko_3_$global_brand#6/global", /*@__PURE__*/ _closure_get("$global_brand", ($scope) => _text($scope["#text/0"], $scope.$global.brand), ($scope) => $scope._._, "__tests__/template.marko_3_$global_brand#6/subscribe"));
...
const $card_content__$global_brand = /*@__PURE__*/ _global_join("brand", "__tests__/template.marko_1_$global_brand#6/global", /*@__PURE__*/ _closure_get("$global_brand", ($scope) => _text($scope["#text/0"], $scope.$global.brand), 0, "__tests__/template.marko_1_$global_brand#6/subscribe"));
