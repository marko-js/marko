...
const $try_content__input_message = /*@__PURE__*/ _closure_get("input_message", ($scope) => _text($scope["#text/0"], $scope._._.input_message), ($scope) => $scope._._, "__tests__/template.marko_2_input_message#4/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_message($scope);
	$try_content__input_boom($scope);
};
const $try_content__input_boom = /*@__PURE__*/ _closure_get("input_boom", ($scope) => _text($scope["#text/1"], $scope._._.input_boom ? boom() : ""), ($scope) => $scope._._, "__tests__/template.marko_2_input_boom#5/subscribe");
