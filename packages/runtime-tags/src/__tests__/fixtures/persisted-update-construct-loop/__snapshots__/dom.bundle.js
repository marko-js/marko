...
const $PanelB_content = _content_resume("a3", "<section class=b>B: <!></section>", "Db%", $PanelB_content__setup);
const $PanelA_content__setup = ($scope) => _text($scope.a, getLabel?.($scope.$.topic));
const $PanelA_content = _content_resume("a2", "<span class=a>A: <!></span>", "Db%", $PanelA_content__setup);
