...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_of($global().items, (item) => {
		...
		_html(`<em>LOOP_ONLY_MARKUP</em>${_escape(_hole_value($scope2_id, "PatchHole:#text/0", serverLoopSentinel?.(), _persisted_reason()))}${_el_resume($scope2_id, "#text/0")}`);
...
_renderer_shells({
	...
	"__tests__/template.marko_2_update": ["<em>LOOP_ONLY_MARKUP</em><!><!><!>", "b%b%c"],
	"__tests__/template.marko_2_content": ["<em>LOOP_ONLY_MARKUP</em><!><!><!>", "b%b%c"],
