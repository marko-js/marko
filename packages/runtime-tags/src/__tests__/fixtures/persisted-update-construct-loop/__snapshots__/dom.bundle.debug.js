...
const $for_content__walks = "b%b%c", $for_content__template = "<em>LOOP_ONLY_MARKUP</em><!><!><!>";
...
const $PanelA = /*@__PURE__*/ _const_persisted("PanelA");
const $PanelB = /*@__PURE__*/ _const_persisted("PanelB");
const $for = /*@__PURE__*/ _for_of("#ul/2", "<em>LOOP_ONLY_MARKUP</em><!><!><!>", "b%b%", $for_content__setup, $for_content__$params);
