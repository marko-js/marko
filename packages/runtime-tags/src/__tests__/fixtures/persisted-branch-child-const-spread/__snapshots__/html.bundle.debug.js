...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	_html(`<div id=fixed${_patch_attrs_partial(input.attrs, { id: 1 }, "#div/0", $scope0_id, "div", $scope0_owned, 0)}>${_patch_text($scope0_id, "#text/1", input.title, void 0, $scope0_owned, 1)}</div>${_el_resume($scope0_id, "#div/0")}`);
