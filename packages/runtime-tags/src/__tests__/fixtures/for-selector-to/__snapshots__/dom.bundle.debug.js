...
const $walks = "D l";
const $for_content__selected = /*@__PURE__*/ _for_selector("#tbody/0", "selected", "#LoopKey", /*@__PURE__*/ _render(($scope) => _attr_class($scope["#tr/0"], $scope._.selected === $scope["#LoopKey"] && "danger")));
const $for_content__setup__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope["#LoopKey"]));
