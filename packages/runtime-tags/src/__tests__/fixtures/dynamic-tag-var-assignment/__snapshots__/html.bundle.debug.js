...
var counter_default = _template("__tests__/tags/counter.marko", (input) => {
	...
	let x = 1;
	_html_opens("__tests__/tags/counter.marko:2:1"), _html(`<button class=inc>${_escape(x)}${_el_resume($scope0_id, "#text/1")}</button>${_el_resume($scope0_id, "#button/0")}`);
	const $return = x;
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let count = _dynamic_tag($scope0_id, "#text/0", getCounter(), {}, void 0, void 0, void 0, "__tests__/template.marko:5:1");
	_var($scope0_id, "#scopeOffset/1", $getCounter_scope, "__tests__/template.marko_0_count/var", "#text/0");
	_html_opens("__tests__/template.marko:6:1"), _html(`<button class=reset>reset</button>${_el_resume($scope0_id, "#button/2")}`);
