...
const $item_content__input_show = /*@__PURE__*/ _closure_get(5, ($scope) => $item_content__if($scope, $scope._.e ? 0 : 1));
const $item_content = /*@__PURE__*/ _content("b0", "<!><!><!>", "b%", $item_content__input_show);
