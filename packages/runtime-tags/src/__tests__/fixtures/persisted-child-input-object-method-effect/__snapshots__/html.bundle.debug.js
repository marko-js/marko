...
var probe_default = _template_persisted("__tests__/tags/probe.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		input_opts: ["input.opts"],
		input_label: ["input.label"]
	}) : (_filled_guard($scope0_reason, 0) && _patch_write($scope0_id, "input_opts", input.opts), _filled_guard($scope0_reason, 1) && _patch_write($scope0_id, "input_label", input.label));
}, 0, 0);
