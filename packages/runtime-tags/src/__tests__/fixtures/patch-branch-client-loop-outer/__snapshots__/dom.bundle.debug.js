...
const $walks = "D%b l";
const $if_content__input_note = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_note", /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._._.input_note), ($scope) => $scope._._, "__tests__/template.marko_2_input_note#5/subscribe"), 0);
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/0", "<li><!><!></li>", "D%b%", $for_content__setup, $for_content__$params);
