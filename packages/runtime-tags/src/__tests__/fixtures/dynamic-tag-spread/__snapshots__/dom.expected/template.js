export const $template = /*@__PURE__*/((_w0, _w1) => `<div>${_w0}</div><div>${_w1}</div>`)(_wrapper_template, _wrapper_template);
export const $walks =
/*@__PURE__*/
/* next(1), <wrapper>, out(1), next(1), <wrapper>, out(1) */
((_w0, _w1) => `D/${_w0}&lD/${_w1}&l`)(_wrapper_walks, _wrapper_walks);
