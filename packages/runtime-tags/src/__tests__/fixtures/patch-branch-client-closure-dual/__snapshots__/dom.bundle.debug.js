...
const $walks = "D%b l";
const $if_content3__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], "s:" + $scope._._.input_title), ($scope) => $scope._._, "__tests__/template.marko_3_input_title#4/subscribe"), 1);
const $if_content3__setup = $if_content3__input_title;
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], "p:" + $scope._._.input_title), ($scope) => $scope._._, "__tests__/template.marko_2_input_title#4/subscribe"), 0);
