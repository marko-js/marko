// template.marko
const $if_content3__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(7, ($scope) => _text($scope.a, "s:" + $scope._._.e), ($scope) => $scope._._, "a1", 4), 1);
const $if_content3__setup = $if_content3__input_title;
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(7, ($scope) => _text($scope.a, "p:" + $scope._._.e), ($scope) => $scope._._, "a0", 4), 0);
