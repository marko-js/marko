...
const $walks$1 = "b%c";
const $setup$1 = () => {};
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/tags/panel/index.marko1", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], $scope._._.input_title), ($scope) => $scope._._, "__tests__/tags/panel/index.marko_2_input_title#5/subscribe"), 0);
