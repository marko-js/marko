...
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("b1", 5, /*@__PURE__*/ _closure_get(7, ($scope) => _text($scope.a, $scope._._.f), ($scope) => $scope._._, "b2", 5), 0);
...
const $input_title = _fill_const("a0", 5, ($scope) => $input_title$1($scope.a, $scope.f));
