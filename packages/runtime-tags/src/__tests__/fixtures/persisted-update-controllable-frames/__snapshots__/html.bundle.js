...
var template_default = _template("a", (input) => {
	...
	_try($scope0_id, "e", _content_resume("a4", () => {
		...
		}, $sg__input_eta__OR__input_tick, "a2");
...
_renderer_shells({
	...
	"a": ["<button class=count>clicked <!></button><input class=sku><select class=ship><option value=ground>ground</option><option value=air>air</option><option value=sea>sea</option></select><!><!>", " Db%l b b%c"]
});
