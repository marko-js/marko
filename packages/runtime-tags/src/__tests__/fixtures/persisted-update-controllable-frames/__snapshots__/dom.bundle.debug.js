...
const $try = /*@__PURE__*/ _try("#text/4", $try_content__template, $try_content__walks, $try_content__setup);
...
const $await_content = /*@__PURE__*/ _await_content("#text/0", "<p class=eta> </p>", "D ");
const $try_content__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content__$params);
const $try_content__input_eta__OR__input_tick = /*@__PURE__*/ _or(1, ($scope) => {
	if (!updating) $try_content__await_promise($scope, resolveAfter($scope._.input_eta, $scope._.input_tick));
});
...
const $try = /*@__PURE__*/ _try("#text/4", "<!><!><!>", "b%", $try_content__setup);
