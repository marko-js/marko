		...
		_if(() => {
			if (input.count) {
				const $scope2_id = _scope_id();
				{
					...
					$si__input_count__OR__input_name && _subscribe($si__input_name && $Child_content__input_name__closures, _scope($scope3_id, { _: _scope_with_id($scope2_id) }), "a0", $sg__input_name);
				}
