...
const $wrap_content__input_msg = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(6, $wrap_content__input_msg__OR__count, ($scope) => $scope._._, "a5", 4), 0);
const $wrap_content__setup = ($scope) => {
	$wrap_content__input_msg($scope);
	$wrap_content__count($scope);
};
const $wrap_content__count = /*@__PURE__*/ _closure_get(7, $wrap_content__input_msg__OR__count, ($scope) => $scope._._, "a6", 5);
