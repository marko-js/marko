...
const $wrap_content__input_msg = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_msg", /*@__PURE__*/ _closure_get("input_msg", $wrap_content__input_msg__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_input_msg#4/subscribe"), 0);
const $wrap_content__setup = ($scope) => {
	$wrap_content__input_msg($scope);
	$wrap_content__count($scope);
};
const $wrap_content__count = /*@__PURE__*/ _closure_get("count", $wrap_content__input_msg__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_count#5/subscribe");
const $wrap_content = /*@__PURE__*/ _content("__tests__/template.marko_2*content", "<span> </span>", "D ", $wrap_content__setup);
