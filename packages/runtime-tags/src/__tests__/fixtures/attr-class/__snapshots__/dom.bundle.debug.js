...
const $walks$1 = " b%c";
const $setup$1 = () => {};
const $if_content__input_test_class = /*@__PURE__*/ _if_closure("#text/1", 0, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#div/0"], $scope._.input_test_class)));
...
const $input_class = /*@__PURE__*/ _render(($scope, input_class) => _attr_class($scope["#div/0"], input_class));
...
const $input_c__OR__input_d__render = /*@__PURE__*/ _render(($scope) => _attr_class_items($scope["#div/0"], {
	b: $scope.c,
	d: $scope.d
}));
const $input_c__OR__input_d = /*@__PURE__*/ _or(10, ($scope) => {
	$input_c__OR__input_d__render($scope);
...
const $input_c__OR__input_d__OR__input_e__OR__input_f__OR__input_g__OR__input_h = /*@__PURE__*/ _or(15, /*@__PURE__*/ _render(($scope) => _attr_class_items($scope["#div/2"], {
	c: $scope.c,
	d: $scope.d,
	e: $scope.e,
	f: $scope.f,
...
const $c__render = /*@__PURE__*/ _render(($scope) => _attr_class($scope["#div/1"], $scope.c && "active"));
