...
export default _._template("__tests__/tags/custom-tag.marko", input => {
  const $scope0_reason = _._scope_reason(),
    $sg__input_test = _._serialize_guard($scope0_reason, /* input.test */3),
    $si__input_test = _._serialize_if($scope0_reason, /* input.test */3);
  ...
  _._if(() => {
    if (input.test) {
      ...
      ($si__input_test) && _._scope($scope1_id, {
