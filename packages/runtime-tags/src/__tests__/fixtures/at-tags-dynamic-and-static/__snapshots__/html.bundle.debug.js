...
var hello_default = _template("__tests__/tags/hello/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_item = _serialize_guard($scope0_reason, 1), $sg__input_other = _serialize_guard($scope0_reason, 2);
	...
	_dynamic_tag($scope0_id, "#text/1", input.other, {}, 0, 0, $sg__input_other);
