...
export default _._template("__tests__/tags/hello/index.marko", input => {
  ...
  _._for_of(input.item, item => {
    ...
    _._serialize_guard($scope0_reason, /* input.item */1) && _._scope($scope1_id, {}, "__tests__/tags/hello/index.marko", "1:1");
  ...
  _._serialize_guard($scope0_reason, /* input.item, input.other */0) && _._scope($scope0_id, {}, "__tests__/tags/hello/index.marko", 0);
});