...
const $other_content = _._content_resume("__tests__/template.marko_2_content", "other", /* over(1) */"b");
const $item_content = _._content_closures(_._content_resume("__tests__/template.marko_1_content", "<!>:<!>", /* replace, over(2), replace, over(1) */"%c%b"), {
  a($scope, a) {
