...
const $other_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "other");
const $item_content = /*@__PURE__*/ _content_closures(/*@__PURE__*/ _content("__tests__/template.marko_1_content", "<!>:<!>", "%c%"), {
	a($scope) {
