...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const Detail = { content: _content("__tests__/template.marko_2_content", () => {
		...
		_html(`<h2 class=title>${_escape(_hole_value($scope2_id, "UpdateHole:#text/0", $global().title, _persisted_reason()))}${_el_resume($scope2_id, "#text/0", _persisted_reason())}</h2>`);
