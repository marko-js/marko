...
const $Detail_content__update = (patch, live) => {
	...
	if ("#childScope/2" in patch) _update_load(patch["#childScope/2"], live["#childScope/2"], "__tests__/tags/gadget.marko_0_update");
};
...
var gadget_marko_update_default = _resume("__tests__/tags/gadget.marko_0_update", $update);
