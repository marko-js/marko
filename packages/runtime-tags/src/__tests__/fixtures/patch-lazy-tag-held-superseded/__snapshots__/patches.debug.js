// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-lazy-tag-held-superseded/template.marko_1*shell;b%b/ D%c%l&b;<!><!><button><!>:<!></button><!>`, {
  "PatchReady:ready:packages/runtime-tags/src/__tests__/fixtures/patch-lazy-tag-held-superseded/child.marko": {
    "PatchBranch:#main/0": [{
