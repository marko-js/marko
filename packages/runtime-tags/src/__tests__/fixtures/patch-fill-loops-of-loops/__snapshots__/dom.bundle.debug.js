...
const $walks = "D%b l";
const $for_content2__input_suffix__OR__count = /*@__PURE__*/ _fill_join_for("__tests__/template.marko0", "input_suffix", /*@__PURE__*/ _init_join("__tests__/template.marko_2_input_suffix#5/init", /*@__PURE__*/ _or(1, ($scope) => _text($scope["#text/0"], $scope["#LoopKey"] + ":" + $scope._._.input_suffix + "@" + $scope._._.count))), 0, "#text/0", "#text/0");
const $for_content2__input_suffix = /*@__PURE__*/ _closure_get("input_suffix", $for_content2__input_suffix__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_input_suffix#5/subscribe");
const $for_content2__setup = ($scope) => {
	$for_content2__input_suffix($scope);
	$for_content2__count($scope);
};
const $for_content2__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_2_count#6/init", "count", $for_content2__input_suffix__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_count#6/subscribe");
