...
const $walks = "D%b l";
const $for_content2__input_suffix__OR__count__OR__cell = /*@__PURE__*/ _fill_join("__tests__/template.marko1", "cell", /*@__PURE__*/ _fill_join_for("__tests__/template.marko0", "input_suffix", /*@__PURE__*/ _init_join("__tests__/template.marko_2_input_suffix#5/init", /*@__PURE__*/ _or(3, ($scope) => _text($scope["#text/0"], $scope.cell + ":" + $scope._._.input_suffix + "@" + $scope._._.count), 2)), 0, "#text/0", "#text/0"));
