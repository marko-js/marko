...
var dump_default = _template_patch("__tests__/tags/dump/index.marko", (input) => {
	...
	_html(`<p>${_patch_text($scope0_id, "#text/0", input.format(input.value), void 0, $scope0_reason, 0)}</p>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/dump/index.marko", 0);
}, 0, 0);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		input_suffix: ["input.suffix"],
		count: "1:6"
	}) : _filled_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/template.marko0", input.suffix);
}, 1, () => [dump_default]);
