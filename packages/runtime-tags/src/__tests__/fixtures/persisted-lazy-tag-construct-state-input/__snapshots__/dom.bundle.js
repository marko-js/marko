...
const $if_content__input_label__OR__n = /*@__PURE__*/ _fill_join_if("b0", 6, /*@__PURE__*/ _init_join("b3", /*@__PURE__*/ _or(2, ($scope) => $load_Child_tag_input_label($scope.b, `${$scope._.g}${$scope._.h}`))), 0, 2, 0);
