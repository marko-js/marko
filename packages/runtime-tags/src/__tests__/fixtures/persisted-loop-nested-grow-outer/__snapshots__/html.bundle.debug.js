...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_for_of(input.rows, (row) => {
		...
		_filled_guard($scope0_reason, 0) ? _patch_value($scope1_id, "__tests__/template.marko0", row?.id) : _patch_init($scope1_id, "__tests__/template.marko_1_input_rows#4/init");
