// template.marko
const $for_content2__count__OR__row_id = /*@__PURE__*/ _fill_join_for("a0", 4, /*@__PURE__*/ _init_join("a6", /*@__PURE__*/ _or(1, ($scope) => _text($scope.a, $scope._.e + "@" + $scope._._.f))), 0, 0);
