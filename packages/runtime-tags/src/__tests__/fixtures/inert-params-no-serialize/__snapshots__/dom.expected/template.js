...
const $child_content__x = /* @__PURE__ */_._const("x", $scope => _._text($scope["#text/0"], $scope.x));
const $child_content__$params = /* @__PURE__ */_._const("$params2", $scope => $child_content__x($scope, $scope.$params2[0]));
