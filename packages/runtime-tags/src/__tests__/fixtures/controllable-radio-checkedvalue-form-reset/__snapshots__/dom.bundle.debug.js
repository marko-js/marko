// template.marko
const $template = "<form><input type=radio name=p><input type=radio name=p><input type=radio name=p><button type=reset>reset</button></form><span>v=<!></span>";
const $walks = "D b b lDb%l";
...
_resumed["__tests__/template.marko_0/checkedValueChange2"] = $checkedValueChange2;
