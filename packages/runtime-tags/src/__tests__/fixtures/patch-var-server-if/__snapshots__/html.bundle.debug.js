...
_shells({
	"__tests__/template.marko": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko !__tests__/template.marko_0;${_w0};${_w1}`)(((_w0) => `D0${_w0}&%b l`)("b"), ((_w0) => `<main>${_w0}<!><button>+</button></main>`)($template$1)),
	"__tests__/template.marko_1*shell": "__tests__/template.marko_1*shell __tests__/template.marko_1_count#7/init;Db%;<p>big <!></p>"
});
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_client_guard($scope0_reason, 0) && _var($scope0_id, "#scopeOffset/1", $childScope, "__tests__/template.marko_0_double#8/var");
	...
	}, $scope0_id, "#text/2", 1, $sg__input_n, $sg__input_n, void 0, void 0, ["__tests__/template.marko_1*shell"], $scope0_reason, 0);
