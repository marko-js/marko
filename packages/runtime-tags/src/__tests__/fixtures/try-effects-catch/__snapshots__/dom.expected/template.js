export const _template_ = "<div></div><!><div></div>";
export const _walks_ = /* get, over(1), replace, over(1), get, over(1) */" b%b b";
...
const _setup__effect = _$.effect("__tests__/template.marko_0", _scope => (_scope["#div/2"].textContent = "This is good"));
