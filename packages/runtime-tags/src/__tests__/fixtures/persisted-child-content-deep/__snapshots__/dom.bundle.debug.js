...
const $card_content = /*@__PURE__*/ _content$1("__tests__/template.marko_3*content", "<p> </p>", "D ", $card_content__setup);
const $box_content__setup = ($scope) => $input_content_direct$1($scope["#childScope/0"], $card_content($scope));
const $box_content = /*@__PURE__*/ _content$1("__tests__/template.marko_2*content", $template$2, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D%l"), $box_content__setup);
