...
const $card_content = /*@__PURE__*/ _content("a0", "<p> </p>", "D ", $card_content__input_title);
const $box_content__setup = ($scope) => {
	/* @__PURE__ */ $setup$1($scope.a);
	$input_content_direct$1($scope.a, $card_content($scope));
};
const $box_content = /*@__PURE__*/ _content("a1", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D%l"), $box_content__setup);
