...
var template_default = _template_persisted("a", (input) => {
		...
		if (input.summary) {
			...
			_if(() => {
				if (input.detail) {
					...
					_subscribe(_unfilled_if($scope0_reason, 3) && $input_detail__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }));
					return 0;
				}
	...
	}, $scope0_id, "b", 1, $sg__input_summary, $sg__input_summary, void 0, void 0, ["a0"], $scope0_reason, 2);
