...
const $walks = "D%b l";
const $if_content2__input_inner = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_inner", /*@__PURE__*/ _closure_get("input_inner", ($scope) => _text($scope["#text/0"], $scope._._.input_inner), ($scope) => $scope._._, "__tests__/template.marko_2_input_inner#5/subscribe"), 0);
