...
const $setup = () => {};
const $input_a = /*@__PURE__*/ _render(($scope, input_a) => _text($scope["#text/0"], input_a ? null : 1));
const $input_b = /*@__PURE__*/ _render(($scope, input_b) => _text($scope["#text/1"], input_b ? true : "x<y"));
