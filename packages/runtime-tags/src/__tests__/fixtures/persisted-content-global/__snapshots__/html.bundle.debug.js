...
var widget_default = _template_persisted("__tests__/tags/widget/index.marko", (input) => {
	...
	_html(`<section><span>${_patch_text($scope0_id, "#text/0", input.value, void 0, $scope0_reason, 0)}</span>`);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	widget_default({
		...
		content: _content_elide("__tests__/template.marko_1*content", () => {
			...
			_subscribe(_unfilled_if() && $global_brand__closures, _scope($scope1_id, {}, "__tests__/template.marko", "3:4"));
		}, $scope0_id)
	});
