...
var doubler_default = /*@__PURE__*/ _template_patch("__tests__/tags/doubler/index.marko", $template$1, "b", 0, $input);
...
const $double = _var_resume("__tests__/template.marko_0_double#5/var", ($scope, double) => _text($scope["#text/2"], double));
