...
var custom_input_default = _template("__tests__/tags/custom-input.marko", (input) => {
	...
	_html_opens("__tests__/tags/custom-input.marko:1:1"), _html(`<input${_attr_input_value($scope0_id, "#input/0", input.value, input.valueChange && _resume(($next) => {
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html_opens("__tests__/template.marko:3:1"), _html(`<span>${_escape(value)}${_el_resume($scope0_id, "#text/1")} <!>${_escape(typeof value)}${_el_resume($scope0_id, "#text/2")}</span>`);
