...
const $walks = " b";
const $setup = () => {};
const $for_content__setup = ($scope) => _attr($scope["#span/0"], "id", $scope["#LoopKey"]);
...
const $for = /*@__PURE__*/ _for_of("#div/0", "<span> </span>", " D ", $for_content__setup, $for_content__$params);
