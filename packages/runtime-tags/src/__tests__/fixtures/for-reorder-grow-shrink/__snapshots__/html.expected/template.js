...
export default _._template("__tests__/template.marko", input => {
  ...
  _._for_of(input.children, child => {
    ...
    _._html(`<span${_._attr("id", child.id)}>${_._escape(child.text)}${_._el_resume($scope1_id, "#text/1", ($sg__input_children))}</span>${_._el_resume($scope1_id, "#span/0", ($sg__input_children))}`);
