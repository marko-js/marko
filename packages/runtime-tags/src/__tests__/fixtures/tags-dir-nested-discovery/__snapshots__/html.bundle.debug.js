...
var icon_star_default = _template("__tests__/tags/icons/icon-star.marko", (input) => {
	...
	_html_opens("__tests__/tags/icons/icon-star.marko:1:1"), _html("<span class=icon-star>star</span>");
});
...
var greeting_default = _template("__tests__/tags/util/greeting.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	_html_opens("__tests__/tags/util/greeting.marko:1:1"), _html(`<p>Hello, ${_sep($sg__input_name)}${_escape(input.name)}${_el_resume($scope0_id, "#text/0", $sg__input_name)}!</p>`);
