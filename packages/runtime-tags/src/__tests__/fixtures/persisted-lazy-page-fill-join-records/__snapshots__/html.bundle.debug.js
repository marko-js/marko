...
var card_default = _template_persisted("__tests__/tags/card.marko", (input) => {
	...
	_html("</section>");
	$scope0_reason && _scope($scope0_id, {}, "__tests__/tags/card.marko", 0);
}, 0, 0);
	...
	_for_of([1, 2], (item) => {
		...
		card_default({
			...
			content: _content_elide("__tests__/page-b.marko_2*content", () => {
				...
				const $scope2_id = _scope_id();
				_html(`<span>${_patch_text($scope2_id, "#text/0", p, void 0, $scope0_owned, 0)}/${_text_resume($scope2_id, "#text/1", count, 2)}/${_patch_text($scope2_id, "#text/2", item, 2)}</span>`);
				_subscribe(_unfilled_if($scope0_owned, 0) && $p__closures, _subscribe($count__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/page-b.marko", "5:4")));
			}, $scope1_id)
		});
		_scope($scope1_id, {
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
		...
		if (input.page === 0) {
			...
			$Layout_withLoadAssets({
				...
				content: _content_elide("__tests__/template.marko_2*content", () => {
					...
					}, $scope2_id, "#text/0", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["__tests__/template.marko_3*shell", "__tests__/template.marko_4*shell"], $scope0_owned, 4);
					$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 4) && $input_page__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "11:8"));
	...
	}, $scope0_id, "#body/0", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["__tests__/template.marko_5*shell", "__tests__/template.marko_1*shell"], $scope0_owned, 4);
