# Write
```html
  <body><!--M_[3--><h1>Hello <!>World<!--M_*3 #text/0--></h1><!--M_]2 #text/0--><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.c=[0,_.a={name:"World","ClosureScopes:name":_.d=new Set},{"ConditionalScope:#text/0":_.b={_:_.a,"ClosureSignalIndex:name":0},"ConditionalRenderer:#text/0":"__tests__/template.marko_1_renderer"},_.b],(_.d).add(_.b),_.c)];M._.w()</script></body>
```
