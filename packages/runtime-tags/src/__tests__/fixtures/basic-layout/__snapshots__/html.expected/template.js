...
export default _._template("__tests__/template.marko", input => {
  ...
  _layout({
    content: _._content("__tests__/template.marko_1_content", () => {
      ...
      _._serialize_guard($scope0_reason, /* input.name */0) && _._subscribe($name__closures, _._scope($scope1_id, {
  ...
  _._serialize_guard($scope0_reason, /* input.name */0) && _._scope($scope0_id, {
