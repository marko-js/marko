...
const _name$layout_content = _$.registerDynamicClosure("__tests__/template.marko_1_name/subscriber", "name/3", (_scope, name) => _$.data(_scope["#text/0"], name));
...
export const _name_ = /* @__PURE__ */_$.value("name/3", (_scope, name) => _name$layout_content(_scope));
export const _input_ = /* @__PURE__ */_$.value("input/2", (_scope, input) => _name_(_scope, input.name));
