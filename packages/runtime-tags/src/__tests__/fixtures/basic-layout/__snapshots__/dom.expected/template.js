...
const $layout_content__input_name = /* @__PURE__ */_._closure_get("name", $scope => _._text($scope["#text/0"], $scope._.name));
...
const $name__closure = /* @__PURE__ */_._closure($layout_content__input_name);
