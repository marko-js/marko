...
const $for_content3__for = /* @__PURE__ */_._for_to("#ul/0", "<li></li>", /* get, over(1) */" b", $for_content4__setup, $for_content4__$params);
...
const $for3 = /* @__PURE__ */_._for_to("#text/2", "<ul></ul>", /* get, over(1) */" b", $for_content3__setup, $for_content3__$params);
