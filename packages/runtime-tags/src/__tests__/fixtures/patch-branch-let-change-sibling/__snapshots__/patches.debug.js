// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-sibling/template.marko_1*shell packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-sibling/template.marko_1_store_set#11/init!packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-sibling/template.marko_1;Db%l ;<span>Seen <!></span><button>+</button>`, {
  "PatchText:#text/2": "b",
  "PatchBranch:#text/4": [{
    "PatchSetup:": {
