...
_shells({
	...
	"__tests__/tags/host/index.marko_1*shell": /*@__PURE__*/ ((_w0, _w1) => `__tests__/tags/host/index.marko_1*shell;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `b%b/${_w0}&b`)("D l"), /*@__PURE__*/ ((_w0) => `<!><!>${_w0}<!>`)($template$2))
});
