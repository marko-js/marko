...
const _count$myTag_content = _$.registerDynamicClosure("__tests__/template.marko_1_count/subscriber", "count/3", (_scope, count) => {
...
const _count = _$.registerBoundSignal("__tests__/template.marko_0_count/var", /* @__PURE__ */_$.value("count/3", (_scope, count) => _count$myTag_content(_scope)));
