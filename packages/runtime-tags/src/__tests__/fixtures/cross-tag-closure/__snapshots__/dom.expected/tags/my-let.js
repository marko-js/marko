...
export const _input_value_ = /* @__PURE__ */_$.value("input_value/2", (_scope, input_value) => _value(_scope, input_value));
export const _input_ = /* @__PURE__ */_$.value("input/1", (_scope, input) => _input_value_(_scope, input.value));
