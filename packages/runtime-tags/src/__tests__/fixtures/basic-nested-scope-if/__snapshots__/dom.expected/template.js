...
const $else_content = /* @__PURE__ */_$.createRenderer("<span>The button was clicked <!> times.</span>", /* next(1), over(1), replace, out(1) */"Db%l", $setup$else$content);
...
const $if_content = /* @__PURE__ */_$.createRenderer("<button> </button>", /* get, next(1), get, out(1) */" D l", $setup$if$content);
