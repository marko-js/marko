// template.marko
const $else_content__clickCount = /*@__PURE__*/ _if_closure(0, 1, /*@__PURE__*/ _render(($scope) => _text($scope.a, $scope._.b)));
const $else_content__setup = $else_content__clickCount;
const $if_content__clickCount = /*@__PURE__*/ _if_closure(0, 0, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope._.b)));
