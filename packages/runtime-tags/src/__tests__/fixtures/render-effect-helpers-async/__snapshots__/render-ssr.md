...
REMOVE: .sM_1::text(".sM_1~*{--M_t9HJvrK:green;}")
INSERT: .sM_1::text(".sM_1~*{--M_t9HJvrK:purple;}")
...
REMOVE: .sM_1::text(".sM_1~*{--M_t9HJvrK:purple;}")
INSERT: .sM_1::text(".sM_1~*{--M_t9HJvrK:green;}")
