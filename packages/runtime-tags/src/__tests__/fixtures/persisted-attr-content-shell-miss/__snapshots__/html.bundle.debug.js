...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_if(() => input.show ? 0 : undefined, $scope0_id, "#text/2", $sg__input_show, $sg__input_show, $sg__input_show, void 0, void 0, "__tests__/template.marko_0/update_if_#text/2", [() => {
		...
		_html(`</div>${_el_resume($scope2_id, "#div/2")}`);
		_script($scope2_id, "__tests__/template.marko_2");
		writeScope($scope2_id, { n: _seed_fill(_state_reason() && n) }, "__tests__/template.marko", "8:2", { n: "9:8" });
	}], ["__tests__/template.marko_2_update"], "__tests__/template.marko_r0");
	_script($scope0_id, "__tests__/template.marko_0");
	writeScope($scope0_id, {
		Panel: (_serialize_if($scope0_reason, 0) || _patch_reason()) && Panel,
...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<button class=tap>tap <!></button><div class=host></div>", " Db%l b"],
	"__tests__/template.marko_2_content": ["<button class=tap>tap <!></button><div class=host></div>", " Db%l b"],
