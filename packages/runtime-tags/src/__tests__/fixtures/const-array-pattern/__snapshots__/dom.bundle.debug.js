...
const $others = /*@__PURE__*/ _render(($scope, others) => _text($scope["#text/4"], others.join(",")));
const $first = /*@__PURE__*/ _render(($scope, first) => _text($scope["#text/2"], first));
const $second3 = /*@__PURE__*/ _render(($scope, second) => _text($scope["#text/3"], second));
const $second2 = ($scope, $second) => $second3($scope, void 0 !== $second ? $second : "dflt");
const $input_list = $pattern2;
const $n = /*@__PURE__*/ _let("n/13", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.n)));
