...
const $walks = "D%b l";
const $await_content2__outer = /*@__PURE__*/ _closure_get("outer", ($scope) => _text($scope["#text/0"], $scope._.outer), 0, "__tests__/template.marko_3_outer#2/subscribe");
...
const $await_content__input_inner = /*@__PURE__*/ _closure_get("input_inner", ($scope) => $await_content__await_promise($scope, $scope._._.input_inner), ($scope) => $scope._._, "__tests__/template.marko_2_input_inner#6/subscribe");
