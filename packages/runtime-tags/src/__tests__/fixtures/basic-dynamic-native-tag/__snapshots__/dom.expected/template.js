...
export const _tagName = /* @__PURE__ */_$.value("tagName", (_scope, tagName) => _dynamicTag(_scope, tagName, () => ({
  class: ["a", "b"]
})));
export const _input = /* @__PURE__ */_$.value("input", (_scope, input) => _tagName(_scope, input.tagName));
