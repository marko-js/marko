...
const _dynamicTag = /* @__PURE__ */_$.dynamicTag("#text/0", _scope => _tagName_input(_scope, () => ({
  class: ["a", "b"]
})), () => _tagName_input);
export const _tagName_ = /* @__PURE__ */_$.value("tagName", (_scope, tagName) => _dynamicTag(_scope, tagName || _tagName_content(_scope)), () => _dynamicTag);
