export const $template = /*@__PURE__*/((_w0, _w1, _w2) => `<div id=value-missing>${_w0}</div><div id=value-undefined>${_w1}</div><div id=value-set>${_w2}</div><div id=dynamic><!></div>`)(_wrap_template, _wrap_template, _wrap_template);
export const $walks =
/*@__PURE__*/
