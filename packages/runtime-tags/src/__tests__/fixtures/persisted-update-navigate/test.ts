...
// fixture's generated persisted entry; in csr mode it is a plain input
...
// that client state (`expanded`) survived the hostile `expanded: false`
// default riding in the payload.
