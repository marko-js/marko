...
const $expanded = _var_resume("a5", /*@__PURE__*/ _let_persisted(15, ($scope) => {
...
const $input_product_featured = _var_resume("a6", /*@__PURE__*/ _const_persisted(11, $input_product_featured__OR__expanded));
_static_shells({
	"a1": [$template, $walks],
	"a": [$template, $walks]
});
const $expanded_seed = _update_signal("a5");
const $input_product_featured_update = _update_signal("a6");
