...
var my_textarea_default = _template("__tests__/tags/my-textarea.marko", (input) => {
	...
	_html(`<textarea${_attrs($textarea_input, "#textarea/0", $scope0_id, "textarea")}>${_attrs_textarea_value($scope0_id, "#textarea/0", $textarea_input)}</textarea>${_el_resume($scope0_id, "#textarea/0")}`);
