...
var my_textarea_default = _template("__tests__/tags/my-textarea.marko", (input) => {
	...
	_html_opens("__tests__/tags/my-textarea.marko:1:1"), _html(`<textarea${_attrs($textarea_input, "#textarea/0", $scope0_id, "textarea")}>${_attr_textarea_value($scope0_id, "#textarea/0", $textarea_input.value, $textarea_input.valueChange, 1)}</textarea>${_el_resume($scope0_id, "#textarea/0")}`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html_opens("__tests__/template.marko:3:1"), _html(`<span>${_escape(value)}${_el_resume($scope0_id, "#text/1")}</span>`);
