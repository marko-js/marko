...
// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-cross/template.marko_1*shell !packages/runtime-tags/src/__tests__/fixtures/patch-branch-let-change-cross/template.marko_1;Db%l ;<span>Seen <!></span><button>+</button>`, {
  "PatchText:#text/0": "Store!",
  "PatchBranch:#text/2": [{
    "PatchSetup:": {
