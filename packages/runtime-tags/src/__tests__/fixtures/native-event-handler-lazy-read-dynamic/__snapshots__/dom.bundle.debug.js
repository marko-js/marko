...
const $enabled__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/3"], $scope.enabled));
...
const $other = /*@__PURE__*/ _let("other/7", /*@__PURE__*/ _render(($scope) => _text($scope["#text/4"], $scope.other)));
const $log = /*@__PURE__*/ _let("log/8", /*@__PURE__*/ _render(($scope) => _text($scope["#text/5"], $scope.log)));
