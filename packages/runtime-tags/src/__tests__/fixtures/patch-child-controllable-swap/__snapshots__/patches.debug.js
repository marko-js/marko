...
// PATCH
[`packages/runtime-tags/src/__tests__/fixtures/patch-child-controllable-swap/tags/counter/index.marko_1*shell !packages/runtime-tags/src/__tests__/fixtures/patch-child-controllable-swap/tags/counter/index.marko_1;Db%l ;<span>Seen <!></span><button>+</button>`, (_.a = {
  "PatchText:#text/0": "Store!",
  "PatchChild:#childScope/2": {
    "PatchBranch:#text/0": [{
      "PatchSetup:": {
