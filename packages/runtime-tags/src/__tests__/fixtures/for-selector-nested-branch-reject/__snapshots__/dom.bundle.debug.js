...
const $template = "<!><!><!>";
const $walks = "b%c";
const $for_content__selected = /*@__PURE__*/ _closure_get("selected/6", ($scope) => _attr_class($scope["#li/0"], $scope._._.selected === $scope["#LoopKey"] && "danger"), ($scope) => $scope._._, "__tests__/template.marko_2_selected#4/subscribe");
