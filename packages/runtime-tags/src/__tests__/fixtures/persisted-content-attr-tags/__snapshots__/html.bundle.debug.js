...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", $tag, {}, 0, 0, $sg__input_header, _patch_dynamic_tag($scope0_id, "#text/0", $tag, 0, 0, 0, $scope0_reason, 1));
	_html("</header><footer>");
	const $tag2 = input.footer;
	_dynamic_tag($scope0_id, "#text/1", $tag2, {}, 0, 0, $sg__input_footer, _patch_dynamic_tag($scope0_id, "#text/1", $tag2, 0, 0, 0, $scope0_reason, 2));
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	card_default({
		header: attrTag({ content: _content_elide("__tests__/template.marko_1*content", () => {
			...
			_html(`<b>${_patch_text($scope1_id, "#text/0", input.h, void 0, $scope0_reason, 0)}</b>`);
			_subscribe(_unfilled_if($scope0_reason, 0) && $input_h__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "3:6"));
		}, $scope0_id) }),
