...
const $placeholder_content2 = _content("__tests__/template.marko_4*content", "inner");
const $placeholder_content = _content("__tests__/template.marko_3*content", "outer");
