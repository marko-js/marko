...
const $frame_content__input_label__OR__count = /*@__PURE__*/ _fill_join_scope("__tests__/template.marko0", "input_label", /*@__PURE__*/ _or(1, ($scope) => _text($scope["#text/0"], $scope._.input_label + ":" + $scope._.count)), () => $frame_content__input_label, 0);
