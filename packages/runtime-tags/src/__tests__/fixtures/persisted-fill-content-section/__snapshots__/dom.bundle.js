// template.marko
const $frame_content__input_label__OR__count = /*@__PURE__*/ _fill_join_scope("a0", 4, /*@__PURE__*/ _or(1, ($scope) => _text($scope.a, $scope._.e + ":" + $scope._.f)), () => $frame_content__input_label, 0);
