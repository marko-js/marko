...
# Write
```html
  <!--M_[4-->f<!--M_]1 #text/1-->g<script>M._.r.push(_=>(_.d=[1,_.e={}],(_.a["ConditionalScope:#text/1"]=_.e),_.d))</script>
```
...
<html>
  ...
  <body>
    ...
    g
    <script>
      M._.r.push(_=&gt;(_.d=[1,_.e={}],(_.a["ConditionalScope:#text/1"]=_.e),_.d))
    </script>
    <script>
