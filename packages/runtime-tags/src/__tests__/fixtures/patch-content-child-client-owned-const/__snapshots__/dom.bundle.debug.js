...
const $if_content__input_content = /*@__PURE__*/ _fill_join("__tests__/tags/card/index.marko0", "input_content", /*@__PURE__*/ _if_closure("#text/1", 0, ($scope) => $if_content__dynamicTag($scope, $scope._.input_content)));
...
const $card_content__input_note = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_note", /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._.input_note), 0, "__tests__/template.marko_1_input_note#3/subscribe"), 0);
...
function $setup($scope) {
	...
	$input_title($scope["#childScope/0"]);
}
