...
const $try_content__input_fail = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_fail", /*@__PURE__*/ _closure_get("input_fail", $try_content__input_fail__OR__input_x, ($scope) => $scope._._, "__tests__/template.marko_2_input_fail#3/subscribe"), 0);
const $try_content__setup = ($scope) => {
	$try_content__input_fail($scope);
	$try_content__input_x($scope);
};
const $try_content__input_x = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_x", /*@__PURE__*/ _closure_get("input_x", $try_content__input_fail__OR__input_x, ($scope) => $scope._._, "__tests__/template.marko_2_input_x#4/subscribe"), 0);
