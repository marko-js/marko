...
const $try_content__input_fail = /*@__PURE__*/ _fill_join_closure("a0", 3, /*@__PURE__*/ _closure_get(5, $try_content__input_fail__OR__input_x, ($scope) => $scope._._), 0);
const $try_content__setup = ($scope) => {
	$try_content__input_fail($scope);
	$try_content__input_x($scope);
};
const $try_content__input_x = /*@__PURE__*/ _fill_join_closure("a1", 4, /*@__PURE__*/ _closure_get(6, $try_content__input_fail__OR__input_x, ($scope) => $scope._._), 0);
