...
const $catch_content = _content_resume("a0", "<b> </b>", "D ", 0, $catch_content__$params);
const $try_content__input_fail__OR__input_x = /*@__PURE__*/ _or(1, ($scope) => _text($scope.a, check($scope._._.d, $scope._._.e)));
const $try_content__input_fail = /*@__PURE__*/ _fill_join_closure("a0", 3, /*@__PURE__*/ _closure_get(5, $try_content__input_fail__OR__input_x, ($scope) => $scope._._, "a7", 3), 0);
const $try_content__setup = ($scope) => {
	$try_content__input_fail($scope);
	$try_content__input_x($scope);
};
const $try_content__input_x = /*@__PURE__*/ _fill_join_closure("a1", 4, /*@__PURE__*/ _closure_get(6, $try_content__input_fail__OR__input_x, ($scope) => $scope._._, "a8", 4), 0);
...
const $wrap_content = _content_resume("a2", "<!><!><!>", "b%", $wrap_content__setup);
