...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	wrap_default({ content: _content_resume("__tests__/template.marko_1*content", () => {
		...
		_try($scope1_id, "#text/0", _content_resume("__tests__/template.marko_2*content", () => {
			...
			_subscribe(_source_if($scope0_reason, 2) && $input_x__closures, _subscribe(_source_if($scope0_reason, 1) && $input_fail__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "6:4")));
