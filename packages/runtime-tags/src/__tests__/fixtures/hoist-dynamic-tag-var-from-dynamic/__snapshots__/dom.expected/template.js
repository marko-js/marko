...
const _inputShowSectionNull_content = _$.registerContent("__tests__/template.marko_4_renderer", "<!><!><!>", /* dynamicTagWithVar */"D1D", _setup$inputShowSectionNull_content, 0, "#text/2?");
...
const _thing_content2 = _$.registerContent("__tests__/template.marko_3_renderer", "<!><!><!>", /* dynamicTagWithVar */"D1D", _setup$thing_content2, 0, "#childScope/0?");
...
const _thing_content = _$.registerContent("__tests__/template.marko_1_renderer", "<!><!><!>", /* dynamicTagWithVar */"D1D", _setup$thing_content, 0, "#childScope/0?");
