...
const $inputshowsectionnull_content = _content_resume("__tests__/template.marko_4_content", "<!>", "1", $inputshowsectionnull_content__setup, 0, "ClosureScopes:4");
...
const $thing_content2 = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<!>", "1", $thing_content2__setup, 0, "ClosureScopes:3");
const $inputshowThingnull_content__setup = ($scope) => {
	/* @__PURE__ */ $setup$1($scope["#childScope/0"]);
	$input_content($scope["#childScope/0"], $thing_content2($scope));
};
const $inputshowThingnull_content = _content_resume("__tests__/template.marko_2_content", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$1), $inputshowThingnull_content__setup, 0, "ClosureScopes:2");
...
const $thing_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<!>", "1", $thing_content__setup, 0, "ClosureScopes:1");
