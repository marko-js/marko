...
const $inputshowsectionnull_content__setHtml = _var_resume("a7", /*@__PURE__*/ _const(2));
const $inputshowsectionnull_content__setup = ($scope) => $inputshowsectionnull_content__dynamicTag($scope, child_default);
const $inputshowsectionnull_content = _content_resume("a8", "<!><!><!>", "b1c", $inputshowsectionnull_content__setup, 0, "B4");
...
const $thing_content2__setHtml = _var_resume("a5", /*@__PURE__*/ _const(2));
const $thing_content2__setup = ($scope) => $thing_content2__dynamicTag($scope, child_default);
const $thing_content2 = /*@__PURE__*/ _content("a6", "<!><!><!>", "b1c", $thing_content2__setup, 0, "B3");
const $inputshowThingnull_content__setup = ($scope) => {
	/* @__PURE__ */ $setup($scope.a);
	$input_content($scope.a, $thing_content2($scope));
};
const $inputshowThingnull_content = _content_resume("a4", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($walks), $inputshowThingnull_content__setup, 0, "B2");
const $setHtml_getter = _hoist_resume("a1", 2, "B1");
const $thing_content__setHtml = _var_resume("a2", /*@__PURE__*/ _const(2));
