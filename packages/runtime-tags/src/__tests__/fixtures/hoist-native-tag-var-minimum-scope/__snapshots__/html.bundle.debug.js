...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_to(2, 0, 1, (i) => {
		...
		const $for_content__$el_getter = _hoist($scope1_id, "__tests__/template.marko_1_#div#0/hoist");
		_for_to(2, 0, 1, (j) => {
			const $scope2_id = _scope_id();
			const $for_content2__$el_getter = _hoist($scope2_id, "__tests__/template.marko_2_#div#0/hoist");
