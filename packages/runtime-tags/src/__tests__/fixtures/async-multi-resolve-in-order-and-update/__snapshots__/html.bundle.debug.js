...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let n = 2;
	_html_opens("__tests__/template.marko:5:1", "__tests__/template.marko:6:1"), _html(`<button>increment</button>${_el_resume($scope0_id, "#button/0")}<p>1 * <!>${_escape(n)}${_el_resume($scope0_id, "#text/1")} = `);
	...
	_html_opens("__tests__/template.marko:7:1"), _html(`</p><p>2 * <!>${_escape(n)}${_el_resume($scope0_id, "#text/3")} = `);
	...
	_html_opens("__tests__/template.marko:8:1"), _html(`</p><p>3 * <!>${_escape(n)}${_el_resume($scope0_id, "#text/5")} = `);
	...
	_html_opens("__tests__/template.marko:9:1"), _html(`</p><p>4 * <!>${_escape(n)}${_el_resume($scope0_id, "#text/7")} = `);
	...
	_html_opens("__tests__/template.marko:10:1"), _html(`</p><p>5 * <!>${_escape(n)}${_el_resume($scope0_id, "#text/9")} = `);
