...
var greetings_default = _template("__tests__/tags/greetings.marko", (input) => {
	_scope_reason();
	const $scope0_id = _scope_id();
	_html_opens("__tests__/tags/greetings.marko:3:1"), _html("<div>greetings</div>");
});
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let format = shout;
	let message = "hello";
	_html_opens("__tests__/template.marko:5:1"), _html(`<button>shout</button>${_el_resume($scope0_id, "#button/0")}`);
