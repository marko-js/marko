// template.marko
const $Foo_content__walks = "%c", $Foo_content__template = "<!> foo", $Bar_content__walks = /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Foo_content__walks), $Bar_content__template = $Foo_content__template;
...
const $Foo_content__if = /*@__PURE__*/ _if("#text/0", $Bar_content__template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Bar_content__walks), $if_content__setup);
