...
_shells({
	...
	a2: "a2;D ;<b> </b>",
	a3: "a3;b%;<!><!><!>",
	a: /*@__PURE__*/ ((_w0, _w1) => `a !a5;${_w0};${_w1}`)(((_w0) => `D%b/${_w0}& l`)(" b"), ((_w0) => `<main><!>${_w0}<button>interactive</button></main>`)($template))
});
var template_default = _template_patch("a", (input) => {
	...
	_dynamic_tag($scope0_id, "a", $tag, $input2, _content_resume("a4", () => {
		...
		$scope0_page && _subscribe(_unfilled_if($scope0_reason, 2) && $input_p__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }));
