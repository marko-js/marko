...
const $inputas_content__input_p = /*@__PURE__*/ _closure_get(8, ($scope) => $inputas_content__await_promise($scope, $scope._.g));
const $inputas_content__setup = ($scope) => {
	$inputas_content__input_p($scope);
	$await_content($scope);
};
const $dynamicTag = /*@__PURE__*/ _dynamic_tag(0, _content_resume("a4", "<!><!><!>", "b%", $inputas_content__setup));
