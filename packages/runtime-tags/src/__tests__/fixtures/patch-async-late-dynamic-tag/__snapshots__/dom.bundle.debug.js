...
const $frame_content__input_q = /*@__PURE__*/ _closure_get("input_q", ($scope) => $frame_content__await_promise($scope, $scope._.input_q));
...
const $inputas_content__input_p = /*@__PURE__*/ _closure_get("input_p", ($scope) => $inputas_content__await_promise($scope, $scope._.input_p));
const $inputas_content__setup = ($scope) => {
	$inputas_content__input_p($scope);
	$await_content($scope);
};
const $inputas_content = _content_resume("__tests__/template.marko_1*content", "<!><!><!>", "b%", $inputas_content__setup);
