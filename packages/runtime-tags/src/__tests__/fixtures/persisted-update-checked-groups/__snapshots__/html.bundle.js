...
var template_default = _template("a", (input) => {
	...
	writeScope($scope0_id, {
		...
		v: _seed_fill(_state_reason() && note),
		w: _seed_fill(_state_reason() && count)
	});
	_resume_branch($scope0_id);
}, 1);
_renderer_shells({
	"a2": ["<button class=count>clicked <!></button><fieldset class=plan><input value=basic type=radio name=plan class=plan-basic><input value=pro type=radio name=plan class=plan-pro><input value=max type=radio name=plan class=plan-max></fieldset><fieldset class=ship><input value=ground type=radio name=ship class=ship-ground><input value=air type=radio name=ship class=ship-air></fieldset><fieldset class=extras><input value=warranty type=checkbox class=extra-warranty><input value=setup type=checkbox class=extra-setup></fieldset><input type=checkbox class=gift><input type=checkbox name=promo class=promo><output class=note> </output>", " Db%lD b b lD b lD b l b bD l"],
	"a": ["<button class=count>clicked <!></button><fieldset class=plan><input value=basic type=radio name=plan class=plan-basic><input value=pro type=radio name=plan class=plan-pro><input value=max type=radio name=plan class=plan-max></fieldset><fieldset class=ship><input value=ground type=radio name=ship class=ship-ground><input value=air type=radio name=ship class=ship-air></fieldset><fieldset class=extras><input value=warranty type=checkbox class=extra-warranty><input value=setup type=checkbox class=extra-setup></fieldset><input type=checkbox class=gift><input type=checkbox name=promo class=promo><output class=note> </output>", " Db%lD b b lD b lD b l b bD l"]
});
