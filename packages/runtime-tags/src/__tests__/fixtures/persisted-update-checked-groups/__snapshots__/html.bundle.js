...
_renderer_shells({
	"a2": ["<button class=count>clicked <!></button><fieldset class=plan><input type=radio name=plan class=plan-basic><input type=radio name=plan class=plan-pro><input type=radio name=plan class=plan-max></fieldset><fieldset class=ship><input type=radio name=ship class=ship-ground><input type=radio name=ship class=ship-air></fieldset><fieldset class=extras><input type=checkbox class=extra-warranty><input type=checkbox class=extra-setup></fieldset><input type=checkbox class=gift><input type=checkbox name=promo class=promo><output class=note> </output>", " Db%lD b b lD b lD b l b bD l"],
	"a": ["<button class=count>clicked <!></button><fieldset class=plan><input type=radio name=plan class=plan-basic><input type=radio name=plan class=plan-pro><input type=radio name=plan class=plan-max></fieldset><fieldset class=ship><input type=radio name=ship class=ship-ground><input type=radio name=ship class=ship-air></fieldset><fieldset class=extras><input type=checkbox class=extra-warranty><input type=checkbox class=extra-setup></fieldset><input type=checkbox class=gift><input type=checkbox name=promo class=promo><output class=note> </output>", " Db%lD b b lD b lD b l b bD l"]
});
