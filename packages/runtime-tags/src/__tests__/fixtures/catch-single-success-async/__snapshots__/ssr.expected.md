...
# Write
```html
  <!--M_[4-->c<!--M_]2 #text/0-->d<!--M_!b--><!--M_]1 #text/0-->f<!--M_[3-->g<!--M_]1 #text/1-->h<script>M._.r.push(_=>(_.f=[_.g={}],(_.b["ConditionalScope:#text/0"]=_.g),_.f))</script>
```
...
<html>
  ...
  <body>
    ...
    h
    <script>
      M._.r.push(_=&gt;(_.f=[_.g={}],(_.b["ConditionalScope:#text/0"]=_.g),_.f))
    </script>
  </body>
</html>
```
