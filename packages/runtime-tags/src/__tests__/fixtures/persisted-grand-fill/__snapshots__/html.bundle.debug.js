...
var badge_default = _template_persisted("__tests__/tags/card/tags/badge/index.marko", (input) => {
	...
	$scope0_reason && _scope($scope0_id, {}, "__tests__/tags/card/tags/badge/index.marko", 0);
}, 0, 0);
...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	const $scope0_owned = _persisted_ownership(), $scope0_reason = _persisted_reason();
	const $scope0_id = _scope_id();
	_html(`<h3>${_patch_text($scope0_id, "#text/0", input.title, void 0, $scope0_owned, 0)}</h3>`);
	...
	$scope0_reason && _scope($scope0_id, { "#childScope/1": _existing_scope($childScope) }, "__tests__/tags/card/index.marko", 0);
}, 0, () => [badge_default]);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_subtitle: ["input.subtitle"],
		show: "1:6"
	}) : (_filled_guard($scope0_owned, 1) && _patch_value($scope0_id, "__tests__/template.marko0", input.title), _filled_guard($scope0_owned, 2) && _patch_value($scope0_id, "__tests__/template.marko1", input.subtitle));
}, 1, () => [card_default]);
