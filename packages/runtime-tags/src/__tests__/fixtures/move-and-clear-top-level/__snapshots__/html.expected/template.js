...
export default _._template("__tests__/template.marko", input => {
  ...
  _._for_of(input.children, child => {
    ...
    _._html(`${_._escape(child.text)}${_._el_resume($scope1_id, "#text/0", ($sg__input_children))}`);
    ($si__input_children) && _._scope($scope1_id, {}, "__tests__/template.marko", "1:2");
  }, function (c) {
    return c.id;
  }, $scope0_id, "#text/0", $sg__input_children, $sg__input_children, ($sg__input_children), 0, 1);
