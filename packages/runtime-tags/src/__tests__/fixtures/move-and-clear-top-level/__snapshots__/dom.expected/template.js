...
export const _input_children_ = /* @__PURE__ */_$.value("input_children/3", (_scope, input_children) => _for(_scope, [input_children, function (c) {
  return c.id;
}]));
export const _input_ = /* @__PURE__ */_$.value("input/2", (_scope, input) => _input_children_(_scope, input.children));
