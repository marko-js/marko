...
const $get__script = _script("__tests__/template.marko_0_get#3", ($scope) => _el_read($scope["#div/2"]).textContent = $scope.get());
const $get = _var_resume("__tests__/template.marko_0_get#3/var", /*@__PURE__*/ _const("get", $get__script));
