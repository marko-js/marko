...
const $walks = " b%/&c";
const $load_Child_trigger = /* @__PURE__ */ _load_race_trigger(/* @__PURE__ */ _load_visible_trigger(":is(body)"), /* @__PURE__ */ _load_event_trigger("mouseover", ":is(body)"));
let $load_Child_tag_input_value = /* @__PURE__ */ _load_signal($load_Child_trigger(() => import("./v:child.marko.input_value.mjs")));
let $load_Child_setup = /* @__PURE__ */ _load_setup("#text/1", "#childScope/2", $load_Child_trigger(() => import("./v:child.marko.setup.mjs")));
