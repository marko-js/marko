...
// template.marko
const $body_content__input_title = /*@__PURE__*/ _fill_join_closure("a0", 4, /*@__PURE__*/ _closure_get(6, ($scope) => _text($scope.a, $scope._.e)), 0);
const $body_content = _content_resume("a0", "<em> </em>", "D ", $body_content__input_title);
