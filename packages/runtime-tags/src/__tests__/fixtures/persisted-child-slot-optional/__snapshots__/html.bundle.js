...
var card_default = _template_persisted("b", (input) => {
	...
	_dynamic_tag($scope0_id, "b", input.content, {}, 0, 0, _source_guard($scope0_reason, 1), "b0");
	_html("</div>");
	$scope0_reason ? writeScope($scope0_id, {}) : _owned_guard($scope0_owned, 1) && _patch_value($scope0_id, "b0", input.content);
}, 0, 0);
