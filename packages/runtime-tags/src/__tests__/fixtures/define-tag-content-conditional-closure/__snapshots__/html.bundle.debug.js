...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	Box.content({ content: _content_resume("__tests__/template.marko_1*content", () => {
		...
		_subscribe($si__input_label && $input_label__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "9:2"), "__tests__/template.marko_1_input_label#3/subscribe", $sg__input_label);
