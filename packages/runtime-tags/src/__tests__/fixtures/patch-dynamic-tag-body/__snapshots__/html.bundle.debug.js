...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", $tag, $input2, _content_resume("__tests__/template.marko_2*content", () => {
		const $scope2_id = _scope_id();
		const $scope2_reason = _scope_reason();
		_html("hi");
	}, $scope0_id), 0, $sg__input_tag__OR__input_cls, _patch_dynamic_tag($scope0_id, "#text/0", $tag, $input2, "__tests__/template.marko_2*content", 0, $scope0_reason, 0));
