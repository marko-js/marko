...
var template_default = _template_patch("a", (input) => {
	...
	_dynamic_tag($scope0_id, "a", $tag, $input2, _content_resume("a1", () => {
		...
		_scope_reason();
		_html("hi");
	}, $scope0_id), 0, $sg__input_tag__OR__input_cls, _patch_dynamic_tag($scope0_id, "a", $tag, $input2, "a1", 0, $scope0_reason, 0));
	...
	}, $scope0_id), 0, $sg__input_wrap, _patch_dynamic_tag($scope0_id, "b", $tag2, 0, "a0", 0, $scope0_reason, 5));
	$scope0_page && _scope($scope0_id, {
