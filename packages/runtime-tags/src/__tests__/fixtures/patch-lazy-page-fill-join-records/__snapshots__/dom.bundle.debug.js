...
const $walks = "b%b D l";
const $card_content__count = /*@__PURE__*/ _init_closure_get("__tests__/page-b.marko_2_count#6/init", "count", ($scope) => _text($scope["#text/1"], $scope._._.count), ($scope) => $scope._._, "__tests__/page-b.marko_2_count#6/subscribe");
const $card_content__setup = ($scope) => {
	$card_content__count($scope);
	$card_content__p($scope);
	$card_content__item($scope);
};
const $card_content__p = /*@__PURE__*/ _closure_get("p", ($scope) => _text($scope["#text/0"], $scope._._.p), ($scope) => $scope._._, "__tests__/page-b.marko_2_p#7/subscribe");
...
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/0", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$1), $for_content__setup, $for_content__$params);
...
const $else_content2__input_note = /*@__PURE__*/ _closure_get("input_note", 0, ($scope) => $scope._._._, "__tests__/template.marko_4_input_note#6/subscribe");
const $else_content2__setup = $else_content2__input_note;
const $if_content__input_wide = /*@__PURE__*/ _closure_get("input_wide", 0, ($scope) => $scope._._._, "__tests__/template.marko_3_input_wide#5/subscribe");
const $if_content__setup = ($scope) => {
	$if_content__input_wide($scope);
	$if_content__input_note($scope);
};
const $if_content__input_note = /*@__PURE__*/ _closure_get("input_note", 0, ($scope) => $scope._._._, "__tests__/template.marko_3_input_note#6/subscribe");
