...
var template_default = _template("a", (input) => {
	...
	const Outer = { content: _content("a5", (outer) => {
		...
		Inner.content({ content: _content_resume("a4", () => {
			...
			_subscribe($si__outer_content && $Outer_content2__outer_content__closures, _subscribe($si__outer_label && $Outer_content2__outer_label__closures, _scope($scope5_id, { _: _scope_with_id($scope3_id) }), "a2", $sg__outer_label || $sg__outer_content), "a3", $sg__outer_label || $sg__outer_content);
