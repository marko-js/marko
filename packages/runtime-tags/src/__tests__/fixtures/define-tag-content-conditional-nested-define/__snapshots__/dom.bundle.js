// template.marko
const $Inner_content2__outer_label = /*@__PURE__*/ _closure_get(5, ($scope) => _text($scope.a, $scope._.d), 0, "a2");
...
const $Inner_content2__outer_content = /*@__PURE__*/ _closure_get(6, ($scope) => $Inner_content2__dynamicTag($scope, $scope._.e), 0, "a3");
...
const $Outer_content__input_label = /*@__PURE__*/ _closure_get(4, ($scope) => _text($scope.a, $scope._.d), 0, "a6");
