...
const $try_content__input_fast = /*@__PURE__*/ _closure_get("input_fast", ($scope) => $try_content__await_promise($scope, $scope._.input_fast));
...
const $try_content__input_slow = /*@__PURE__*/ _closure_get("input_slow", ($scope) => $try_content__await_promise2($scope, $scope._.input_slow));
