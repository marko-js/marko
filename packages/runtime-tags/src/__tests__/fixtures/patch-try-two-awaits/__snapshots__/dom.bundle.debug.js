...
const $try_content__input_fast = /*@__PURE__*/ _closure_get("input_fast", ($scope) => $try_content__await_promise($scope, $scope._.input_fast), 0, "__tests__/template.marko_1_input_fast#4/subscribe");
...
const $try_content__input_slow = /*@__PURE__*/ _closure_get("input_slow", ($scope) => $try_content__await_promise2($scope, $scope._.input_slow), 0, "__tests__/template.marko_1_input_slow#5/subscribe");
...
const $input_fast__closure = /*@__PURE__*/ _closure($try_content__input_fast);
