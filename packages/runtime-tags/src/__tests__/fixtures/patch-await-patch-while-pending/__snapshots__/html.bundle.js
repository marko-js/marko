...
var template_default = _template_patch("a", (input) => {
	...
	_try($scope0_id, "c", _content_resume("a3", () => {
		...
		$scope0_page && _subscribe(_unfilled_if($scope0_reason, 1) && $input_promise__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }), _client_guard($scope0_reason, 1) && "a5", 0);
