...
const $Wrapper_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "badge");
...
const $walks = " Db%l%bD l";
const Wrapper = "em";
const $Wrapper_content = _content_resume("__tests__/template.marko_1_content", "badge");
