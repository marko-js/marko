...
const $await_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => _text($scope["#text/0"], $scope._._._._.input_value), ($scope) => $scope._._._._, "__tests__/template.marko_4_input_value#4/pending");
...
const $try_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => $try_content__await_promise($scope, Promise.resolve($scope._._._.input_value)), ($scope) => $scope._._._);
