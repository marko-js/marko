...
const $if_content__checkedValue__OR__$checkedValueChange = /* @__PURE__ */_._or(1, $scope => _._attr_input_checkedValue($scope, "#input/0", $scope._.checkedValue, $scope._.$checkedValueChange, "b"));
const $if_content__checkedValue = /* @__PURE__ */_._if_closure("#text/1", 0, $if_content__checkedValue__OR__$checkedValueChange);
...
const $if_content__$checkedValueChange = /* @__PURE__ */_._if_closure("#text/1", 0, $if_content__checkedValue__OR__$checkedValueChange);
...
const $checkedValue__OR__$checkedValueChange = /* @__PURE__ */_._or(8, $scope => {
