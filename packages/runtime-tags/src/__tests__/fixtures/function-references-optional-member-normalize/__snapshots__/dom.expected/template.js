...
const $a2__script = _._script("__tests__/template.marko_0_a", ($scope, {
  a
}) => (_._el_read($scope["#div/0"]).textContent = a.bar() || "missing a"));
const $a2 = /* @__PURE__ */_._const("a", $a2__script);
const $b2__script = _._script("__tests__/template.marko_0_b", ($scope, {
  b
}) => (_._el_read($scope["#div/1"]).textContent = b.baz() || "missing b"));
...
const $c2__script = _._script("__tests__/template.marko_0_c", ($scope, {
  c
}) => (_._el_read($scope["#div/2"]).textContent = c.baz() || "missing c"));
const $c2 = /* @__PURE__ */_._const("c", $c2__script);
const $foo_bar = /* @__PURE__ */_._const("foo_bar", ($scope, foo_bar) => $c2($scope, {
  foo: foo_bar,
  baz: $c($scope)
}));
