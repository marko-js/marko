...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	_html(`<h3>${_patch_text($scope0_id, "#text/0", input.title, $scope0_owned, 0)}${_el_resume($scope0_id, "#text/0")}</h3><p>${_patch_text($scope0_id, "#text/1", input.body, $scope0_owned, 1)}${_el_resume($scope0_id, "#text/1")}</p>`);
