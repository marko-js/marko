...
var custom_tag_default = _template("__tests__/tags/custom-tag.marko", (input) => {
	...
	_html_opens("__tests__/tags/custom-tag.marko:1:1"), _html(`<div>${_escape(input)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 0))}</div>`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/2", tags[0], [x], 0, 1, void 0, "__tests__/template.marko:5:1");
