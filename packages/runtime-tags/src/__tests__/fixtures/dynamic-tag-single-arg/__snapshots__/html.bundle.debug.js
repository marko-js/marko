...
var custom_tag_default = _template("__tests__/tags/custom-tag.marko", (input) => {
	...
	_html(`<div>${_escape(input)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 0))}</div>`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	writeScope($scope0_id, { x: x === 1 ? void 0 : x }, "__tests__/template.marko", 0, { x: "3:6" });
