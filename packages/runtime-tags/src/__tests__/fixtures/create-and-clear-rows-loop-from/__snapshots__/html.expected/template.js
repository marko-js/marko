...
export default _._template("__tests__/template.marko", input => {
  ...
  _._for_to(input.to, input.from, input.step, n => {
    ...
    _._serialize_guard($scope0_reason, /* input.from, input.to, input.step */3) && _._scope($scope1_id, {}, "__tests__/template.marko", "2:4");
  ...
  _._serialize_guard($scope0_reason, /* input.from, input.to, input.step */3) && _._scope($scope0_id, {
