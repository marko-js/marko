...
export default _._template("__tests__/template.marko", input => {
  ...
  }, 0, $scope0_id, "#div/0", _._serialize_guard($serialize, /* input.from, input.to, input.step */3), _._serialize_guard($serialize, /* input.from, input.to, input.step */3), _._serialize_guard($serialize, /* input.from, input.to, input.step */3), "</div>");
