# Write
```html
  <div><!--M_[2-->0<!--M_*2 #text/0-->, <!--M_[3 -->1<!--M_*3 #text/0-->, <!--M_[4 -->2<!--M_*4 #text/0-->, <!--M_[5 -->3<!--M_*5 #text/0-->, <!--M_]1 #div/0--></div><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.f=[0,{input_to:3,"LoopScopeMap:#div/0":new Map(_.a=[[0,_.b={}],[1,_.c={}],[2,_.d={}],[3,_.e={}]])},_.b,_.c,_.d,_.e])]</script>
```
