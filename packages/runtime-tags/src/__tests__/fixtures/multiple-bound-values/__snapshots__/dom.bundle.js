...
const $count$1 = /*@__PURE__*/ _let_change(12, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope.m)));
...
const $count2$1 = /*@__PURE__*/ _let_change(14, /*@__PURE__*/ _render(($scope) => _text($scope.d, $scope.o)));
...
const $count2__render = /*@__PURE__*/ _render(($scope) => _text($scope.c, $scope.e));
