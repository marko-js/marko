// heading.marko
var heading_default = _template("a", (input) => {
	...
	_dynamic_tag($scope0_id, "a", input.type, {}, _content_resume("a0", () => {
		const $scope1_id = _scope_id();
		_scope_reason();
		_dynamic_tag($scope1_id, "a", input.content, {}, 0, 0, $sg__input_content);
		$si__input_type__OR__input_content && _subscribe($si__input_content && $input_content__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }), "a1", $sg__input_content);
...
// template.marko
const $Heading_withLoadAssets = withLoadAssets(heading_default, "_a");
