...
var card_default = /*@__PURE__*/ _template("__tests__/tags/card/index.marko", $template$2, "D%l", 0, $input$2);
...
const $walks = "D%b l";
const $card_content__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], "t:" + $scope._._._.input_title), ($scope) => $scope._._._, "__tests__/template.marko_3_input_title#4/subscribe"), 0);
...
const $box_content__setup = ($scope) => $input_content_direct$1($scope["#childScope/0"], $card_content($scope));
