...
var tabs_default = /*@__PURE__*/ _template_patch("__tests__/tags/tabs/index.marko", $template$1, "b%c", 0, $input);

// template.marko
const $template = "<main><!><button class=flip>f</button><button class=toggle>t</button></main>";
const $walks = "D%b b l";
const $if_content__on = /*@__PURE__*/ _if_closure("#text/0", 0, ($scope) => $input_tab($scope["#childScope/0"], attrTag({ on: $scope._.on })));
const $if_content__setup = $if_content__on;
...
const $on = /*@__PURE__*/ _let("on/4", $if_content__on);
