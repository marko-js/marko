...
const $for_content__count = /*@__PURE__*/ _closure_get("count", $for_content__count__OR__i, ($scope) => $scope._._._);
...
const $tag_content__show = /*@__PURE__*/ _closure_get("show", ($scope) => $tag_content__if($scope, $scope._.show ? 0 : 1));
