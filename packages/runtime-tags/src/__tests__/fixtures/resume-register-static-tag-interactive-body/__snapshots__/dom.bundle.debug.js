...
const $for_content__count = /*@__PURE__*/ _closure_get("count/4", $for_content__count__OR__i, ($scope) => $scope._._._, "__tests__/template.marko_3_count#2/subscribe");
...
const $tag_content__count = /*@__PURE__*/ _closure_get("count/4", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_1_count#2/subscribe");
...
const $tag_content__show = /*@__PURE__*/ _closure_get("show/5", ($scope) => $tag_content__if($scope, $scope._.show ? 0 : 1), 0, "__tests__/template.marko_1_show#3/subscribe");
