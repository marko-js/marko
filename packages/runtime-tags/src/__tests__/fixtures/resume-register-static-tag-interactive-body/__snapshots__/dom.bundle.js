...
const $for_content__count = /*@__PURE__*/ _closure_get(4, $for_content__count__OR__i, ($scope) => $scope._._._);
...
const $tag_content__show = /*@__PURE__*/ _closure_get(5, ($scope) => $tag_content__if($scope, $scope._.d ? 0 : 1));
