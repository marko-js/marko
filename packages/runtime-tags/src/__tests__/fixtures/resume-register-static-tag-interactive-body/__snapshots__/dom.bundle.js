...
const $for_content__count = /*@__PURE__*/ _closure_get(4, $for_content__count__OR__i, ($scope) => $scope._._._, "a0", 2);
...
const $tag_content__count = /*@__PURE__*/ _closure_get(4, ($scope) => _text($scope.b, $scope._.c), 0, "a3", 2);
...
const $tag_content__show = /*@__PURE__*/ _closure_get(5, ($scope) => $tag_content__if($scope, $scope._.d ? 0 : 1), 0, "a4", 3);
