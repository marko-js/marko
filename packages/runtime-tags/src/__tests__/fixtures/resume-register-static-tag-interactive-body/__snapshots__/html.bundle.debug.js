...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_dynamic_tag($scope0_id, "#text/0", tag, {}, _content("__tests__/template.marko_1*content", () => {
		...
		_if(() => {
			if (show) {
				...
				forOf([1, 2], (i) => {
					...
					}, "__tests__/template.marko", "9:6", { i: "9:10" }));
				});
		...
		_subscribe($show__closures, _subscribe($count__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "6:4")));
	}, $scope0_id), 0, 0);
	_scope($scope0_id, {
		count,
		show,
