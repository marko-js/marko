...
const $wrap_content__input_note = /*@__PURE__*/ _closure_get("input_note", ($scope) => _text($scope["#text/0"], $scope._.input_note), 0, "__tests__/tags/card/index.marko_1_input_note#5/subscribe");
...
var card_default = /*@__PURE__*/ _template("__tests__/tags/card/index.marko", $template, $walks, $setup, $input);
