...
_construct("__tests__/tags/store.marko_0_update", $construct$3);
const $merge$3 = _resume("__tests__/tags/store.marko_0_update", $update2$3);
_update_content("__tests__/tags/store.marko", $merge$3, $construct$3);
...
const $Dashboard_content__if = /*@__PURE__*/ _if("#text/9", "<p class=admin>admin tools enabled</p>");
...
const $Dashboard_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", $Dashboard_content__template, $Dashboard_content__walks, $Dashboard_content__setup);
...
_static_shells({
	"__tests__/template.marko_2_update": [$Dashboard_content__template, $Dashboard_content__walks],
	"__tests__/template.marko_2_content": [$Dashboard_content__template, $Dashboard_content__walks],
...
const $Dashboard_content__session_greeting = ($scope, session_greeting) => _text($scope["#text/0"], session_greeting);
const $Dashboard_content__session_plan = ($scope, session_plan) => $input_label($scope["#childScope/6"], session_plan);
const $Dashboard_content__for = /*@__PURE__*/ _for_of("#ul/8", "<li><!>: <!></li>", " D%c%", 0, $for_content__$params);
const $Dashboard_content__if = /*@__PURE__*/ _if("#text/9", "<p class=admin>admin tools enabled</p>");
