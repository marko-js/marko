...
_update_content("d", $merge$2, $construct$1);
...
_construct("a7", $Dashboard_content__construct);
_construct("a1", $construct);
_update_content("a4", $Dashboard_content__update, $Dashboard_content__construct);
const $noop_update = () => {};
...
// template.marko
const $Dashboard_content__setup__script = _script_update("a5", ($scope) => _on($scope.e, "click", function() {
	_var_change($scope.b, $scope.n + 1);
}));
const $Dashboard_content__tally = _var_resume("a3", /*@__PURE__*/ _const_persisted(13, ($scope) => _text($scope.f, $scope.n)));
