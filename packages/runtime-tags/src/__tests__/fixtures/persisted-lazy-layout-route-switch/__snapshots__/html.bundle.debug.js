...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
		...
		if (input.page === 0) {
			...
			$Layout_withLoadAssets({
				...
				content: _content_elide("__tests__/template.marko_2*content", () => {
					...
					}, $scope2_id, "#text/0", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["__tests__/template.marko_4*shell", "__tests__/template.marko_5*shell"], $scope0_owned, 1);
					$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 1) && $input_page__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "11:8"));
	...
	}, $scope0_id, "#body/0", 1, $sg__input_page, $sg__input_page, void 0, void 0, ["__tests__/template.marko_3*shell", "__tests__/template.marko_1*shell"], $scope0_owned, 1);
