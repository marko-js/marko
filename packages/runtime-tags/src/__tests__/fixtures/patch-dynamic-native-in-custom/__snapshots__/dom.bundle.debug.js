...
const $inputonpdiv_content__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_label", /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/0"], $scope._._.input_label), ($scope) => $scope._._, "__tests__/template.marko_2_input_label#5/subscribe"), 0);
...
const $Card_content__input_on = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_on", /*@__PURE__*/ _closure_get("input_on", $Card_content__input_on__OR__count, 0, "__tests__/template.marko_1_input_on#4/subscribe"), 0);
const $Card_content__setup = ($scope) => {
	$Card_content__input_on($scope);
	$Card_content__count($scope);
};
const $Card_content__count = /*@__PURE__*/ _closure_get("count", $Card_content__input_on__OR__count, 0, "__tests__/template.marko_1_count#6/subscribe");
