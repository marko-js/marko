...
// template.marko
const $b_content = /*@__PURE__*/ _content("a2", "B");
const $a_content__count = /*@__PURE__*/ _closure_get(2, ($scope) => _text($scope.a, $scope._.b));
const $a_content = /*@__PURE__*/ _content("a1", "A <!>", "b%", $a_content__count);
