...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_html(`<html><head><meta name=hosts${_patch_attr($scope0_id, "#meta/0", "content", config.hosts)}>${_el_resume($scope0_id, "#meta/0")}${_flush_head()}</head><body><p>${_patch_text($scope0_id, "#text/1", input.msg, void 0, $scope0_reason, 0)}</p>`), _trailers("</body></html>");
