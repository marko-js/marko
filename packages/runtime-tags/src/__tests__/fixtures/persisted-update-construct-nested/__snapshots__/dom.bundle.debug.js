...
_static_shells({
	"__tests__/tags/shell.marko_0_update": [$template$1, "D%l"],
	"__tests__/tags/shell.marko": [$template$1, "D%l"]
});
...
const $PanelB_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<section class=b>Panel B: <!></section>", "Db%", $PanelB_content__setup);
...
const $Page_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", $Page_content__template, $Page_content__walks, $Page_content__setup);
const $PanelA_content__setup = ($scope) => _text($scope["#text/0"], getLabel?.($scope.$global.topic));
const $PanelA_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=a>Panel A: <!></p>", "Db%", $PanelA_content__setup);
...
_static_shells({
	"__tests__/template.marko_2_update": [$Page_content__template, $Page_content__walks],
	"__tests__/template.marko_2_content": [$Page_content__template, $Page_content__walks],
...
const $Page_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<h3 class=page-heading>Page</h3><!><!>", "b%", $Page_content__setup);
const $PanelA_content__setup = ($scope) => _text($scope["#text/0"], getLabel?.($scope.$global.topic));
const $PanelA_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=a>Panel A: <!></p>", "Db%", $PanelA_content__setup);
