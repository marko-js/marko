...
_renderer_shells({
	"__tests__/template.marko_3_update": ["<section class=b>Panel B: <!></section>", "Db%l"],
	"__tests__/template.marko_3_content": ["<section class=b>Panel B: <!></section>", "Db%l"],
	...
	"__tests__/template.marko_1_update": ["<p class=a>Panel A: <!></p>", "Db%l"],
	"__tests__/template.marko_1_content": ["<p class=a>Panel A: <!></p>", "Db%l"],
