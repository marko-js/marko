...
_renderer_shells({
	"a6": ["<section class=b>Panel B: <!></section>", "Db%l"],
	"a3": ["<section class=b>Panel B: <!></section>", "Db%l"],
	"a7": ["<h3 class=page-heading>Page</h3><!><!>", "b%c"],
	"a4": ["<h3 class=page-heading>Page</h3><!><!>", "b%c"],
	"a8": ["<p class=a>Panel A: <!></p>", "Db%l"],
	"a2": ["<p class=a>Panel A: <!></p>", "Db%l"],
