...
var child_a_default = _template("__tests__/tags/child-a/index.marko", (input) => {
	...
	_html_opens("__tests__/tags/child-a/index.marko:1:1"), _html(`<div>${_escape(input.a)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 1))} ${_sep($sg__input_b)}${_escape(input.b)}${_el_resume($scope0_id, "#text/1", $sg__input_b)} ${_sep($sg__input_c)}${_escape(input.c)}${_el_resume($scope0_id, "#text/2", $sg__input_c)}</div>`);
...
var child_c_default = _template("__tests__/tags/child-c/index.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	_html_opens("__tests__/tags/child-c/index.marko:1:1"), _html(`<div>${_escape(input.a)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 1))} ${_sep($sg__input_b)}${_escape(input.b)}${_el_resume($scope0_id, "#text/1", $sg__input_b)}</div>`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	let n = 1;
	_html_opens("__tests__/template.marko:3:1"), _html(`<button>inc <!>${_escape(n)}${_el_resume($scope0_id, "#text/1")}</button>${_el_resume($scope0_id, "#button/0")}`);
