...
const $frame_content__input_second = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_second", /*@__PURE__*/ _closure_get("input_second", $frame_content__input_second__OR__input_first__OR__showSecond, 0, "__tests__/template.marko_1_input_second#4/subscribe"), 0);
...
const $frame_content__input_first = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_first", /*@__PURE__*/ _closure_get("input_first", $frame_content__input_second__OR__input_first__OR__showSecond, 0, "__tests__/template.marko_1_input_first#5/subscribe"), 0);
const $frame_content__showSecond = /*@__PURE__*/ _closure_get("showSecond", $frame_content__input_second__OR__input_first__OR__showSecond, 0, "__tests__/template.marko_1_showSecond#6/subscribe");
