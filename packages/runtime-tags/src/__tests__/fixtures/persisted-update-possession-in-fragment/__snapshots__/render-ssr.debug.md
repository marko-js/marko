...
# Update `{"$global":{"persisted":true,"persistedFragment":true,"view":"dashboard","widget":"y","topic":"sales"}}`
```html
<button
  class="count"
>
...
# Update `{"$global":{"persisted":true,"persistedFragment":true,"view":"home","widget":"x","topic":"growth"}}`
```html
<button
  class="count"
>
