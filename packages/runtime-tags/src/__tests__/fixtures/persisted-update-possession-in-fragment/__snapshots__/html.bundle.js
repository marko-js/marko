...
var template_default = _template("a", (input) => {
	...
	const WidgetX = { content: _content("a0", () => {
	...
	const WidgetY = { content: _content("a1", () => {
	...
	const Widget = { content: _content("a3", () => {
		const $scope2_id = _scope_id();
		_scope_reason();
		_dynamic_tag($scope2_id, "a", $global().widget === "y" ? WidgetY : WidgetX, {}, 0, 0, _persisted_reason() | _persisted_reason(), "a2");
	...
	const Dashboard = { content: _content("a5", () => {
