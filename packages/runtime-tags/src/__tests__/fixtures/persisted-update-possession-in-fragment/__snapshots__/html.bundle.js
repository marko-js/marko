...
var template_default = _template("a", (input) => {
	...
	const WidgetY = { content: _content("a5", () => {
	...
	const Widget = { content: _content("a4", () => {
		...
		_scope_reason();
		_dynamic_tag($scope2_id, "a", $global().widget === "y" ? WidgetY : WidgetX, {}, 0, 0, _persisted_reason() | _persisted_reason(), "a3");
		_persisted_reason() && writeScope($scope2_id, {});
		_resume_branch($scope2_id);
	}) };
	const Home = { content: _content("a6", () => {
