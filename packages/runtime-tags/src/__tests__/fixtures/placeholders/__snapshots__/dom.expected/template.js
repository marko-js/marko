...
export const _input_x_ = /* @__PURE__ */_$.value("input_x/9", (_scope, input_x) => {
  _$.data(_scope["#text/0"], input_x);
  _$.data(_scope["#text/1"], input_x);
  _$.data(_scope["#text/2"], input_x);
  _$.html(_scope, input_x, "#text/3");
});
export const _input_ = /* @__PURE__ */_$.value("input/8", (_scope, input) => _input_x_(_scope, input.x));
export const _params__ = /* @__PURE__ */_$.value("_params_/7", (_scope, _params_) => _input_(_scope, _params_[0]));
