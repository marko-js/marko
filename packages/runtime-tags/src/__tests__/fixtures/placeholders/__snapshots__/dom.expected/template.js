export const _template = "<!><span> <div></div></span><div><div>a</div><!>Hello Text &lt;a/><!><!><script></script><style></style></div>";
export const _walks = /* replace, over(1), next(1), get, out(1), next(1), over(1), replace, over(2), replace, over(1), replace, over(1), get, over(1), get, out(1) */"%bD lDb%c%b%b b l";
import * as _$ from "@marko/runtime-tags/debug/dom";
export const _input_x = /* @__PURE__ */_$.value("input_x", (_scope, input_x) => {
