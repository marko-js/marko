...
const $walks = /*@__PURE__*/ ((_w0, _w1) => `b/${_w0}&/${_w1}&b`)($walks$1, $walks$2);
...
// tags/card.marko
const $template$3 = "<button id=t>t</button><!><!>";
const $walks$3 = " b%c";
...
var card_default = /*@__PURE__*/ _template("__tests__/tags/card.marko", $template$3, $walks$3, $setup$3, $input$1);

// tags/heading.marko
const $template$2 = "<!><!><!>";
const $walks$2 = "b%c";
const $setup$2 = () => {};
const $inputtype_content = /*@__PURE__*/ _content("__tests__/tags/heading.marko_1*content", "shared body: registered once");
...
var heading_default = /*@__PURE__*/ _template("__tests__/tags/heading.marko", $template$2, "b%c", 0, $input, $renders);
...
var a_default = /*@__PURE__*/ _template("__tests__/tags/a.marko", $template$1, $walks$1, $setup$1);
...
var b_default = /*@__PURE__*/ _template("__tests__/tags/b.marko", $template, $walks, $setup);
