...
export const $walks =
/*@__PURE__*/
/* over(1), replace, over(1), <thing>, replace, over(1), replace, over(1), replace, over(2) */
(_w0 => `b%b/${_w0}&%b%b%c`)(_thing_walks);
...
const $if_content__if = /* @__PURE__ */_._if("#text/0", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $if_content2__setup);
...
const $if2 = /* @__PURE__ */_._if("#text/2", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $if_content3__setup);
const $if3 = /* @__PURE__ */_._if("#text/3", _child_template,
/*@__PURE__*/
/* <child/var> */
(_w0 => `0${_w0}&`)(_child_walks), $if_content4__setup);
