...
const $get$hoisted_setHtml = _._hoist(2, "Ad");
_._var_resume("c1", _._const(2));
const $get$hoisted_setHtml2 = _._hoist(2, "Ac");
_._var_resume("c2", _._const(2));
const $get$hoisted_setHtml3 = _._resume("c3", _._hoist(2, "Aa", "Aa"));
