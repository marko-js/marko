...
const $walks$1 = "Db%l";
const $setup$1 = () => {};
const $input_label$1 = /*@__PURE__*/ _render(($scope, input_label) => _text($scope.a, input_label));
...
const $walks = "Db%l";
const $setup = () => {};
const $input_label = /*@__PURE__*/ _render(($scope, input_label) => _text($scope.a, input_label));
