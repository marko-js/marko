...
const $xdivspan_content = _content_resume("__tests__/template.marko_2*content", "n");
const $xdivundefined_content = _content_resume("__tests__/template.marko_1*content", "u");
