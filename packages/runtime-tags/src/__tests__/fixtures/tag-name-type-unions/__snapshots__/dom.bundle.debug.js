...
const $walks$2 = "Db%l";
const $setup$2 = () => {};
const $input_label$1 = /*@__PURE__*/ _render(($scope, input_label) => _text($scope["#text/0"], input_label));
...
const $walks$1 = "Db%l";
const $setup$1 = () => {};
const $input_label = /*@__PURE__*/ _render(($scope, input_label) => _text($scope["#text/0"], input_label));
