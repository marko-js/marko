...
const $xdivA_content = _content_resume("__tests__/template.marko_4*content", "m");
const $navigator_content = _content_resume("__tests__/template.marko_3*content", "g");
const $xdivspan_content = /*@__PURE__*/ _content("__tests__/template.marko_2*content", "n");
const $xdivundefined_content = /*@__PURE__*/ _content("__tests__/template.marko_1*content", "u");
