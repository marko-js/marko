...
const $xdivspan_content = _content_resume("__tests__/template.marko_2_content", "n");
const $xdivundefined_content = _content_resume("__tests__/template.marko_1_content", "u");
