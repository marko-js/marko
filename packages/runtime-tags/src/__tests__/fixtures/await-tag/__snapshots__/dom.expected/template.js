...
const $await_content3 = /* @__PURE__ */_$.createRenderer("Got: <!> <!>", /* over(1), replace, over(2), replace, over(1) */"b%c%b", $setup$await$content, $params4$await$content);
...
const $await_content2 = /* @__PURE__ */_$.createRenderer("Got: <!> <!>", /* over(1), replace, over(2), replace, over(1) */"b%c%b", $setup$await$content2, $params3$await$content);
...
const $await_content = /* @__PURE__ */_$.createRenderer("Got: <!> <!>", /* over(1), replace, over(2), replace, over(1) */"b%c%b", $setup$await$content3, $params2$await$content);
