# Write
```html
  <div><!--M_[2-->Got: a <!>0<!--M_*2 #text/1--><!--M_]1 #text/0--><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.b={1:_.a={count:0,"count!":_.c=new Set},2:_.d={_:_.a,"count(":0}},(_.c).add(_.d),(_.a["#text/0!"]=_.d),_.b)]</script>
```

# Write
```html
  <script>M._.r.push(_=>(_.e={3:_.f={_:_.a,"count(":2}},(_.c).add(_.f),(_.a["#text/2!"]=_.f),_.e))</script>
```

# Write
```html
  <!--M_[4-->Got: b <!>0<!--M_*4 #text/1--><!--M_]1 #text/1--><!--M_[3-->Got: c <!>0<!--M_*3 #text/1--><!--M_]1 #text/2--><button>Inc</button><!--M_*1 #button/3--></div><script>M._.r.push(_=>(_.g={4:_.h={_:_.a,"count(":1}},(_.c).add(_.h),(_.a["#text/1!"]=_.h),_.g),1,"__tests__/template.marko_0_count");M._.w()</script>
```
