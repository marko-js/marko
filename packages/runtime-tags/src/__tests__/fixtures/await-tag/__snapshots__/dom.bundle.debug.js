...
const $await_content3__count = /*@__PURE__*/ _closure_get("count", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.count)));
const $await_content3__setup = $await_content3__count;
const $await_content3__value = /*@__PURE__*/ _render(($scope, value) => _text($scope["#text/0"], value));
const $await_content3__$params = ($scope, $params4) => $await_content3__value($scope, $params4[0]);
const $await_content2__count = /*@__PURE__*/ _closure_get("count", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.count)));
const $await_content2__setup = $await_content2__count;
const $await_content2__value = /*@__PURE__*/ _render(($scope, value) => _text($scope["#text/0"], value));
const $await_content2__$params = ($scope, $params3) => $await_content2__value($scope, $params3[0]);
const $await_content__count = /*@__PURE__*/ _closure_get("count", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._.count)));
