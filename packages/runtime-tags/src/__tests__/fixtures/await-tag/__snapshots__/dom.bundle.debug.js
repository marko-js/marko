...
const $await_content3__count = /*@__PURE__*/ _closure_get("count/5", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_3_count#4/subscribe");
...
const $await_content2__count = /*@__PURE__*/ _closure_get("count/5", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_2_count#4/subscribe");
...
const $await_content__count = /*@__PURE__*/ _closure_get("count/5", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_1_count#4/subscribe");
...
const $await_content = /*@__PURE__*/ _await_content("#text/0", "Got: <!> <!>", "b%c%", $await_content__setup);
const $await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content__$params);
const $await_content2 = /*@__PURE__*/ _await_content("#text/1", "Got: <!> <!>", "b%c%", $await_content2__setup);
