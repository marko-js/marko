// template.marko
const $await_content3__count = /*@__PURE__*/ _closure_get(5, ($scope) => _text($scope.b, $scope._.e));
const $await_content2__count = /*@__PURE__*/ _closure_get(5, ($scope) => _text($scope.b, $scope._.e));
