// template.marko
const $sometimesBar = /*@__PURE__*/ _render(($scope, sometimesBar) => _attr($scope.c, "id", sometimesBar));
const $bar = /*@__PURE__*/ _let(4, ($scope) => $sometimesBar($scope, $scope.e || _id($scope)));
const $sometimesBaz = /*@__PURE__*/ _render(($scope, sometimesBaz) => _attr($scope.d, "id", sometimesBaz));
