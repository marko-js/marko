...
const $walks = " b b b b";
const $sometimesBar = /*@__PURE__*/ _render(($scope, sometimesBar) => _attr($scope["#div/2"], "id", sometimesBar));
const $bar = /*@__PURE__*/ _let("bar/4", ($scope) => $sometimesBar($scope, $scope.bar || _id($scope)));
const $sometimesBaz = /*@__PURE__*/ _render(($scope, sometimesBaz) => _attr($scope["#div/3"], "id", sometimesBaz));
const $baz = /*@__PURE__*/ _let("baz/5", ($scope) => $sometimesBaz($scope, $scope.baz || _id($scope)));
const $alwaysFoo = /*@__PURE__*/ _render(($scope, alwaysFoo) => _attr($scope["#div/1"], "id", alwaysFoo));
