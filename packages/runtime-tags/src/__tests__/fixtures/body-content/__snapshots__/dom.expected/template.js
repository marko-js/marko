...
const _clickCount$FancyButton_content = _$.registerDynamicClosure("__tests__/template.marko_1_clickCount/subscriber", "clickCount/1", (_scope, clickCount) => _$.data(_scope["#text/0"], clickCount));
