...
const $FancyButton_content__clickCount = /*@__PURE__*/ _closure_get("clickCount/2", ($scope) => _text($scope["#text/0"], $scope._.clickCount), 0, "__tests__/template.marko_1_clickCount#1/subscribe");
