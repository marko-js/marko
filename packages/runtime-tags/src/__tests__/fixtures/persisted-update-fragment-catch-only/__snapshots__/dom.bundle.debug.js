...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_6_content", "<p class=loading>loading…</p>", "b");
...
const $catch_content = /*@__PURE__*/ _content("__tests__/template.marko_4_content", "<p class=failed>failed: <!></p>", "Db%l", 0, $catch_content__$params);
...
const $try_content__update = (_patch, _live) => {
	if ("BranchScopes:#text/0" in _patch) _update_branch(_patch, _live, "#text/0", $try_content2__update);
};
...
const $catch_content__err_message = ($scope, err_message) => _text($scope["#text/0"], err_message);
const $catch_content__$params = ($scope, $params2) => $catch_content__err_message($scope, $params2[0]?.message);
const $catch_content = _content_resume("__tests__/template.marko_4_content", "<p class=failed>failed: <!></p>", "Db%l", 0, $catch_content__$params);
const $try_content__try = /*@__PURE__*/ _try("#text/0", "<!><!><!>", "b%c", $try_content2__setup);
const $try_content__setup = ($scope) => $try_content__try($scope, { placeholder: attrTag({ content: $placeholder_content($scope) }) });
const $Reports_content__try = /*@__PURE__*/ _try("#text/0", "<!><!><!>", "b%c", $try_content__setup);
const $Reports_content__setup = ($scope) => $Reports_content__try($scope, { catch: attrTag({ content: $catch_content($scope) }) });
