...
var template_default = _template("a", (input) => {
	...
	const Reports = { content: _content("a6", () => {
		...
		}, $scope2_id), { catch: attrTag({ content: _content_resume("a4", (err) => {
	...
	_dynamic_tag($scope0_id, "c", $global().view === "reports" ? Reports : Home, {}, 0, 0, _persisted_reason() | _persisted_reason(), "a7");
