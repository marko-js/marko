...
var template_default = _template("__tests__/template.marko", (input) => {
	const $scope0_reason = _scope_reason(), $sg__input_flag = _serialize_guard($scope0_reason, 4);
	const $scope0_id = _scope_id();
	let count = 0;
	...
	_if(() => input.flag ? 0 : undefined, $scope0_id, "#text/4", $sg__input_flag, $sg__input_flag, $sg__input_flag, 0, 1, "__tests__/template.marko_0/update_if_#text/4", [() => {
		const $scope1_id = _scope_id();
		_html("<p class=flagged>flag on</p>");
		$sg__input_flag && writeScope($scope1_id, {}, "__tests__/template.marko", "7:2");
