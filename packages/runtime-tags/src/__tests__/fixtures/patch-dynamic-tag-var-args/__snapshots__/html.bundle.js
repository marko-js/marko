...
var counter_default = _template_patch("a", (input) => {
	_scope_reason();
...
var template_default = _template_patch("b", (input) => {
	...
	let n = _dynamic_tag($scope0_id, "a", $tag, [...$input2], 0, 1, void 0, _patch_dynamic_tag($scope0_id, "a", $tag, $input2, 0, "b0", $scope0_reason, 0));
	_var($scope0_id, "b", $inputoncounternull_scope, "b0");
	_html(`<p>${_patch_text($scope0_id, "c", n, void 0, $scope0_reason, 0)}</p></main>`);
	$scope0_page && _scope($scope0_id, {
