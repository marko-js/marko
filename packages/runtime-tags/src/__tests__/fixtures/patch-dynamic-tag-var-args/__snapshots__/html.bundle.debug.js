...
var counter_default = _template_patch("__tests__/counter.marko", (input) => {
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	let n = _dynamic_tag($scope0_id, "#text/0", $tag, [...$input2], 0, 1, void 0, _patch_dynamic_tag($scope0_id, "#text/0", $tag, $input2, 0, "__tests__/template.marko_0_n#8/var", $scope0_reason, 0));
	_var($scope0_id, "#scopeOffset/1", $inputoncounternull_scope, "__tests__/template.marko_0_n#8/var");
	_html(`<p>${_patch_text($scope0_id, "#text/2", n, void 0, $scope0_reason, 0)}</p></main>`);
	$scope0_page && _scope($scope0_id, {
