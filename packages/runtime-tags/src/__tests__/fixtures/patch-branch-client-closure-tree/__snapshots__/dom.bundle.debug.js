...
const $walks = "D%b l";
const $if_content2__input_title = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_title", /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/0"], "d:" + $scope._._.input_title), ($scope) => $scope._._, "__tests__/template.marko_2_input_title#4/subscribe"), 0);
