...
const $_classspandiv_content = /*@__PURE__*/ _content_resume("__tests__/tags/wrap.marko_1*content", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($template$2), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)("b%c"), $_classspandiv_content__setup);
