...
const $walks$1 = "b%c";
const $setup$1 = () => {};
const $_classspandiv_content__input_foo = /*@__PURE__*/ _closure_get("input_foo/7", ($scope) => $foo($scope["#childScope/0"], $scope._.input_foo), 0, "__tests__/tags/wrap.marko_1_input_foo#3/subscribe");
