# Write
```html
  <div><button>0<!--M_*1 #text/1--></button><!--M_*1 #button/0--></div><script>WALKER_RUNTIME("M")("_");M._.r=[_=>(_.a={1:{"clickCount/2":0}}),1,"__tests__/template.marko_0_clickCount",0];M._.w()</script>
```
