// template.marko
const $for_content__input_note = /*@__PURE__*/ _fill_join_closure("a0", 5, /*@__PURE__*/ _closure_get(8, ($scope) => _text($scope.b, $scope._._.f), ($scope) => $scope._._, "a0", 5), 0);
const $for_content__setup = $for_content__input_note;
const $for_content__item = ($scope, item) => _text($scope.a, item);
const $for_content__$params = ($scope, $params2) => $for_content__item($scope, $params2[0]);
const $if_content__for = /*@__PURE__*/ _for_of_unkeyed(0, "<li><!>: <!></li>", "D%c%", $for_content__setup, $for_content__$params);
const $if_content__items = /*@__PURE__*/ _if_closure(0, 0, ($scope) => $if_content__for($scope, [$scope._.h]));
const $if = /*@__PURE__*/ _if(0, "<ul></ul>", " ", $if_content__items);
