...
const $try_content__input_b = /*@__PURE__*/ _closure_get("input_b", ($scope) => $try_content__await_promise2($scope, $scope._.input_b), 0, "__tests__/template.marko_1_input_b#4/subscribe");
