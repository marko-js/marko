...
const $body_content__$global_brand = /*@__PURE__*/ _global_join("brand", "__tests__/template.marko_1_$global_brand#3/global", /*@__PURE__*/ _closure_get("$global_brand", ($scope) => _text($scope["#text/0"], $scope.$global.brand), 0, "__tests__/template.marko_1_$global_brand#3/subscribe"));
