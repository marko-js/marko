...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
		...
		if (input.show) {
			...
			card_default({
				...
				content: _content_elide("__tests__/template.marko_2*content", () => {
					...
					_html(`<em>${_patch_text($scope2_id, "#text/0", input.note, void 0, $scope0_reason, 5)}</em>`);
					_subscribe(_unfilled_if($scope0_reason, 5) && $input_note__closures, _scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "3:6"));
				}, $scope1_id)
			});
			_scope($scope1_id, {
	...
	}, $scope0_id, "#main/0", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/template.marko_1*shell"], $scope0_reason, 3);
