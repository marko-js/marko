...
const $obj_name = /*@__PURE__*/ _const("obj_name", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.obj_name)));
...
const $copy_name = /*@__PURE__*/ _const("copy_name", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.copy_name)));
