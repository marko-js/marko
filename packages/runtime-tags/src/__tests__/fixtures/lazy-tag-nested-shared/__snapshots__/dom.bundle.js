...
const $obj_name = /*@__PURE__*/ _const(5, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope.f)));
...
const $copy_name = /*@__PURE__*/ _const(6, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope.g)));
