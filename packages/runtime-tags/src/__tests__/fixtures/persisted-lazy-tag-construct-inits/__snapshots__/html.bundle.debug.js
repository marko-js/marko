...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	}, $scope0_id, "#main/2", 1, $sg__input_show, $sg__input_show, void 0, void 0, ["__tests__/template.marko_1*shell"], $scope0_reason, 1);
	_html(`</main>${_el_resume($scope0_id, "#main/2", $sg__input_show)}<p>${_patch_text($scope0_id, "#text/3", input.label, void 0, $scope0_reason, 2)}</p>`);
