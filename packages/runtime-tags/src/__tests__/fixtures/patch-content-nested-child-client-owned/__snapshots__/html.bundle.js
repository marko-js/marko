...
_shells({ b: /*@__PURE__*/ ((_w0, _w1) => `b;${_w0};${_w1}`)(((_w0) => `E l/${_w0}&l`)($walks$1), ((_w0) => `<section><h2> </h2>${_w0}</section>`)($template$1)) });
...
var template_default = _template_patch("a", (input) => {
	...
	child_default({
		...
		content: _content_resume("a1", () => {
			...
			_subscribe(_source_if($scope0_reason, 1) && $input_note__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }), _client_guard($scope0_reason, 1) && "a0", $sg__input_note);
