...
export default _._template("__tests__/tags/my-for.marko", input => {
  const $scope0_reason = _._scope_reason(),
    $sg__input_to = _._serialize_guard($scope0_reason, /* input.to */1),
    $sg__input_to__OR__input_content = _._serialize_guard($scope0_reason, /* input.to, input.content */0);
  const $scope0_id = _._scope_id();
  _._for_to(input.to, 0, 1, (...args) => {
    const $scope1_id = _._scope_id();
    _._dynamic_tag($scope1_id, "#text/0", input.content, [...args], 0, 1, ($sg__input_to__OR__input_content));
