...
const $for = /*@__PURE__*/ _for_to("#text/0", "<!>", "%", $for_content__setup, $for_content__$params);
...
var my_for_default = /*@__PURE__*/ _template("__tests__/tags/my-for.marko", "<!>", "%b", $setup$1, $input);
...
const $myfor_content = _content_resume("__tests__/template.marko_1_content", " ", " ", 0, $myfor_content__$params);
