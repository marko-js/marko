...
export default _._template("__tests__/template.marko", input => {
    ...
    if (input.a) {
      ...
      _._if(() => {
        if (input.b) {
          ...
          _._serialize_guard($scope0_reason, /* input.c, input.b */0) && _._subscribe($bar2__closures, _._scope($scope2_id, {
            _: _._serialize_if($scope0_reason, /* input.c */3) && _._scope_with_id($scope1_id),
      ...
      _._serialize_guard($scope0_reason, /* input.c, input.b */0) && _._scope($scope1_id, {
        foo,
  ...
  _._serialize_guard($scope0_reason, /* input.c, input.a, input.b */2) && _._scope($scope0_id, {
