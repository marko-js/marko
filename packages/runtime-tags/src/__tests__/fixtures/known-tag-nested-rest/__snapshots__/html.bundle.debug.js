...
var leaf_default = _template("__tests__/tags/leaf.marko", (input) => {
	...
	_html_opens("__tests__/tags/leaf.marko:1:1"), _html(`<div>val ${_sep($sg__input_data_val)}${_escape(input.data.val)}${_el_resume($scope0_id, "#text/0", $sg__input_data_val)}</div>`);
...
var mid_default = _template("__tests__/tags/mid.marko", (input) => {
	...
	_html_opens("__tests__/tags/mid.marko:2:1"), _html(`<p>${_escape(first)}${_el_resume($scope0_id, "#text/0", _serialize_guard($scope0_reason, 1))} ${_sep($sg__input_group_keep)}${_escape(keep)}${_el_resume($scope0_id, "#text/1", $sg__input_group_keep)}</p>`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	const $scope0_id = _scope_id();
	let n = 1;
	_html_opens("__tests__/template.marko:2:1"), _html(`<button>inc <!>${_escape(n)}${_el_resume($scope0_id, "#text/1")}</button>${_el_resume($scope0_id, "#button/0")}`);
