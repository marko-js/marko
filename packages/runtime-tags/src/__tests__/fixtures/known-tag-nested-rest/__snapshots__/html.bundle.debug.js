...
var leaf_default = _template("__tests__/tags/leaf.marko", (input) => {
	...
	_html(`<div>val ${_text_resume($scope0_id, "#text/0", input.data.val, $sg__input_data_val * 2)}</div>`);
	_serialize_if($scope0_reason, 0) && _scope($scope0_id, {}, "__tests__/tags/leaf.marko", 0);
});
