...
const $walks$2 = "Db%l";
const $setup$2 = () => {};
const $input_data_val = /*@__PURE__*/ _render(($scope, input_data_val) => _text($scope["#text/0"], input_data_val));
...
const $setup$1 = () => {};
const $first = /*@__PURE__*/ _render(($scope, first) => _text($scope["#text/0"], first));
const $keep = /*@__PURE__*/ _render(($scope, keep) => _text($scope["#text/1"], keep));
