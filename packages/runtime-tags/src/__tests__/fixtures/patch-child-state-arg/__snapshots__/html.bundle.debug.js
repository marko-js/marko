...
var arg_badge_default = _template_patch("__tests__/tags/arg-badge/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<p>Value ${_patch_text($scope0_id, "#text/0", input.value, 2, $scope0_reason, 0)}</p>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/arg-badge/index.marko", 0);
}, 0, 0);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	if ($scope0_page || _must_render(arg_badge_default)) {
