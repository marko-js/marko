...
const $template = "<!><!><!>";
const $walks = "b%c";
const $await_content__clicks = /*@__PURE__*/ _closure_get("clicks", ($scope) => _text($scope["#text/1"], $scope._._.clicks), ($scope) => $scope._._, "__tests__/template.marko_3_clicks#1/subscribe");
...
const $placeholder_content__clicks = /*@__PURE__*/ _closure_get("clicks", ($scope) => _text($scope["#text/1"], $scope._.clicks), 0, "__tests__/template.marko_1_clicks#1/subscribe");
