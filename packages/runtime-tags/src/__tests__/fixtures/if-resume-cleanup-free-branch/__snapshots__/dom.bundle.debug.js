...
const $if$1 = /*@__PURE__*/ _if("#text/0", "<div>n is <!></div>", "Db%", $if_content__setup$1);
...
var leaf_default = /*@__PURE__*/ _template("__tests__/tags/leaf.marko", "<!>", "%b", $setup$1, $input);
...
const $if = /*@__PURE__*/ _if("#text/2", "<!>", /*@__PURE__*/ ((_w0) => `/${_w0}&`)("%b"), $if_content__setup);
