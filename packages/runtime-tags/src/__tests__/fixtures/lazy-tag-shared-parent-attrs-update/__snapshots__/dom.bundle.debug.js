...
const $template$2 = "<!><!><!><!>";
const $walks$2 = "b%/&c";
let $lazy_Child_tag_input_value$1 = /* @__PURE__ */ _lazy_signal(() => import("./v:child.marko.input_value.mjs"));
let $lazy_Child_setup$1 = /* @__PURE__ */ _lazy_setup("#text/0", "#childScope/1", () => import("./v:child.marko.setup.mjs"));
const $setup$2 = $lazy_Child_setup$1;
const $input_value$1 = ($scope, input_value) => $lazy_Child_tag_input_value$1($scope["#childScope/1"], input_value);
const $input$1 = ($scope, input) => $input_value$1($scope, input.value);
var parent_a_default = /* @__PURE__ */ _template("__tests__/parent-a.marko", $template$2, $walks$2, $setup$2, $input$1);
...
const $setup$1 = $lazy_Child_setup;
const $input_value = ($scope, input_value) => $lazy_Child_tag_input_value($scope["#childScope/1"], input_value * 2);
const $input = ($scope, input) => $input_value($scope, input.value);
var parent_b_default = /* @__PURE__ */ _template("__tests__/parent-b.marko", $template$1, $walks$1, $setup$1, $input);
...
const $input = ($scope, input) => $input_value($scope, input.value);
var child_default = /* @__PURE__ */ _template("__tests__/components/child.marko", $template, "D l", $setup, $input);
