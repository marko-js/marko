...
_static_shells({ "__tests__/tags/badge.marko_0_update": [$template$3, $walks$3] });
const $update2$2 = () => {};
...
var panel_marko_persisted_default = /*@__PURE__*/ _template("__tests__/tags/panel.marko", $template$2, $walks$2, $setup$2, $input$2);
_static_shells({
	"__tests__/tags/panel.marko_0_update": [$template$2, $walks$2],
	"__tests__/tags/panel.marko": [$template$2, $walks$2]
});
const $_holes$1 = /*@__PURE__*/ _update_scopes({
	"PatchAttr:open:#details/0": /*@__PURE__*/ _update_controllable("#details/0", _update_details_or_dialog_open),
	"PatchHole:#text/1": /*@__PURE__*/ _update_text("#text/1"),
	"PatchHole:#text/2": /*@__PURE__*/ _update_text("#text/2")
});
const $merge$2 = _resume("__tests__/tags/panel.marko_0_update", $_holes$1);
_update_content("__tests__/tags/panel.marko", $merge$2);
...
const $on = _var_resume("__tests__/tags/toggle.marko_0_on/var", /*@__PURE__*/ _let_persisted("on/6", ($scope) => _text($scope["#text/1"], $scope.on ? "on" : "off")));
...
var toggle_marko_persisted_default = /*@__PURE__*/ _template("__tests__/tags/toggle.marko", $template$1, $walks$1, $setup$1, $input$1);
_static_shells({
	"__tests__/tags/toggle.marko_0_update": [$template$1, $walks$1],
	"__tests__/tags/toggle.marko": [$template$1, $walks$1]
});
...
_construct("__tests__/tags/toggle.marko_0_update", $construct$1);
const $merge$1 = _resume("__tests__/tags/toggle.marko_0_update", $update2$1);
_update_content("__tests__/tags/toggle.marko", $merge$1, $construct$1);
...
const $count = _var_resume("__tests__/template.marko_0_count/var", /*@__PURE__*/ _let_persisted("count/17", ($scope) => _text($scope["#text/1"], $scope.count)));
const $setup__script = _script_shared(($scope) => _on($scope["#button/0"], "click", function() {
	$count($scope, $scope.count + 1);
}));
function $setup($scope) {
	$setup$1($scope["#childScope/6"]);
	$count($scope, 0);
	$setup__script($scope);
}
...
const $input_panel_title = ($scope, input_panel_title) => $input_title($scope["#childScope/4"], input_panel_title);
const $input_panel_body = ($scope, input_panel_body) => $input_body($scope["#childScope/4"], input_panel_body);
const $input_panel_expanded = ($scope, input_panel_expanded) => $input_expanded($scope["#childScope/4"], input_panel_expanded);
const $input_name = ($scope, input_name) => $input_name$1($scope["#childScope/6"], input_name);
...
const $construct = ($scope) => {
	...
	_construct_child($scope, "#childScope/4", "__tests__/tags/panel.marko_0_update");
	_construct_child($scope, "#childScope/6", "__tests__/tags/toggle.marko_0_update");
...
const $update2 = ($patch, $live) => {
	...
	if ("#childScope/4" in $patch) $merge$2($patch["#childScope/4"], $live["#childScope/4"]);
	if ("#childScope/6" in $patch) $merge$1($patch["#childScope/6"], $live["#childScope/6"]);
};
...
const $template = /*@__PURE__*/ ((_w0, _w1, _w2) => `<button>clicked <!></button>${_w0}<!>${_w1}<!>${_w2}<!>`)($template$3, $template$2, $template$1);
const $walks = /*@__PURE__*/ ((_w0, _w1, _w2) => ` Db%l/${_w0}&%b/${_w1}&%b/${_w2}&%b`)($walks$3, $walks$2, $walks$1);
const $count = /*@__PURE__*/ _let_persisted("count/17", ($scope) => _text($scope["#text/1"], $scope.count));
