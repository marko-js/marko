...
const _merge$3 = _resume("__tests__/tags/badge.marko_0_update", $_holes$2);
_update_content("__tests__/tags/badge.marko", _merge$3);
function _patch2$3() {
...
const $_holes$1 = /*@__PURE__*/ _update_scopes({
	"PatchAttr:open:#details/0": /*@__PURE__*/ _update_controllable("#details/0", _attr_details_or_dialog_open_default),
	"PatchHole:#text/1": /*@__PURE__*/ _update_text("#text/1"),
	"PatchHole:#text/2": /*@__PURE__*/ _update_text("#text/2")
});
const _merge$2 = _resume("__tests__/tags/panel.marko_0_update", $_holes$1);
_update_content("__tests__/tags/panel.marko", _merge$2);
function _patch2$2() {
...
const $update2$1 = (_patch, _live) => {
	...
	if ("on" in _patch) _update_seed(_live, $on_seed, _patch["on"]);
	$_holes(_patch, _live);
};
const _merge$1 = _resume("__tests__/tags/toggle.marko_0_update", $update2$1);
_update_content("__tests__/tags/toggle.marko", _merge$1);
function _patch2$1() {
...
const $count = _var_resume("__tests__/template.marko_0_count/var", /*@__PURE__*/ _let_persisted("count/14", ($scope) => _text($scope["#text/1"], $scope.count)));
...
const $update2 = (_patch, _live) => {
	...
	if ("#childScope/2" in _patch) _merge$3(_patch["#childScope/2"], _live["#childScope/2"]);
