...
const $if = /*@__PURE__*/ _if(0, "<span> </span>", "D ", $if_content__setup);
...
const $for = /*@__PURE__*/ _for_of_unkeyed(3, /*@__PURE__*/ ((_w0) => `<div>${_w0}</div>`)($template), /*@__PURE__*/ ((_w0) => `D/${_w0}&l`)("b%c"), $for_content__setup, $for_content__$params);
