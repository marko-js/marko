...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_html(`<input${_attrs(attrs, "#input/0", $scope0_id, "input")}>${_el_resume($scope0_id, "#input/0")}<span>value=[${_text_resume($scope0_id, "#text/1", value, 2)}]</span><button>drop</button>${_el_resume($scope0_id, "#button/2")}`);
