...
export const _input_value_ = /* @__PURE__ */_$.value("input_value/4", (_scope, input_value) => {
  _$.resetAbortSignal(_scope, 0);
  _input_value__effect(_scope);
});
export const _input_ = /* @__PURE__ */_$.value("input/3", (_scope, input) => _input_value_(_scope, input.value));
