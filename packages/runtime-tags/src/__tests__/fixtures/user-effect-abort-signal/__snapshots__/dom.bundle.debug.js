...
const $walks = "D%c%l";
const $a = /*@__PURE__*/ _let("a/5", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.a)));
const $b = /*@__PURE__*/ _let("b/6", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.b)));
