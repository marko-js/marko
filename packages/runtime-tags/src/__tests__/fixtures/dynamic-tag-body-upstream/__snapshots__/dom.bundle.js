...
// template.marko
const $tag_content__input_foo = /*@__PURE__*/ _closure_get(8, ($scope) => $input_foo($scope.a, $scope._.g), 0, "a3");
const $tag_content = _content("a2", $template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D l"), $tag_content__input_foo);
_content_resume($tag_content);
const $inputtag_content__input_foo = /*@__PURE__*/ _closure_get(8, ($scope) => $input_foo($scope.a, $scope._.g), 0, "a1");
