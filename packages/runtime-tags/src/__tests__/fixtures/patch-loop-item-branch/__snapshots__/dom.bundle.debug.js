...
const $if_content__for = /*@__PURE__*/ _for_of_unkeyed("#ul/0", "<li> </li>", "D ", 0, $for_content2__$params);
...
const $for_content__$params = ($scope, $params2) => $for_content__item_children($scope, $params2[0]?.children);
