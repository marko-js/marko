	...
	_for_of(input.items, (item) => {
		...
		_if(() => {
			if (item.children.length) {
				...
				}, 0, $scope2_id, "#ul/0", 1, 1, $sg__input_items, void 0, void 0, "__tests__/template.marko_3*shell", $scope0_reason, 0);
				_html(`</ul>${_el_resume($scope2_id, "#ul/0")}`);
				_scope($scope2_id, { _: _scope_with_id($scope1_id) }, "__tests__/template.marko", "5:8");
				return 0;
			}
