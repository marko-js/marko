...
var page_default = _template_persisted("__tests__/page.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render(), $sg__input_down = _source_guard($scope0_reason, 0);
	const $scope0_id = _scope_id();
	...
	$scope0_page && _scope($scope0_id, { "ClosureScopes:input_down": $input_down__closures }, "__tests__/page.marko", 0);
}, 0, () => [panel_default]);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	$scope0_page && _scope($scope0_id, { input_down: input.down }, "__tests__/template.marko", 0, { input_down: ["input.down"] });
}, 1, () => [page_default]);
