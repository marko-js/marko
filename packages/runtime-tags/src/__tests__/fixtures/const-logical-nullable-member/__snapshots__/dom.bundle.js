...
const $viaAnd_label = /*@__PURE__*/ _render(($scope, viaAnd_label) => _text($scope.a, viaAnd_label ?? "none"));
const $viaTernary_label = /*@__PURE__*/ _render(($scope, viaTernary_label) => _text($scope.b, viaTernary_label ?? "none"));
...
const $viaAndAssign_label = /*@__PURE__*/ _render(($scope, viaAndAssign_label) => _text($scope.c, viaAndAssign_label ?? "none"));
