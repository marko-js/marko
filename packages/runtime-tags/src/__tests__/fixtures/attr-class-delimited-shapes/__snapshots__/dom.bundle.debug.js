...
const $walks = " b b b";
const $d__OR__more__OR__obj__OR__k = /*@__PURE__*/ _or(9, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#div/1"], [
	"a",
	["b", $scope.d],
	...$scope.more,
	...["n1", $scope.d],
...
const $d__OR__moreStyles = /*@__PURE__*/ _or(6, /*@__PURE__*/ _render(($scope) => _attr_style($scope["#div/2"], [
	"color:red",
