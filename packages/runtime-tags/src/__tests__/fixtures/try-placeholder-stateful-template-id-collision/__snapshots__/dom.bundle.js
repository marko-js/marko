...
const $await_content__clicks = /*@__PURE__*/ _closure_get(6, $await_content__clicks__OR__tag__OR__body, ($scope) => $scope._._, "a1");
const $await_content__tag = /*@__PURE__*/ _closure_get(7, $await_content__clicks__OR__tag__OR__body, ($scope) => $scope._._, "a2");
const $placeholder_content__clicks = /*@__PURE__*/ _closure_get(6, ($scope) => $input_label($scope.a, `placeholder ${$scope._.e}`), 0, "a0");
