...
const $await_content__clicks = /*@__PURE__*/ _closure_get("clicks", $await_content__clicks__OR__tag__OR__body, ($scope) => $scope._._, "__tests__/template.marko_3_clicks#4/subscribe");
const $await_content__setup = ($scope) => {
	$await_content__clicks($scope);
	$await_content__tag($scope);
};
const $await_content__tag = /*@__PURE__*/ _closure_get("tag", $await_content__clicks__OR__tag__OR__body, ($scope) => $scope._._, "__tests__/template.marko_3_tag#5/subscribe");
...
const $placeholder_content__clicks = /*@__PURE__*/ _closure_get("clicks", ($scope) => $input_label($scope["#childScope/0"], `placeholder ${$scope._.clicks}`), 0, "__tests__/template.marko_1_clicks#4/subscribe");
