...
const $placeholder_content2 = _content_resume("a2", "LOADING B...", "b");
...
const $try_content__count = /*@__PURE__*/ _closure_get(5, ($scope) => $try_content__await_promise($scope, resolveAfter($scope._.e)));
