...
const $walks$2 = "b";
const $setup$2 = () => {};
var frag_a_default = /*@__PURE__*/ _template_patch("__tests__/frag-a.marko", $template$2, "b");

// frag-b.marko
const $template$1 = "<strong>beta</strong>";
const $walks$1 = "b";
const $setup$1 = () => {};
var frag_b_default = /*@__PURE__*/ _template_patch("__tests__/frag-b.marko", $template$1, "b");
