...
var frag_a_default = _template_patch("__tests__/frag-a.marko", (input) => {
...
var frag_b_default = _template_patch("__tests__/frag-b.marko", (input) => {
	const $scope0_reason = _scope_reason();
	const $scope0_id = _scope_id();
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_patch_dynamic_tag($scope0_id, "#section/0", $content, 0, 0, 0, $scope0_reason, 0);
