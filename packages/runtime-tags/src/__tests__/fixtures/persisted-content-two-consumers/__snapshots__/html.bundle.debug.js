...
var card_default = _template_persisted("__tests__/tags/card/index.marko", (input) => {
	...
	_dynamic_tag$1($scope0_id, "#text/1", input.content, {}, 0, 0, $sg__input_content, 1);
	_html$1("<footer>");
	_patch_dynamic_tag($scope0_id, "#text/2", input.content, $scope0_owned, 1);
	_dynamic_tag$1($scope0_id, "#text/2", input.content, {}, 0, 0, $sg__input_content, 1);
