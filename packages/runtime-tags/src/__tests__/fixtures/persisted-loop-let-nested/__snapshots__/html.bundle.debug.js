// template.marko
_renderer_shells({
	"__tests__/template.marko_1_shell": ",`__tests__/template.marko_1_shell;D%b%;<li><!><!></li>`",
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_for_of(input.items, (item) => {
		...
		}, $scope1_id, "#text/1", $sg__input_items, $sg__input_items, $sg__input_items, void 0, void 0, ["__tests__/template.marko_2_shell"]);
		_html("</li>");
		writeScope($scope1_id, {}, "__tests__/template.marko", "2:4");
	}, "id", $scope0_id, "#ul/0", $sg__input_items, $sg__input_items, $sg__input_items, void 0, void 0, "__tests__/template.marko_1_shell");
