...
const $ChildB_content__count__OR__$bar = /* @__PURE__ */_._or(11, $scope => $ChildB_content__bar($scope, void 0 !== $scope.$bar2 ? $scope.$bar2 : $scope._.count + 1));
...
const $ChildB_content__$bar = /* @__PURE__ */_._const("$bar2", $ChildB_content__count__OR__$bar);
...
const $ChildA_content__count__OR__$foo = /* @__PURE__ */_._or(10, $scope => $ChildA_content__$pattern($scope, void 0 !== $scope.foo ? $scope.foo : {
  bar: $scope._.count + 2
}));
const $ChildA_content__bar = ($scope, bar) => _._text($scope["#text/1"], bar);
const $ChildA_content__count__OR__$bar = /* @__PURE__ */_._or(11, $scope => $ChildA_content__bar($scope, void 0 !== $scope.$bar ? $scope.$bar : $scope._.count + 1));
...
const $ChildA_content__$bar = /* @__PURE__ */_._const("$bar", $ChildA_content__count__OR__$bar);
