...
const $thing_content__input_title = /*@__PURE__*/ _closure_get("input_title", ($scope) => _text($scope["#text/1"], $scope._.input_title), 0, "__tests__/template.marko_1_input_title#4/subscribe");
