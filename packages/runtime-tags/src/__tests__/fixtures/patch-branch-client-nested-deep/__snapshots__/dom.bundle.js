...
const $if_content2__input_b = /*@__PURE__*/ _fill_join_closure("a1", 5, /*@__PURE__*/ _closure_get(8, ($scope) => $if_content2__if($scope, $scope._._.f ? 0 : 1), ($scope) => $scope._._, "a0", 5), 0);
