...
const $if_content2__input_b = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko1", "input_b", /*@__PURE__*/ _closure_get("input_b", ($scope) => $if_content2__if($scope, $scope._._.input_b ? 0 : 1), ($scope) => $scope._._, "__tests__/template.marko_2_input_b#5/subscribe"), 0);
