...
const $await_content2__clicks = _closure_get(4, $await_content2__clicks__OR__inner, ($scope) => $scope._._._._, "a0");
const $await_content__clicks = _closure_get(4, ($scope) => _text($scope.b, $scope._._.d), ($scope) => $scope._._, "a3");
