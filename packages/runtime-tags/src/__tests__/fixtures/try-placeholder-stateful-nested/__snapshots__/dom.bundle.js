...
const $placeholder_content2 = _content("a1", $template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D l"), $placeholder_content2__setup);
const $placeholder_content__setup = ($scope) => $input_label($scope.a, "outer placeholder");
const $placeholder_content = _content("a4", $template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)("D l"), $placeholder_content__setup);
