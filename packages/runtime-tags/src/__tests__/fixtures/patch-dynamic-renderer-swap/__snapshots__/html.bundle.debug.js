...
var card_a_default = _template_patch("__tests__/card-a.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<section class=a>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 0)}</section>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/card-a.marko", 0);
}, 0, 0);
...
var card_b_default = _template_patch("__tests__/card-b.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<article class=b>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 0)}!</article>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/card-b.marko", 0);
}, 0, 0);
