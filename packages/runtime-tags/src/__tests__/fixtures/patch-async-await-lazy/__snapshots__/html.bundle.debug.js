...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_try($scope0_id, "#text/1", _content_resume("__tests__/template.marko_1*content", () => {
		...
		$scope0_page && _subscribe(_unfilled_if($scope0_reason, 5) && $input_slow__closures, _subscribe(_unfilled_if($scope0_reason, 4) && $input_related__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "7:6"), _client_guard($scope0_reason, 4) && "__tests__/template.marko_1_input_related#8/subscribe", 0), _client_guard($scope0_reason, 5) && "__tests__/template.marko_1_input_slow#9/subscribe", 0);
