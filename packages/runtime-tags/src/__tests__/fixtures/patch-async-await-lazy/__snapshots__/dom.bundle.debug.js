...
const $try_content__input_related = /*@__PURE__*/ _closure_get("input_related", $try_content__input_related__OR__input_slow, 0, "__tests__/template.marko_1_input_related#8/subscribe");
const $try_content__setup = ($scope) => {
	$try_content__input_related($scope);
	$try_content__input_slow($scope);
	$await_content($scope);
};
const $try_content__input_slow = /*@__PURE__*/ _closure_get("input_slow", $try_content__input_related__OR__input_slow, 0, "__tests__/template.marko_1_input_slow#9/subscribe");
