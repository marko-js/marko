...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_try($scope0_id, "#text/2", _content_resume("__tests__/template.marko_1_content", () => {
		...
		_await($scope1_id, "#text/0", resolveAfter(input.value, input.tick), (value) => {
			...
			$sg__input_value__OR__input_tick && writeScope($scope3_id, {}, "__tests__/template.marko", "12:6");
		}, $sg__input_value__OR__input_tick);
		$sg__input_value__OR__input_tick && _subscribe($sg__input_tick && $input_tick__closures, _subscribe($sg__input_value && $input_value__closures, writeScope($scope1_id, { _: _scope_with_id($scope0_id) }, "__tests__/template.marko", "10:4")));
