...
const $walks = " b b";
const $for_content__input_selected__OR__enabled__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#li/0"], $scope._.enabled && $scope._.input_selected === $scope.row_id && "sel")), 2);
