// template.marko
const $for_content__input_selected__OR__enabled__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope.a, $scope._.g && $scope._.f === $scope.e && "sel")), 2);
