...
var inner_default = _template_patch("__tests__/tags/outer/tags/inner/index.marko", (input) => {
	...
	_if(() => {
		if (input.open) {
			...
			_html("<em>o</em>");
			$scope0_page && _scope($scope1_id, {}, "__tests__/tags/outer/tags/inner/index.marko", "1:2");
			return 0;
		}
	}, $scope0_id, "#text/0", 1, $sg__input_open, $sg__input_open, void 0, void 0, ["__tests__/tags/outer/tags/inner/index.marko_1*shell"], $scope0_reason, 0);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/outer/tags/inner/index.marko", 0);
}, 0, 0);
...
var outer_default = _template_patch("__tests__/tags/outer/index.marko", (input) => {
	...
	$scope0_page && _scope($scope0_id, { "#childScope/0": _existing_scope($childScope) }, "__tests__/tags/outer/index.marko", 0);
}, 0, () => [inner_default]);
...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		input_o: ["input.o"],
		show: "1:6"
	}) : _filled_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/template.marko0", input.o);
}, 1, () => [outer_default]);
