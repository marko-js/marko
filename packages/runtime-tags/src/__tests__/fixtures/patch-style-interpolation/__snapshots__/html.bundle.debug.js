...
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	_html(`${_style_html(`--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bpatch-19style-19interpolation-1btemplate-1amarko_0:${_patch_style($scope0_id, "#style/0", "--M_packages-1bruntime-19tags-1bsrc-1b__tests__-1bfixtures-1bpatch-19style-19interpolation-1btemplate-1amarko_0", input.color, $scope0_reason, 0)};`)}${_el_resume($scope0_id, "#style/0")}<div class=box>Hi</div>`);
