...
var template_default = _template("a", (input) => {
	...
	writeScope($scope0_id, { n: _seed_fill(_state_reason() && n) });
	_resume_branch($scope0_id);
}, 1);
_renderer_shells({
	"a0": ["<h1> </h1><button class=inc>count <!></button><!><p class=detail> </p><span class=extra> </span><!><!>", "D l Db%l%bD lD l%c"],
	"a": ["<h1> </h1><button class=inc>count <!></button><!><p class=detail> </p><span class=extra> </span><!><!>", "D l Db%l%bD lD l%c"]
});
