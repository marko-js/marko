...
const $multipliedCount = /*@__PURE__*/ _render(($scope, multipliedCount) => _text($scope["#text/3"], multipliedCount));
...
const $multiplier__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope.multiplier));
