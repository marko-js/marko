...
_renderer_shells({ "__tests__/tags/card.marko_0_update": [[
	"<section class=card>",
...
_renderer_shells({
	"__tests__/tags/counter.marko_0_update": ["<button class=counter> </button>", " D l"],
	"__tests__/tags/counter.marko": ["<button class=counter> </button>", " D l"]
});
