...
_static_shells({ "__tests__/tags/badge.marko_0_update": [$template$4, $walks$4] });
const $update2$4 = () => {};
...
const $input_heading$1 = ($scope, input_heading) => {
	...
	_text($scope["#text/2"], input_heading);
};
const $input_tone$1 = ($scope, input_tone) => $input_tone$2($scope["#childScope/0"], input_tone);
const $input_flagged$1 = ($scope, input_flagged) => _attr_class($scope["#p/3"], ["meta", input_flagged && "flagged"]);
const $input_meta$1 = ($scope, input_meta) => _text($scope["#text/4"], input_meta);
...
_static_shells({ "__tests__/tags/card.marko_0_update": [$template$3, $walks$3] });
const $update2$3 = () => {};
...
_construct("__tests__/tags/counter.marko_0_update", $construct$2);
const $merge$2 = _resume("__tests__/tags/counter.marko_0_update", $update2$2);
_update_content("__tests__/tags/counter.marko", $merge$2, $construct$2);
...
_static_shells({
	"__tests__/tags/widget.marko_0_update": [$template$1, $walks$1],
	"__tests__/tags/widget.marko": [$template$1, $walks$1]
});
const $_holes = /*@__PURE__*/ _update_scopes({ "PatchHole:#text/0": /*@__PURE__*/ _update_text("#text/0") });
const $construct$1 = ($scope) => {
	_construct_child($scope, "#childScope/1", "__tests__/tags/counter.marko_0_update");
};
...
_update_content("__tests__/tags/widget.marko", $merge$1, $construct$1);
...
const $input_widget = ($scope, input_widget) => $input_label($scope["#childScope/4"], input_widget);
...
const $construct = ($scope) => {
	...
	_construct_child($scope, "#childScope/4", "__tests__/tags/widget.marko_0_update");
