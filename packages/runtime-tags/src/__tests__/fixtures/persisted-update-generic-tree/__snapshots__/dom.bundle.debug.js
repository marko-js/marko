...
const _merge$4 = _resume("__tests__/tags/badge.marko_0_update", $_holes$2);
_update_content("__tests__/tags/badge.marko", _merge$4);
function _patch2$4(_fail) {
	return patch(_merge$4, _fail);
}
...
const $update2$3 = (_patch, _live) => {
	...
	if ("#childScope/0" in _patch) _merge$4(_patch["#childScope/0"], _live["#childScope/0"]);
};
const _merge$3 = _resume("__tests__/tags/card.marko_0_update", $update2$3);
_update_content("__tests__/tags/card.marko", _merge$3);
...
const _merge$2 = _resume("__tests__/tags/counter.marko_0_update", $update2$2);
_update_content("__tests__/tags/counter.marko", _merge$2);
...
const $update2$1 = (_patch, _live) => {
	$_holes(_patch, _live);
	if ("#childScope/1" in _patch) _merge$2(_patch["#childScope/1"], _live["#childScope/1"]);
};
const _merge$1 = _resume("__tests__/tags/widget.marko_0_update", $update2$1);
_update_content("__tests__/tags/widget.marko", _merge$1);
