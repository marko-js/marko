...
const $await_content__shared = _closure_get("shared", ($scope) => $load_Child_tag_input_shared($scope["#childScope/1"], $scope._._.shared), ($scope) => $scope._._, "__tests__/template.marko_2_shared#2/pending");
