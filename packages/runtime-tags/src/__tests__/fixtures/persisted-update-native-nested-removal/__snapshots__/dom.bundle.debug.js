...
const $Child_content__update = (_patch, _live) => {
...
const $update = (_patch, _live) => {
	...
	if ("input_child" in _patch) _live["input_child"] = _patch["input_child"];
	if ("Child" in _patch) _live["Child"] = _patch["Child"];
...
_update_content("__tests__/template.marko_2_content", $Child_content__update);
