...
const $Child_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", $Child_content__template, $Child_content__walks, $Child_content__setup);
...
const $inputouter_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", $inputouter_content__template, $inputouter_content__walks, $inputouter_content__setup);
...
_static_shells({
	"__tests__/template.marko_2_update": [$Child_content__template, $Child_content__walks],
	"__tests__/template.marko_2_content": [$Child_content__template, $Child_content__walks],
	"__tests__/template.marko_1_update": [$inputouter_content__template, $inputouter_content__walks],
	"__tests__/template.marko_1_content": [$inputouter_content__template, $inputouter_content__walks],
...
_construct("__tests__/template.marko_2_update", $Child_content__construct);
_construct("__tests__/template.marko_0_update", $construct);
_update_content("__tests__/template.marko_2_content", _update_pair, $Child_content__construct);
...
const $Child_content__setup = $Child_content__setup__script;
const $Child_content = _content_resume("__tests__/template.marko_2_content", "<button class=child>child</button>", " ", $Child_content__setup);
const $inputouter_content__dynamicTag = /*@__PURE__*/ _dynamic_tag("#text/0");
const $inputouter_content__input_child__OR__Child = /*@__PURE__*/ _or(1, ($scope) => $inputouter_content__dynamicTag($scope, $scope._.input_child === "component" ? $scope._.Child : $scope._.input_child === "native" ? "span" : undefined));
const $inputouter_content__input_child = /*@__PURE__*/ _closure_get("input_child", ($scope) => {
	if (!updating) $inputouter_content__input_child__OR__Child($scope);
...
const $inputouter_content = _content_resume("__tests__/template.marko_1_content", "<!><!><!>", "b%", $inputouter_content__setup);
