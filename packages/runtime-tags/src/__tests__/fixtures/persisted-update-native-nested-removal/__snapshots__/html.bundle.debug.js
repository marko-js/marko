...
_renderer_shells({
	"__tests__/template.marko_2_update": ["<button class=child>child</button>", " b"],
	"__tests__/template.marko_2_content": ["<button class=child>child</button>", " b"],
	"__tests__/template.marko_1_update": ["<!><!><!>", "b%c"],
	"__tests__/template.marko_1_content": ["<!><!><!>", "b%c"],
	"__tests__/template.marko_0_update": ["<button class=count>count <!></button><!><!>", " Db%l%c"],
	"__tests__/template.marko": ["<button class=count>count <!></button><!><!>", " Db%l%c"]
});
