...
const $inputtype_content = /*@__PURE__*/ _content("__tests__/tags/heading.marko_2*content", "item <!>", "b%", $inputtype_content__setup);
...
var heading_default = /*@__PURE__*/ _template("__tests__/tags/heading.marko", $template$1, $walks$1, $setup$1, $input, $renders);
