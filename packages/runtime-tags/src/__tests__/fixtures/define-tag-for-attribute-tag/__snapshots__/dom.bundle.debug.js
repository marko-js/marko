...
const $input_thing_selected = /*@__PURE__*/ _const("input_thing_selected", /*@__PURE__*/ _render(($scope) => _attr_class_item($scope["#div/0"], "selected", $scope.input_thing_selected)));
