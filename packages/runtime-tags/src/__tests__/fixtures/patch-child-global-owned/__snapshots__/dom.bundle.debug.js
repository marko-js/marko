...
const $global_flag = /*@__PURE__*/ _global_join("flag", "__tests__/tags/g-badge/index.marko_0_$global_flag#5/global", ($scope, $global_flag) => _text($scope["#text/1"], $scope.$global.flag));
