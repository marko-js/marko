...
const $walks$2 = "D l";
_shells({ "__tests__/tags/badge.marko": "__tests__/tags/badge.marko;D ;<b class=badge> </b>" });
var badge_default = _template_patch("__tests__/tags/badge.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<b class=badge>${_patch_text($scope0_id, "#text/0", input.label, void 0, $scope0_reason, 0)}</b>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/badge.marko", 0);
}, 0, 0);
...
_shells({ "__tests__/template.marko": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko !__tests__/template.marko_0;${_w0};${_w1}`)(((_w0) => `D%b/${_w0}& l`)($walks$1), ((_w0) => `<main><!>${_w0}<button id=o>o</button></main>`)($template$1)) });
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, {
		...
		on: "1:6",
		input_badge_label: ["input.badge.label"]
	}) : (_filled_guard($scope0_reason, 0) && _patch_value($scope0_id, "__tests__/template.marko0", input.props), _filled_guard($scope0_reason, 1) && _patch_value($scope0_id, "__tests__/template.marko1", input.badge?.label));
