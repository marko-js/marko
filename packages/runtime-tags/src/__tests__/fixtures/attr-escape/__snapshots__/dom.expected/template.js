...
const _expr_input_foo_input_bar = /* @__PURE__ */_$.intersection(2, _scope => {
  const {
    input_foo,
    input_bar
  } = _scope;
...
export const _input_bar_ = /* @__PURE__ */_$.value("input_bar", (_scope, input_bar) => _$.attr(_scope["#div/0"], "bar", `a ${input_bar} b`), () => _expr_input_foo_input_bar);
