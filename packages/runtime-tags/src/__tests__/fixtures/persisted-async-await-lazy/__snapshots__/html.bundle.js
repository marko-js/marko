...
var template_default = _template_persisted("a", (input) => {
	...
	_try($scope0_id, "b", _content_resume("a4", () => {
		...
		$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 6) && $input_slow__closures, _subscribe(_unfilled_if($scope0_owned, 5) && $input_related__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) })));
