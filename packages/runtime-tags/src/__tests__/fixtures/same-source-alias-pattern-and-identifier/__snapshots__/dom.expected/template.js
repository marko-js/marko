...
export const _b_ = /* @__PURE__ */_$.value("b/5", (_scope, b) => {
  _$.data(_scope["#text/0"], b);
  _c(_scope, b);
});
export const _pattern__ = /* @__PURE__ */_$.value("_pattern_/4", (_scope, _pattern_) => _b_(_scope, _pattern_.b));
export const _input_ = /* @__PURE__ */_$.value("input/3", (_scope, input) => _pattern__(_scope, input.a));
