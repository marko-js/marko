...
const $wrapper_content__input_button_label = /*@__PURE__*/ _closure_get("label/6", ($scope) => _text($scope["#text/1"], $scope._.label), 0, "__tests__/template.marko_1_label#4/subscribe");
...
const $wrapper_content__rest = /*@__PURE__*/ _closure_get("rest/7", ($scope) => {
