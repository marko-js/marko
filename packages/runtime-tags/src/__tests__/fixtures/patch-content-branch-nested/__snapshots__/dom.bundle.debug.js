...
const $walks = " b";
const $setup = () => {};
const $widget_content__input_text = /*@__PURE__*/ _closure_get("input_text", ($scope) => _text($scope["#text/0"], $scope._._._.input_text), ($scope) => $scope._._._, "__tests__/template.marko_3_input_text#6/subscribe");
...
const $if_content2__input_label = /*@__PURE__*/ _closure_get("input_label", ($scope) => $input_label$1($scope["#childScope/0"], $scope._._.input_label), ($scope) => $scope._._, "__tests__/template.marko_2_input_label#5/subscribe");
