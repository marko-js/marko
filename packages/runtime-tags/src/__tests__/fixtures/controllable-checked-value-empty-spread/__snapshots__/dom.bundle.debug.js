...
const $walks = " b bD l";
const $v__OR__rest__render = /*@__PURE__*/ _render(($scope) => _attrs($scope, "#input/1", {
	type: "checkbox",
...
const $v__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.v === undefined ? "undefined" : "value=" + $scope.v));
