// template.marko
const $for_content__selected__OR__hovered__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope.a, [$scope._.d === $scope.e && "sel", $scope._.e === $scope.e && "hov"])), 2);
