...
const $walks = " b b b";
const $for_content__selected__OR__hovered__OR__row_id = /*@__PURE__*/ _or(5, /*@__PURE__*/ _render(($scope) => _attr_class($scope["#li/0"], [$scope._.selected === $scope.row_id && "sel", $scope._.hovered === $scope.row_id && "hov"])), 2);
...
const $for_content__row_label = /*@__PURE__*/ _render(($scope, row_label) => _text($scope["#text/1"], row_label));
