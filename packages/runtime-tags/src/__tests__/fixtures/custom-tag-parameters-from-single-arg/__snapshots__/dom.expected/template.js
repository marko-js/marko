...
const _count$customTag_content = /* @__PURE__ */_$.value("count/2", (_scope, count) => _$.data(_scope["#text/0"], count));
const _params_2$customTag_content = /* @__PURE__ */_$.value("_params_2/1", (_scope, _params_2) => _count$customTag_content(_scope, _params_2[0]));
