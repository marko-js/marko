...
_shells({
	...
	"__tests__/template.marko_2*shell": "__tests__/template.marko_2*shell __tests__/template.marko_2_input_suffix#7/init __tests__/template.marko_2_count#8/init;D ;<p> </p>"
});
var template_default = _template_patch("__tests__/template.marko", (input) => {
	...
	let count = 0;
	_html(`<main><h1>${_patch_text($scope0_id, "#text/0", input.heading, void 0, $scope0_reason, 0)}</h1>`);
	_for_of(input.rows, (row) => {
		...
		_for_of(row.cells, (cell) => {
			...
			}, "__tests__/template.marko", "5:6", { "#LoopKey": "5:10" }), _client_guard($scope0_reason, 2) && "__tests__/template.marko_2_input_suffix#7/subscribe"), "__tests__/template.marko_2_count#8/subscribe");
