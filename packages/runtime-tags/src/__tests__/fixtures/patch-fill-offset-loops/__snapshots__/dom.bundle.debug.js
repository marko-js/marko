...
const $for_content2__input_suffix = /*@__PURE__*/ _closure_get("input_suffix", $for_content2__input_suffix__OR__count, ($scope) => $scope._._);
const $for_content2__setup = ($scope) => {
	$for_content2__input_suffix($scope);
	$for_content2__count($scope);
};
const $for_content2__count = /*@__PURE__*/ _init_closure_get("__tests__/template.marko_2_count#8/init", "count", $for_content2__input_suffix__OR__count, ($scope) => $scope._._);
