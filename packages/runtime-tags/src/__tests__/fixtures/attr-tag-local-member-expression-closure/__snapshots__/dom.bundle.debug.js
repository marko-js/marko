...
const $Child_content__for = /*@__PURE__*/ _for_of("#text/0", "<!>", "%", 0, $for_content2__$params);
...
const $for = /*@__PURE__*/ _for_of("#text/0", $Child_content__template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Child_content__walks), 0, $for_content__$params);
