...
const $template = "<!><!><!>";
const $walks = "b%c";
const $item_content = /*@__PURE__*/ _content_closures(/*@__PURE__*/ _content("__tests__/template.marko_4_content", " ", " b"), { item_text: /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.item_text)) });
