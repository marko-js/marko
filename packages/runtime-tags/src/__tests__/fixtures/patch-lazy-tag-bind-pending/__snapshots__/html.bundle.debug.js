...
var child_default = _template_patch("__tests__/child.marko", (input) => {
	...
	$scope0_page ? _scope($scope0_id, { input_title: input.title }, "__tests__/child.marko", 0, {
...
_shells({ "__tests__/template.marko": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko;${_w0};${_w1}`)(((_w0) => `D%b/${_w0}&l`)(" b"), ((_w0) => `<main><!>${_w0}</main>`)($template$1)) });
