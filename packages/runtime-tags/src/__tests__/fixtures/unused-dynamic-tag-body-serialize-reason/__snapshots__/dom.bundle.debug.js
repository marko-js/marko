...
const $Wrap_content2 = _content("__tests__/template.marko_3*content", /*@__PURE__*/ ((_w0) => `<!>${_w0}<!>`)($Message_content__template), /*@__PURE__*/ ((_w0) => `b/${_w0}&b`)($Message_content__walks), $Wrap_content2__setup);
