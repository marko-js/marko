...
const $template = $Wrap_content__template;
const $walks = /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Wrap_content__walks);
_resume_dynamic_tag();
...
const $Wrap_content2 = _content_resume("__tests__/template.marko_3_content", $Message_content__template, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($Message_content__walks), $Wrap_content2__setup);
...
const $Wrap_content__dynamicTag = /*@__PURE__*/ _dynamic_tag("#text/0");
const $Wrap_content__as__OR__onClick__OR__content = /*@__PURE__*/ _or(6, ($scope) => $Wrap_content__dynamicTag($scope, $scope.as, () => ({
...
const $x = /*@__PURE__*/ _let("x/1", ($scope) => $Wrap_content__onClick($scope["#childScope/0"], $onClick($scope)));
