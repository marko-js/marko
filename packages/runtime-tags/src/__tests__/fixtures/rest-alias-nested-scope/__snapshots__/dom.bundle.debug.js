...
const $walks = "b%c";
const $setup = () => {};
const $if_content__input_value_foo = /*@__PURE__*/ _if_closure("#text/0", 0, /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.foo)));
const $if_content__setup = ($scope) => {
	$if_content__input_value_foo._($scope);
	$if_content__rest._($scope);
};
const $if_content__rest__render = /*@__PURE__*/ _render(($scope) => _attrs_content($scope, "#span/1", $scope._.rest));
...
const $if_content__rest = /*@__PURE__*/ _if_closure("#text/0", 0, ($scope) => {
	$if_content__rest__render($scope);
