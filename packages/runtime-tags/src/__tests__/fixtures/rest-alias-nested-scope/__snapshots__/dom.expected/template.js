...
const $if_content__input_value_foo = /* @__PURE__ */_._if_closure("#text/0", 0, $scope => _._text($scope["#text/0"], $scope._.foo));
...
const $input_value_foo = /* @__PURE__ */_._const("foo", $if_content__input_value_foo);
