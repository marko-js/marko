...
const $if = /*@__PURE__*/ _if(1, "<section><!></section>", "D%", $if_content__input_content);
...
// template.marko
const $Card_content__input_label = /*@__PURE__*/ _fill_join_closure("b0", 3, /*@__PURE__*/ _closure_get(4, ($scope) => _text($scope.a, $scope._.d), 0, "b0", 3), 0);
