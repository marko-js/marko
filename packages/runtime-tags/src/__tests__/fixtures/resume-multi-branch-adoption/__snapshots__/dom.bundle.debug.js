...
const $walks = " b b%c";
const $if_content__item__script = _script("__tests__/template.marko_2_item#2", ($scope) => $signal($scope, 0).onabort = () => _el_read($scope._._["#div/1"]).append(`destroyed ${$scope._.item}`));
