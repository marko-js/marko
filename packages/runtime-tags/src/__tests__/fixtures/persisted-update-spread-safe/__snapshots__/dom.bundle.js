...
const $attrs = _var_resume("a3", /*@__PURE__*/ _let_persisted(9, $input_title__OR__attrs));
const $count = _var_resume("a4", /*@__PURE__*/ _let_persisted(11, ($scope) => _text($scope.b, $scope.l)));
const $setup__script = _script_shared(($scope) => _on($scope.a, "click", function() {
	$count($scope, $scope.l + 1);
}));
const $input_title = _var_resume("a5", /*@__PURE__*/ _const_persisted(8, $input_title__OR__attrs));
