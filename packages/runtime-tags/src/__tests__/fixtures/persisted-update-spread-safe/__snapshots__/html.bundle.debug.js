...
var child_default = _template("__tests__/tags/child.marko", (input) => {
	...
	_html(`<div${_attr_class(_hole_value($scope0_id, "UpdateAttr:class:#div/0", input.class, _persisted_reason()))}${_attr("data-request", _hole_value($scope0_id, "UpdateAttr:data-request:#div/0", input["data-request"], _persisted_reason()))}></div>${_el_resume($scope0_id, "#div/0", $sg__input_class__OR__input_data_request)}`);
...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_update_child($scope0_id, "UpdateChild:#childScope/4", $childScope);
