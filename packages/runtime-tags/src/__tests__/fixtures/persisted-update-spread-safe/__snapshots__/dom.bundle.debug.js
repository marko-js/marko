...
_static_shells({ "__tests__/tags/child.marko_0_update": [$template$1, " b"] });
const $update2$1 = () => {};
...
const $attrs = _var_resume("__tests__/template.marko_0_attrs/var", /*@__PURE__*/ _let_persisted("attrs/9", $input_title__OR__attrs));
...
const $update2 = ($patch, $live) => {
	...
	if ("ConditionalRenderer:#text/5" in $patch) _update_region("#text/5")($patch, $live);
};
...
const $attrs = /*@__PURE__*/ _let_persisted("attrs/9", $input_title__OR__attrs);
