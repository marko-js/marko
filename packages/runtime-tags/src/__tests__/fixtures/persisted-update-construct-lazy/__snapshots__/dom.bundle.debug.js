...
const $Detail_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", $Detail_content__template, $Detail_content__walks, $Detail_content__setup);
...
_static_shells({
	"__tests__/template.marko_2_update": [$Detail_content__template, $Detail_content__walks],
	"__tests__/template.marko_2_content": [$Detail_content__template, $Detail_content__walks],
...
_static_shells({
	"__tests__/tags/gadget.marko_0_update": [$template, $walks],
	"__tests__/tags/gadget.marko": [$template, $walks]
});
...
const $Detail_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<h2 class=title> </h2><!><!><!>", "D l%/&", $Detail_content__setup);
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=home>welcome home</p>");
