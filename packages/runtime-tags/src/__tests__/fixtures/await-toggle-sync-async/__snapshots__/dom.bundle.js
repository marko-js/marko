...
const $showAsync__script = _script("a0", ($scope) => _on($scope.b, "click", function() {
	$showAsync($scope, !$scope.c);
}));
const $showAsync = /*@__PURE__*/ _let(2, ($scope) => {
	$await_promise($scope, $scope.c ? resolveAfter("ASYNC") : "SYNC");
