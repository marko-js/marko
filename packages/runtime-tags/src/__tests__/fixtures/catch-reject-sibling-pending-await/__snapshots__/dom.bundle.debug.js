...
const $await_content2 = /*@__PURE__*/ _await_content("#text/0", "slow sibling");
const $try_content2__await_promise = /*@__PURE__*/ _await_promise("#text/0");
const $await_content3 = /*@__PURE__*/ _await_content("#text/1", "never");
...
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_3*content", "loading outer...");
const $await_content__changes = /*@__PURE__*/ _closure_get("changes", ($scope) => _text($scope["#text/2"], $scope._._.changes), ($scope) => $scope._._, "__tests__/template.marko_2_changes#1/subscribe");
