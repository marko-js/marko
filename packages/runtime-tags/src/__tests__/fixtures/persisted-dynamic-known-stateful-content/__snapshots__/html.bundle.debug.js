...
var card_default = _template_persisted("__tests__/card.marko", (input) => {
	...
	$scope0_reason ? _scope($scope0_id, {
		...
		input_content: ["input.content"],
		open: "1:6"
	}) : _filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/card.marko0", input.content);
}, 0, 0);
...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	}, "__tests__/template.marko", 0, { input_label: ["input.label"] }) : _filled_guard($scope0_owned, 0) && _patch_value($scope0_id, "__tests__/template.marko0", input.label);
}, 1, () => [card_default]);
