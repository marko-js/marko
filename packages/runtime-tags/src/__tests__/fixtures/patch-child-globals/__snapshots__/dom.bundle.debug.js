...
const $walks$1 = "D l";
const $global_brand = /*@__PURE__*/ _global_join("brand", "__tests__/tags/widget/index.marko_0_$global_brand#1/global", ($scope, $global_brand) => _text($scope["#text/0"], $scope.$global.brand));
function $setup$1($scope) {
	$global_brand($scope, $scope.$global.brand);
}
var widget_default = /*@__PURE__*/ _template_patch("__tests__/tags/widget/index.marko", $template$1, "D l", $setup$1);
