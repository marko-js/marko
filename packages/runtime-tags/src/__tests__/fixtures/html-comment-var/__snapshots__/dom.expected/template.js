...
const _spanName = _$.registerBoundSignal("__tests__/template.marko_0_spanName/var", /* @__PURE__ */_$.value("spanName/7", (_scope, spanName) => _$.data(_scope["#text/5"], spanName)));
const _divName = _$.registerBoundSignal("__tests__/template.marko_0_divName/var", /* @__PURE__ */_$.value("divName/6", (_scope, divName) => _$.data(_scope["#text/2"], divName)));
