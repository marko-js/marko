...
const _spanName = _$.registerBoundSignal("__tests__/template.marko_0_spanName/var", /* @__PURE__ */_$.value("spanName", (_scope, spanName) => _$.data(_scope["#text/3"], spanName)));
const _divName = _$.registerBoundSignal("__tests__/template.marko_0_divName/var", /* @__PURE__ */_$.value("divName", (_scope, divName) => _$.data(_scope["#text/1"], divName)));
