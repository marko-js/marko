...
const $divName = _var_resume("__tests__/template.marko_0_divName/var", /*@__PURE__*/ _render(($scope, divName) => _text($scope["#text/2"], divName)));
...
const $spanName = _var_resume("__tests__/template.marko_0_spanName/var", /*@__PURE__*/ _render(($scope, spanName) => _text($scope["#text/5"], spanName)));
