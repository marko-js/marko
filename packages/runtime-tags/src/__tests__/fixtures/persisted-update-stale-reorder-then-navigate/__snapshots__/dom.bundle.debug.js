...
const $try_content__walks = "b%c", $try_content__template = "<!><!><!>", $await_content__walks = " D l", $await_content__template = "<button> </button>";
const $template = "<h1><!> clicked <!></h1><main><!></main>";
const $walks = " D%c%lD%l";
_enable_catch();
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "fetching…");
...
_static_shells({
	"__tests__/template.marko_2_update": [$await_content__template, $await_content__walks],
	"__tests__/template.marko_2_content": [$await_content__template, $await_content__walks],
...
_construct("__tests__/template.marko_2_update", $await_content__construct);
_construct("__tests__/template.marko_0_update", $construct);
const $noop_update = () => {};
_update_content("__tests__/template.marko_3_content", $noop_update);
_update_content("__tests__/template.marko_2_update", $await_content__update);
...
const $walks = " D%c%lD%l";
_enable_catch();
const $placeholder_content = _content_resume("__tests__/template.marko_3_content", "fetching…");
