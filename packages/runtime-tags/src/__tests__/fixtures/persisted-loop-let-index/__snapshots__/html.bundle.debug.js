// template.marko
_renderer_shells({ "__tests__/template.marko_1_shell": ",`__tests__/template.marko_1_shell __tests__/template.marko_1;D bD l ;<li> <span> </span><button>+</button></li>`" });
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	const $scope0_owned = _persisted_ownership(), $scope0_reason = _persisted_reason(), $sg__input_labels = _serialize_guard($scope0_reason, 0);
	...
	}, 0, $scope0_id, "#ul/0", $sg__input_labels, $sg__input_labels, $sg__input_labels, void 0, void 0, "__tests__/template.marko_1_shell");
