...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_for_of(input.labels, (label) => {
		...
		let picks = 0;
		_html(`<li>${_patch_text($scope1_id, "#text/0", label, void 0, $scope0_owned, 0)}<span>${_text_resume($scope1_id, "#text/1", picks)}</span><button>+</button>${_el_resume($scope1_id, "#button/2")}</li>`);
	...
	}, 0, $scope0_id, "#ul/0", 1, $sg__input_labels, $sg__input_labels, void 0, void 0, "__tests__/template.marko_1*shell", $scope0_owned, 0);
