...
export default _._template("__tests__/tags/list/index.marko", input => {
  ...
  _._for_of(input.item, item => {
    ...
    _._serialize_guard($scope0_reason, /* input.item */0) && _._scope($scope1_id, {}, "__tests__/tags/list/index.marko", "1:1");
  ...
  _._serialize_guard($scope0_reason, /* input.item */0) && _._scope($scope0_id, {}, "__tests__/tags/list/index.marko", 0);
});