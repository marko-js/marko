...
var template_default = _template_persisted("a", (input) => {
	...
	widget_default({ content: _content_elide("a0", () => {
		...
		}, $scope1_id, "a", 1, $sg__input_kind, $sg__input_kind, void 0, void 0, ["a2", "a1"], $scope0_owned, 0);
		$scope0_reason && _subscribe(_unfilled_if($scope0_owned, 0) && $input_kind__closures, _scope($scope1_id, { _: _scope_with_id($scope0_id) }));
