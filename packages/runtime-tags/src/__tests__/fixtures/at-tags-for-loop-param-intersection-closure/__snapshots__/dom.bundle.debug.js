...
const $item_content__mult__OR__item = /*@__PURE__*/ _or(2, ($scope) => _text($scope["#text/0"], $scope.item * $scope._.mult));
const $item_content__mult = /*@__PURE__*/ _closure_get("mult/4", $item_content__mult__OR__item, 0, "__tests__/template.marko_1_mult#3/subscribe");
