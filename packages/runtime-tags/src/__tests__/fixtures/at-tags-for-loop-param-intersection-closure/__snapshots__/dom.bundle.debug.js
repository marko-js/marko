...
const $item_content__mult__OR__item = /*@__PURE__*/ _or(1, /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope.item * $scope._.mult)));
...
const $mult__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope.mult));
