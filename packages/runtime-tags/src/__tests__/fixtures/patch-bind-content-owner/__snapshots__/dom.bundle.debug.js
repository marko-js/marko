...
const $frame_content__input_show = /*@__PURE__*/ _closure_get("input_show", ($scope) => $frame_content__if($scope, $scope._.input_show ? 0 : 1), 0, "__tests__/template.marko_1_input_show#6/subscribe");
