...
const $template$1 = "";
const $walks$1 = "";
const $Content_content__input_label = /*@__PURE__*/ _fill_join_closure("__tests__/tags/child.marko0", "input_label", /*@__PURE__*/ _closure_get("input_label", ($scope) => _text($scope["#text/1"], $scope._.input_label)), 0);
...
const $Content_content__count = /*@__PURE__*/ _closure_get("count", ($scope) => _text($scope["#text/2"], $scope._.count));
