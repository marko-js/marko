...
var price_card_default = /*@__PURE__*/ _template_patch("__tests__/tags/price-card.marko", $template$1, $walks$1, $setup$1, $input$1);
...
const $card = _var_resume("__tests__/template.marko_0_card#8/var", /*@__PURE__*/ _const("card"));
