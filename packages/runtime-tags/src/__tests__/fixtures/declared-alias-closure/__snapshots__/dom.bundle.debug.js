...
const $if_content__value_class = /*@__PURE__*/ _closure_get("value_class/5", ($scope) => _attr_class($scope["#span/0"], $scope._._.value_class), ($scope) => $scope._._);
const $if_content__setup = ($scope) => {
	$if_content__value_class($scope);
	$if_content__text($scope);
};
const $if_content__text = /*@__PURE__*/ _closure_get("text/6", ($scope) => _text($scope["#text/1"], $scope._._.text), ($scope) => $scope._._);
const $Child_content__if = /*@__PURE__*/ _if("#text/0", "<span> </span>", " D ", $if_content__setup);
const $Child_content__value = /*@__PURE__*/ _closure_get("value/4", ($scope) => $Child_content__if($scope, $scope._.value ? 0 : 1));
