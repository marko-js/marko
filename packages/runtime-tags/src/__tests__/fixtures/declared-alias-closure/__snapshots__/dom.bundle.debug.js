...
const $Child_content2__input__render = /*@__PURE__*/ _render(($scope) => _attrs_content($scope, "#div/0", $scope.input));
...
const $Child_content2__input = /*@__PURE__*/ _const("input", ($scope) => {
	$Child_content2__input__render($scope);
	$Child_content2__input__script($scope);
});
const $Child_content2__$params = ($scope, $params2) => $Child_content2__input($scope, $params2[0]);
const $if_content__value_class = /*@__PURE__*/ _closure_get("value_class", /*@__PURE__*/ _render(($scope) => _attr_class($scope["#span/0"], $scope._._.value_class)), ($scope) => $scope._._);
const $if_content__setup = ($scope) => {
	$if_content__value_class($scope);
	$if_content__text($scope);
};
const $if_content__text = /*@__PURE__*/ _closure_get("text", /*@__PURE__*/ _render(($scope) => _text($scope["#text/1"], $scope._._.text)), ($scope) => $scope._._);
