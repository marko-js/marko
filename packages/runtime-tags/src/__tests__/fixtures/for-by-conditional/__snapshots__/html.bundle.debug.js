...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_for_of(input.items, (item) => {
		...
		_html(`<div>${_text_resume($scope1_id, "#text/0", item.name, $sg__input_items__OR__input_useKey)}</div>`);
		$si__input_items__OR__input_useKey && _scope($scope1_id, {}, "__tests__/template.marko", "1:2");
