...
const $if_content = /* @__PURE__ */_$.createRenderer(`<div>${_counter_template}</div>`, /* next(1), beginChild, _counter_walks, endChild, out(1) */`D/${_counter_walks}&l`, $setup$if$content);
