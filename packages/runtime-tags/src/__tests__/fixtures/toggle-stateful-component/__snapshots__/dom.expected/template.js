...
const _onCount$if_content = /* @__PURE__ */_$.conditionalClosure("onCount/2", "#div/0", 0, (_scope, onCount) => _counter_input_onCount(_scope["#childScope/0"], onCount));
...
const _onCount = /* @__PURE__ */_$.value("onCount/2");
