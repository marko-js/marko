...
const _onCount$if_content = /* @__PURE__ */_$.conditionalClosure("onCount", "#div/0", 0, (_scope, onCount) => _counter_input_onCount(_scope["#childScope/0"], onCount), () => /* @__PURE__ */_$.inChild("#childScope/0", _counter_input_onCount));
