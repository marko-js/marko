...
const $box_content__input_a = /*@__PURE__*/ _fill_join_closure("a0", 6, /*@__PURE__*/ _closure_get(9, $box_content__input_a__OR__count, ($scope) => $scope._._, "a5", 6), 0);
const $box_content__setup = ($scope) => {
	$box_content__input_a($scope);
	$box_content__count($scope);
};
const $box_content__count = /*@__PURE__*/ _closure_get(10, $box_content__input_a__OR__count, ($scope) => $scope._._, "a6", 8);
