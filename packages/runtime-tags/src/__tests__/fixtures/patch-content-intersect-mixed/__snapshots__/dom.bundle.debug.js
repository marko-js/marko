...
const $box_content__input_a = /*@__PURE__*/ _fill_join_closure("__tests__/template.marko0", "input_a", /*@__PURE__*/ _closure_get("input_a", $box_content__input_a__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_input_a#6/subscribe"), 0);
const $box_content__setup = ($scope) => {
	$box_content__input_a($scope);
	$box_content__count($scope);
};
const $box_content__count = /*@__PURE__*/ _closure_get("count", $box_content__input_a__OR__count, ($scope) => $scope._._, "__tests__/template.marko_2_count#8/subscribe");
