...
var panel_default = _template("__tests__/tags/panel.marko", (input) => {
	...
	writeScope($scope0_id, { hits: _seed_fill(_state_reason() && hits) }, "__tests__/tags/panel.marko", 0, { hits: "1:6" });
	_resume_branch($scope0_id);
});
_renderer_shells({
	"__tests__/tags/panel.marko_0_update": ["<button class=panel><!> hit <!></button>", " D%c%l"],
	"__tests__/tags/panel.marko": ["<button class=panel><!> hit <!></button>", " D%c%l"]
});
