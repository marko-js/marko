...
var template_default = _template("a", (input) => {
	...
	_dynamic_tag($scope0_id, "d", input.show ? $Panel_withLoadAssets : null, { label: input.label }, 0, 0, _serialize_guard($scope0_reason, 0) | _persisted_reason(), "a1");
	_script($scope0_id, "a0");
	writeScope($scope0_id, {
		h: (_serialize_if($scope0_reason, 3) || _update_reason()) && input.show,
		i: (_serialize_if($scope0_reason, 2) || _update_reason()) && input.label,
