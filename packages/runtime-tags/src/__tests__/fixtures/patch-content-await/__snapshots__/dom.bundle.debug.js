...
const $walks = " b";
const $setup = () => {};
const $await_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => _text($scope["#text/0"], $scope._._._.input_value), ($scope) => $scope._._._, "__tests__/template.marko_3_input_value#4/subscribe");
...
const $card_content__input_value = /*@__PURE__*/ _closure_get("input_value", ($scope) => $card_content__await_promise($scope, Promise.resolve($scope._._.input_value)), ($scope) => $scope._._, "__tests__/template.marko_2_input_value#4/subscribe");
