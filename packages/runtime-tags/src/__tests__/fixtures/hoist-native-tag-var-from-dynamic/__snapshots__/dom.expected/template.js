...
const $inputshowChildnull_content__$hoisted_el__script = _._script("__tests__/template.marko_2_$hoisted_el2", $scope => {
  for (const element of $scope.$hoisted_el2) {
...
const $hoisted_el6__script = _._script("__tests__/template.marko_0_$hoisted_el3", $scope => {
  for (const element of $scope.$hoisted_el3) {
    element().classList.add('outer');
  }
});
const $hoisted_el6 = /* @__PURE__ */_._const("$hoisted_el3", $hoisted_el6__script);
const $hoisted_el5__script = _._script("__tests__/template.marko_0_$hoisted_el", $scope => {
  for (const element of $scope.$hoisted_el) {
