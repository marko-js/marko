...
const _get_hoisted_el = _$.hoist("#p/0>", "#text/2?");
const _inputShowSectionNull_content = _$.registerContent("__tests__/template.marko_4_renderer", "<p></p>", /* get */" ", 0, 0, "#text/2?");
const _get_hoisted_el2 = _$.register("__tests__/template.marko_2/_hoisted_el2", _$.hoist("#div/0>", "#childScope/0?"));
const _get_hoisted_el3 = _$.register("__tests__/template.marko_0/_hoisted_el3", _$.hoist("#div/0>", "#childScope/0?", "#text/1?"));
const _child_content2 = _$.registerContent("__tests__/template.marko_3_renderer", "<div></div>", /* get */" ", 0, 0, "#childScope/0?");
...
const _inputShowChildNull_content = _$.registerContent("__tests__/template.marko_2_renderer", `<!>${_child_template}<!>`, /* beginChild, _child_walks, endChild */`D/${_child_walks}&D`, _setup$inputShowChildNull_content, 0, "#text/1?");
const _get_hoisted_el4 = _$.register("__tests__/template.marko_0/_hoisted_el", _$.hoist("#span/0>", "#childScope/0?"));
const _child_content = _$.registerContent("__tests__/template.marko_1_renderer", "<span></span>", /* get */" ", 0, 0, "#childScope/0?");
