...
const $inputshowsectionnull_content = _$.registerContent("__tests__/template.marko_4_renderer", "<p></p>", /* get, over(1) */" b", 0, 0, "ClosureScopes:4");
...
const $child_content2 = /* @__PURE__ */_$.createContent("__tests__/template.marko_3_renderer", "<div></div>", /* get, over(1) */" b", 0, 0, "ClosureScopes:3");
...
const $inputshowChildnull_content = _$.registerContent("__tests__/template.marko_2_renderer", `<!>${_child_template}<!>`, /* over(1), beginChild, _child_walks, endChild, over(1) */`b/${_child_walks}&b`, $setup$inputshowChildnull$content, 0, "ClosureScopes:2");
const $get$hoisted_el4 = _$.register("__tests__/template.marko_0_$hoisted_el/hoist", _$.hoist("Getter:#span/0", "ClosureScopes:1"));
const $child_content = /* @__PURE__ */_$.createContent("__tests__/template.marko_1_renderer", "<span></span>", /* get, over(1) */" b", 0, 0, "ClosureScopes:1");
