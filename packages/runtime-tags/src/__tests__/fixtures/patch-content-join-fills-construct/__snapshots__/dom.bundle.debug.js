...
_resumed["__tests__/tags/box.marko_0/valueChange"] = $valueChange;
var box_default = /*@__PURE__*/ _template("__tests__/tags/box.marko", "", "", $setup$3);
...
const $input$2 = ($scope, input) => $input_base($scope, input.base);
...
const $input$1 = ($scope, input) => $input_aside($scope, input.aside);
var panel_default = /*@__PURE__*/ _template("__tests__/tags/panel.marko", $template$1, $walks$1, 0, $input$1);

// page.marko
const $template = /*@__PURE__*/ ((_w0) => `${_w0}<button class=bonus>bonus</button><!><!>`)("");
const $walks = /*@__PURE__*/ ((_w0) => `0${_w0}& b%c`)("");
const $aside_content__bonus__OR__p_base__OR__item_n = /*@__PURE__*/ _fill_join_subscribers("__tests__/page.marko1", "item_n", /*@__PURE__*/ _fill_join_subscribers("__tests__/page.marko0", "p_base", /*@__PURE__*/ _or(1, ($scope) => $input_base($scope["#childScope/0"], ($scope._._.bonus ?? $scope._._.p_base) + $scope._.item_n), 2), () => $aside_content__p_base, 0), () => $aside_content__item_n, 0);
const $aside_content__bonus = /*@__PURE__*/ _init_closure_get("__tests__/page.marko_2_bonus#7/init", "bonus", $aside_content__bonus__OR__p_base__OR__item_n, ($scope) => $scope._._, "__tests__/page.marko_2_bonus#7/subscribe");
...
const $aside_content__p_base = /*@__PURE__*/ _fill_join_closure("__tests__/page.marko0", "p_base", /*@__PURE__*/ _init_closure_get("__tests__/page.marko_2_p_base#9/init", "p_base", $aside_content__bonus__OR__p_base__OR__item_n, ($scope) => $scope._._, "__tests__/page.marko_2_p_base#9/subscribe"), 0);
const $aside_content__item_n = /*@__PURE__*/ _fill_join_closure("__tests__/page.marko1", "item_n", /*@__PURE__*/ _init_closure_get("__tests__/page.marko_2_item_n#3/init", "item_n", $aside_content__bonus__OR__p_base__OR__item_n, 0, "__tests__/page.marko_2_item_n#3/subscribe"), 0);
...
const $for_content__item_n = /*@__PURE__*/ _fill_const("__tests__/page.marko1", "item_n", $for_content__item_n__closure);
...
const $p_base = /*@__PURE__*/ _fill_const("__tests__/page.marko0", "p_base", $p_base__closure);
const $for = /*@__PURE__*/ _for_of_unkeyed("#text/3", $template$1, /*@__PURE__*/ ((_w0) => `/${_w0}&`)($walks$1), $for_content__setup, $for_content__$params);
