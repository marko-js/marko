...
const $aside_content__bonus = /*@__PURE__*/ _init_closure_get("a7", 11, $aside_content__bonus__OR__p_base__OR__item_n, ($scope) => $scope._._, "a10", 7);
const $aside_content__p_base = /*@__PURE__*/ _fill_join_closure("a0", 9, /*@__PURE__*/ _init_closure_get("a8", 12, $aside_content__bonus__OR__p_base__OR__item_n, ($scope) => $scope._._, "a11", 9), 0);
const $aside_content__item_n = /*@__PURE__*/ _fill_join_closure("a1", 3, /*@__PURE__*/ _init_closure_get("a9", 4, $aside_content__bonus__OR__p_base__OR__item_n, 0, "a12", 3), 0);
