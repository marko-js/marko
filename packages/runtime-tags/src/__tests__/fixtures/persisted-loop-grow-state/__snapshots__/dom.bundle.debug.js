...
const $for_content__count = /*@__PURE__*/ _init_for_closure("__tests__/template.marko_1_count#6/init", "#text/0", $for_content__input_title__OR__count__OR__item);
const $for_content__item = /*@__PURE__*/ _fill_const("__tests__/template.marko1", "item", $for_content__input_title__OR__count__OR__item);
