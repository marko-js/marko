...
var doubler_default = /*@__PURE__*/ _template_patch("__tests__/tags/doubler/index.marko", $template$2, "b", 0, $input$1);
...
var shower_default = /*@__PURE__*/ _template_patch("__tests__/tags/shower/index.marko", $template$1, "D l", 0, $input);
...
const $double = _var_resume("__tests__/template.marko_0_double#5/var", ($scope, double) => $input_value($scope["#childScope/2"], double));
