...
const $placeholder_content4 = /*@__PURE__*/ _content("__tests__/template.marko_11*content", "LOADING B2");
const $placeholder_content3 = /*@__PURE__*/ _content("__tests__/template.marko_10*content", "LOADING B1");
...
const $try_content4__promiseB = /*@__PURE__*/ _closure_get("promiseB", ($scope) => $try_content4__await_promise($scope, $scope._._._.promiseB), ($scope) => $scope._._._);
...
const $try_content3__promiseB = /*@__PURE__*/ _closure_get("promiseB", ($scope) => $try_content3__await_promise($scope, $scope._.promiseB));
...
const $placeholder_content2 = /*@__PURE__*/ _content("__tests__/template.marko_5*content", "LOADING A2");
const $placeholder_content = /*@__PURE__*/ _content("__tests__/template.marko_4*content", "LOADING A1");
...
const $try_content2__promiseA = /*@__PURE__*/ _closure_get("promiseA", ($scope) => $try_content2__await_promise($scope, $scope._._._.promiseA), ($scope) => $scope._._._);
