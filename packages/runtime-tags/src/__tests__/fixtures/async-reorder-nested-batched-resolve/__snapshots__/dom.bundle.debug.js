...
const $try_content4__promiseB = /*@__PURE__*/ _closure_get("promiseB", ($scope) => $try_content4__await_promise($scope, $scope._._._.promiseB), ($scope) => $scope._._._, "__tests__/template.marko_9_promiseB#4/pending");
...
const $try_content3__promiseB = /*@__PURE__*/ _closure_get("promiseB", ($scope) => $try_content3__await_promise($scope, $scope._.promiseB), 0, "__tests__/template.marko_7_promiseB#4/pending");
...
const $placeholder_content2 = _content_resume("__tests__/template.marko_5*content", "LOADING A2");
const $placeholder_content = _content_resume("__tests__/template.marko_4*content", "LOADING A1");
...
const $try_content2__promiseA = /*@__PURE__*/ _closure_get("promiseA", ($scope) => $try_content2__await_promise($scope, $scope._._._.promiseA), ($scope) => $scope._._._, "__tests__/template.marko_3_promiseA#1/pending");
