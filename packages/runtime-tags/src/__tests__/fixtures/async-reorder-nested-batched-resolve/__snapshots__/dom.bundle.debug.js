...
const $try_content4__promiseB = _closure_get("promiseB", ($scope) => $try_content4__await_promise($scope, $scope._._._.promiseB), ($scope) => $scope._._._, "__tests__/template.marko_9_promiseB#4/pending");
...
const $try_content3__promiseB = _closure_get("promiseB", ($scope) => $try_content3__await_promise($scope, $scope._.promiseB), 0, "__tests__/template.marko_7_promiseB#4/pending");
...
const $try_content2__promiseA = _closure_get("promiseA", ($scope) => $try_content2__await_promise($scope, $scope._._._.promiseA), ($scope) => $scope._._._, "__tests__/template.marko_3_promiseA#1/pending");
