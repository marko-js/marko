...
const $placeholder_content4 = _content("__tests__/template.marko_11*content", "LOADING B2");
const $placeholder_content3 = _content("__tests__/template.marko_10*content", "LOADING B1");
const $await_content4 = /*@__PURE__*/ _await_content("#text/0", "<div level=4></div>", " ");
const $try_content4__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content4__$params);
const $try_content4__promiseB = /*@__PURE__*/ _closure_get("promiseB/5", ($scope) => $try_content4__await_promise($scope, $scope._._._.promiseB), ($scope) => $scope._._._);
...
const $try_content3__promiseB = /*@__PURE__*/ _closure_get("promiseB/5", ($scope) => $try_content3__await_promise($scope, $scope._.promiseB));
...
const $placeholder_content = _content("__tests__/template.marko_4*content", "LOADING A1");
const $await_content2 = /*@__PURE__*/ _await_content("#text/0", "<div level=2><!></div>", " D%", $await_content2__setup);
const $try_content2__await_promise = /*@__PURE__*/ _await_promise("#text/0", $await_content2__$params);
const $try_content2__promiseA = /*@__PURE__*/ _closure_get("promiseA/2", ($scope) => $try_content2__await_promise($scope, $scope._._._.promiseA), ($scope) => $scope._._._);
...
const $try_content__promiseA = /*@__PURE__*/ _closure_get("promiseA/2", ($scope) => $try_content__await_promise($scope, $scope._.promiseA));
