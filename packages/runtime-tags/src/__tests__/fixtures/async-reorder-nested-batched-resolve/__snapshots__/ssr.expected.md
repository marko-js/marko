...
# Write
```html
  <t M_=c><div class=a level=1><!--M_[5--><!--M_[6--><div class=a level=2><!--M_[7--><!--M_!^d-->LOADING B1<!--M_!d--><!--M_]6 #text/1--></div><!--M_]5 #text/0--><!--M_]4 #text/1--></div></t><t M_=d><!--M_#e--></t><script>M._.r.push(_=>(_.g=[1,_.e={"ConditionalScope:#text/1":_.f={"#BranchAccessor":"#text/1"}},_.f],_.f["#PlaceholderContent"]=_._["__tests__/template.marko_5_renderer"](_.e),_.g),_=>(_.c.f("a"),_.h=[]),_=>(_.l=[_.i={"ConditionalScope:#text/1":_.j={"#BranchAccessor":"#text/1"},promiseB:new Promise((f,r)=>_.k={f,r})},_.j],_.j["#PlaceholderContent"]=_._["__tests__/template.marko_10_renderer"](_.i),(_.f["ConditionalScope:#text/0"]=_.i),_.l));M._.w()</script>
```

# Write
```html
  <t M_=e><div class=b level=3><!--M_[10--><div class=b level=4></div><!--M_]9 #text/1--></div></t><script>M._.r.push(_=>(_.o=[1,_.m={"ConditionalScope:#text/1":_.n={"#BranchAccessor":"#text/1"}},_.n],_.n["#PlaceholderContent"]=_._["__tests__/template.marko_11_renderer"](_.m),_.o),_=>(_.k.f("b"),_.p=[]));M._.w()</script>
```
