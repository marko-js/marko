...
const $walks = "D%b l";
const $for_content2__item = /*@__PURE__*/ _for_closure("#text/0", ($scope) => _text($scope["#text/0"], $scope._.item));
...
const $for_content__for = /*@__PURE__*/ _for_of_unkeyed("#text/0", "<li><!><!></li>", "D%b%", $for_content2__setup, $for_content2__$params);
