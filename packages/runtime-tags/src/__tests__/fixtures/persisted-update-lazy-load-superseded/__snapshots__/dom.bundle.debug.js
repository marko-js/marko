...
const $Resolve_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<!><!><!><!>", "b%/&c", $Resolve_content__setup);
...
const $Reject_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<!><!><!><!>", "b%/&c", $Reject_content__setup);
const $Home_content__setup = ($scope) => _text($scope["#text/0"], $scope.$global.label);
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=home> </p>", "D l", $Home_content__setup);
