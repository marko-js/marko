...
const $template = "<!><!><!><!>";
const $walks = "b%b%c";
const $await_content2__v__script = _script("__tests__/template.marko_4_v#2", ($scope) => console.log("effect " + $scope.v));
const $await_content2__v = /*@__PURE__*/ _const("v", ($scope) => {
...
const $await_content__value = /*@__PURE__*/ _closure_get("value/3", ($scope) => _text($scope["#text/1"], $scope._._.value), ($scope) => $scope._._, "__tests__/template.marko_2_value#2/subscribe");
