...
_static_shells({
	"__tests__/tags/layout.marko_0_update": [$template$2, $walks$2],
	"__tests__/tags/layout.marko": [$template$2, $walks$2]
});
...
const $merge$2 = _resume("__tests__/tags/layout.marko_0_update", $update2$2);
_update_content("__tests__/tags/layout.marko", $merge$2);
...
_static_shells({
	"__tests__/tags/frame.marko_0_update": [$template$1, "D%l"],
	"__tests__/tags/frame.marko": [$template$1, "D%l"]
});
const $update2$1 = ($patch, $live) => {
	if ("ConditionalRenderer:#text/0" in $patch || "BranchScopes:#text/0" in $patch) _update_dynamic($patch, $live, "ConditionalRenderer:#text/0", "BranchScopes:#text/0");
};
const $merge$1 = _resume("__tests__/tags/frame.marko_0_update", $update2$1);
_update_content("__tests__/tags/frame.marko", $merge$1);
...
const $Dashboard_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", $Dashboard_content__template, $Dashboard_content__walks, $Dashboard_content__setup);
const $frame_content__Home__OR__Dashboard = /*@__PURE__*/ _or(5, ($scope) => $input_content$1($scope["#childScope/2"], $scope.$global.view === "dashboard" ? $scope._.Dashboard : $scope._.Home));
const $frame_content__Home = /*@__PURE__*/ _closure_get("Home", ($scope) => {
	if (!updating) $frame_content__Home__OR__Dashboard($scope);
});
const $frame_content__count = _var_resume("__tests__/template.marko_2_count/var", /*@__PURE__*/ _let_persisted("count/4", ($scope) => _text($scope["#text/1"], $scope.count)));
...
const $frame_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", $frame_content__template, $frame_content__walks, $frame_content__setup);
...
_static_shells({
	"__tests__/template.marko_3_update": [$Dashboard_content__template, $Dashboard_content__walks],
	"__tests__/template.marko_3_content": [$Dashboard_content__template, $Dashboard_content__walks],
	"__tests__/template.marko_2_update": [$frame_content__template, $frame_content__walks],
	"__tests__/template.marko_2_content": [$frame_content__template, $frame_content__walks],
...
const $Dashboard_content__construct = ($scope) => {
	_text($scope["#text/1"], $scope.tally);
...
const $frame_content__update = ($patch, $live) => {
	...
	if ("#childScope/2" in $patch) $merge$2($patch["#childScope/2"], $live["#childScope/2"]);
};
const $construct = ($scope) => {
	_construct_child($scope, "#childScope/0", "__tests__/tags/frame.marko_0_update");
};
const $update2 = ($patch, $live) => {
	if ("#childScope/0" in $patch) $merge$1($patch["#childScope/0"], $live["#childScope/0"]);
};
_construct("__tests__/template.marko_3_update", $Dashboard_content__construct);
_construct("__tests__/template.marko_2_update", $frame_content__construct);
_construct("__tests__/template.marko_0_update", $construct);
_update_content("__tests__/template.marko_3_content", $Dashboard_content__update, $Dashboard_content__construct);
_update_content("__tests__/template.marko_2_content", $frame_content__update, $frame_content__construct);
const $noop_update = () => {};
...
const $Dashboard_content = /*@__PURE__*/ _content("__tests__/template.marko_3_content", "<button class=bump>tally <!></button><p class=greeting>hello <!></p>", " Db%lDb%", $Dashboard_content__setup);
const $frame_content__Home__OR__Dashboard = /*@__PURE__*/ _or(5, ($scope) => $input_content$1($scope["#childScope/2"], $scope.$global.view === "dashboard" ? $scope._.Dashboard : $scope._.Home));
const $frame_content__Home = /*@__PURE__*/ _closure_get("Home", ($scope) => {
	if (!updating) $frame_content__Home__OR__Dashboard($scope);
});
const $frame_content__count = /*@__PURE__*/ _let_persisted("count/4", ($scope) => _text($scope["#text/1"], $scope.count));
...
const $frame_content = /*@__PURE__*/ _content("__tests__/template.marko_2_content", /*@__PURE__*/ ((_w0) => `<button class=count>clicked <!></button>${_w0}<!>`)($template$2), /*@__PURE__*/ ((_w0) => ` Db%l/${_w0}&%b`)($walks$2), $frame_content__setup);
const $Home_content = /*@__PURE__*/ _content("__tests__/template.marko_1_content", "<p class=home>welcome home</p>");
const $Home = /*@__PURE__*/ _const_persisted("Home");
const $Dashboard = /*@__PURE__*/ _const_persisted("Dashboard");
function $setup($scope) {
