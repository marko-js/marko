...
const $Tag_content2__name = /*@__PURE__*/ _closure_get("name", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], _assert_init($scope._, "name"))));
const $Tag_content2__setup = $Tag_content2__name;
const $Tag_content2 = /*@__PURE__*/ _content("__tests__/template.marko_2_content", "<div> </div>", "D l", $Tag_content2__setup);
