...
var template_default = _template_persisted("__tests__/template.marko", (input) => {
	...
	_attr_select_value($scope0_id, "#select/0", input.picked, void 0, () => {
		...
		_for_of(input.options, (o) => {
			...
			_html(`<option${_patch_attr_option_value($scope1_id, "#option/0", o.value, $scope0_owned, 1)}>${_patch_text($scope1_id, "#text/1", o.label, void 0, $scope0_owned, 1)}</option>${_el_resume($scope1_id, "#option/0")}`);
			_scope($scope1_id, {}, "__tests__/template.marko", "4:6");
		}, (o) => o.id, $scope0_id, "#select/0", 1, 1, _source_guard($scope0_reason, 1), void 0, void 0, "__tests__/template.marko_1*shell", $scope0_owned, 1);
		_html("</select>");
	});
