...
var child_default = _template("__tests__/child.marko", (input) => {
	...
	_html_opens("__tests__/child.marko:1:1"), _html(`<span class=child>${_escape(input.value)}${_el_resume($scope0_id, "#text/1", _serialize_guard($scope0_reason, 0))}</span>${_el_resume($scope0_id, "#span/0")}`);
