...
_shells({
	...
	"__tests__/template.marko_1*shell": /*@__PURE__*/ ((_w0, _w1) => `__tests__/template.marko_1*shell;${_w0};${_w1}`)(/*@__PURE__*/ ((_w0) => `D%b/${_w0}&l`)($walks$1), /*@__PURE__*/ ((_w0) => `<main><!>${_w0}</main>`)($template$1))
});
