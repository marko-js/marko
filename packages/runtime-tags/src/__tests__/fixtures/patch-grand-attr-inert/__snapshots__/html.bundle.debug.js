...
const $walks$2 = "D l";
_shells({ "__tests__/tags/mid/tags/leaf/index.marko": "__tests__/tags/mid/tags/leaf/index.marko;D ;<pre> </pre>" });
var leaf_default = _template_patch("__tests__/tags/mid/tags/leaf/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	_html(`<pre>${_patch_text($scope0_id, "#text/0", input.stamp, void 0, $scope0_reason, 0)}</pre>`);
	$scope0_page && _scope($scope0_id, {}, "__tests__/tags/mid/tags/leaf/index.marko", 0);
}, 0, 0);
...
var mid_default = _template_patch("__tests__/tags/mid/index.marko", (input) => {
	const $scope0_reason = _scope_reason(), $scope0_page = _page_render();
	const $scope0_id = _scope_id();
	...
	$scope0_page && _scope($scope0_id, { "#childScope/0": _existing_scope($childScope) }, "__tests__/tags/mid/index.marko", 0);
}, 0, () => [leaf_default]);
