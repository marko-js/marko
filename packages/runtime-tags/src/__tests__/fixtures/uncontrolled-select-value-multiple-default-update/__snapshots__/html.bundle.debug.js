...
var template_default = _template("__tests__/template.marko", (input) => {
	...
	_attr_select_value($scope0_id, "#select/0", initialValue, void 0, () => {
		_html(`<select multiple><option${_attr_option_value("")}></option><option${_attr_option_value("a")}></option></select>`);
	});
	...
	_attr_select_value($scope0_id, "#select/3", value, undefined, () => {
		_html(`${_el_resume($scope0_id, "#select/2")}<select multiple><option${_attr_option_value("")}></option><option${_attr_option_value("b")}></option></select>`);
	});
