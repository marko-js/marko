...
const $await_content__changes = /*@__PURE__*/ _closure_get("changes", /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope._._.changes)), ($scope) => $scope._._, "__tests__/template.marko_2_changes/pending");
