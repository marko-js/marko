	...
	_try($scope0_id, "#text/0", _content_resume("__tests__/template.marko_1*content", () => {
		...
		_await($scope1_id, "#text/0", resolveAfter("outer", 1), () => {
			...
			_try($scope2_id, "#text/0", _content_resume("__tests__/template.marko_4*content", () => {
				...
				_scope_reason();
				_try($scope4_id, "#text/0", _content_resume("__tests__/template.marko_6*content", () => {
				...
				}, $scope4_id), { catch: attrTag({ content: _content_resume("__tests__/template.marko_7*content", () => {
					_scope_reason();
