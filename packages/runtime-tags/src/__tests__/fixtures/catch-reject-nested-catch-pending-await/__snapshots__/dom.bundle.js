...
const $catch_content = _content_resume("a2", "caught: <!>", "b%", 0, $catch_content__$params);
const $placeholder_content = _content_resume("a6", "loading outer...");
const $await_content__changes = _closure_get(2, ($scope) => _text($scope.c, $scope._._.b), ($scope) => $scope._._, "a4");
