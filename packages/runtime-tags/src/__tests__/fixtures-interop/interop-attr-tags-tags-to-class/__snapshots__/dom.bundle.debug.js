...
const $walks = " D l%c";
_resumed["__tests__/components/class-list.marko"] = _marko_template;
const $item_content2 = _content("__tests__/template.marko_2*content", "<em>second</em>");
const $item_content = _content("__tests__/template.marko_1*content", "<em>first</em>");
...
_resumed["__tests__/template.marko_0/onSelect"] = $onSelect;
