...
const $template = "<!><!><!><!>";
const $walks = "b%b%c";
const $inputuseClassClassLayoutsection_content__count = /*@__PURE__*/ _closure_get("count", ($scope) => _text($scope["#text/1"], $scope._.count), 0, "__tests__/template.marko_1_count#5/subscribe");
...
const $inputuseClassClassLayoutsection_content2 = _content_resume($inputuseClassClassLayoutsection_content);
