...
const $template = "<!><!><!>";
const $walks = "b%c";
const $classlayout_content__multiplier__OR__baseCount = /*@__PURE__*/ _or(7, /*@__PURE__*/ _render(($scope) => _text($scope["#text/4"], $scope._.multiplier * $scope.baseCount)));
const $classlayout_content__multiplier__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/2"], $scope._.multiplier));
...
const $classlayout_content__message = /*@__PURE__*/ _render(($scope, message) => _text($scope["#text/0"], message));
const $classlayout_content__baseCount__render = /*@__PURE__*/ _render(($scope) => _text($scope["#text/3"], $scope.baseCount));
