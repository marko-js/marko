...
const $classlayout_content = _content("__tests__/template.marko_1*content", "<h1> </h1><button id=tags><!> * <!> = <!></button>", "D l D%c%c%", $classlayout_content__setup, $classlayout_content__$params);
