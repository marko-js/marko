...
const $walks$1 = " b";
const $setup$1 = () => {};
const $input__script$1 = _script("__tests__/components/tags-spread.marko_0_input#2", ($scope) => _attrs_script($scope, "#div/0"));
...
const $walks = " D%l";
const $setup = () => {};
const $input__script = _script("__tests__/components/tags-passthrough.marko_0_input#3", ($scope) => _attrs_script($scope, "#div/0"));
...
var tags_passthrough_default = /*@__PURE__*/ _template("__tests__/components/tags-passthrough.marko", $template, $walks, 0, $input);

// components/class-thing.marko
var import_renderer = /* @__PURE__ */ __toESM(require_renderer());
var import_registry = require_registry();
var import_defineComponent = /* @__PURE__ */ __toESM(require_defineComponent());
const _marko_componentType$1 = "__tests__/components/class-thing.marko", _marko_template$1 = (0, import_vdom.t)(_marko_componentType$1);
