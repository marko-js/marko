...
var tags_layout_default = _template("b", (input) => {
	...
	_html(`</div>${_el_resume($scope0_id, "a")}<div id=passthrough>`);
	_dynamic_tag($scope0_id, "b", input.stuff.content, {}, 0, 0, _serialize_guard($scope0_reason, 1));
	_html("</div><span id=inner>");
	_dynamic_tag($scope0_id, "c", inner.content, {}, 0, 0, _serialize_guard($scope0_reason, 0));
	_html("</span>");
	...
	(0, import_dynamic_tag.default)(out, tags_layout_default, () => (0, import_attr_tag.i)(() => {
		(0, import_attr_tag.a)("stuff", (0, import_attr_tag.i)(() => {
			(0, import_attr_tag.a)("inner", { "content": (0, import_runtime_html.c)((out) => {
				out.w(`Inner ${(0, import_escape_xml.x)(state.n)}`);
			}) });
		}, {
			"class": "stuff",
			"content": (0, import_runtime_html.c)((out) => {
				out.w(`Body ${(0, import_escape_xml.x)(state.n)}`);
			})
		}));
