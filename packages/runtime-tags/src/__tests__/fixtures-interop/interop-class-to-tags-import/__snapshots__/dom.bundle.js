...
const $walks = " D l";
const $count = /*@__PURE__*/ _let(5, /*@__PURE__*/ _render(($scope) => _text($scope.b, $scope.f)));
...
const $input_count = /*@__PURE__*/ _render(($scope, input_count) => _attr($scope.a, "data-parent", input_count));
