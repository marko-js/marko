...
const _marko_load_Child = (0, import_load_tag_browser.default)("__tests__/components/child.marko", () => import("./child.mjs"), (0, import_load_tag_race_trigger.default)((0, import_load_tag_visible_trigger.default)("body"), (0, import_load_tag_idle_trigger.default)({ timeout: 100 })));
(0, import_registry.r)(_marko_componentType, () => _marko_template);
const _marko_component = {
	onCreate() {
		this.state = { value: 0 };
