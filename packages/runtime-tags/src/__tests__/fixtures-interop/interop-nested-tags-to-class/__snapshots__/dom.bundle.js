...
// template.marko
const $classlayout_content__count = /*@__PURE__*/ _closure_get(2, ($scope) => _text($scope.b, $scope._.b), 0, "a2", 1);
const $classlayout_content__setup__script = _script("a1", ($scope) => _on($scope.a, "click", function() {
...
const $classlayout_content = _content("a0", "<button id=tags> </button>", " D ", $classlayout_content__setup);
