...
const _marko_componentType = "__tests__/components/my-button.marko", _marko_template = (0, import_vdom.t)(_marko_componentType);
...
const $mybutton_content__count = /*@__PURE__*/ _closure_get("count", /*@__PURE__*/ _render(($scope) => _text($scope["#text/0"], $scope._.count)));
const $mybutton_content__setup = $mybutton_content__count;
const $mybutton_content = _content_resume("__tests__/template.marko_1_content", " ", " b", $mybutton_content__setup);
