...
_marko_template$1._ = (0, import_renderer.default)(function(input, out, _componentDef, _component, state, $global) {
	...
	out.w("none");
	out.w("</div>");
	(0, import_dynamic_tag.default)(out, tags_pinger_default, () => ({ "onPing": f("__tests__/components/class-host/index.marko/h0", _marko_class_fn(_component), _component) }), null, null, null, _componentDef, "1");
}, {
