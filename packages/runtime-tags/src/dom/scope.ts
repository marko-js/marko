...
export function createScopeInto(
  $global: Scope[typeof AccessorProp.Global],
  closestBranch: BranchScope | undefined,
  into: Scope,
) {
  Object.assign(into, {
    [AccessorProp.Id]: nextScopeId++,
