...
const _count_effect = _$.effect("packages/translator-interop/src/__tests__/fixtures/let/template.marko_0_count", _scope => _$.on(_scope["#button/0"], "click", _onClick(_scope)));
