...
const _count_effect = _effect("packages/translator-interop/src/__tests__/fixtures/let/template.marko_0_count", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
