...
const $classlayout_content = _$.registerContent("__tests__/template.marko_1_renderer", "<h1> </h1><button id=tags><!> * <!> = <!></button>", /* next(1), get, out(1), get, next(1), replace, over(2), replace, over(2), replace, out(1) */"D l D%c%c%l", $setup$classlayout$content, $params2$classlayout$content);
