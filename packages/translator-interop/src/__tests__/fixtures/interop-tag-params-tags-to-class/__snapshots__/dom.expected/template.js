...
const _multiplier$classLayoutBody_effect = _$.effect("__tests__/template.marko_1_multiplier", (_scope, {
  _: {
    multiplier
  }
...
const _multiplier$classLayoutBody = _$.registerSubscriber("__tests__/template.marko_1_multiplier/subscriber", /* @__PURE__ */_$.dynamicClosure("multiplier", (_scope, multiplier) => {
...
const _classLayoutBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRendererWithOwner("<h1> </h1><button id=tags><!> * <!> = <!></button>", /* next(1), get, out(1), get, next(1), replace, over(2), replace, over(2), replace */"D l D%c%c%", void 0, () => [_multiplier$classLayoutBody], () => _params_2$classLayoutBody));
