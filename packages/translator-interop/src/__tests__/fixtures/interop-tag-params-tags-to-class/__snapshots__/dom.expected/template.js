...
const _message$classLayout_content = /* @__PURE__ */_$.value("message/8", (_scope, message) => _$.data(_scope["#text/0"], message));
const _baseCount$classLayout_content = /* @__PURE__ */_$.value("baseCount/6", (_scope, baseCount) => {
  _$.data(_scope["#text/3"], baseCount);
  _expr_multiplier_baseCount$classLayout_content(_scope);
});
const _params_2$classLayout_content = /* @__PURE__ */_$.value("_params_2/5", (_scope, _params_2) => {
...
const _multiplier$classLayout_content = _$.registerDynamicClosure("__tests__/template.marko_1_multiplier/subscriber", "multiplier/1", (_scope, multiplier) => {
