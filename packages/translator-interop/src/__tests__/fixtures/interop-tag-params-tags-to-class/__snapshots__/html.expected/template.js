...
const _renderer = /* @__PURE__ */_createRenderer((input, _tagVar) => {
  ...
  const multiplier = 1;
  const _dynamicScope = _dynamicTagInput(_classLayout, {}, /* @__PURE__ */_createRenderer((baseCount, message) => {
