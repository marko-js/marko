...
import { register as _register, data as _data, dynamicTagAttrs as _dynamicTagAttrs, conditional as _conditional, state as _state, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _count = /* @__PURE__ */_state("count", (_scope, count) => _data(_scope["#text/1"], count));
