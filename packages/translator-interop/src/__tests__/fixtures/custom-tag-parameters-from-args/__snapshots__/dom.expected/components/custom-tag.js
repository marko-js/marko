...
import { on as _on, data as _data, dynamicTagAttrs as _dynamicTagAttrs, intersection as _intersection, effect as _effect, conditional as _conditional, intersections as _intersections, state as _state, value as _value, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _expr_x_y_effect = _effect("packages/translator-interop/src/__tests__/fixtures/custom-tag-parameters-from-args/components/custom-tag.marko_0_x_y", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
...
const _y = /* @__PURE__ */_state("y", (_scope, y) => _data(_scope["#text/2"], y), () => _intersections([_expr_x_y, _expr_Text_x_y]));
const _x = /* @__PURE__ */_state("x", (_scope, x) => _data(_scope["#text/1"], x), () => _intersections([_expr_x_y, _expr_Text_x_y]));
