...
const _count$classLayoutBody_effect = _$.effect("__tests__/template.marko_1_count", (_scope, {
  _: {
    count
  }
...
const _count$classLayoutBody = _$.registerSubscriber("__tests__/template.marko_1_count/subscriber", /* @__PURE__ */_$.dynamicClosure("count", (_scope, count) => {
  _$.data(_scope["#text/1"], count);
  _count$classLayoutBody_effect(_scope);
}));
const _classLayoutBody = _$.register("__tests__/template.marko_1_renderer", /* @__PURE__ */_$.createRendererWithOwner("<button id=tags> </button>", /* get, next(1), get */" D ", void 0, () => [_count$classLayoutBody]));
