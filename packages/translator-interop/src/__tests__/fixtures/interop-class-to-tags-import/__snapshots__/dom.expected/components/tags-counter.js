...
import { attr as _attr, on as _on, data as _data, effect as _effect, state as _state, value as _value, createRenderer as _createRenderer, createTemplate as _createTemplate } from "@marko/runtime-tags/debug/dom";
...
const _count_effect = _effect("packages/translator-interop/src/__tests__/fixtures/interop-class-to-tags-import/components/tags-counter.marko_0_count", _scope => _on(_scope["#button/0"], "click", _onClick(_scope)));
