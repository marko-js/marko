...
export default _$.createTemplate("__tests__/components/tags-layout.marko", (input, $serialize) => {
  ...
  _$.dynamicTag($scope0_id, "#text/2", input.stuff.content, {}, 0, 0, _$.serializeGuard($serialize, /* input.stuff.content */0));
  _$.write("</div>");
