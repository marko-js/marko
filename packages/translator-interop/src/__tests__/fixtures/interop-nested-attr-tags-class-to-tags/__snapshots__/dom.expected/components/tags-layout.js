...
const _inputStuffContent_input = /* @__PURE__ */_$.dynamicTagAttrs("#text/2");
const _dynamicTag = /* @__PURE__ */_$.dynamicTag("#text/2", _scope => _inputStuffContent_input(_scope, () => ({})), () => _inputStuffContent_input);
...
export const _input_stuff_content_ = /* @__PURE__ */_$.value("input_stuff_content", (_scope, input_stuff_content) => _dynamicTag(_scope, input_stuff_content), () => _dynamicTag);
