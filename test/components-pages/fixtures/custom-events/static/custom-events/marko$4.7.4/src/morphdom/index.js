$_mod.def("/marko$4.7.4/src/morphdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var specialElHandlers = require('/marko$4.7.4/src/morphdom/specialElHandlers'/*'./specialElHandlers'*/);
var componentsUtil = require('/marko$4.7.4/src/components/util-browser'/*'../components/util'*/);
var existingComponentLookup = componentsUtil.___componentLookup;
var destroyNodeRecursive = componentsUtil.___destroyNodeRecursive;
var VElement = require('/marko$4.7.4/src/runtime/vdom/vdom'/*'../runtime/vdom/vdom'*/).___VElement;
var virtualizeElement =  VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.7.4/src/components/event-delegation'/*'../components/event-delegation'*/);
