$_mod.def("/marko$4.7.4/src/components/init-components-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
...
var ComponentDef = require('/marko$4.7.4/src/components/ComponentDef'/*'./ComponentDef'*/);
