$_mod.def("/marko$4.7.4/src/components/ComponentDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.7.4/src/components/util-browser'/*'./util'*/);
