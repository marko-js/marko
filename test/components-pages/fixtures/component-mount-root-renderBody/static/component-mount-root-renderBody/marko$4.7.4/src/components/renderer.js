$_mod.def("/marko$4.7.4/src/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.7.4/src/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.7.4/src/components/ComponentsContext'/*'./ComponentsContext'*/);
...
var beginComponent = require('/marko$4.7.4/src/components/beginComponent-browser'/*'./beginComponent'*/);
var endComponent = require('/marko$4.7.4/src/components/endComponent-browser'/*'./endComponent'*/);
