$_mod.def("/marko-test$1.0.0/components-pages/fixtures/async-boundaries/components/app-init-async/component", function(require, exports, module, __filename, __dirname) { var expect = require('/chai$3.5.0/index'/*'chai'*/).expect;
