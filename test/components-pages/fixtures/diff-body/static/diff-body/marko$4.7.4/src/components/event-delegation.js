$_mod.def("/marko$4.7.4/src/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.7.4/src/components/util-browser'/*'./util'*/);
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.7.4/src/components/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
