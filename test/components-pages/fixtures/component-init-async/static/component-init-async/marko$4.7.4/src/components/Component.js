$_mod.def("/marko$4.7.4/src/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var complain = 'MARKO_DEBUG' && require('/complain$1.2.0/index'/*'complain'*/);

var domInsert = require('/marko$4.7.4/src/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var defaultCreateOut = require('/marko$4.7.4/src/runtime/createOut'/*'../runtime/createOut'*/);
var getComponentsContext = require('/marko$4.7.4/src/components/ComponentsContext'/*'./ComponentsContext'*/).___getComponentsContext;
var componentsUtil = require('/marko$4.7.4/src/components/util-browser'/*'./util'*/);
...
var RenderResult = require('/marko$4.7.4/src/runtime/RenderResult'/*'../runtime/RenderResult'*/);
...
var updateManager = require('/marko$4.7.4/src/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.7.4/src/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.7.4/src/components/event-delegation'/*'./event-delegation'*/);
