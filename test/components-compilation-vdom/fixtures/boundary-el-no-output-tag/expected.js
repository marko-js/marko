...
var marko_template = module.exports = require("marko/src/vdom").t(__filename),
    ...
    marko_componentType = marko_registerComponent("/marko-test$1.0.0/components-compilation-vdom/fixtures/boundary-el-no-output-tag/index.marko", function() {
...
marko_template.meta = {
    id: "/marko-test$1.0.0/components-compilation-vdom/fixtures/boundary-el-no-output-tag/index.marko",
    component: "./",
    tags: [
