...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-test$1.0.0/components-compilation/fixtures-deprecated/bind-widget/widget",
...
marko_template.meta = {
    legacy: true,
    id: "/marko-test$1.0.0/components-compilation/fixtures-deprecated/bind-widget/widget",
    component: "./widget",
    deps: [
