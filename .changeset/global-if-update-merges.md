...
their owning expression was merged into another node's extra (`$global`
reads are tracked at identifier-visit time, after a branch tag's analyze
merged its test) landed on the stale extra, so the merged
