...
var RENDER_BODY_TO_JSON = function() { return RENDER_BODY_TOKEN; };
...
function doInclude(input, out, throwError) {
    ...
    if (renderBody) {
        ...
        var componentDef = componentsContext && componentsContext.___componentDef;
        var willRerenderInBrowser = componentDef && (componentDef.___flags & FLAG_WILL_RERENDER_IN_BROWSER);
