...
function _init_closure_get(initId, valueAccessor, fn, getOwnerScope, resumeId, ownerValueAccessor) {
  return (_resumed[initId] = _closure_get(
    valueAccessor,
    fn,
    getOwnerScope,
    resumeId,
...
function reorderKeyed(newScopes, start, newEnd, parentNode, afterReference) {
