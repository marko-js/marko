...
Re-measured 2026-07-15 after the review-readiness phases (fixture renames, new
pairing-integrity and async-matrix guards, the rename pass, and the comment
sweep): the wire totals are byte-identical to the 2026-07-14 table — 11
payloads / 12 frames, **3002 raw / 2118 gzip / 1889 Brotli**, with per-case
rows unchanged (cross-route fragment hop 805 / 481 / 441; same-route follow-up
491 / 321 / 280; async multi-frame 368 / 299 / 277; keyed loop 902 / 601 /
530; conditional divergence 352 / 325 / 273; sparse value update 84 / 91 /
88). Raw attribution now stands at node/branch markers or references 840
(28.0%), fragment HTML 691 (23.0%), frame/runtime syntax 549 (18.3%), ordinary
values 343 (11.4%), scope fills/ids/metadata 290 (9.7%), fragment metadata 178
(5.9%), effect/registry entries 111 (3.7%), and lazy/async framing 0. The
possession echo is unchanged (keyed-loop worst case 269 raw header-value bytes
over three navigations). The representative fragment fixture's update runtime
is now 8529 min / 3354 Brotli (down from 8590 / 3378 via the review-phase
runtime deletions).
