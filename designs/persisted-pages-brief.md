...
(`x-marko-have`), CSP-safe frame application, CSS/asset delivery on
navigation, marker-cost suppression, and remaining controllable-input
edge coverage. Design docs live alongside this file in `designs/`.
