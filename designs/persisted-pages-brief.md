...
- new structure arrives as server-rendered, resumable HTML;
...
drives the existing signal graph. At the first divergent dynamic branch, the
server sends resumable HTML for the new branch and the client swaps it at the
known Marko boundary.
