 ...
 */
function emitLifecycleEvent(widget, eventType, eventMethod) {
    var listenerMethod = widget[eventMethod];

    if (listenerMethod) {
        listenerMethod.call(widget);
    }
...
function destroy(widget, removeNode, recursive) {
    ...
    if (!isRerender) {
        emitLifecycleEvent(widget, 'beforeDestroy', 'onBeforeDestroy');
    ...
    if (!isRerender) {
        emitLifecycleEvent(widget, 'destroy', 'onDestroy');
    }
}
...
Widget.prototype = widgetProto = {
    ...
    doUpdate: function (stateChanges, oldState) {
        ...
        emitLifecycleEvent(this, 'beforeUpdate', 'onBeforeUpdate');
        ...
        emitLifecycleEvent(this, 'afterUpdate', 'onAfterUpdate');
    ...
    _rerender: function(props, isReuse) {
        ...
        emitLifecycleEvent(self, 'beforeUpdate', 'onBeforeUpdate');
        ...
        updateManager.batchUpdate(function() {
            ...
            emitLifecycleEvent(self, 'afterUpdate', 'onAfterUpdate');
