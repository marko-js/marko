...
WidgetsContext.prototype = {
    ...
    addReusableWidget: function(existingWidget, newState, widgetBody) {
        ...
        reusableWidgets.push(widgetBody);
    },
    ...
    reuseWidgets: function() {
        ...
        if (reusableWidgets) {
            for (var i=0, len=reusableWidgets.length; i<len; i+=3) {
                var existingWidget = reusableWidgets[i];
                var newState = reusableWidgets[i+1];
                var widgetBody = reusableWidgets[i+2];
