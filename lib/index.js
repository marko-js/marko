...
if (typeof window === 'undefined') {
    extend(exports, require('./widgets_' + 'server'));
} else {
    extend(exports, require('./widgets_browser'));
    extend(WidgetsContext.prototype, require('./WidgetsContext_browser'));

    if (window.$) {
        try {
            extend(exports, require('./widgets_' + 'jquery'));
            require('./Widget').prototype.$ = require('./Widget_' + 'jquery'); 
        } catch(e) {}
    }
}
