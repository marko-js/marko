...
impact: low
effort: med
site: packages/runtime-tags/src/translator/util/patch/refresh.ts › isPatchFillBinding
---
...
Check: the template above under `patches: true`; `patches.debug.js` carries three `PatchValue` keys per item.
